                            ...
                            switch ($_GET['reportview']) {
                                case "zadolchf":
                                    if ($_GET['export'] == 'yes') {
                                        ...
                                        require $_SERVER['DOCUMENT_ROOT'] . '/dognet/___header.php';
                                        include 'php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf/dognet-report-reportview-spravka-zadolchf.php';
                                    }
                                    break;
                                ...
                                case "uncomplstages2":
                                    if ($_GET['export'] == 'yes') {
                                        require 'php/examples/simple/report/report-details/restr_5/reports/list/uncomplstages2/export/___header-export.php';
                                        include $_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_5/reports/list/uncomplstages2/export/___controls-export.php";
                                    } else {
                                        require $_SERVER['DOCUMENT_ROOT'] . '/dognet/___header.php';
                                        include 'php/examples/simple/report/report-details/restr_5/reports/list/uncomplstages2/dognet-report-reportview(restr_5)-list-uncomplstages.php';
                                    }
                                    break;
                                case "filterdocs":
                                    if ($_GET['export'] == 'yes') {
                            ...
                            switch ($_GET['reportview']) {
                                case "zadolchf":
                                    if (isset($_GET['export']) && $_GET['export'] == 'yes') {
                                        ...
                                        require $_SERVER['DOCUMENT_ROOT'] . '/dognet/___header.php';
                                        include 'php/examples/simple/report/report-details/restr_4/reports/spravka/zadolchf/dognet-report-reportview-spravka-zadolchf.php';
                                    }
                                    break;
                                case "zadolchf_ondate":
                                    if ($_GET['export'] == 'yes') {
                                ...
                                case "alldocsexp2":
                                    if ($_GET['export'] == 'yes') {
                                        require 'php/examples/simple/report/report-details/restr_4/reports/other/alldocsexp_v2/export/___header-export.php';
                                        include $_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_4/reports/other/alldocsexp_v2/export/___controls-export.php";
                                    } else {
                                        require $_SERVER['DOCUMENT_ROOT'] . '/dognet/___header.php';
                                        include 'php/examples/simple/report/report-details/restr_4/reports/other/alldocsexp_v2/dognet-report-reportview(restr_4)-other-alldocsexp.php';
                                    }
                                    break;
                                case "postexp":
                                    if ($_GET['export'] == 'yes') {
                                ...
                                case "uncomplstages2":
                                    if ($_GET['export'] == 'yes') {
                                        require 'php/examples/simple/report/report-details/restr_4/reports/list/uncomplstages2/export/___header-export.php';
                                        include $_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_4/reports/list/uncomplstages2/export/___controls-export.php";
                                    } else {
                                        require $_SERVER['DOCUMENT_ROOT'] . '/dognet/___header.php';
                                        include 'php/examples/simple/report/report-details/restr_4/reports/list/uncomplstages2/dognet-report-reportview(restr_4)-list-uncomplstages.php';
                                    }
                                    break;
                                case "filterdocs":
                                    if ($_GET['export'] == 'yes') {
