...
if ( !isset($_POST['kodblankwork_tab4_summadop']) || !is_numeric($_POST['kodblankwork_tab4_summadop']) ) {
	echo json_encode( [ "data" => [] ] );
}
else {
$_KODBLANKWORK = $_POST['kodblankwork_tab4_summadop'];
$_KODTIPBLANK = $_POST['kodtipblank_tab4_summadop'];
