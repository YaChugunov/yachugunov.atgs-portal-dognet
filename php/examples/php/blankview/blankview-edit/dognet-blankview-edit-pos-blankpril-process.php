...
#
			...
			// Переименовываем файл
				...
				if ($_QRY_paperfiles[0]['flag'] == "0") {
					...
					$__newFileName = "NEW-B-{$_numberpril}-POS-DO-{$_kodblankwork}";
...
if ( !isset($_POST['kodblankwork_tab2_blankpril']) || !is_numeric($_POST['kodblankwork_tab2_blankpril']) ) {
	echo json_encode( [ "data" => [] ] );
}
else {
$_KODBLANKWORK = $_POST['kodblankwork_tab2_blankpril'];
