...
if ( !isset($_POST['zayvfrom_year']) || !is_numeric($_POST['zayvfrom_year']) ) {
	echo json_encode( [ "data" => [] ] );
}
else {
$__zayvfrom_year =$_POST['zayvfrom_year'];
...
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
	->on( 'postCreate', function ( $editor_doczayv, $id, $values, $row ) {
		updateFields( $editor_doczayv->db(), 'CRT', $id, $values );
	} )
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
	->on( 'postEdit', function ( $editor_doczayv, $id, $values, $row ) {
		updateFields( $editor_doczayv->db(), 'UPD', $id, $values );
	} )
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
	->on( 'preRemove', function ( $editor_doczayv, $id, $values ) {
		delAttachment( $editor_doczayv->db(), $id );
		updateFields( $editor_doczayv->db(), 'DEL', $id, $values );
	} )
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
...
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
	...
	->where( 'YEAR(dognet_doczayv.datezayv)', $__zayvfrom_year, '>=' )
	->process( $_POST )
	->json();
}
