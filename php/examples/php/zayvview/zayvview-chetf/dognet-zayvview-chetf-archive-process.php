...
Editor::inst($db, 'dognet_doczayvchetf')
	->fields(
		...
		Field::inst('dognet_doczayvchetf_files.kodzayvchetf'),
		// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
	...
	#
	#
	->leftJoin('dognet_doczayvchetf_files', 'dognet_doczayvchetf_files.kodzayvchetf', '=', 'dognet_doczayvchetf.kodzayvchetf')
