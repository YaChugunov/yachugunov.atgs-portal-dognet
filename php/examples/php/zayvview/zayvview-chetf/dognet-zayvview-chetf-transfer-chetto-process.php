...
if (!isset($_POST['chFrom_year']) || !is_numeric($_POST['chFrom_year'])) {
	...
	Editor::inst($db, 'dognet_doczayvchet')
		...
		->leftJoin('sp_contragents', 'sp_contragentskodpost', '=', 'dognet_doczayvchet.kodpost')
		...
		->where('YEAR(dognet_doczayvchet.zayvchetdate)', $__chFrom_year)
		->process($_POST)
		->json();
}
