...
if ( !isset($_POST['kodzayv']) || !is_numeric($_POST['kodzayv']) ) {
  ...
  ->fields(
    ...
    Field::inst( 'dognet_doczayvchet_files.file_url' ), 
    Field::inst( 'dognet_doczayvchetf_files.file_url' )
  )
	...
	->leftJoin( 'dognet_doczayvchet_files', 'dognet_doczayvchet_files.kodzayvchet', '=', 'dognet_doczayvchet.kodzayvchet' )
	->leftJoin( 'dognet_doczayvchetf_files', 'dognet_doczayvchetf_files.kodzayvchet', '=', 'dognet_doczayvchet.kodzayvchet' )

  ->where( 'dognet_doczayvchet.kodzayv', $_POST['kodzayv'] )
  ->process($_POST)
  ->json();
}
?>