...
if ($_KODSHAB == "1" or $_KODSHAB == "3") {
	...
	if (!isset($_POST['koddocsubpodr2']) || !is_numeric($_POST['koddocsubpodr2'])) {
		...
		if (empty($_POST['kodchfsubpodr_avchf']) || !isset($_POST['kodchfsubpodr_avchf']) || !is_numeric($_POST['kodchfsubpodr_avchf'])) {
			...
			Editor::inst($db, 'dognet_docavsubpodr')
				...
				// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
				// ->leftJoin('dognet_docavsplitsubpodr', 'dognet_docavsplitsubpodr.kodavsubpodr', '=', 'dognet_docavsubpodr.kodavsubpodr')
