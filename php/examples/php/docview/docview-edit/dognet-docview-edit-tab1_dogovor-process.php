        ...
        Field::inst('dognet_docbase.kodblankwork')
            ->options(
                Options::inst()
                    ...
                    ->value('kodblankwork')
                    ->label(['yearblankwork', 'numberblankwork', 'kodstatusblank', 'nameblankwork'])
                    ->render(function ($row) {
        ...
        Field::inst('dognet_docbase.kodobject')
            ->options(
                Options::inst()
                    ->table('sp_objects')
                    ->value('kodobject')
                    ->label(['kodobject', 'nameobjectshot'])
        ...
        Field::inst('dognet_docbase.kodstatus')
            ->options(
                Options::inst()
                    ...
                    ->value('kodstatus')
                    ->label(['kodstatus', 'statusnameshot'])
                    ->render(function ($row) {
        ...
        Field::inst('dognet_docbase.kodispolruk')
            ->options(
                Options::inst()
                    ...
                    ->value('kodispolruk')
                    ->label(['kodispolruk', 'ispolrukname'])
                    ->render(function ($row) {
        ...
        Field::inst('dognet_docbase.koddened')
            ->options(
                Options::inst()
                    ...
                    ->value('koddened')
                    ->label(['koddened', 'namedenedshot', 'namedenedfull'])
                    ->render(function ($row) {
