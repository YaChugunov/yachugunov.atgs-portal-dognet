...
#
#
		$_QRY = $db->sql( "SELECT chetfnumber, kodkalplan FROM dognet_kalplanchf WHERE id=".$id )->fetchAll();
...
#
	// Делаем запись в системный лог
	// Все параметры в таблице portal_log_messages
		PORTAL_SYSLOG('99940010', '0000003', $id, $_QRY2[0]['kodchfact'], $_QRY2[0]['chetfnumber'], $_QRY2[0]['kodkalplan']);
#
#
		KALPLANCHF_PR_ZADOLG_CHF( $db, "kalplanchf", $id, $action_kalplanchf, NULL );
#
