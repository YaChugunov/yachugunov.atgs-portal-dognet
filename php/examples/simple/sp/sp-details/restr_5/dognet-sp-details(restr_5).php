...
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/sp/sp-details/restr_5/tabs/css/sp-details-common-tables.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/sp/sp-details/restr_5/tabs/css/sp-details-common-customForm.css">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
							<ul id="main-tabs-menu" class="nav nav-tabs">
								...
								<li id="tab-5-link"><a data-toggle="tab" href="#tab-5" title="">Исполнители (руководство)</a></li>
								<li id="tab-6-link"><a data-toggle="tab" href="#tab-6" title="">Типы договоров</a></li>
								<li id="tab-7-link"><a data-toggle="tab" href="#tab-7" title="">Статусы договоров</a></li>
							</ul>
							<div class="tab-content">
								<div id="tab-1" class="tab-pane fade in active">
									<?php include("tabs/dognet-sp-details(restr_5)-tab1_zakazchiki.php"); ?>
								</div>
								<div id="tab-2" class="tab-pane fade">
									<?php include("tabs/dognet-sp-details(restr_5)-tab2_subpodr.php"); ?>
								</div>
								<div id="tab-8" class="tab-pane fade">
									<?php include("tabs/dognet-sp-details(restr_5)-tab8_contact.php"); ?>
								</div>
								<div id="tab-3" class="tab-pane fade">
									<?php include("tabs/dognet-sp-details(restr_5)-tab3_objects.php"); ?>
								</div>
								<div id="tab-4" class="tab-pane fade">
									<?php include("tabs/dognet-sp-details(restr_5)-tab4_ispolniteli.php"); ?>
								</div>
								<div id="tab-5" class="tab-pane fade">
									<?php include("tabs/dognet-sp-details(restr_5)-tab5_ispolniteliruk.php"); ?>
								</div>
								<div id="tab-6" class="tab-pane fade">
									<?php include("tabs/dognet-sp-details(restr_5)-tab6_doctypes.php"); ?>
								</div>
								<div id="tab-7" class="tab-pane fade">
									<?php include("tabs/dognet-sp-details(restr_5)-tab7_docstatus.php"); ?>
								</div>
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	...
	$('#tab-5-link').on( 'click', function () {
		document.getElementById("dognet-subsubtitle").innerHTML = "Исполнители (рук)";
	} );
</script>
