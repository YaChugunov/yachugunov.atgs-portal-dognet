...
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/sp/sp-details/restr_3/tabs/css/sp-details-common-tables.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/sp/sp-details/restr_3/tabs/css/sp-details-common-customForm.css">
						...
						<div class="col-xs-12 col-sm-12 col-md-12">
							...
							<div class="tab-content">
								<div id="tab-1" class="tab-pane fade in active">
									<?php include("tabs/dognet-sp-details(restr_3)-tab1_zakazchiki.php"); ?>
								</div>
								<div id="tab-2" class="tab-pane fade">
									<?php include("tabs/dognet-sp-details(restr_3)-tab2_subpodr.php"); ?>
								</div>
								<div id="tab-3" class="tab-pane fade">
									<?php include("tabs/dognet-sp-details(restr_3)-tab3_objects.php"); ?>
								</div>
								<div id="tab-4" class="tab-pane fade">
									<?php include("tabs/dognet-sp-details(restr_3)-tab4_ispolniteli.php"); ?>
								</div>
								<div id="tab-5" class="tab-pane fade">
									<?php include("tabs/dognet-sp-details(restr_3)-tab5_ispolniteliruk.php"); ?>
								</div>
							</div>
						</div>
					</div>
