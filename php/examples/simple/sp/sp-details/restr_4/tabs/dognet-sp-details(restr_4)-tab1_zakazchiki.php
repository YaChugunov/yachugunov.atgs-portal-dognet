...
//
			table_tab1_zakazchiki
				.columns(2)
				.search($("#tab1_zakFullNameSearch_text").val())
				.draw();
//
			table_tab1_zakazchiki
				.columns(3)
...
//
		$('#tab1_zakazchikiSearch_btnClear').click(function(e){
			$('#tab1_zakFullNameSearch_text').val('');
			$('#tab1_zakNameSearch_text').val('');
			$('#tab1_zakRukSearch_text').val('');
			$('#tab1_zakAddrSearch_text').val('');
			$('#tab1_zakTelSearch_text').val('');
...
// ----- ----- ----- ----- -----
		$("#tab1_zakFullNameSearch_text").on("keyup", function(event) {
...
// :::
include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/sp/sp-details/restr_4/tabs/forms/sp-details-tab1_zakazchiki-customForm.php");
include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/sp/sp-details/restr_4/tabs/forms/sp-details-tab1_zakazchiki-filters.php");
// ----- ----- ----- ----- -----
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/sp/sp-details/restr_4/tabs/css/sp-details-tab1_zakazchiki-main.css">
<section>
