...
<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		editor_tab8_contact
			.on('open', function() {
				$('#kodzakaz_filter').val('');
				if (($('#DTE_Field_dognet_spcontact-kodzakaz').value) != editor_tab8_contact.field('dognet_spcontact.kodzakaz').get()) {}
				// Поиск в ниспадающем списке по содержимому текстового поля для ответного документа
				// $('#DTE_Field_dognet_spcontact-kodzakaz').filterByText(editor_tab8_contact, $('#kodzakaz_filter'), 'dognet_spcontact.kodzakaz', false);
				// --- -- --- -- ---
				$('#koddoc_filter').val('');
				if (($('#DTE_Field_dognet_spcontact-koddoc').value) != editor_tab8_contact.field('dognet_spcontact.koddoc').get()) {}
				// Поиск в ниспадающем списке по содержимому текстового поля для ответного документа
				// $('#DTE_Field_dognet_spcontact-koddoc').filterByText(editor_tab8_contact, $('#koddoc_filter'), 'dognet_spcontact.koddoc', false);
				//
				//
...
// :::
include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/sp/sp-details/restr_4/tabs/forms/sp-details-tab8_contact-customForm.php");
// ----- ----- ----- ----- -----
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/sp/sp-details/restr_4/tabs/css/sp-details-tab8_contact-main.css">
<section>
