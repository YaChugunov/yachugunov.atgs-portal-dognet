...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/sp/sp-details/restr_4/tabs/css/sp-details-tab1_zakazchiki-filters.css">
    ...
    <div id="filters-tab1_zakazchiki-panel" class="panel-collapse collapse">
			<div id="filters-tab1_zakazchiki" class="panel-body space30">
				...
				<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
					<div class="form-group space10" style="width:100%">
						<label for="tab1_zakFullNameSearch_text"><b>Полное название :</b></label>
						<input type="text" id="tab1_zakFullNameSearch_text" class="form-control" placeholder="Все" name="tab1_zakFullNameSearch_text">
					</div>
				</div>
