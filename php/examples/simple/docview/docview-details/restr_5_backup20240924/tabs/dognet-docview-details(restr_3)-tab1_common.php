...
/* 					var blank = ' / Бланк № '+row.data().dognet_docblankwork.numberblankwork+' / '+row.data().dognet_docblankwork.nameblankwork; */
			...
			if (d.dognet_docbase.usecreatekcp === '1') {
				var specialcomm = "<span style='background-color: rgb(255, 242, 204)'>Договор подписан на электронной площадке</span>";
			}
			rowData = table_tab1_common.row( row );
			d.DN = (d.dognet_docbase.daynachdoc < 10) ? d.dognet_docbase.daynachdoc.padStart(2,'0') : d.dognet_docbase.daynachdoc;
			d.MN = (d.dognet_docbase.monthnachdoc < 10) ? d.dognet_docbase.monthnachdoc.padStart(2,'0') : d.dognet_docbase.monthnachdoc;
			d.DE = (d.dognet_docbase.dayenddoc < 10) ? d.dognet_docbase.dayenddoc.padStart(2,'0') : d.dognet_docbase.dayenddoc;
			d.ME = (d.dognet_docbase.monthenddoc < 10) ? d.dognet_docbase.monthenddoc.padStart(2,'0') : d.dognet_docbase.monthenddoc;
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-details/restr_3/tabs/css/docview-details-common-tab1_common.css">
<section>
