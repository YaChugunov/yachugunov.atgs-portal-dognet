...
$(document).ready(function() {
	...
	table_tab10_contsp = $('#docview-details-tab10_contsp').DataTable( {
		...
		ajax: {
			url: "php/examples/simple/docview/docview-details/restr_3/tabs/process/dognet-docview-details-tab10_contsp-process.php",
			type: "POST"
		},
		serverSide: true,
		columns: [
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-details/restr_3/tabs/css/docview-details-common-tab10_contsp.css">
<section>
