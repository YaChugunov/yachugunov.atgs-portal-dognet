...
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-details/restr_3/tabs/css/docview-details-common-tabs.css">

<script type="text/javascript" language="javascript" class="init">
var urlAjax_tab_countRecords =
    "<?php echo __ROOT; ?>/dognet/php/examples/simple/docview/docview-details/php/ajaxrequests/ajaxReq-tab-countRecords.php";
// ** ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- **
...
<div class="container">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <?php include "dognet-docview-details(restr_3)-main.php"; ?>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div id="main-tabs">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <ul id="main-tabs-menu" class="nav nav-tabs">
                            ...
                            <li><a data-toggle="tab" href="#tab-6" title="">Субподряд</a><span
                                      class="main-tab6 itemCnt"></span></li>
                        ...
                        <div class="tab-content">
                            <div id="tab-1" class="tab-pane fade in active">
                                <?php
include "tabs/dognet-docview-details(restr_3)-tab1.php";
?>
                            </div>
                            <div id="tab-2" class="tab-pane fade">
                                <?php include "tabs/dognet-docview-details(restr_3)-tab2.php"; ?>
                            </div>
                            <div id="tab-4" class="tab-pane fade">
                                <?php include "tabs/dognet-docview-details(restr_3)-tab4.php"; ?>
                            ...
                            <div id="tab-5" class="tab-pane fade">
                                <?php include "tabs/dognet-docview-details(restr_3)-tab5_zadolg.php"; ?>
                            </div>
                            <div id="tab-6" class="tab-pane fade">
                                <?php include "tabs/dognet-docview-details(restr_3)-tab6.php"; ?>
                            </div>
                            <div id="tab-7" class="tab-pane fade">
                                <?php
/*                                         include("tabs/dognet-docview-details(restr_3)-tab7_zayvdocs.php");  */
include "tabs/dognet-docview-details(restr_3)-tab7.php";
?>
                            </div>
                            <div id="tab-8" class="tab-pane fade">
                                <?php include "tabs/dognet-docview-details(restr_3)-tab8_paperotgr.php"; ?>
                            </div>
                            <div id="tab-9" class="tab-pane fade">
                                <?php include "tabs/dognet-docview-details(restr_3)-tab9_paperacts_warning.php"; ?>
                            </div>
                            <div id="tab-10" class="tab-pane fade">
                                <?php include "tabs/dognet-docview-details(restr_3)-tab10.php"; ?>
                            </div>
                        </div>
                    </div>
                </div>
