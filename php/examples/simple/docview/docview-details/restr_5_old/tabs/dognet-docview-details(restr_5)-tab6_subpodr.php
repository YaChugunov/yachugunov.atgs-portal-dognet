	...
	$(document).ready(function() {
		...
		var editor_tab5_chfsubpodr = new $.fn.dataTable.Editor({
			...
			ajax: {
				...
				data: function(d) {
					var selected = table_tab6_subpodr.row({
						selected: true
					});
					if (selected.any()) {
		...
		var editor_tab5_oplchfsubpodr = new $.fn.dataTable.Editor({
			...
			ajax: {
				...
				data: function(d) {
					var selected2 = table_tab6_subpodr.row({
						selected: true
					});
					if (selected2.any()) {
		...
		editor_tab6_subpodr.on('open', function() {
			$(".modal-dialog").css("width", "80%");
		});
		editor_tab6_subpodr.on('close', function() {
			$(".modal-dialog").css("width", "80%");
		});
