...
if (mysqli_num_rows($_QRY_ZAYV)>0) {
	include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/docview/docview-details/restr_5/tabs/dognet-docview-details(restr_5)-tab7_zayv_main.php");
?>
<div id="doc-details-tabs" class="doc-details-tabs" style="width:100%">
	...
	<div class="tab-content" style="padding:5px; width:100%">
		<div id="doc-details-tab7-2" class="tab-pane fade in active">
			<?php include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/docview/docview-details/restr_5/tabs/dognet-docview-details(restr_5)-tab7_zayv_child_dop.php"); ?>
		</div>
		<div id="doc-details-tab7-3" class="tab-pane fade">
			<?php include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/docview/docview-details/restr_5/tabs/dognet-docview-details(restr_5)-tab7_zayv_files.php"); ?>
		</div>
		<div id="doc-details-tab7-4" class="tab-pane fade">
			<?php // include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/docview/docview-details/restr_5/tabs/dognet-docview-details(restr_5)-tab7_zayv_child_dopspec.php"); ?>
		</div>
		<div id="doc-details-tab7-5" class="tab-pane fade">
			<?php include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/docview/docview-details/restr_5/tabs/dognet-docview-details(restr_5)-tab7_zayv_child_chets.php"); ?>
		</div>
		<div id="doc-details-tab7-6" class="tab-pane fade">
			<?php include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/docview/docview-details/restr_5/tabs/dognet-docview-details(restr_5)-tab7_zayv_child_dop-docspec.php"); ?>
		</div>
	</div>
</div>
<?php
