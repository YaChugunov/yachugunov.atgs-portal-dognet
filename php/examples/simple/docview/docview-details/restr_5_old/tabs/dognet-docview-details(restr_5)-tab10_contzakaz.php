<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		table_tab10_contzakaz = $('#docview-details-tab10_contzakaz').DataTable({
			...
			ajax: {
				url: "php/examples/simple/docview/docview-details/restr_5/tabs/process/dognet-docview-details-tab10_contzakaz-process.php",
				type: "POST"
			},
			serverSide: true,
			columns: [{
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-details/restr_5/tabs/css/docview-details-common-tab10_contzakaz.css">
<section>
