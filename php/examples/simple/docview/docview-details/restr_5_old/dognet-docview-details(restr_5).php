...
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-details/restr_5/tabs/css/docview-details-common-tabs.css">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12">
				<?php include("dognet-docview-details(restr_5)-main.php"); ?>
			</div>
			<div class="col-xs-12 col-sm-12 col-md-12">
				<div id="main-tabs">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
							<ul id="main-tabs-menu" class="nav nav-tabs">
								...
								<li style="float:right"><a href="dognet-docview.php?docview_type=edit&uniqueID=<?php echo $_GET['uniqueID']; ?>" title="В режим редактирования"><span class="glyphicon glyphicon-pencil"></span></a></li>
								<li style="float:right"><a href="dognet-docview.php?docview_type=current" title="В список текущих договоров"><span class="glyphicon glyphicon-th-list"></span></a></li>
							</ul>
							<div class="tab-content">
								<div id="tab-1" class="tab-pane fade in active">
									<?php include("tabs/dognet-docview-details(restr_5)-tab1.php"); ?>
								</div>
								<div id="tab-2" class="tab-pane fade">
									<?php include("tabs/dognet-docview-details(restr_5)-tab2.php"); ?>
								</div>
								<div id="tab-4" class="tab-pane fade">
									<?php include("tabs/dognet-docview-details(restr_5)-tab4.php"); ?>
								</div>
								<div id="tab-5" class="tab-pane fade">
									<?php include("tabs/dognet-docview-details(restr_5)-tab5_zadolg.php"); ?>
								</div>
								<div id="tab-6" class="tab-pane fade">
									<?php include("tabs/dognet-docview-details(restr_5)-tab6.php"); ?>
								</div>
								<div id="tab-7" class="tab-pane fade">
									<?php include("tabs/dognet-docview-details(restr_5)-tab7.php"); ?>
								</div>
								<div id="tab-8" class="tab-pane fade">
									<?php include("tabs/dognet-docview-details(restr_5)-tab8_paperotgr.php"); ?>
								</div>
								<div id="tab-9" class="tab-pane fade">
									<?php include("tabs/dognet-docview-details(restr_5)-tab9_paperacts_warning.php"); ?>
								</div>
								<div id="tab-10" class="tab-pane fade">
									<?php include("tabs/dognet-docview-details(restr_5)-tab10.php"); ?>
								</div>
							</div>
						</div>
					</div>
