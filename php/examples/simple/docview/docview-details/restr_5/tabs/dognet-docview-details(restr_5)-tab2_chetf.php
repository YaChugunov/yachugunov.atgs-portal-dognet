...
; ?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-details/restr_5/tabs/css/docview-details-common-tab2_chetf.css">
...
// END ::: BLOCK CHF_1
    ...
    //
    //
} else {; //; //; // ----- ----- ----- ----- ----- ----- ----- ----- ----- -----; // Блок вывода счетов-фактур для договоров без календарного плана (этапов); // BEGIN ::: BLOCK CHF_0
    ?>
        <tr style="background-color:#f7f7f7; color:#111">
