...
; ?>
<link rel="stylesheet"
  href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-details/restr_5/tabs/css/docview-details-common-tab2_avans.css">
...
else {; //; //; // ----- ----- ----- ----- ----- ----- ----- ----- ----- -----; // Блок вывода авансовых платежей для договоров без календарного плана (этапов); // BEGIN ::: BLOCK AV_0
    ?>
    <tr style="background-color:#f7f7f7; color:#111">
