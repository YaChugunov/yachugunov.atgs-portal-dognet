...
?>
<link rel="stylesheet"
  href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-details/restr_3/tabs/css/docview-details-common-tab2_chetf.css">
      ...
      <tbody>
        ...
        <tr style="background-color:#f7f7f7; color:#111">
          <td class="docview-details-tab2-chetfzadolg text-center"
            style="font-size:1.0em; font-weight:700; border-bottom:none"><a
              href="#tab2-chetf-row-<?php echo $row_getKalplan['kodkalplan']; ?>" data-toggle="collapse"><span
                class='glyphicon glyphicon-option-vertical'></span></a></td>
          <td class="docview-details-tab2-chetfzadolg-numberstage text-center"
            style="font-size:1.0em; font-weight:700; border-bottom:none"><?php echo $row_getKalplan['numberstage']; ?>
          </td>
        ...
        <tr id="tab2-chetf-row-<?php echo $row_getKalplan['kodkalplan']; ?>" class="collapse in">
          <td colspan="8" class="docview-details-tab2-chetfzadolg-collapse">
            <table id="docview-details-tab2-chetfzadolg-collapse-table" class="table table-responsive display compact"
              cellspacing="0" width="100%">
              <tbody>
                <?php
                ...
                <tr>
                  ...
                  <td class="docview-details-tab2-chetfzadolg-summastage text-right">
                    <?php echo number_format((float)($row_getChetf['chetfsumma']), 2, '.', ' ') . $__dened; ?></td>
                  <td class="docview-details-tab2-chetfzadolg-summastage text-right">
                ...
                <tr>
                  ...
                  <td></td>
                  <td class="docview-details-tab2-chetfzadolg-summastage text-right">
                    <?php echo number_format((float)($row_getOplatachf['summaopl']), 2, '.', ' ') . $__dened; ?></td>
                  <td colspan="2"></td>
                </tr>
                <?php
                ...
                <tr>
                  ...
                  <td></td>
                  <td class="docview-details-tab2-chetfzadolg-summastage text-right">
                    <?php echo number_format((float)($row_getAvanschf['summaoplav']), 2, '.', ' ') . $__dened; ?></td>
                  <td></td>
                </tr>
                <?php
        ...
        <tr id="tab2-chetf-row-<?php echo $row_getKalplan['kodkalplan']; ?>" class="collapse in">
          ...
          <td colspan="6" class="docview-details-tab2-chetfzadolg-collapse">
            <table id="docview-details-tab2-chetfzadolg-collapse-table" class="table table-responsive display compact"
              ...
              <tbody>
                <tr>
                  <td class="docview-details-tab2-message text-left text-danger" style="text-align:left">Счетов-фактур
    ...
    <tr id="tab2-chetf-row-<?php echo $varKoddoc; ?>" class="collapse in">
      ...
      <td colspan="6" class="docview-details-tab2-chetfzadolg-collapse">
        <table id="docview-details-tab2-chetfzadolg-collapse-table" class="table table-responsive display compact"
          ...
          <tbody>
            <tr>
              <td class="docview-details-tab2-message text-left text-danger" style="text-align:left">Счетов-фактур по
