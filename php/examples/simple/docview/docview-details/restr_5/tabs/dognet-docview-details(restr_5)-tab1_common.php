...
$(document).ready(function() {
    ...
    table_tab1_common = $('#docview-details-tab1_common').DataTable({
        ...
        createdRow: function(row, d, dataIndex) {
            ...
            var specialcomm = (d.dognet_docbase.usecreatekcp == '1') ?
...
; ?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-details/restr_5/tabs/css/docview-details-common-tab1_common.css">
<section>
