...
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-details/restr_5/tabs/css/docview-details-common-tabs.css">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="tab-content">
                            <div id="tab-1" class="tab-pane fade in active">
                                <?php
include "tabs/dognet-docview-details(restr_5)-tab1.php";
?>
                            </div>
...
; ?>
                            ...
                            <div id="tab-7" class="tab-pane fade">
                                <?php
/*                                         include("tabs/dognet-docview-details(restr_5)-tab7_zayvdocs.php");  */
include "tabs/dognet-docview-details(restr_5)-tab7.php";
?>
                            </div>
