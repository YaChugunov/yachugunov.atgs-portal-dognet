...
//
	table_zayv_main = $('#docview-zayv-main').DataTable( {
		dom: "<'row'<'col-sm-5'><'col-sm-4'><'col-sm-3'>>" + "<'row'<'col-sm-12'tr>>" + "<'row'<'col-sm-1'B><'col-sm-5'i><'col-sm-6'p>>",
		language: {
			url: "php/examples/simple/docview/docview-details/dt_russian-tab7_zayv_main.json"
		},
		ajax: {
			url: "php/examples/php/docview/docview-details/dognet-docview-details-tab7_zayv_main-process.php",
			type: "POST"
		},
		serverSide: true,
...
// Array to track the ids of the details displayed rows
  ...
  $('#docview-zayv-main tbody').on( 'click', 'tr td.details-control', function () {
      ...
      if ( row.child.isShown() ) {
		...
		rowData.child( <?php include('templates/docview-details_tab7_zayv_main.tpl'); ?> ).show();
...
//
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-details/restr_4/tabs/css/docview-details-common-tab7_zayv_main.css">
<h3 class="docview-details-title2 text-right">Заявки к договору</h3>
<div class="demo-html"></div>
<table id="docview-zayv-main" class="table table-responsive table-bordered display compact" cellspacing="0" width="100%">
	<thead>
		<tr>
