...
$(document).ready(function() {
    ...
    table_tab10_contblank = $('#docview-details-tab10_contblank').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/docview/docview-details/restr_4/tabs/process/dognet-docview-details-tab10_contblank-process.php",
            type: "POST"
        },
        serverSide: true,
        columns: [{
        ...
        createdRow: function(row, d, dataIndex) {
            ...
            if (d.dognet_docblankwork.kodtipblank == "PIR") {
                d.lastname = d.dognet_blankdocpir.nameendcontact;
                d.firstname = d.dognet_blankdocpir.namefistcontact;
                d.midname = d.dognet_blankdocpir.namesecondcontact;
                d.telrab = d.dognet_blankdocpir.numbertelrab;
                d.telmob = d.dognet_blankdocpir.numbertelmob;
                d.telfax = d.dognet_blankdocpir.numbertelfax;
                d.email = d.dognet_blankdocpir.nameemail;
                d.dolj = d.dognet_blankdocpir.namedoljcontact;
                d.dop1 = d.dognet_blankdocpir.dopcontact1;
            ...
            rowData.child(<?php include('templates/docview-details_tab10_contblank.tpl'); ?>)
                .show();
        }
    });
});
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-details/restr_4/tabs/css/docview-details-common-tab10_contblank.css">
<section>
