...
date_default_timezone_set('Europe/Moscow');
	...
	$__title = 'Договор';
	$__subtitle = "Текущие договора";
	$__subsubtitle = "Расширенный поиск";
...
<div class="container">
	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12">
			<?php include("dognet-docview-search(restr_4)-main.php"); ?>
		</div>
	</div>
	<div class="row space20">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<?php // include($_SERVER['DOCUMENT_ROOT']."/dognet/_assets/includes/dognet_search-bottom-legend.php"); ?>
		</div>
	</div>
</div>
