...
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-search/restr_3/css/docview-search-main.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-search/restr_3/css/docview-search-filters.css">
<?php
//
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
//
...
<section>
                ...
                <div id="docview-search-filters" class="row">
                    ...
                    <div class="col-xs-12 col-sm-5 col-md-3 col-lg-3 space20">
                        <div class="form-group space10" style="width:100%">
                            ...
                            <select id="ZakazSelector1" class="form-control">
                                ...
                                ?>
                                    <option value='<?php echo $_ROW_ZAK["kodcontragent"]; ?>'>
                                        <?php echo $_ROW_ZAK["nameshort"]; ?></option>
                                <?php
                                }
                                ?>
                            </select>
                    ...
                    <div class="col-xs-12 col-sm-5 col-md-3 col-lg-3 space20">
                        <div class="form-group space10" style="width:100%">
                            ...
                            <select id="ObjectSelector1" class="form-control">
                                ...
                                ?>
                                    <option value='<?php echo $_ROW_OBJ["kodobject"]; ?>'>
                                        <?php echo $_ROW_OBJ["nameobjectshot"]; ?></option>
                                <?php
                                }
                                ?>
                            </select>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-2 col-lg-2 space20">
                        <div class="form-group space10" style="width:100%">
                            ...
                            <select id="TypeSelector1" class="form-control">
                                ...
                                ?>
                                    <option value='<?php echo $_ROW_TIP["kodtip"]; ?>'><?php echo $_ROW_TIP["nametip"]; ?>
                                    </option>
                                <?php
                                }
                                ?>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-2 col-lg-2 space20">
                        <div class="form-group space10" style="width:100%">
                            ...
                            <select id="StatusSelector1" class="form-control">
                                ...
                                ?>
                                    <option value='<?php echo $_ROW_STS["kodstatus"]; ?>'>
                                        <?php echo $_ROW_STS["statusnameshot"]; ?></option>
                                <?php
                                }
                                ?>
                            </select>
                    ...
                    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 space20">
                        <div class="form-group space10" style="width:100%">
                            ...
                            <select id="IspSelector1" class="form-control">
                                ...
                                ?>
                                    <option value='<?php echo $_ROW_ISP["kodispol"]; ?>'>
                                        <?php echo $_ROW_ISP["ispolnameshot"]; ?></option>
                                <?php
                                }
                                ?>
                            </select>
                    ...
                    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 space20">
                        <div class="form-group space10" style="width:100%">
                            ...
                            <select id="IsprukSelector1" class="form-control">
                                ...
                                ?>
                                    <option value='<?php echo $_ROW_ISPRUK["kodispolruk"]; ?>'>
                                        <?php echo $_ROW_ISPRUK["ispolrukname"]; ?></option>
                                <?php
                                }
                                ?>
                            </select>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-right">
                        <div class="input-group-btn">
                            <button id="columnSearch_btnApply" class="btn btn-default" type="submit">Применить
                                фильтры</button>
        ...
        <div id="docsearch-result">
            ...
            <table id="docview-doc-main" class="table table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    //
                    //
                    $qry = "SELECT * FROM dognet_docbase WHERE " . $qryPart . " AND kodshab<>'0' AND numberchet='' AND koddel<>'99'";
                    $_QRY_FILTER_DOCS = mysqlQuery($qry);
                    /* 	$_QRY_FILTER_DOCS = mysqlQuery( "SELECT * FROM dognet_docbase WHERE koddel='99'" ); */
                    if (mysqli_num_rows($_QRY_FILTER_DOCS) >= 1 && mysqli_num_rows($_QRY_FILTER_DOCS) <= 20) {
                        //
                        // ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
                        //
                    ...
                    ?>
                            <tr id="docview-filter-row-<?php echo $_ROW_FILTER_DOCS['koddoc']; ?>" class="collapse in">
                                ...
                                <td class="docview-filter-docnumber text-center" style="">
                                    <?php echo $_ROW_FILTER_DOCS['docnumber']; ?></td>
                                <td class="docview-filter-yearnachdoc text-center" style="">
                                    <?php echo $_ROW_FILTER_DOCS['yearnachdoc']; ?></td>
                                <td class="docview-filter-docnameshot text-center" style="">
                                    <?php echo $_ROW_FILTER_DOCS['docnameshot']; ?></td>
                                <td class="docview-filter-url text-center" style="">
                                    <?php echo '<a href="dognet-docview.php?docview_type=details&uniqueID=' . $_ROW_FILTER_DOCS['koddoc'] . '" target="_blank"><span class="glyphicon glyphicon-list-alt"></span></a>'; ?>
                                </td>
                            </tr>
                        <?php
                        }
                    } elseif (mysqli_num_rows($_QRY_FILTER_DOCS) > 20) {
                        ?>
                        <tr id="docview-filter-row-<?php echo $_ROW_FILTER_DOCS['koddoc']; ?>" class="collapse in">
                            <td colspan="5" class="">
                                <div class="text-center" style="padding:10px">
                                    <span style="color:#951402; font-size:1.5em; font-weight:300; font-family:'Oswald', sans-serif">Найдено
                                        более 20-ти договоров. Попробуйте сузить параметры поиска.</span>
                                </div>
                            </td>
                        </tr>
                    <?php
                    ...
                    ?>
                        <tr id="docview-filter-row-<?php echo $_ROW_FILTER_DOCS['koddoc']; ?>" class="collapse in">
                            <td colspan="5" class="">
                                <div class="text-center" style="padding:10px">
                                    <span style="color:#951402; font-size:1.5em; font-weight:300; font-family:'Oswald', sans-serif">По
                                        выбранным критериям ни одного договора не найдено.</span>
                                </div>
                            </td>
                        </tr>
                    <?php
    ...
    ?>
        <div class="text-center" style="padding:10px; border:1px #951402 solid; border-radius:5px">
            <span style="color:#951402; font-size:1.5em; font-weight:300; font-family:'Oswald', sans-serif">Ни один критерий
                не определен.</span>
        </div>
    <?php
    }
