...
#
require($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/docview/docview-current/restr_4/letter/export/_docx/export2docx_styles.inc.php");
# ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
#
...
$src = $_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/docview/docview-current/restr_4/letter/export/_docx/logo_footer_cert.png";
...
$src = $_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/docview/docview-current/restr_4/letter/export/_docx/logo_header_atgs.png";
...
function countDown() {
    ...
    timer = setInterval(function() {
        ...
        url2 = 'http://' + host +
            '/dognet/dognet-docview.php?docview_type=current&export=yes&tip=letter_notify&uniqueID1=' +
            uniqueID1 + '&zak=' + zak;
        if (i < 0) {
            clearInterval(timer);
