...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-current/restr_4/css/docview-current-customform.css">
    ...
    <div class="doc-current-tabs" style="width:100%">
        <ul id="" class="nav nav-tabs doc-current-tabs-menu">
            <li class="active"><a data-toggle="tab" href="#doc-editor-tab-1" title=""><span
                          id="doc-editor-menu-tab-1-errmsg"></span>Параметры</a></li>
            <li><a data-toggle="tab" href="#doc-editor-tab-2" title=""><span
                          id="doc-editor-menu-tab-2-errmsg"></span>Название и сроки</a></li>
            <li><a data-toggle="tab" href="#doc-editor-tab-3" title=""><span
                          id="doc-editor-menu-tab-3-errmsg"></span>Финансовая часть</a></li>
            <li><a data-toggle="tab" href="#doc-editor-tab-4" title=""><span
                          id="doc-editor-menu-tab-4-errmsg"></span>Комментарии</a></li>
        </ul>
