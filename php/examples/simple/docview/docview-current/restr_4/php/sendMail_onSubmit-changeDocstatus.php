...
$ispolmail = "";
$_kodzakaz = ""; // UPDATE / 24.03.2023
$_docnumber = $_POST['docnumber'];
$_namedoc = $_POST['namedoc'];
$_ispolname = $_POST['ispolname'];
$_docstatus = $_POST['docstatus'];
$_summadoc = $_POST['summadoc'];
$_koddoc = $_POST['koddoc'];
$_kodstatus = $_POST['kodstatus'];
$_kodispol = $_POST['kodispol'];

if ($_kodispol != "") {
	$_QRY = mysqli_fetch_assoc(mysqlQuery("SELECT ispolmail FROM dognet_spispol WHERE kodispol = {$_kodispol}"));
	$ispolmail = $_QRY['ispolmail'];
	$arr_ispolmail = explode(',', $ispolmail);
}

// UPDATE / 14.06.2022
// 
// Добавляем передачу ID договора в рассылку.
// С удивлением обнаружил, что ссылка на вновь созданный договор в письме битая.
// Ошибочно передавал несуществующий koddoc из формы при первичном создании договора, его там не может быть в принципе. Он повляется после создания записи в строке.
// 
if ($_docnumber != "") {
	$_QRY = mysqli_fetch_assoc(mysqlQuery("SELECT koddoc, kodzakaz FROM dognet_docbase WHERE docnumber = {$_docnumber}"));
	$_koddoc = $_QRY['koddoc'];
	$_kozakaz = $_QRY['kodzakaz'];
}
// END UPDATE
...
// UPDATE / 24.03.2023
// 
// Добавляем в рассылку ЗАКАЗЧИКА / ПЛАТЕЛЬЩИКА
...
if ($_docnumber != "" && $ispolmail != "") {
	...
	//
	//
	$subjectTxt = "Договор [Текущие договора] : Создан договор № 3-4/" . $_docnumber . ", где вы являетесь Исполнителем";
	$msgtext = "СОЗДАН ДОГОВОР";
	if ($_kodstatus == "245597345680479") {
		$subjectTxt = "Договор [Текущие договора] : Подписан в скане договор № 3-4/" . $_docnumber . ", где вы являетесь Исполнителем";
		$msgtext = "ПОДПИСАН В СКАНЕ";
	}
	if ($_kodstatus == "245381842747296") {
		$subjectTxt = "Договор [Текущие договора] : Подписан в оригинале договор № 3-4/" . $_docnumber . ", где вы являетесь Исполнителем";
		$msgtext = "ПОДПИСАН В ОРИГИНАЛЕ";
	}
	...
	$message3 = '
			...
			<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="left"><![endif]--><img alt="Alternate text" border="0" class="left fixedwidth fullwidthOnMobile" src="http://atgs.ru/ext/img/54a786fe-e089-481b-5f16-322992b1271c.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 112px; display: block;" title="Alternate text" width="112"/>
			...
			<p style="font-size: 24px; line-height: 1.2; word-break: break-word; text-align: left; mso-line-height-alt: 29px; margin: 0;"><span style="color: #eb8619; font-size: 24px;"><span style=""><strong><span style="font-size: 28px;">' . $msgtext . '</span><br/></strong></span></span></p>
			<p style="font-size: 20px; line-height: 1.2; word-break: break-word; text-align: left; mso-line-height-alt: 24px; margin: 0;"><span style="color: #ffffff; font-size: 20px;"><span style=""><strong><span style="color: #000000;"><span style="color: #000000;">3 - 4</span> /</span> </strong></span></span><span style="color: #ffffff; font-size: 20px; background-color: #000000; padding-left: 5px; padding-right: 5px;"><span style=""><strong>' . $_docnumber . '</strong></span></span></p>
			</div>
			</div>
			<!--[if mso]></td></tr></table><![endif]-->
			<!--[if (!mso)&(!IE)]><!-->
			...
			<div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
			<p style="font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"><strong><span style="color: #000000; font-size: 18px;"><span style="">' . $_namedoc . '</span></span></strong></p>
			</div>
			</div>
			<!--[if mso]></td></tr></table><![endif]-->
			<!--[if (!mso)&(!IE)]><!-->
			...
			<div style="color:#555555;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.2;padding-top:5px;padding-right:10px;padding-bottom:5px;padding-left:10px;">
			<div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
			<p style="font-size: 12px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"><span style="font-size: 12px; color: #333333;">ИСПОЛНИТЕЛЬ</span></p>
			</div>
			</div>
			<!--[if mso]></td></tr></table><![endif]-->
			<!--[if (!mso)&(!IE)]><!-->
			...
			<div style="color:#555555;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.2;padding-top:5px;padding-right:10px;padding-bottom:5px;padding-left:10px;">
			<div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
			<p style="font-size: 12px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"><span style="color: #000000;"><strong><span style="font-size: 12px;">' . $_ispolname . '</span></strong></span></p>
			</div>
			</div>
			<!--[if mso]></td></tr></table><![endif]-->
			<!--[if (!mso)&(!IE)]><!-->
	...
	if ($_kodstatus == "245381842747296" || $_kodstatus == "245597345680479") {
		$message3 .= '
			<div style="background-color:transparent;">
			<div class="block-grid mixed-two-up" style="min-width: 320px; max-width: 600px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; Margin: 0 auto; background-color: transparent;">
			<div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
			...
			<div style="color:#555555;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.2;padding-top:5px;padding-right:10px;padding-bottom:5px;padding-left:10px;">
			<div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
			<p style="font-size: 12px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"><span style="font-size: 12px; color: #333333;">ЗАКАЗЧИК (ПЛАТЕЛЬЩИК)</span></p>
			</div>
			</div>
			<!--[if mso]></td></tr></table><![endif]-->
			<!--[if (!mso)&(!IE)]><!-->
			...
			<div style="color:#555555;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.2;padding-top:5px;padding-right:10px;padding-bottom:5px;padding-left:10px;">
			<div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
			<p style="font-size: 12px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"><span style="color: #000000;"><strong><span style="font-size: 12px;">' . $_contragentNameF . '</span></strong></span></p>
			</div>
			</div>
			<!--[if mso]></td></tr></table><![endif]-->
			<!--[if (!mso)&(!IE)]><!-->
	...
	$message3 .= '
			...
			<div style="color:#555555;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.2;padding-top:5px;padding-right:10px;padding-bottom:5px;padding-left:10px;">
			<div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
			<p style="font-size: 12px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"><span style="font-size: 12px; color: #333333;">ТЕКУЩИЙ СТАТУС</span></p>
			</div>
			</div>
			<!--[if mso]></td></tr></table><![endif]-->
			<!--[if (!mso)&(!IE)]><!-->
			...
			<div style="color:#555555;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.2;padding-top:5px;padding-right:10px;padding-bottom:5px;padding-left:10px;">
			<div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
			<p style="font-size: 12px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"><span style="color: #000000;"><strong>' . $_docstatus . '</strong></span></p>
			</div>
			</div>
			<!--[if mso]></td></tr></table><![endif]-->
			<!--[if (!mso)&(!IE)]><!-->
			...
			<div style="color:#555555;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.2;padding-top:5px;padding-right:10px;padding-bottom:5px;padding-left:10px;">
			<div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
			<p style="font-size: 12px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"><span style="font-size: 12px; color: #333333;">СУММА ДОГОВОРА</span></p>
			</div>
			</div>
			<!--[if mso]></td></tr></table><![endif]-->
			<!--[if (!mso)&(!IE)]><!-->
			...
			<div style="color:#555555;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.2;padding-top:5px;padding-right:10px;padding-bottom:5px;padding-left:10px;">
			<div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
			<p style="font-size: 12px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"><span style="color: #000000;"><strong><span style="font-size: 12px;">' . $_summadoc . '</span></strong></span></p>
			</div>
			</div>
			<!--[if mso]></td></tr></table><![endif]-->
			<!--[if (!mso)&(!IE)]><!-->
			...
			<div style="color:#555555;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.2;padding-top:5px;padding-right:10px;padding-bottom:5px;padding-left:10px;">
			<div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
			<p style="font-size: 12px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"><span style="color: #000000;"><strong><a href="http://' . $_SERVER['HTTP_HOST'] . '/dognet/dognet-docview.php?docview_type=details&uniqueID=' . $_koddoc . '" target="_blank">Перейти к договору</a></strong></span></p>
			</div>
			</div>
			<!--[if mso]></td></tr></table><![endif]-->
			<!--[if (!mso)&(!IE)]><!-->
	...
	foreach ($arr_ispolmail as $value) {
		$mail3->addAddress($value);
	}
	$mail3->addCC("chugunov@atgs.ru", "Y. Chugunov");
	$mail3->addCC("zholobova@atgs.ru", "J. Zholobova");
