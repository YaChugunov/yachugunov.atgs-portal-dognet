	...
	'<div id="row-details-docview-doc-main-tabs">'+
		'<div class="row">'+
			'<div class="col-xs-12 col-sm-12 col-md-12">'+
				...
				'</ul>'+
				'<div class="row-details-docview-doc-main-table-title_blank"><span>Договор № 3/4-'+d.dognet_docbase.docnumber+'</span></div>'+
						...
						'<div class="hidden-xs col-sm-12 col-md-12 col-lg-12">'+
							...
							'<div style="padding:10px">'+
								...
								'<table id="row-details-docview-doc-main-table" class="table table-condensed table-striped" >'+
									'<tbody>'+
										'<tr>'+
											'<td width="30%"><span class="row-details-docview-doc-main-table-title_topic">Полное название договора</span></td>'+
											'<td width="70%"><span class="row-details-docview-doc-main-table-txt">'+d.dognet_docbase.docnamefullm+'</span></td>'+
										'</tr>'+
										'<tr>'+
