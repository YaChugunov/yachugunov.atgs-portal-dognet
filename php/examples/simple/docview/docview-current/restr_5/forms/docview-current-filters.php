			...
			<div id="docview-current-filters" class="panel-body">
				<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
					<div class="form-group space10" style="width:100%">
						...
						<input type="text" id="docNumberSearch_text" class="form-control" placeholder="Все номера" name="docNumberSearch_text" value="<?php echo ($_SESSION['docviewCurrent']['docNumberSearch_text']!="") ? $_SESSION['docviewCurrent']['docNumberSearch_text'] : ""; ?>">
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
					<div class="form-group space10" style="width:100%">
						<label for="docYearSearch_text"><b>Год начала действия :</b></label>
						<input type="text" id="docYearSearch_text" class="form-control" placeholder="Все года" name="docYearSearch_text" value="<?php echo ($_SESSION['docviewCurrent']['docYearSearch_text']!="") ? $_SESSION['docviewCurrent']['docYearSearch_text'] : ""; ?>">
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
					<div class="form-group space10" style="width:100%">
						...
						<select name="docStatusSearch_text" id="docStatusSearch_text" class="form-control">
							...
							<?php
								...
								?>
										<option value = '<?php echo $_ROW1["statusnameshot"]; ?>' <?php echo ($_SESSION['docviewCurrent']['docStatusSearch_text']==$_ROW1["statusnameshot"]) ? "selected" : ""; ?>><?php echo $_ROW1["statusnameshot"]; ?></option>
							<?php
								}
								?>
						</select>
					...
					<div class="form-group space10" style="width:100%">
						...
						<select name="docTypeSearch_text" id="docTypeSearch_text" class="form-control">
							...
							<?php
								...
								?>
										<option value = '<?php echo $_ROW2["nametip"]; ?>' <?php echo ($_SESSION['docviewCurrent']['docTypeSearch_text']==$_ROW2["nametip"]) ? "selected" : ""; ?>><?php echo $_ROW2["nametip"]; ?></option>
							<?php
								}
								?>
						</select>
					...
					<div class="input-group space10" style="width:100%">
						...
						<select name="docIspolSearch_text" id="docIspolSearch_text" class="form-control">
							...
							<?php
								...
								?>
										<option value = '<?php echo $_ROW3["ispolnamefull"]; ?>' <?php echo ($_SESSION['docviewCurrent']['docIspolSearch_text']==$_ROW3["ispolnamefull"]) ? "selected" : ""; ?>><?php echo $_ROW3["ispolnamefull"]; ?></option>
							<?php
								}
								?>
						</select>
			...
			<div class="panel-footer">
				<div class="text-right">
					<div class="checkbox" style="float:left; text-align:left">
						<label><input type="checkbox" id="checkbox_saveFiltersPanelState" value="1"><b>Сохранить состояние фильтров</b>&nbsp;&nbsp;&nbsp;<span class="text-danger">( сброшены фильтры могут быть либо вручную либо при новом входе в систему )</span></label>
