...
$properties->setTitle('Письмо о направлении договора');
$properties->setDescription('Письмо о направлении договора');
...
$properties->setSubject('Письмо о направлении договора');
...
#
require($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/docview/docview-current/restr_5/letter/export/_docx/export2docx_styles.inc.php");
# ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
#
...
$src = $_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/docview/docview-current/restr_5/letter/export/_docx/logo_footer_cert.png";
...
$src = $_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/docview/docview-current/restr_5/letter/export/_docx/logo_header_atgs.png";
...
#
$innerTable->addRow(250, $_TBL_Body_Row);
$innerTable->addCell(10000, $_InnerTBL_Body_Cell)->addTextRun($_TXTRUN_Align_Left)->addText('О направлении договора', $_FONT_P12_I);
#
#
#
...
#
$innerTable->addRow(250, $_TBL_Body_Row);
$innerTable->addCell(10000, $_InnerTBL_Body_Cell)->addTextRun($_TXTRUN_Align_Center)->addText($_ZAK_DOLG, $_FONT_P12_B);
#
$innerTable->addRow(250, $_TBL_Body_Row);
$innerTable->addCell(10000, $_InnerTBL_Body_Cell)->addTextRun($_TXTRUN_Align_Center)->addText($_ZAK_ORG, $_FONT_P12_B);
#
$innerTable->addRow(250, $_TBL_Body_Row);
$innerTable->addCell(10000, $_InnerTBL_Body_Cell)->addTextRun($_TXTRUN_Align_Center)->addText($_ZAK_FIO, $_FONT_P12_B);
# ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
...
$doc_number = $_ROW_docbase['docnumber'];
...
$textrun->addText('Направляю Вам подписанный с нашей стороны договор №3-4/', $_FONT_P12);
$textrun->addText($_ROW_docbase['docnumber'] . ' от ', $_FONT_P12);
$textrun->addText($doc_date . ' г.', $_FONT_P12);
#
$textrun = $section->addTextRun($_PARAGRAF_3L);
$textrun->addText('Прошу Вас подписать, поставить печать и выслать наш экземпляр по адресу: 109388 г. Москва, ул. Полбина, д.11.', $_FONT_P12);
#
# Дополнительная фраза
# ----- ----- -----
$textrun = $section->addTextRun($_PARAGRAF_3L);
$textrun->addText('Приложение к письму: ', $_FONT_P10_I);
$textrun = $section->addTextRun($_PARAGRAF_3L);
$textrun->addText('- Договор №3-4/', $_FONT_P10_I);
$textrun->addText($_ROW_docbase['docnumber'] . ' от ', $_FONT_P10_I);
$textrun->addText($doc_date . ' г. ', $_FONT_P10_I);
$textrun->addText('на XX л. в 2-х экз.', $_FONT_P10_I);
...
$innerTable->addCell(7000, $_InnerTBL_Body_Cell)->addTextRun($_TXTRUN_Align_Left)->addText('С уважением, ', $_FONT_H14_B);
$innerTable->addRow(350, $_TBL_Body_Row);
$innerTable->addCell(1000, $_InnerTBL_Body_Cell)->addTextRun($_TXTRUN_Align_Right)->addText('', $_FONT_H14_B);
...
$filename = "LETTER-ABOUTDOC_" . $_SESSION['id'] . "_" . date('YmdHis') . ".DOCX";
...
if (isset($_GET['log']) && $_GET['log'] == 'yes') {
	...
	$nameactcreate = "Сопроводительное письмо";
...
PORTAL_SYSLOG('99944200', '0000002', null, $_GET['docview_type'], "Сопроводительное письмо", "WORD");
...
<div id="link">
	<div class="">
		<a class="format-selected" href="<?php echo $__URL; ?>"><?php echo "Скачать документ"; ?></a>
	</div>
	<div class="circles">
		<div class="circle">
...
<script type="text/javascript">
	...
	function countDown() {
		...
		timer = setInterval(function() {
			...
			url1 = 'http://' + host + '/dognet/dognet-docview.php';
			url2 = 'http://' + host + '/dognet/dognet-docview.php?docview_type=current&export=yes&uniqueID1=' + uniqueID1 +
				'&zak=' + zak;
			if (i < 0) {
				clearInterval(timer);
				document.getElementById("link").innerHTML =
					"<div class='space20'><span style='padding:0 15px'><a class='return-link' href=" + url1 +
					">Вернуться в Договора</a></span></div><div class='space20'><span style='padding:0 15px'><a class='return-link' href=" +
