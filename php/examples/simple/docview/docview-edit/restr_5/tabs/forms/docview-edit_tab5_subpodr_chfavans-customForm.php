...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_5/tabs/css/docview-edit-tab5_subpodr_chfavans-customForm.css">
      ...
      <div id="doc-editor-tab5-chfavans-3" class="tab-pane fade in active">
        <div class="Section">
          <div class="Block100">
            ...
            <fieldset class="field25">
              <editor-field name="dognet_docavsubpodr.sumostsubpodr"></editor-field>
            </fieldset>
          </div>
          <div class="Block100">
            <legend>Зачет аванса</legend>
            <fieldset class="field40">
              <editor-field name="dognet_docavsubpodr.useavans"></editor-field>
            </fieldset>
            <fieldset class="field40">
