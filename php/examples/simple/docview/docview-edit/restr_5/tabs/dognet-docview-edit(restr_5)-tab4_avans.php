<script type="text/javascript" language="javascript" class="init">
    ...
    function ajaxRequest_sumallavans(data1, data2, data3, data4, responseHandler) {
        ...
        // Fire off the request to /form.php
        request = $.ajax({
            url: "php/examples/simple/docview/docview-edit/restr_5/tabs/process/ajaxrequests/ajaxReq-docviewedit-tab4_avans-sumallavans.php",
            type: "post",
            cache: false,
            data: {
                action: data1,
...
<section>
    <div id="docview-tab4_avans" class="" style="padding:0 5px">
        ...
        <h3 class="parent-title space20">Авансы по основному договору <span id="sumctrl_av_title" style="font-weight:300; font-size:0.9em; float:right; padding-right:10px"></span></h3>
