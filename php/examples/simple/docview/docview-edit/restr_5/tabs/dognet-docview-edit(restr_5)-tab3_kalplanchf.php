...
$(document).ready(function() {
    ...
    function getChfDate(kodchfact, callback) {
        ...
        // Делаем AJAX запрос
        $.ajax({
            url: "php/examples/simple/docview/docview-edit/restr_5/tabs/process/ajaxrequests/ajaxGetChfDate.php",
            type: "post",
            data: {
                kodchfact: kodchfact
            },
...
<section>
    <link rel="stylesheet"
          href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_5/tabs/css/docview-edit-tab3_kalplanchf.css">
    <div class="" style="padding-left:5px; padding-right:5px">
        ...
        ?>
        <link rel="stylesheet"
              href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_5/tabs/css/docview-edit-tab3_kalplanchf_oplata.css">
        ...
        <link rel="stylesheet"
              href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_5/tabs/css/docview-edit-tab3_kalplanchf_avans.css">
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
            <div class="space30"></div>
