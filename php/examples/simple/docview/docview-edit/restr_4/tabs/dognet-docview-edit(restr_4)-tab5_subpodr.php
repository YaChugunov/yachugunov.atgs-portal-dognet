...
$(document).ready(function() {
    ...
    var editor_tab5_subpodr = new $.fn.dataTable.Editor({
        ...
        fields: [{
            ...
            label: "Бланк ГИП как основание",
            name: "dognet_docsubpodr.kodblankwork",
            type: "select",
            def: "---",
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_4/tabs/css/docview-edit-tab5_subpodr.css">
<section>
    <div class="" style="padding-left:5px; padding-right:5px">
        <div class="space30"></div>
        <h3 class="parent-title space20">Договора субподряда</h3>
        <div class="demo-html"></div>
        <table id="docview-edit-tab5_subpodr" class="table table-responsive table-bordered display compact"
...
; ?>
        <link rel="stylesheet"
              href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_4/tabs/css/docview-edit-tab5_subpodr_chetfact.css">
        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
            <div class="space30"></div>
            <h3 class="child-title space20">Счета-фактуры субподрядчика</h3>
            <div class="demo-html"></div>
            <table id="docview-edit-tab5_chfsubpodr" class="table table-responsive table-bordered display compact"
                   cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th></th>
...
; ?>
        <link rel="stylesheet"
              href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_4/tabs/css/docview-edit-tab5_subpodr_oplatachf.css">
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
            <div class="space30"></div>
            <h3 class="child-title space20">Оплаты по счету-фактуре</h3>
            <div class="demo-html"></div>
            <table id="docview-edit-tab5_oplchfsubpodr" class="table table-responsive table-bordered display compact"
                   cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>С-ф</th>
...
; ?>
        <link rel="stylesheet"
              href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_4/tabs/css/docview-edit-tab5_subpodr_chfavans.css">
        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
            <div class="space30"></div>
            ...
            <div class="demo-html"></div>
            <table id="docview-edit-tab5_avchfsubpodr" class="table table-responsive table-bordered display compact"
                   cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>С-ф</th>
...
; ?>
        <link rel="stylesheet"
              href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_4/tabs/css/docview-edit-tab5_subpodr_chfavanssplit.css">
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
            <div class="space30"></div>
            <h3 class="child-title space20">Сплит аванса</h3>
            <!-- 			<h3 class="child-title space20"><span id="safasfaslaksjdlkasjd"></span></h3> -->
            <div class="demo-html"></div>
            <table id="docview-edit-tab5_avsplitsubpodr" class="table table-responsive table-bordered display compact"
                   cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>С-ф</th>
...
<div id="subpodr-block-legend" class="col-xs-12 col-sm-12 col-md-12 col-lg-12"
    ...
    <div style="float: left">
        <p><span class="label label-icon"><span class="lbl lbl-red">Сплит</span></span><span
                  style="font-size:0.8em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Из
                аванса
