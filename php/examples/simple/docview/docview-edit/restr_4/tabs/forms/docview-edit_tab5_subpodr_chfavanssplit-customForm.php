...
?>
<link rel="stylesheet"
  href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_4/tabs/css/docview-edit-tab5_subpodr_chfavanssplit-customForm.css">
        ...
        <div class="Section">
          <div class="Block100">
            ...
            <div class="Block100" style="justify-content:end">
              <div class=""
                style="float:right; font-family:'Play', sans-serif; font-size:1.0em; font-weight:500; color:#999; padding: 0 15px">
                Аванс&nbsp;<span id="calcAvans-valuesDB-sumav" class="small"
                  style="font-weight:700; color:#111"></span>&nbsp;&middot;&nbsp;В
                сплите&nbsp;<span id="calcAvans-valuesDB-sumavsplit" class="small"
                  style="font-weight:700; color:#111"></span>&nbsp;&middot;&nbsp;Зачтено&nbsp;<span
                  id="calcAvans-valuesDB-sumavchfsplit" class="small"
                  style="font-weight:700; color:#111"></span>&nbsp;&middot;&nbsp;Незачтенный
                остаток&nbsp;<span id="calcAvans-valuesDB-sumavost" class="small"
                  style="font-weight:700; color:#111"></span>
              </div>
            </div>
