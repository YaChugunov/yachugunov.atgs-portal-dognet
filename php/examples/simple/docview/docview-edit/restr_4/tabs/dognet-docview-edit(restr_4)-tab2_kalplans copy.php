...
$(document).ready(function() {
        ...
        i18n: {
            ...
            remove: {
                ...
                confirm: {
                    ...
                    "1": "<div class=''><p class='text-dark'>Вы уверены, что хотите удалить этот этап??</p><p class='text-danger'><b>Важно помнить, что при удалении этапа договора вместе с ним удалятся: <ul class='text-danger'><li>все связанные с ним счета-фактуры</li><li>все связанные с ним авансы</li><li>оплаты по связанным счетам-фактурам</li><li>зачеты авансов по этим счетам-фактурам</li></ul></b></p><p class='text-danger'><b>Процедуры восстановления вышеперечисленных удаленных данных на текущий момент не предусмотрено!</b></p></div>"
                }
            },
            error: {
    ...
    //
    editor_tab2_kalplans.on('preSubmit', function(e, action) {
        console.log('preSubmit вызван с действием:', action);

        // Если это удаление - пропускаем валидацию
        if (action === 'remove') {
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_4/tabs/css/docview-edit-tab2_kalplans.css">
<section>
    <div id="docview-tab2_kalplans" class="" style="padding:0 5px">
        <div class="space30"></div>
        <h3 class="parent-title space20">Этапы основного договора <span id="sumctrl_title"
                  style="font-weight:300; font-size:0.9em; float:right; padding-right:10px"></span></h3>
        <div class="demo-html"></div>
        <table id="docview-edit-tab2_kalplans" class="table table-responsive table-bordered display compact"
