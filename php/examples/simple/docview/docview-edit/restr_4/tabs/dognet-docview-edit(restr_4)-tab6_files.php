...
$(document).ready(function() {
    ...
    var editor_tab6_files = new $.fn.dataTable.Editor({
        ...
        fields: [{
            ...
            type: "upload",
            display: function(id) {
                return '<div class="lnkDocFileID"><a target="_blank" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet' +
                    editor_tab6_files.file('dognet_docpaper_files', id).file_webpath +
                    '">Текущий прикрепленный файл</a></div>';
            },
            dragDrop: false,
    ...
    editor_tab6_files.on('initEdit', function(e, node, data, items, type) {
        ...
        if (data.dognet_docpaper.docFileID == '' || data.dognet_docpaper.docFileID == null) {
            ...
            editor_tab6_files.field('dognet_docpaper.lnkDocFileID').val(
                'Если вы хотите обновить прикрепленный файл, создайте новую запись и удалите старую!'
            );
            ...
            if (window.initCreate != 1) {
                filelink = "http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet" + data
                    .dognet_docpaper_files.file_webpath + "";
                window.txtlink = '<a target="_blank" href="' + filelink +
                    '">Текущий прикрепленный файл</a>';
...
// :::
include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/docview/docview-edit/restr_4/tabs/forms/docview-edit_tab6_files-customForm.php");
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_4/tabs/css/docview-edit-tab6_files.css">
<section>
    <div class="" style="padding-left:5px; padding-right:5px">
        ...
        <table id="docview-edit-tab6_files" class="table table-responsive table-bordered display compact"
