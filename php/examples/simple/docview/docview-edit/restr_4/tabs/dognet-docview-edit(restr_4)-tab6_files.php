...
// ----- ----- ----- ----- -----
				...
				type: "upload",
				display: function ( id ) { return '<div class="lnkDocFileID"><a target="_blank" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet'+editor_tab6_files.file( 'dognet_docpaper_files', id ).file_webpath+'">Текущий прикрепленный файл</a></div>'; },
				dragDrop: false,
...
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_4/tabs/css/docview-edit-tab6_files.css">
<section>
