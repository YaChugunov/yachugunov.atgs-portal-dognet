...
function ajaxRequest_sumallchf(data1, data2, data3, data4, responseHandler) {
    ...
    request = $.ajax({
        url: "php/examples/simple/docview/docview-edit/restr_4/tabs/process/ajaxrequests/ajaxReq-docviewedit-tab3_kalplanchf-sumallchf.php",
        type: "post",
        cache: false,
        data: {
            action: data1,
    ...
    request.done(function(response, textStatus, jqXHR) {
        ...
        var sumoplchf = x[4];
        var sumoplavchf = x[5];
        var sumchf_html = (parseFloat(sumchf) != 0) ?
            '<span title="Сумма всех счетов-фактур по договору" class="">' +
            sumchf +
        ...
        var sumoplchf_html = (parseFloat(sumoplchf) != 0) ?
            ...
            sumoplchf +
            '</span>' : '<span title="Сумма всех оплат по всем счетам-фактурам по договору" class="">' +
            sumoplchf +
            '</span>';
        ...
        $('#sumctrl_chf_title').html(sumchf_html + " / " + sumoplchf_html + " / " + sumoplavchf_html + " / " +
            sumzadol_html);
        console.log("ajaxRequest_sumallchf : " + doc_summa + " / " + stage_summa + " / " + sumchf + " / " +
            sumzadol +
            " >>> " + res);
...
$(document).ready(function() {
    ...
    editor_tab3_kalplanchf = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/docview/docview-edit/restr_4/tabs/process/dognet-docview-edit(restr_4)-tab3_kalplanchf-process.php",
            data: function(d) {
    ...
    editor_tab3_oplatachf = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: 'php/examples/simple/docview/docview-edit/restr_4/tabs/process/dognet-docview-edit(restr_4)-tab3_oplatachf_child-process.php',
            data: function(d) {
    ...
    table_tab3_oplatachf = $('#docview-edit-tab3_oplata').DataTable({
        dom: "<'row'<'col-md-8 col-sm-12'B><'col-md-4 col-sm-12'>r>t<'row'<'col-md-12 col-sm-12 footer'p>>",
        // 		dom: "Bfrtip",
        language: {
        ...
        if (action == "create") {
            ...
            $("#DTE_Field_dognet_kalplanchf-kodkalplan").on("change", function(val) {
                ...
                if ($("#DTE_Field_dognet_kalplanchf-kodkalplan option:selected").val() != "") {
                    ...
                    // Fire off the request to /form.php
                    request2 = $.ajax({
                        url: "php/examples/simple/docview/docview-edit/restr_4/tabs/process/dognet-docview-edit(restr_4)-tab3_kalplanchf_fetch2-process.php",
                        type: "post",
                        cache: false,
                        data: {
                ...
                // Fire off the request to /form.php
                request = $.ajax({
                    url: "php/examples/simple/docview/docview-edit/restr_4/tabs/process/dognet-docview-edit(restr_4)-tab3_kalplanchf_fetch-process.php",
                    type: "post",
                    cache: false,
                    data: {
                        "kodkalplan": kodkalplan
...
<section>
    <link rel="stylesheet"
          href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_4/tabs/css/docview-edit-tab3_kalplanchf.css">
    <div class="" style="padding-left:5px; padding-right:5px">
        <div class="space30"></div>
        <h3 class="parent-title space20">Счета-фактуры <span id="sumctrl_chf_title"
                  style="font-weight:300; font-size:0.9em; float:right; padding-right:10px"></span></h3>
        <div class="demo-html"></div>
        <table id="docview-edit-tab3_kalplanchf" class="table table-responsive table-bordered display compact"
    ...
    ?>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
            ...
            <div class="demo-html"></div>
            <table id="docview-edit-tab3_oplata" class="table table-responsive table-bordered display compact"
                   cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>ID оплаты</th>
        ...
        <link rel="stylesheet"
              href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_4/tabs/css/docview-edit-tab3_kalplanchf_avans.css">
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
            <div class="space30"></div>
            <h3 class="child-title space20">Зачтенные авансы / части авансов</h3>
            <div class="demo-html"></div>
            <table id="docview-edit-tab3_avans" class="table table-responsive table-bordered display compact"
                   cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>ID аванса</th>
