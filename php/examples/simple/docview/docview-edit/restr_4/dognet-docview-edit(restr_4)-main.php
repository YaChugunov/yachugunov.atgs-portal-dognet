...
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_4/tabs/css/docview-edit-common-tables.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_4/tabs/css/docview-edit-common-customForm.css">
...
$_var_docnumber = !empty($row_docbase['docnumber']) ? $row_docbase['docnumber'] : "";
$_var_docnameshot = !empty($row_docbase['docnameshot']) ? $row_docbase['docnameshot'] : "";
$_var_docnamefullm = !empty($row_docbase['docnamefullm']) ? $row_docbase['docnamefullm'] : "";
?>
