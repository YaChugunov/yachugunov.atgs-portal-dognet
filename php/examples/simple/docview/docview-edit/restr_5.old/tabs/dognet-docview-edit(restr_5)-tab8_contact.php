...
<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		editor_tab8_contact = new $.fn.dataTable.Editor({
			display: "bootstrap",
			ajax: "php/examples/simple/docview/docview-edit/restr_5/tabs/process/dognet-docview-edit(restr_5)-tab8_contact-process.php",
		...
		table_tab8_contact = $('#sp-tab8_contact-table').DataTable({
			...
			ajax: {
				url: "php/examples/simple/docview/docview-edit/restr_5/tabs/process/dognet-docview-edit(restr_5)-tab8_contact-process.php",
				type: "POST"
			},
			serverSide: true,
			columns: [{
...
// :::
include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/docview/docview-edit/restr_5/tabs/forms/docview-edit_tab8_contact-customForm.php");
// ----- ----- ----- ----- -----
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_5/tabs/css/docview-edit-tab8_contact-main.css">
<section>
