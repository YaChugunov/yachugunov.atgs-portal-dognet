...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_5/tabs/css/docview-edit-tab1_dogovor-customForm.css">
						...
						<div class="Block100">
							...
							<div class="Block100 fieldset-table-row">
								...
								<div class="fieldset-table-cell" style="width:100%; padding-bottom:5px">
									<div><div class="chekbox-inline-text">Договор подписан на электронной площадке</div></div>
								</div>
							</div>
						</div>
				</div>
