...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_5/tabs/css/docview-edit-tab3_kalplanchf-customForm.css">
		...
		<div class="tab-content" style="padding:5px">
			<div id="doc-editor-tab3-kalplanchf-1" class="tab-pane fade in active">
				<div class="Section">
					...
					<div id="check-useavans" class="Block100" style="display:none">
						<div class="fieldset-table-row" style="">
							...
							<div class="fieldset-table-cell" style="width:100%">
								<div><div class="chekbox-inline-text">Зачесть аванс сразу после добавления счета-фактуры</div></div>
							</div>
						</div>
					</div>
					<div id="div-useavans" class="Block100" style="display:none">
						...
						<div class="Block30" id="div-usesumzachet" style="display:none">
							<fieldset class="field100">
								<editor-field name="usesumzachet"></editor-field>
							</fieldset>
						</div>
						<div class="Block20 fieldset-table-row" id="fieldset-table-row_useallostatok" style="display:none; padding-top:25px">
							<div class="fieldset-table-cell" style="padding-bottom:3px">
								<fieldset class="field100">
							...
							<div class="fieldset-table-cell" style="width:100%">
								<div><div class="chekbox-inline-text">Весь остаток</div></div>
							</div>
						</div>
					</div>
				</div>
