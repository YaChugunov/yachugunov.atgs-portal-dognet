	...
	<div class="doc-editor-tabs" style="width:100%">
		...
		<div class="tab-content" style="padding:5px">
			<div id="doc-editor-tab2-1" class="tab-pane fade in active">
				<div class="Section">
					<div class="Block100">
						<legend>Общая информация <span id="sumctrl_msg" style="font-weight:300; font-size:0.9em; float:right; padding-right:10px"></span></legend>
						<div class="Block100">
						...
						<div id="check-idobjectready" class="Block100" style="">
							<div class="fieldset-table-row" style="">
								...
								<div class="fieldset-table-cell" style="width:100%">
									<div><div class="chekbox-inline-text">При готовности объекта</div></div>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="Section">
					<div class="Block100">
						...
						<div class="Block50" style="margin-top:10px">
							<p class="" style="display:block; width:100%; margin-bottom:0; font-weight:700">1-ый аванс (планируемый, не реально полученный)</p>
							...
							<p class="" style="display:block; width:100%; margin-bottom:0; font-weight:700">2-ой аванс (дата/дни после 1-го полученного аванса)</p>
							<div style="display:flex">
								<fieldset class="useavplan">
						...
						<div class="Block50" style="margin-top:10px">
							<p class="" style="display:block; width:100%; margin-bottom:0; font-weight:700">3-ий аванс (дата/дни после 1-го полученного аванса)</p>
							<div style="display:flex">
								<fieldset class="useavplan">
							...
							<p class="" style="display:block; width:100%; margin-bottom:0; font-weight:700">4-ый аванс (дата/дни после 1-го полученного аванса)</p>
							<div style="display:flex">
								<fieldset class="useavplan">
