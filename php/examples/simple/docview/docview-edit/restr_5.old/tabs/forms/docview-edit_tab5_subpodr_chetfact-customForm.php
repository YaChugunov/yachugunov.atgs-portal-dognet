...
?>
<link rel="stylesheet"
  href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_5/tabs/css/docview-edit-tab5_subpodr_chetfact-customForm.css">
<div id="customForm_tab5_chfsubpodr">
  <div class="doc-editor-tabs" style="width:100%">
    <ul id="" class="nav nav-tabs doc-editor-tabs-menu">
      <li class="active"><a data-toggle="tab" href="#doc-editor-tab5-chetfact-3" title="">Параметры</a></li>
    ...
    <div class="tab-content" style="padding:5px">
      <!-- <div id="doc-editor-tab5-chetfact-2" class="tab-pane fade in active">
				<div class="Section">
				</div>
			</div> -->
      <div id="doc-editor-tab5-chetfact-3" class="tab-pane fade in active">
        <div class="Section">
          <div class="Block100">
      ...
      <!-- <div id="doc-editor-tab5-chetfact-1" class="tab-pane fade">
                <div class="Section">
                    <div class="Block100">
