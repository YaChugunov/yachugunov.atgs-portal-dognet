<script type="text/javascript" language="javascript" class="init">
  ...
  $(document).ready(function() {
    ...
    // ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
    // АВАНСЫ
    var editor_tab5_avsubpodr = new $.fn.dataTable.Editor({
      display: "bootstrap",
      ajax: {
        url: "php/examples/simple/docview/docview-edit/restr_5/tabs/process/dognet-docview-edit(restr_5)-tab5_subpodr_child_avans-process.php",
        data: function(d) {
    ...
    var table_tab5_avsubpodr = $('#docview-edit-tab5_avsubpodr').DataTable({
      dom: "<'row'<'col-md-8 col-sm-12'B><'col-md-4 col-sm-12'>r>t<'row'<'col-md-12 col-sm-12 footer'>>",
      language: {
      ...
      buttons: [{
          text: '<span class="glyphicon glyphicon-refresh"></span>',
          action: function(e, dt, node, config) {
            table_tab5_avsubpodr.ajax.reload();
            table_tab5_avsubpodr.columns().search('').draw();
          }
        },
        {
          extend: "create",
          editor: editor_tab5_avsubpodr,
          text: '<span class="glyphicon glyphicon-plus"></span>',
          formButtons: ['Создать',
            {
              text: 'Отмена',
    ...
    var editor_tab5_avchfsubpodr = new $.fn.dataTable.Editor({
      ...
      ajax: {
        ...
        data: function(d) {
          ...
          if (selected.any()) {
            d.koddocsubpodr_avchf = selected.data().dognet_docchfsubpodr.koddocsubpodr;
            d.kodchfsubpodr_avchf = selected.data().dognet_docchfsubpodr.kodchfsubpodr;
          } else {
            d.koddocsubpodr_avchf = '';
            d.kodchfsubpodr_avchf = '';
          }
        },
        success: function(json) {
      ...
      fields: [{
        label: "Договор",
        type: "select",
        name: "dognet_docavchfsubpodr.koddocsubpodr",
        placeholder: "-- Выберите договор"
      }, {
        label: "Аванс",
        type: "select",
        name: "dognet_docavchfsubpodr.kodavsubpodr",
        placeholder: "---",
        options: [{
          label: "---",
          value: ""
        ...
        label: "Счет-фактура",
        type: "select",
        name: "dognet_docavchfsubpodr.kodchfsubpodr",
        placeholder: "-- Без зачета",
        options: [{
          label: "-- Без зачета",
          value: ""
        ...
        label: "Дата аванса",
        name: "dognet_docavchfsubpodr.dateavchfsubpodr",
        type: "datetime",
        format: "DD.MM.YYYY"
      }, {
        label: "Сумма аванса",
        name: "dognet_docavchfsubpodr.sumavchfsubpodr"
      }, {
        label: "Отменить зачет аванса",
        type: "checkbox",
        name: "cancelAvans",
    ...
    var table_tab5_avchfsubpodr = $('#docview-edit-tab5_avchfsubpodr').DataTable({
      ...
      ajax: {
        ...
        data: function(d) {
          ...
          console.log(d.koddocsubpodr_avchf, d.kodchfsubpodr_avchf);
        }
      },
      serverSide: true,
      select: {
      ...
      createdRow: function(row, data, index) {
        ...
        if ((data.dognet_docavchfsubpodr.kodchfsubpodr === data.dognet_docchfsubpodr
            .kodchfsubpodr) &&
          (data.dognet_docavchfsubpodr.kodchfsubpodr === data.kodchfsubpodr)) {
          /* 								$(row).css({ 'color':'#FFF'	}); */
        }

        if (data.dognet_docavchfsubpodr.kodchfsubpodr === "") {
          $(row).css({
            'font-style': 'italic',
            'color': '#AAA'
          });
      ...
      columns: [{
          data: "dognet_docavchfsubpodr.kodchfsubpodr",
          className: ""
        },
        {
          data: "dognet_docavchfsubpodr.kodavchfsubpodr",
          className: ""
        },
        {
          data: "dognet_docavchfsubpodr.dateavchfsubpodr",
          className: ""
        },
        {
          data: "dognet_docavchfsubpodr.sumavchfsubpodr",
          className: ""
        }
      ],
      columnDefs: [{
    ...
    editor_tab5_avchfsubpodr.dependent('cancelAvans', function(val) {
      if (val == 1) {
        editor_tab5_avchfsubpodr.field('cancelAvans').processing(false);
        editor_tab5_avchfsubpodr.field('dognet_docavchfsubpodr.kodchfsubpodr').disable();
        editor_tab5_avchfsubpodr.field('dognet_docavchfsubpodr.kodchfsubpodr').set("");
      } else {
        editor_tab5_avchfsubpodr.field('cancelAvans').processing(false);
        editor_tab5_avchfsubpodr.field('dognet_docavchfsubpodr.kodchfsubpodr').enable();
      }
    });
    // ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
    //
    ...
    table_tab5_subpodr.on('select', function() {
      //
      table_tab5_avsubpodr.buttons().enable();
      table_tab5_avsubpodr.ajax.reload();
    ...
    table_tab5_chfsubpodr.on('select', function() {
      ...
      editor_tab5_avchfsubpodr
        .field('dognet_docavchfsubpodr.kodchfsubpodr')
        .set(table_tab5_chfsubpodr.row({
          selected: true
        }).data().dognet_docchfsubpodr.kodchfsubpodr);
    });
    ...
    editor_tab5_subpodr.on('open close', function() {
      $(".modal-dialog").css({
        "width": "60%",
        "min-width": "640px",
        "max-width": "800px"
    ...
    editor_tab5_avsubpodr.on('open close', function() {
      $(".modal-dialog").css({
        "width": "60%",
        "min-width": "640px",
        "max-width": "800px"
    ...
    // Изменяем размер диалогового окна редактирования счета-фактуры
    editor_tab5_chfsubpodr.on('open close', function() {
      $(".modal-dialog").css({
        "width": "60%",
        "min-width": "640px",
        "max-width": "800px"
    ...
    editor_tab5_oplchfsubpodr.on('open close', function() {
      $(".modal-dialog").css({
        "width": "60%",
        "min-width": "640px",
        "max-width": "800px"
    ...
    editor_tab5_avchfsubpodr.on('open close', function() {
      $(".modal-dialog").css({
        "width": "60%",
        "min-width": "640px",
        "max-width": "800px"
...
include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/docview/docview-edit/restr_5/tabs/forms/docview-edit_tab5_subpodr_avans-customForm.php");
...
<section>
  <div class="" style="padding-left:5px; padding-right:5px">
    ...
    <?php // ----- ----- ----- ----- ----- 
    ?>
    <link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_5/tabs/css/docview-edit-tab5_subpodr_avans.css">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <div class="space30"></div>
      <h3 class="child-title space20">Авансовые платежи по договору субподряда</h3>
      <div class="demo-html"></div>
      <table id="docview-edit-tab5_avsubpodr" class="table table-responsive table-bordered display compact" cellspacing="0" width="100%">
        <thead>
          <tr>
            <th>ID аванса</th>
            <th>Дата</th>
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
      <div class="space30"></div>
      <h3 class="child-title space20">Зачеты авансов/частей авансов по счету-фактуре</h3>
