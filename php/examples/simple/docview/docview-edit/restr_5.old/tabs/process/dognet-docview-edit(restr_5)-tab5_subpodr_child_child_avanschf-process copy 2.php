...
function update_chfZadol($db, $id, $kodchfsubpodr) {
	...
	// -----
	$_QRY_2 = $db->sql("SELECT SUM(sumchfavsubpodr) as sumavans FROM dognet_docavsubpodr WHERE kodchfsubpodr=" . $kodchfsubpodr)->fetchAll();
	if ($_QRY_2) {
...
if ($_KODSHAB == "1" or $_KODSHAB == "3") {
	#
	#
	if (!isset($_POST['koddocsubpodr_avchf']) || !is_numeric($_POST['koddocsubpodr_avchf'])) {
		echo json_encode(["data" => []]);
	} else {
		$__koddocsubpodr = $_POST['koddocsubpodr_avchf'];
		$__kodchfsubpodr = $_POST['kodchfsubpodr_avchf'];
		$_SESSION['tmp_SelectedKodchfsubpodr'] = $_POST['kodchfsubpodr_avchf'];
		// Build our Editor instance and process the data coming from _POST
		Editor::inst($db, 'dognet_docavchfsubpodr')
			->fields(
				// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
				Field::inst('dognet_docavchfsubpodr.kodchfsubpodr')
					->options(
						Options::inst()
				...
				Field::inst('dognet_docavchfsubpodr.koddocsubpodr')
					->options(
						Options::inst()
				...
				Field::inst('dognet_docavchfsubpodr.kodavsubpodr')
					->options(
						Options::inst()
							->table('dognet_docavsubpodr')
							->value('kodavsubpodr')
							->label(array('kodavsubpodr', 'dateavsubpodr', 'sumavsubpodr', 'sumostsubpodr'))
							->render(function ($row) use ($__koddocsubpodr) {
								return ("Дата : " . date("d.m.Y", strtotime($row['dateavsubpodr'])) . " / Вся сумма аванса : " . $row['sumavsubpodr'] . " / Доступный остаток для зачета : " . $row['sumostsubpodr']);
							})
							->where(function ($q) use ($__koddocsubpodr) {
								$q->where('koddocsubpodr', $__koddocsubpodr, '=');
							})
				...
				Field::inst('dognet_docavchfsubpodr.kodavchfsubpodr'),
				Field::inst('dognet_docavchfsubpodr.dateavchfsubpodr')
				...
				Field::inst('dognet_docavchfsubpodr.sumavchfsubpodr'),
				// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
			...
			// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
			->leftJoin('dognet_docchfsubpodr', 'dognet_docchfsubpodr.kodchfsubpodr', '=', 'dognet_docavchfsubpodr.kodchfsubpodr')
			->leftJoin('dognet_docsubpodr', 'dognet_docsubpodr.koddocsubpodr', '=', 'dognet_docavchfsubpodr.koddocsubpodr')
			...
			->where('dognet_docavchfsubpodr.koddocsubpodr', $__koddocsubpodr)
			->where('dognet_docavchfsubpodr.kodchfsubpodr', $__kodchfsubpodr)
			->process($_POST)
			->json();
	}
	#
