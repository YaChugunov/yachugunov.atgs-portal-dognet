  ...
  $(document).ready(function() {
    ...
    function ajaxRequest_calcChfAvOstatok(kodavsubpodr, kodchfsubpodr, inputvalue, responseHandler) {
      ...
      request_calcChfAvOstatok = $.ajax({
        type: "post",
        url: '<?php echo __ROOT; ?>/dognet/php/examples/simple/docview/docview-edit/restr_5/tabs/process/ajaxrequests/ajaxReq-docveiwedit-subpodr-avans-calcOstatok.php',
        cache: false,
        data: {
      ...
      request_calcChfAvOstatok.done(function(response, textStatus, jqXHR) {
        if (response != "-1") {
          ...
          $('#calcAvans-valuesDB-sumav').html($.fn.dataTable.render.number(' ', ',', 2, '').display(x[0]));
          $('#calcAvans-valuesDB-sumavsplit').html($.fn.dataTable.render.number(' ', ',', 2, '').display(x[1]));
          $('#calcAvans-valuesDB-sumavchfsplit').html($.fn.dataTable.render.number(' ', ',', 2, '').display(x[
            2]));
          $('#calcAvans-valuesDB-sumavost').html($.fn.dataTable.render.number(' ', ',', 2, '').display(x[0] - x[
            2]));
    ...
    var editor_tab5_oplchfsubpodr = new $.fn.dataTable.Editor({
      ...
      ajax: {
        ...
        data: function(d) {
          ...
          if (selected_opl.any()) {
            d.kodoplchfsubpodr = selected_opl.data().dognet_docoplchfsubpodr.kodoplchfsubpodr;
          } else {
            d.kodoplchfsubpodr = '';
          }
          // ----- ----- ----- ----- ----- 
          ...
          if (selected_oplchf.any()) {
            d.kodchfsubpodr_selected = selected_oplchf.data().dognet_docoplchfsubpodr.kodchfsubpodr;
          } else {
          ...
          console.log('TABLE oplchfsubpodr processing >>>>>', 'koddocsubpodr:', d.koddocsubpodr,
            'kodavsubpodr:',
            d.kodavsubpodr, 'kodchfsubpodr_selected:', d.kodchfsubpodr_selected, 'kodchfsubpodr_field:', d
    ...
    var table_tab5_oplchfsubpodr = $('#docview-edit-tab5_oplchfsubpodr').DataTable({
      ...
      ajax: {
        ...
        data: function(d) {
          ...
          console.log('EDITOR oplchfsubpodr processing >>>>>', 'koddocsubpodr:', d.koddocsubpodr,
            'kodavsubpodr:',
            d.kodavsubpodr, 'kodchfsubpodr_selected:', d.kodchfsubpodr_selected, 'kodchfsubpodr_field:', d
    ...
    var editor_tab5_avchfsubpodr = new $.fn.dataTable.Editor({
      ...
      ajax: {
        ...
        data: function(d) {
          ...
          if (selected_chf.any()) {
            d.kodchfsubpodr_selected = selected_chf.data().dognet_docavsubpodr.kodchfsubpodr;
          } else {
            d.kodchfsubpodr_selected = '';
          }
          ...
          console.log('EDIT avchfsubpodr processing >>>>>', 'koddocsubpodr:', d.koddocsubpodr, 'kodavsubpodr:',
            d.kodavsubpodr, 'kodchfsubpodr_selected:', d.kodchfsubpodr_selected, 'kodchfsubpodr_field:', d
    ...
    var table_tab5_avchfsubpodr = $('#docview-edit-tab5_avchfsubpodr').DataTable({
      ...
      ajax: {
        ...
        data: function(d) {
          ...
          console.log('TABLE avchfsubpodr processing >>>>>', 'koddocsubpodr:', d.koddocsubpodr, 'kodavsubpodr:',
            d.kodavsubpodr, 'kodchfsubpodr_selected:', d.kodchfsubpodr_selected, 'kodchfsubpodr_field:', d
    ...
    var editor_tab5_avsplitsubpodr = new $.fn.dataTable.Editor({
      display: "bootstrap",
      ajax: {
        url: "php/examples/simple/docview/docview-edit/restr_5/tabs/process/dognet-docview-edit(restr_5)-tab5_subpodr_child_child_avanschfsplit-process.php",
        data: function(d) {
          ...
          if (selected_chf.any()) {
            d.kodchfsubpodr_selected = selected_chf.data().dognet_docavsplitsubpodr.kodchfsubpodr;
            d.sumavsplit_selected = selected_chf.data().dognet_docavsplitsubpodr.sumavsplit;
          } else {
            d.kodchfsubpodr_selected = '';
            d.sumavsplit_selected = '';
          }
          d.kodchfsubpodr_field = editor_tab5_avsplitsubpodr.field('dognet_docavsplitsubpodr.kodchfsubpodr')
            .val();
          d.sumavsplit_field = editor_tab5_avsplitsubpodr.field('dognet_docavsplitsubpodr.sumavsplit').val();
          console.log(d.koddocsubpodr, d.kodavsubpodr);
          console.log('kodchfsubpodr processing >>>>>', 'kodchfsubpodr_selected:', d.kodchfsubpodr_selected,
            'kodchfsubpodr_field:', d
            .kodchfsubpodr_field, 'sumavsplit_selected:', d.sumavsplit_selected, 'sumavsplit_field:', d
    ...
    editor_tab5_avchfsubpodr
      .on('open', function() {
        ...
        editor_tab5_avchfsubpodr.dependent('dognet_docavsubpodr.kodchfsubpodr', function(val) {
          if (val == "" && editor_tab5_avchfsubpodr.field('dognet_docavsubpodr.useavans').val() == "2") {
            editor_tab5_avchfsubpodr.field('dognet_docavsubpodr.kodchfsubpodr').error(
              'Для полного зачета выбрать счет надо обязательно');
          } else {
            editor_tab5_avchfsubpodr.field('dognet_docavsubpodr.kodchfsubpodr').error('');
    ...
    editor_tab5_avsplitsubpodr
      .on('open', function(e, mode, action) {
        ...
        $(document).on("change", "select#DTE_Field_dognet_docavsplitsubpodr-kodchfsubpodr", function() {
          ajaxRequest_calcChfAvOstatok(editor_tab5_avsplitsubpodr.field('dognet_docavsplitsubpodr.kodavsubpodr')
            .val(), editor_tab5_avsplitsubpodr.field('dognet_docavsplitsubpodr.kodchfsubpodr').val(),
            editor_tab5_avsplitsubpodr.field('dognet_docavsplitsubpodr.sumavsplit').val(), 'calcChfAvOstatok');
        });
    ...
    editor_tab5_avsplitsubpodr
      .on('preSubmit', function(e, data, action) {
        ...
        if (action === "create") {
          var Input_SumSplit = parseFloat(editor_tab5_avsplitsubpodr.field('dognet_docavsplitsubpodr.sumavsplit')
            .val()) + parseFloat(window.res_sumavsplit);
          var limit = parseFloat(window.res_sumav) - parseFloat(window.res_sumavsplit);
          var errMessage = (limit > 0) ? ('Не более ' + $.fn.dataTable.render.number(' ', ',', 2, '').display(
            limit)) : 'Аванс исчерпан';
          if (Input_SumSplit > parseFloat(window.res_sumav)) {
            editor_tab5_avsplitsubpodr.field('dognet_docavsplitsubpodr.sumavsplit').error(errMessage);
    ...
    table_tab5_subpodr.on('select', function() {
      ...
      // Обрабатываем форму оплат (oplchfsubpodr)
      editor_tab5_oplchfsubpodr
        .field('dognet_docoplchfsubpodr.koddocsubpodr')
        .set(table_tab5_subpodr.row({
          selected: true
        }).data().dognet_docsubpodr.koddocsubpodr);
      console.log('OPLCHF koddocsubpodr field:', editor_tab5_oplchfsubpodr.field(
        'dognet_docoplchfsubpodr.koddocsubpodr').val());
...
include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/docview/docview-edit/restr_5/tabs/forms/docview-edit_tab5_subpodr_chfavanssplit-customForm.php");
?>
...
<section>
  <div class="" style="padding-left:5px; padding-right:5px">
    ...
    <?php // ----- ----- ----- ----- ----- 
    ?>
    <link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_5/tabs/css/docview-edit-tab5_subpodr_chfavanssplit.css">
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
      <div class="space30"></div>
...
<div id="subpodr-block-legend" class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-top:25px; border-top:1px solid #00a6dc; padding:20px">
  ...
  <div style="float: left">
    <p><span class="label label-icon"><span class="lbl lbl-light">Без зачета</span></span><span style="font-size:0.8em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Аванс создан,
  ...
  <div style="float: left">
    <p><span class="label label-icon"><span class="lbl lbl-red">Сплит</span></span><span style="font-size:0.8em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Из аванса
        выделены части (сплиты)</span></p>
  </div>
  <div style="float: left">
    <p><span class="label label-icon"><span class="lbl lbl-green">Зачет</span></span><span style="font-size:0.8em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Аванс зачтен
        полностью</span></p>
  </div>
  <div style="float: left">
    <p><span class="label label-icon"><span style="color:#0085c7" class="glyphicon glyphicon-link"></span></span><span style="font-size:0.8em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Оплата, аванс
        целиком
