...
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/letterview/letterview-current/restr_4/css/letterview-current-common-tables.css">
<style>
				...
				<div id="letterview-tabs">
					...
					<div class="tab-content">
						<div id="letterview-tab-2" class="tab-pane fade in active">
							<div class="col-xs-12 col-sm-12 col-md-12 сol-lg-12">
								<?php include("tabs/dognet-letterview(restr_4)-tab2_log.php"); ?>
							</div>
						</div>
					</div>
				</div>
