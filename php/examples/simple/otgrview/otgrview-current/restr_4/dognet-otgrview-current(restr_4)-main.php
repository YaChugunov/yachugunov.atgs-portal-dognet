...
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/otgrview/otgrview-current/restr_4/css/otgrview-current-common-tables.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/otgrview/otgrview-current/restr_4/css/otgrview-current-common-customForm.css">
...
// :::
include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/otgrview/otgrview-current/restr_4/forms/otgrview-current-customForm.php");
include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/otgrview/otgrview-current/restr_4/forms/otgrview-current-filters.php");
// ----- ----- ----- ----- -----
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/otgrview/otgrview-current/restr_4/css/otgrview-current-main.css">
<section>
