...
<style>
#blankview-tabs .nav>li>a {
    color: #666
}

#blankview-tabs .nav>li>a:focus,
#blankview-tabs .nav>li>a:hover {
    background-color: transparent;
}

#blankview-tabs .nav-tabs>li.active>a,
#blankview-tabs .nav-tabs>li>a:hover {
    color: #333333 !important;
}

#blankview-tabs .nav-tabs>li>a::after {
    background: #f1f1f1
}

#blankview-tabs>div.row>div>ul>li>a {
...
#blankview-tabs-menu>li.active>a::after,
#blankview-tabs-menu>li:hover>a::after {
    transform: scale(1);
}
</style>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <ul id="blankview-tabs-menu" class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#blankview-gip-tab-1" title="">Бланки <span
                                          class="glyphicon glyphicon-option-vertical"></span>
                                    <?php echo date('Y'); ?></a></li>
                            <li id="link-to-tab2"><a data-toggle="tab" href="#blankview-gip-tab-2" title="">Поставка</a>
                            </li>
                            <li id="link-to-tab3"><a data-toggle="tab" href="#blankview-gip-tab-3" title="">ПНР</a></li>
                            <li id="link-to-tab4"><a data-toggle="tab" href="#blankview-gip-tab-4"
                                   title="">Субподряд</a></li>
                            <li id="link-to-tab5"><a data-toggle="tab" href="#blankview-gip-tab-5" title="">ПИР</a></li>
                            <li style="float:right"><a data-toggle="tab" href="#blankview-gip-tab-7" title=""><span
                                          class="glyphicon glyphicon-flash text-danger"
                                          style="margin-right:5px"></span><span class="">Как это работает?</span></a>
                            </li>
                            <li style="float:right"><a data-toggle="tab" href="#blankview-gip-tab-6" title="">Архив.</a>
                            </li>
                        </ul>
                        <div class="tab-content">
                            <div id="blankview-gip-tab-1" class="tab-pane fade in active">
                                <?php include ('tabs/dognet-blankview-gip-tab1_blankwork.php'); ?>
                            </div>
                            <div id="blankview-gip-tab-2" class="tab-pane fade">
                                <?php include ('tabs/dognet-blankview-gip-tab2_pos.php'); ?>
                            </div>
                            <div id="blankview-gip-tab-3" class="tab-pane fade">
                                <?php include ('tabs/dognet-blankview-gip-tab3_pnr.php'); ?>
                            </div>
                            <div id="blankview-gip-tab-4" class="tab-pane fade">
                                <?php include ('tabs/dognet-blankview-gip-tab4_sub.php'); ?>
                            </div>
                            <div id="blankview-gip-tab-5" class="tab-pane fade in">
                                <?php
								// include("tabs/message_section-thinkaboutit.php");
								include ('tabs/dognet-blankview-gip-tab5_pir.php');
								?>
                            </div>
                            <div id="blankview-gip-tab-6" class="tab-pane fade in">
                                <?php
								// 										include("tabs/message_section-underconstruction.php");
								include ('tabs/dognet-blankview-gip-tab6_blankarchive.php');
								?>
                            </div>
                            <div id="blankview-gip-tab-7" class="tab-pane fade in">
                                <?php
								include ('dognet-blankview-gip-help.php');
								// 										include("tabs/message_section-thinkaboutit.php");
								?>
                            </div>
                        </div>
