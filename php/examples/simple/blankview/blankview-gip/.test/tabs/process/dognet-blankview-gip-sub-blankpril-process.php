...
#
        ...
        $db->update('dognet_blankworkpril', [
...
# ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
    if ($action_blankworkpril == 'UPD') {
        ...
        if ($_QRY_blankpaper) {
            ...
            $_QRY_blankRowID = $db->sql("SELECT id FROM dognet_blankdocsub WHERE kodblankwork=" . $_kodblankwork)->fetchAll();
...
#
            if ($_docFileID != "") {
                ...
                if ($_QRY_paperfiles[0]['flag'] == "0") {
                    ...
                    $__newFileName = "NEW-B-{$_numberpril}-SUB-CR-{$_kodblankwork}";
...
// ---
                        ...
                        ->db('dognet_blankworkpril_files', 'id', [
