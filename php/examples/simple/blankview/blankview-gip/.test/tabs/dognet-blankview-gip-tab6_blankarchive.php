...
//
//
var reqField_cloneSelectedBlank_arch = {
...
function ajaxRequest_cloneSelectedBlank_arch(kodblankwork, kodtipblank, kodstatusblank, responseHandler) {
    ...
    request = $.ajax({
        url: "php/examples/simple/blankview/blankview-gip/.test/tabs/php/ajaxRequest_cloneSelectedBlank_arch.php",
        type: "post",
        cache: false,
        data: {
...
$(document).ready(function() {
    ...
    var table_blankview_gip_blankarchive = $('#blankview-gip-blankarchive-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.test/tabs/process/dognet-blankview-gip-blankarchive-process.php",
            type: "POST"
        },
        serverSide: true,
        columns: [{
    ...
    $("#blankNumberSearchArchive_text").on("keyup", function(event) {
        if (event.keyCode === 13) {
            ...
            document.getElementById("columnSearchArchive_btnApply").click();
        }
    });
    ...
    $('#blankview-gip-blankarchive-table tbody').on('click', 'tr td.details-control-docblank', function() {
        ...
        if (row.child.isShown()) {
            ...
            d = row.data();
            rowData.child(<?php include ('templates/blankview-gip-blankarchive-doc-table.tpl'); ?>)
                .show();
    ...
    $('#blankview-gip-blankarchive-table tbody').on('click', 'tr td.details-control-blankarchive', function() {
        ...
        if (row.child.isShown()) {
            ...
            if (d.dognet_docblankwork.kodtipblank == "POS") {
                rowData.child(
                        <?php include ('templates/blankview-gip-blankarchive-pos-blank-table.tpl'); ?>)
                    .show();
            }
            if (d.dognet_docblankwork.kodtipblank == "PNR") {
                rowData.child(
                        <?php include ('templates/blankview-gip-blankarchive-pnr-blank-table.tpl'); ?>)
                    .show();
            }
            if (d.dognet_docblankwork.kodtipblank == "SUB") {
                rowData.child(
                        <?php include ('templates/blankview-gip-blankarchive-sub-blank-table.tpl'); ?>)
                    .show();
            }
            // Add to the 'open' array
            if (idx === -1) {
    ...
    var table_blankview_gip_blankarchive_docfiles = $('#blankview-gip-blankarchive-docfiles-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.test/tabs/process/dognet-blankview-gip-blankarchive-docfiles-process.php",
            type: 'post',
            data: function(d) {
                var selected = table_blankview_gip_blankarchive.row({
                    selected: true
                });
                if (selected.any()) {
    ...
    var table_blankview_gip_blankarchive_blankpril = $('#blankview-gip-blankarchive-blankpril-table')
        .DataTable({
            dom: "<'row'<'col-sm-5'><'col-sm-4'<'#toolbar_msg'>><'col-sm-3'>>" + "<'row'<'col-sm-12'tr>>" +
                "<'row'<'col-sm-4'><'col-sm-8'>>",
            // 		dom: "<'space50'r>tip",
            ...
            ajax: {
                url: "php/examples/simple/blankview/blankview-gip/.test/tabs/process/dognet-blankview-gip-blankarchive-blankpril-process.php",
                type: 'post',
                data: function(d) {
                    var selected = table_blankview_gip_blankarchive.row({
                        selected: true
    ...
    var table_blankview_gip_blankarchive_summadop = $('#blankview-gip-blankarchive-summadop-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.test/tabs/process/dognet-blankview-gip-blankarchive-summadop-process.php",
            type: 'post',
            data: function(d) {
                var selected = table_blankview_gip_blankarchive.row({
                    selected: true
        ...
        $.confirm({
            ...
            buttons: {
                confirm: {
                    ...
                    text: "Подтверждаю",
                    action: function() {
                        ajaxRequest_cloneSelectedBlank_arch(d.dognet_docblankwork
                            .kodblankwork, d.dognet_docblankwork.kodtipblank, d
                            .dognet_docblankwork.kodstatusblank);
                    }
                },
                cancel: {
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.test/tabs/css/blankview-gip-tab6_blankarchive.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.test/tabs/css/blankview-gip-tab6_summadop.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.test/tabs/css/blankview-gip-tab6_doc_files.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.test/tabs/css/blankview-gip-tab6_pril_files.css">
<?php
//
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
//
            ...
            <div id="blankview-gip-filters" class="panel-body space30">
                <div class="col-xs-12 col-sm-3 col-md-1 col-lg-1">
                    <div class="form-group space10" style="width:100%">
                        ...
                        <input type="text" id="blankNumberSearchArchive_text" class="form-control" placeholder="###"
                               name="blankNumberSearchArchive_text">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-3 col-md-1 col-lg-1">
                    <div class="form-group space10" style="width:100%">
                        <label for="docNumberSearchArchive_text"><b># дог :</b></label>
                        <input type="text" id="docNumberSearchArchive_text" class="form-control" placeholder="####"
                               name="docNumberSearchArchive_text">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
                    <div class="form-group space10" style="width:100%">
                        <label for="blankStatusSearchArchive_text"><b>Статус :</b></label>
                        <select name="blankStatusSearchArchive_text" id="blankStatusSearchArchive_text"
                                class="form-control">
                ...
                <div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
                    <div class="form-group space10" style="width:100%">
                        ...
                        <select name="blankTypeSearchArchive_text" id="blankTypeSearchArchive_text"
                                class="form-control">
                ...
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                    <div class="input-group space10" style="width:100%">
                        ...
                        <input type="text" id="blankObjectSearchArchive_text" class="form-control"
                               placeholder="Все объекты" name="blankObjectSearchArchive_text">
                    </div>
                </div>
                <?php // ----- ----- ----- ----- ----- ?>
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                    <div class="input-group space10" style="width:100%">
                        ...
                        <input type="text" id="blankNameSearchArchive_text" class="form-control"
                               placeholder="Введите текст для поиска" name="blankNameSearchArchive_text">
                    </div>
                </div>
                <?php // ----- ----- ----- ----- ----- ?>
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-right">
                    <div class="input-group-btn">
                        <button id="columnSearchArchive_btnApply" class="btn btn-default" type="button">Применить
                            фильтры</button>
                        <button id="columnSearchArchive_btnClear" class="btn btn-default" type="button"><i
...
<section>
    ...
    <table id="blankview-gip-blankarchive-table" class="table table-condensed table-bordered compact display"
...
<section>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div id="blankview-gip-blankarchive-summadop">
            ...
            <div class="demo-html"></div>
            <table id="blankview-gip-blankarchive-summadop-table" class="table table-striped" cellspacing="0"
                   width="100%">
                <thead>
                    <tr>
                        <th width="" class=""></th>
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        ...
        <div id="blankview-gip-blankarchive-docfiles">
            ...
            <div class="demo-html"></div>
            <table id="blankview-gip-blankarchive-docfiles-table" class="table table-striped" cellspacing="0"
                   width="100%">
                <thead>
                    <tr>
                        <th width="" class=""></th>
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        ...
        <div id="blankview-gip-blankarchive-blankpril">
            ...
            <div class="demo-html"></div>
            <table id="blankview-gip-blankarchive-blankpril-table" class="table table-striped" cellspacing="0"
                   width="100%">
                <thead>
                    <tr>
                        <th width="" class=""></th>
