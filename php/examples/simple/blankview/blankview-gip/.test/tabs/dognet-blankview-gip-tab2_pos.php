...
function ajaxRequest_sendMailPOS(blanktip, blankname, ispolname, ispolrukname, objname, zakname, summablank,
    ...
    request = $.ajax({
        url: "php/examples/simple/blankview/blankview-gip/.test/tabs/php/sendMail_onSubmit-newBlankPOS.php",
        type: "post",
        cache: false,
        data: {
            blanktip: blanktip,
...
$(document).ready(function() {
    ...
    var editor_blankview_edit_pos = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: "php/examples/simple/blankview/blankview-gip/.test/tabs/process/dognet-blankview-gip-pos-process.php",
    ...
    var table_blankview_gip_pos = $('#blankview-gip-pos-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.test/tabs/process/dognet-blankview-gip-pos-process.php",
            type: "POST"
        },
        serverSide: true,
        columns: [{
    ...
    var editor_blankview_gip_pos_docfiles = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: "php/examples/simple/blankview/blankview-gip/.test/tabs/process/dognet-blankview-gip-pos-docfiles-process.php",
    ...
    var table_blankview_gip_pos_docfiles = $('#blankview-gip-pos-docfiles-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.test/tabs/process/dognet-blankview-gip-pos-docfiles-process.php",
            type: 'post',
            data: function(d) {
    ...
    var editor_blankview_gip_pos_blankpril = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.test/tabs/process/dognet-blankview-gip-pos-blankpril-process.php",
            data: function(d) {
                var selected = table_blankview_gip_pos.row({
                    selected: true
                });
    ...
    var editor_blankview_gip_pos_summadop = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.test/tabs/process/dognet-blankview-gip-pos-summadop-process.php",
            data: function(d) {
                var selected = table_blankview_gip_pos.row({
                    selected: true
                });
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.test/tabs/css/blankview-gip-tab2_pos.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.test/tabs/css/blankview-gip-tab2_summadop.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.test/tabs/css/blankview-gip-tab2_doc_files.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.test/tabs/css/blankview-gip-tab2_pril_files.css">
<?php
// ----- ----- ----- ----- -----
