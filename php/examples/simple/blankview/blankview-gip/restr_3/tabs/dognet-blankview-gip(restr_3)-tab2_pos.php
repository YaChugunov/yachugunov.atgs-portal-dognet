<script type="text/javascript" language="javascript" class="init">
    ...
    function ajaxRequest_sendMailPOS(blanktip, blankname, ispolname, ispolrukname, objname, zakname, summablank,
        ...
        request = $.ajax({
            url: "php/examples/simple/blankview/blankview-gip/restr_3/tabs/php/sendMail_onSubmit-newBlankPOS.php",
            type: "post",
            cache: false,
            data: {
                blanktip: blanktip,
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/restr_3/tabs/css/blankview-gip-tab2_pos.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/restr_3/tabs/css/blankview-gip-tab2_summadop.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/restr_3/tabs/css/blankview-gip-tab2_doc_files.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/restr_3/tabs/css/blankview-gip-tab2_pril_files.css">
<?php
// ----- ----- ----- ----- -----
