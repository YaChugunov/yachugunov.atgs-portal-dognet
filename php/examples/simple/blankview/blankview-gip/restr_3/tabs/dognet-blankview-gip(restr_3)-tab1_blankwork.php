...
//
//
var reqField_cloneSelectedBlank = {
    cloneBlank: function(response) {}
};

function ajaxRequest_cloneSelectedBlank(kodblankwork, kodtipblank, kodstatusblank, responseHandler) {
    var response = false;
    // Fire off the request to /form.php
    request = $.ajax({
        url: "php/examples/simple/blankview/blankview-gip/restr_3/tabs/php/ajaxRequest_cloneSelectedBlank.php",
        type: "post",
        cache: false,
        data: {
        ...
        success: reqField_cloneSelectedBlank[responseHandler]
    });
...
$(document).ready(function() {
    ...
    var table_blankview_gip_blankwork = $('#blankview-gip-blankwork-table').DataTable({
        dom: "<'row'<'col-sm-2'B><'col-sm-9'><'col-sm-3'>>" + "<'row'<'col-sm-12'tr>>" +
            "<'row'<'col-sm-4'i><'col-sm-8'>>",
        // 		dom: "<'space50'r>tip",
        language: {
            url: "php/examples/simple/blankview/blankview-gip/dt_russian-tab1_blankwork.json"
        },
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/restr_3/tabs/process/dognet-blankview-gip(restr_3)-blankwork-process.php",
            type: "POST"
        },
        serverSide: true,
        columns: [{
            ...
            {
                data: "dognet_docblankwork.yearblankwork",
                className: ""
            },
            {
                data: "dognet_docblankwork.nametipblankwork",
                className: "text-uppercase"
            },
            {
                data: "dognet_docblankwork.nameblankwork",
                className: ""
            },
            {
                data: "dognet_docblankwork.nameorgblankwork",
                className: ""
            },
            {
                data: "dognet_docblankwork.kodstatusblank",
                className: ""
            },
            {
                data: "dognet_docblankwork.numberdoccr",
                className: ""
            },
            {
                data: "dognet_docblankwork.dateblankorder",
                className: ""
            },
            {
        ...
        columnDefs: [{
            ...
            },
            {
                ...
                render: function(data, type, row, meta) {
                    ...
                    // Заявка создана.
                    if (tipdoc == "CR" && docdone == 0 && tipblank == "CR" && inprocess == 0 &&
                        blankdone == 0) {
                    ...
                    else if (tipdoc == "CR" && docdone == 0 && tipblank == "CR" && inprocess ==
                        1 && blankdone == 1) {
                        return "<span class='label label-default text-uppercase' style='color:#fafafa; background-color:#ff7611; border:1px #fff solid'>В работе (ГИП)</span>";
                    }
                    // Заявка в работе. ПЕРВАЯ версия бланка отдела договоров.
                    else if (tipdoc == "CR" && docdone == 0 && tipblank == "RD" && inprocess ==
                        1 && blankdone == 1) {
                        return "<span class='label label-default text-uppercase' style='color:#fafafa; background-color:#ff7611; border:1px #fff solid'>В работе 1 (ОД)</span>";
                    }
                    // Заявка в работе. ПЕРВАЯ версия бланка отдела договоров.
                    else if (tipdoc == "CR" && docdone == 1 && tipblank == "CR" && inprocess ==
                        1 && blankdone == 1) {
                        return "<span class='label label-default text-uppercase' style='color:#fafafa; background-color:#ff7611; border:1px #fff solid'>В работе 2 (ОД)</span>";
                    }
                    // Заявка в работе. Промежуточная версия бланка отдела договоров.
                    else if (tipdoc == "RD" && docdone == 1 && tipblank == "RD" && inprocess ==
                        1 && blankdone == 1) {
                        return "<span class='label label-default text-uppercase' style='color:#fafafa; background-color:#ff7611; border:1px #fff solid'>В работе 3 (ОД)</span>";
                    }
                    // Заявка обработана. Можно готовить договор.
                    else if (tipdoc == "RD" && docdone == 1 && tipblank == "DO" && inprocess ==
                        1 && blankdone == 1) {
                    ...
                    else if (tipdoc == "DO" && docdone == 1 && tipblank == "DO" && inprocess ==
                        1 && blankdone == 1) {
                        return "<span class='label label-default text-uppercase' style='color:#999999; background-color:#ccc; border:1px #fff solid'>Договор</span>";
                    } else {
                        return "---";
                    }
                },
            ...
            },
            {
                ...
                searchable: true,
                render: function(data, type, row, meta) {
                    return '<a href="/dognet/dognet-docview.php?docview_type=details&uniqueID=' +
                        row.dognet_docblankwork.koddoc +
                        '" class="docview-details-link" title="Перейти к карточке договора">' +
                        data + '</a>';
                    // 					return data;
                },
                targets: 7
            ...
            },
            {
                ...
                render: function(data, type, row, meta) {
                    ...
                    if ((tipdoc == "RD" || tipdoc == "DO") && docdone == 1 && tipblank ==
                        "DO" && inprocess == 1 && blankdone == 1) {
                        return '<a href="#" title="Создать черновик бланка на основе этого"><span data-kodblankwork="' +
                            row.dognet_docblankwork.kodblankwork + '" data-kodtipblank="' + row
                            .dognet_docblankwork.kodtipblank + '" data-kostatusblank="' + row
                            .dognet_docblankwork.kostatusblank +
        ...
        rowGroup: {
            startRender: function(rows, group, level) {
                ...
                if (level == 0) {
                    if (group == "CR") {
                        return '<span style="text-align:left; white-space:nowrap">Новые бланки / Бланки в работе (бланк получен / взят в работу отделом договоров)</span>';
                    } else if (group == "RD") {
        ...
        createdRow: function(row, data, index) {
            ...
            if (data.dognet_docblankwork.kodtipblank === "SUB") {
                var tipblank = data.dognet_blankdocsub.kodtipblank;
                var inprocess = data.dognet_blankdocsub.kodblankinprocess;
                var blankdone = data.dognet_blankdocsub.kodblankdone;
            }
            if (data.dognet_docblankwork.kodtipblank === "PIR") {
                var tipblank = data.dognet_blankdocpir.kodtipblank;
                var inprocess = data.dognet_blankdocpir.kodblankinprocess;
                var blankdone = data.dognet_blankdocpir.kodblankdone;
            }
            // Заявка создана.
            if (tipdoc == "CR" && docdone == 0 && tipblank == "CR" && inprocess == 0 && blankdone ==
                0) {

            }
            // Заявка создана. Отделом договоров получена.
            if (tipdoc == "CR" && docdone == 0 && tipblank == "CR" && inprocess == 1 && blankdone ==
                1) {

            }
            // Заявка в работе. ПЕРВАЯ версия бланка отдела договоров.
            if (tipdoc == "CR" && docdone == 0 && tipblank == "RD" && inprocess == 1 && blankdone ==
                1) {
                $(row).css({
                    "color": "brown"
                });
            ...
            // Заявка в работе. Промежуточная версия бланка отдела договоров.
            if (tipdoc == "RD" && docdone == 1 && tipblank == "RD" && inprocess == 1 && blankdone ==
                1) {
                $(row).css({
                    "color": "blue",
                });
            ...
            // Заявка обработана. Можно готовить договор.
            if (tipdoc == "RD" && docdone == 1 && tipblank == "DO" && inprocess == 1 && blankdone ==
                1) {

            }
            // Заявка закрыта. Договор создан. Бланк привязан к договору.
            if (tipdoc == "DO" && docdone == 1 && tipblank == "DO" && inprocess == 1 && blankdone ==
                1) {
                $(row).css({
                    "font-style": "italic"
                });
    ...
    $('#blankview-gip-blankwork-table tbody').on('click', 'tr td.details-control-docblank', function() {
        ...
        if (row.child.isShown()) {
            ...
            d = row.data();
            rowData.child(<?php include('templates/blankview-gip-blankwork-doc-table.tpl'); ?>).show();
    ...
    $('#blankview-gip-blankwork-table tbody').on('click', 'tr td.details-control-blankwork', function() {
        var tr = $(this).closest('tr');
        var row = table_blankview_gip_blankwork.row(tr);
        ...
        if (row.child.isShown()) {
            ...
            if (d.dognet_docblankwork.kodtipblank == "POS") {
                rowData.child(
                        <?php include('templates/blankview-gip-blankwork-pos-blank-table.tpl'); ?>)
                    .show();
            }
            if (d.dognet_docblankwork.kodtipblank == "PNR") {
                rowData.child(
                        <?php include('templates/blankview-gip-blankwork-pnr-blank-table.tpl'); ?>)
                    .show();
            }
            if (d.dognet_docblankwork.kodtipblank == "SUB") {
                rowData.child(
                        <?php include('templates/blankview-gip-blankwork-sub-blank-table.tpl'); ?>)
                    .show();
            }
            if (d.dognet_docblankwork.kodtipblank == "PIR") {
                rowData.child(
                        <?php include('templates/blankview-gip-blankwork-pir-blank-table.tpl'); ?>)
                    .show();
            }
            // Add to the 'open' array
            if (idx === -1) {
    ...
    var table_blankview_gip_blankwork_docfiles = $('#blankview-gip-blankwork-docfiles-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/restr_3/tabs/process/dognet-blankview-gip(restr_3)-blankwork-docfiles-process.php",
            type: 'post',
            data: function(d) {
                var selected = table_blankview_gip_blankwork.row({
                    selected: true
                });
                if (selected.any()) {
    ...
    var table_blankview_gip_blankwork_blankpril = $('#blankview-gip-blankwork-blankpril-table').DataTable({
        dom: "<'row'<'col-sm-5'><'col-sm-4'<'#toolbar_msg'>><'col-sm-3'>>" + "<'row'<'col-sm-12'tr>>" +
            "<'row'<'col-sm-4'><'col-sm-8'>>",
        // 		dom: "<'space50'r>tip",
        language: {
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/restr_3/tabs/process/dognet-blankview-gip(restr_3)-blankwork-blankpril-process.php",
            type: 'post',
            data: function(d) {
                var selected = table_blankview_gip_blankwork.row({
                    selected: true
    ...
    var table_blankview_gip_blankwork_summadop = $('#blankview-gip-blankwork-summadop-table').DataTable({
        dom: "<'row'<'col-sm-5'><'col-sm-4'<'#toolbar_msg'>><'col-sm-3'>>" + "<'row'<'col-sm-12'tr>>" +
            "<'row'<'col-sm-4'><'col-sm-8'>>",
        // 		dom: "<'space50'r>tip",
        language: {
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/restr_3/tabs/process/dognet-blankview-gip(restr_3)-blankwork-summadop-process.php",
            type: 'post',
            data: function(d) {
                var selected = table_blankview_gip_blankwork.row({
                    selected: true
                ...
                if (selected.any()) {
                    ...
                    console.log("Summadop (" + selected.id() + ") :: kodtipblank: " + d
                        .kodtipblank);
                }
            }
        },
    ...
    table_blankview_gip_blankwork.on('select', function() {
        ...
        table_blankview_gip_blankwork_summadop.ajax.reload();
    ...
    table_blankview_gip_blankwork.on('init', function() {
        table_blankview_gip_blankwork_summadop.buttons().disable();
    ...
    $('#blankview-gip-blankwork-table tbody').on('click', 'tr td.clone-control-blankwork', function() {
        ...
        $.confirm({
            ...
            content: 'Вы решили создать новую заявку на договор на основе существующего бланка<br>-----<br><b>Бланк № ' +
                d.dognet_docblankwork.numberblankwork + '</b> / <b>' + d.dognet_docblankwork
                .nameorgblankwork + '</b> / <b>' + d.dognet_docblankwork.nameblankwork + '</b>',
            ...
            buttons: {
                confirm: {
                    ...
                    text: "Подтверждаю",
                    action: function() {
                        ajaxRequest_cloneSelectedBlank(d.dognet_docblankwork.kodblankwork, d
                            .dognet_docblankwork.kodtipblank, d.dognet_docblankwork
                            .kodstatusblank);
                    }
                },
                cancel: {
...
?>
<link rel="stylesheet"
    href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/restr_3/tabs/css/blankview-gip-tab1_blankwork.css">
<link rel="stylesheet"
    href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/restr_3/tabs/css/blankview-gip-tab1_summadop.css">
<link rel="stylesheet"
    href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/restr_3/tabs/css/blankview-gip-tab1_doc_files.css">
<link rel="stylesheet"
    href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/restr_3/tabs/css/blankview-gip-tab1_pril_files.css">
<?php
//
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
//
...
<section>
    ...
    <table id="blankview-gip-blankwork-table" class="table table-condensed table-bordered compact display"
        cellspacing="0" width="100%">
        <thead>
            <tr>
                <th class="text-center"><span class='glyphicon glyphicon-option-vertical'></span></th>
                <th width="" class="">№</th>
                <th width="" class="">Состояние</th>
...
<p class="text-danger space20">*Клонирование заявки (бланка) возможно только для уже обработанных отделом договоров
    бланков
    (статусы "Договор, "Ждет договора", "В работе"). В иных случая стоит пользоваться возможностью
    <u><b>дублирования</b></u>
    бланков
    на этапе их создания <u><b>перед</b></u> отправкой на проверку в отдел договоров.
</p>
<?php
//
// ----- ----- -----
...
<section>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="space10"></div>
        <div id="blankview-gip-blankwork-summadop">
            <h3 class="space10">Разбиение суммы договора</h3>
            <div class="demo-html"></div>
            <table id="blankview-gip-blankwork-summadop-table" class="table table-striped" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th width="" class=""></th>
                        <th width="" class=""></th>
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        <div class="space10"></div>
        <div id="blankview-gip-blankwork-docfiles">
            <h3 class="space10">Файлы бланков для печати</h3>
            <div class="demo-html"></div>
            <table id="blankview-gip-blankwork-docfiles-table" class="table table-striped" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th width="" class=""></th>
                        <th width="" class=""></th>
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        <div class="space10"></div>
        <div id="blankview-gip-blankwork-blankpril">
            <h3 class="space10">Прикрепленные к бланку файлы</h3>
            <div class="demo-html"></div>
            <table id="blankview-gip-blankwork-blankpril-table" class="table table-striped" cellspacing="0"
                width="100%">
                <thead>
                    <tr>
                        <th width="" class=""></th>
