...
// ПОЛНОЕ РЕДАКТИРОВАНИЕ БЛАНКА ::: Редактор
	var editor_blankview_edit = new $.fn.dataTable.Editor( {
		display: "bootstrap",
		ajax: "php/examples/php/blankview/blankview-gip/dognet-blankview-gip-process.php",
		table: "#blankview-gip-table",
    i18n: {
...
// ----- ----- ----- ----- -----
/*
	$('#blankview-gip-table').on( 'dblclick', 'tbody tr', function () {
...
// БЛАНК ГОТОВЫЙ ::: Таблица данных
	var table_blankview_gip = $('#blankview-gip-table').DataTable( {
		dom: "<'row'<'col-sm-9'B><'col-sm-3'>>" + "<'row'<'col-sm-12'tr>>" + "<'row'<'col-sm-4'i><'col-sm-8'p>>",
// 		dom: "<'space50'r>tip",
		language: {	url: "russian.json" },
		ajax: {
			url: "php/examples/php/blankview/blankview-gip/dognet-blankview-gip-process.php",
			type: "POST"
		},
		serverSide: true,
		columns: [
...
// Array to track the ids of the edit displayed rows
    ...
    $('#blankview-gip-table tbody').on( 'click', 'tr td.details-control', function () {
        ...
        if ( row.child.isShown() ) {
			...
			d = row.data();
			rowData.child( <?php include('templates/blankview-gip-table.tpl'); ?> ).show();
...
/* Общее для таблицы */
#blankview-gip-table {  }
#blankview-gip-table .details-control:hover { cursor:hand }
#blankview-gip-table > tbody > tr.selected, #docview-details-tab3 > tbody > tr > .selected { color:#000;	background-color:#e9e9e9 }
/*
/*
/* Заголовок таблицы */
#blankview-gip-table > thead {	background-color:#111;	color:#fff; font-family:'Oswald', sans-serif; border-bottom:none;	border-top:none }
#blankview-gip-table > thead > tr > th { border-bottom:none; font-weight:400; font-size:1.0em; text-transform:uppercase }
#blankview-gip-table .sorting:after, #blankview-gip-table .sorting_asc:after, #blankview-gip-table .sorting_desc:after { display:none }
#blankview-gip-table > thead > tr > th.sorting_asc { padding-right:5px }
#blankview-gip-table > thead > tr > th.sorting_desc { padding-right:5px }
/*
/*
/* Тело таблицы */
#blankview-gip-table {  }
#blankview-gip-table > tbody { font-family:'Helioscond', sans-serif; font-size:1.0em; font-weight:300; color:#666; border-bottom:none; border-top:none }
#blankview-gip-table > tbody > tr > td { padding:5px; line-height:1.42857143; vertical-align:middle; border-top:none }
#blankview-gip-table > thead > tr > th { padding:8px 5px; border-bottom:none }
#blankview-gip-table > tbody > tr > td {  }
#blankview-gip-table > tbody > tr > td:last-child { text-align:right }

#blankview-gip-table > tfoot > tr > td { padding:5px 4px }
#blankview-gip-table > tfoot > tr > td:last-child { text-align:right }
#blankview-gip-table > tfoot {
...
----- ----- ----- ----- ----- ----- ----- ----- ----- -----
*/
	#blankview-gip-table > thead > tr > th:first-child, #blankview-gip-table > tbody > tr > td:first-child { width:1%; text-align:center }
	#blankview-gip-table > thead > tr > th:nth-child(2), #blankview-gip-table > tbody > tr > td:nth-child(2) { width:3%; text-align:center; border-left:1px #fff solid }
	#blankview-gip-table > thead > tr > th:nth-child(3), #blankview-gip-table > tbody > tr > td:nth-child(3) { width:4%; text-align:center; border-left:1px #fff solid }
	#blankview-gip-table > thead > tr > th:nth-child(4), #blankview-gip-table > tbody > tr > td:nth-child(4) { width:45%; text-align:left; border-left:1px #fff solid }
	#blankview-gip-table > thead > tr > th:nth-child(5), #blankview-gip-table > tbody > tr > td:nth-child(5) { width:19%; text-align:left; border-left:1px #fff solid }
	#blankview-gip-table > thead > tr > th:nth-child(6), #blankview-gip-table > tbody > tr > td:nth-child(6) { width:5%; text-align:center; border-left:1px #fff solid }
	#blankview-gip-table > thead > tr > th:nth-child(7), #blankview-gip-table > tbody > tr > td:nth-child(7) { width:4%; text-align:center; border-left:1px #fff solid }
	#blankview-gip-table > thead > tr > th:nth-child(8), #blankview-gip-table > tbody > tr > td:nth-child(8) { width:7%; text-align:center; border-left:1px #fff solid }
	#blankview-gip-table > thead > tr > th:nth-child(9), #blankview-gip-table > tbody > tr > td:nth-child(9) { width:8%; text-align:center; border-left:1px #fff solid }
	#blankview-gip-table > thead > tr > th:nth-child(10), #blankview-gip-table > tbody > tr > td:nth-child(10) { width:7%; text-align:center; border-left:1px #fff solid }
	#blankview-gip-table > thead > tr > th:nth-child(11), #blankview-gip-table > tbody > tr > td:nth-child(11) { width:5%; text-align:center; border-left:1px #fff solid }
	#blankview-gip-table .details-control:hover { cursor:pointer }

/*
----- ----- ----- ----- ----- ----- ----- ----- ----- -----
*/
	#blankview-gip-table .sorting_asc:after { display:none }
	#blankview-gip-table > thead > tr > th.sorting_asc { padding-right:8px }
/*
----- ----- ----- ----- ----- ----- ----- ----- ----- -----
*/
...
#blankview-docfiles-table .sorting:after, #blankview-gip-table .sorting_asc:after, #blankview-gip-table .sorting_desc:after { display:none }
...
#blankview-blankpril-table .sorting:after, #blankview-gip-table .sorting_asc:after, #blankview-gip-table .sorting_desc:after { display:none }
...
#blankview-gip-table .group { font-family:'Oswald', sans-serif; font-size:1.3em; font-weight:400; color:#000 }
#blankview-gip-table > tbody > tr.dtrg-start.dtrg-level-0 > td { font-family:'Oswald', sans-serif; font-size:1.3em; font-weight:400; text-align:left; background-color:#d9d9d9; color:#111; padding:5px }
#blankview-gip-table > tbody > tr.dtrg-end.dtrg-level-0 > td { font-family:'Oswald', sans-serif; font-size:1.4em; font-weight:500; color:#000; background-color:#f1f1f1 }
#blankview-gip-table > tbody > tr.dtrg-end.dtrg-level-0 > td { font-family:'Oswald', sans-serif; font-size:1.4em; font-weight:500; color:#000; background-color:#f1f1f1 }
.itogo-lvl0 {  }
...
?>
	...
	<table id="blankview-gip-table" class="table table-striped" cellspacing="0" width="100%">
			<thead>
				<tr>
