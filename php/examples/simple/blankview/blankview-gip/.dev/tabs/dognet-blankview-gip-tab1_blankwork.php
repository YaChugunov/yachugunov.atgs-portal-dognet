...
function ajaxRequest_cloneSelectedBlank(kodblankwork, kodtipblank, kodstatusblank, responseHandler) {
    ...
    request = $.ajax({
        url: "php/examples/simple/blankview/blankview-gip/.dev/tabs/php/ajaxRequest_cloneSelectedBlank.php",
        type: "post",
        cache: false,
        data: {
...
$(document).ready(function() {
    ...
    var table_blankview_gip_blankwork = $('#blankview-gip-blankwork-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.dev/tabs/process/dognet-blankview-gip-blankwork-process.php",
            type: "POST"
        },
        serverSide: true,
        columns: [{
    ...
    var table_blankview_gip_blankwork_docfiles = $('#blankview-gip-blankwork-docfiles-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.dev/tabs/process/dognet-blankview-gip-blankwork-docfiles-process.php",
            type: 'post',
            data: function(d) {
    ...
    var table_blankview_gip_blankwork_blankpril = $('#blankview-gip-blankwork-blankpril-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.dev/tabs/process/dognet-blankview-gip-blankwork-blankpril-process.php",
            type: 'post',
            data: function(d) {
                var selected = table_blankview_gip_blankwork.row({
                    selected: true
    ...
    var table_blankview_gip_blankwork_summadop = $('#blankview-gip-blankwork-summadop-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.dev/tabs/process/dognet-blankview-gip-blankwork-summadop-process.php",
            type: 'post',
            data: function(d) {
                var selected = table_blankview_gip_blankwork.row({
                    selected: true
...
?>
<link rel="stylesheet"
    href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.dev/tabs/css/blankview-gip-tab1_blankwork.css">
<link rel="stylesheet"
    href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.dev/tabs/css/blankview-gip-tab1_summadop.css">
<link rel="stylesheet"
    href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.dev/tabs/css/blankview-gip-tab1_doc_files.css">
<link rel="stylesheet"
    href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.dev/tabs/css/blankview-gip-tab1_pril_files.css">
<?php
//
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
//
