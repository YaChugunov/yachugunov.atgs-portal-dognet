...
function ajaxRequest_sendMailPNR(blanktip, blankname, ispolname, ispolrukname, objname, zakname, summablank,
    responseHandler) {
    var response = false;
    // Fire off the request to /form.php
    request = $.ajax({
        url: "php/examples/simple/blankview/blankview-gip/.dev/tabs/php/sendMail_onSubmit-newBlankPNR.php",
        type: "post",
        cache: false,
        data: {
            blanktip: blanktip,
...
$(document).ready(function() {
    ...
    var editor_blankview_edit_pnr = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: "php/examples/simple/blankview/blankview-gip/.dev/tabs/process/dognet-blankview-gip-pnr-process.php",
    ...
    editor_blankview_edit_pnr.on('open', function() {
        ...
        $('#DTE_Field_dognet_blankdocpnr-csummadocopl').inputmask({
            alias: "currency",
            rightAlign: false,
            greedy: false,
            tabThrough: true,
    ...
    var table_blankview_gip_pnr = $('#blankview-gip-pnr-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.dev/tabs/process/dognet-blankview-gip-pnr-process.php",
            type: "POST"
        },
        serverSide: true,
        columns: [{
        ...
        buttons: [{
            ...
            },
            {
                ...
                text: 'ДУБЛИРОВАТЬ',
                tabIndex: "3",
                className: 'tab3-duplicateButton',
                action: function(e, dt, node, config) {
    ...
    $('#blankview-gip-pnr-table tbody').on('click', 'tr td.details-control', function() {
        ...
        if (row.child.isShown()) {
            ...
            d = row.data();
            rowData.child(<?php include ('templates/blankview-gip-pnr-blanktemplate-table.tpl'); ?>)
                .show();
    ...
    var editor_blankview_gip_pnr_docfiles = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: "php/examples/simple/blankview/blankview-gip/.dev/tabs/process/dognet-blankview-gip-pnr-docfiles-process.php",
    ...
    var table_blankview_gip_pnr_docfiles = $('#blankview-gip-pnr-docfiles-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.dev/tabs/process/dognet-blankview-gip-pnr-docfiles-process.php",
            type: 'post',
            data: function(d) {
    ...
    var editor_blankview_gip_pnr_blankpril = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.dev/tabs/process/dognet-blankview-gip-pnr-blankpril-process.php",
            data: function(d) {
                var selected = table_blankview_gip_pnr.row({
                    selected: true
                });
        ...
        fields: [{
            ...
            display: function(id) {
                return '<div class="lnkDocFileID"><a target="_blank" href="' +
                    editor_blankview_gip_pnr_blankpril.file('dognet_blankworkpril_files',
    ...
    editor_blankview_gip_pnr_blankpril.on('initCreate', function(e) {
        ...
        editor_blankview_gip_pnr_blankpril.field('dognet_blankworkpril.msgDocFileID').val(
        ...
        selected_pnr = table_blankview_gip_pnr.row({
            selected: true
        });
        if (selected_pnr.any()) {
            kodblankwork_pnr = selected_pnr.data().dognet_blankdocpnr.kodblankwork;
        }
        editor_blankview_gip_pnr_blankpril.field('dognet_blankworkpril.kodblankwork').val(
            kodblankwork_pnr);
    });
    ...
    var editor_blankview_gip_pnr_summadop = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.dev/tabs/process/dognet-blankview-gip-pnr-summadop-process.php",
            data: function(d) {
                var selected = table_blankview_gip_pnr.row({
                    selected: true
                });
    ...
    //
    // ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
    table_blankview_gip_pnr.on('select', function(e, dt, type, indexes) {

        if (type === 'row') {
            var rows = table_blankview_gip_pnr.rows(indexes).nodes().to$();
            $.each(rows, function() {
                if (table_blankview_gip_pnr.row($(this)).data().dognet_blankdocpnr
                    .kodblankcreate === "1") {
                    table_blankview_gip_pnr.row($(this)).deselect();
                }
            })
        }
    ...
    editor_blankview_edit_pnr.on('preSubmit', function(e, data, action) {
        ...
        if ((action === "create") && editor_blankview_edit_pnr.field(
                'dognet_blankdocpnr.kodblankcreate').val() == 1 && editor_blankview_edit_pnr.field(
                'sendEmailPNR').val() == 1) {
            ...
            ajaxRequest_sendMailPNR(_blanktip, _blankname, _ispolname, _ispolrukname, _objname,
                _zakname, _summablank, 'sendMail');

        }
        // Осуществляем глубокое копирование объекта и инициализируем переменную
        else if ((action === "edit") && editor_blankview_edit_pnr.field(
                'dognet_blankdocpnr.kodblankcreate').val() == 1 && editor_blankview_edit_pnr.field(
                'sendEmailPNR').val() == 1) {
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.dev/tabs/css/blankview-gip-tab3_pnr.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.dev/tabs/css/blankview-gip-tab3_summadop.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.dev/tabs/css/blankview-gip-tab3_doc_files.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.dev/tabs/css/blankview-gip-tab3_pril_files.css">
<?php
// ----- ----- ----- ----- -----
