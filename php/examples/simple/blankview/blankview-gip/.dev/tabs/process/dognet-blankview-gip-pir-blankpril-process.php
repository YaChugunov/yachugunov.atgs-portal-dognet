...
#	$Const_Part_Of_PATH = "/Volumes/Workspace/WEBdev/__projects/atgs-portal/_tmp/mnt/docNET/STORAGEDOC/DOCBLANK/DOCBLANKTR".$__CURRENT_YEAR."/"
#	$Const_Part_Of_PATH = "/STORAGEDOC/DOCBLANK/DOCBLANKTR".$__CURRENT_YEAR."/"
	# /Volumes/Work/tmp/mnt/docNET/STORAGEDOC/DOCBLANK/DOCBLANKTR2019/TMP_TEST
#
...
# ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
# Функция обновления полей таблицы приложений бланков
# 'dognet_blankworkpril'
# ----- ----- -----
...
# ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
	...
	// Выбираем идентификаторы создаваемого документа
		...
		if ($_QRY_blankpaper) {
			...
			$_QRY_blankRowID = $db->sql( "SELECT id FROM dognet_blankdocpir WHERE kodblankwork=".$_kodblankwork )->fetchAll();
...
#
			...
			// Переименовываем файл
				...
				if ($_QRY_paperfiles[0]['flag'] == "0") {
					...
					$__newFileName = "NEW-B-{$_numberpril}-PIR-CR-{$_kodblankwork}";
...
// ----- ----- ----- ----- -----
		...
		->validator( Validate::notEmpty( ValidateOptions::inst()
			->message( 'Описание файла обязательно' )
		) ),
