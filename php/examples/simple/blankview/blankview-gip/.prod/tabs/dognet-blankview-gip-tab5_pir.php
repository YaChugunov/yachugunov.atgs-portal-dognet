...
function ajaxRequest_sendMailPIR(blanktip, blankname, ispolname, ispolrukname, objname, zakname, summablank,
    ...
    request = $.ajax({
        url: "php/examples/simple/blankview/blankview-gip/.prod/tabs/php/sendMail_onSubmit-newBlankPIR.php",
        type: "post",
        cache: false,
        data: {
            blanktip: blanktip,
...
$(document).ready(function() {
    ...
    var editor_blankview_edit_pir = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: "php/examples/simple/blankview/blankview-gip/.prod/tabs/process/dognet-blankview-gip-pir-process.php",
    ...
    var table_blankview_gip_pir = $('#blankview-gip-pir-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.prod/tabs/process/dognet-blankview-gip-pir-process.php",
            type: "POST"
        },
        serverSide: true,
        columns: [{
    ...
    var editor_blankview_gip_pir_docfiles = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: "php/examples/simple/blankview/blankview-gip/.prod/tabs/process/dognet-blankview-gip-pir-docfiles-process.php",
    ...
    var table_blankview_gip_pir_docfiles = $('#blankview-gip-pir-docfiles-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.prod/tabs/process/dognet-blankview-gip-pir-docfiles-process.php",
            type: 'post',
            data: function(d) {
    ...
    var editor_blankview_gip_pir_blankpril = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.prod/tabs/process/dognet-blankview-gip-pir-blankpril-process.php",
            data: function(d) {
                var selected = table_blankview_gip_pir.row({
                    selected: true
                });
    ...
    var editor_blankview_gip_pir_summadop = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.prod/tabs/process/dognet-blankview-gip-pir-summadop-process.php",
            data: function(d) {
                var selected = table_blankview_gip_pir.row({
                    selected: true
                });
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.prod/tabs/css/blankview-gip-tab5_pir.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.prod/tabs/css/blankview-gip-tab5_summadop.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.prod/tabs/css/blankview-gip-tab5_doc_files.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.prod/tabs/css/blankview-gip-tab5_pril_files.css">
<?php
// ----- ----- ----- ----- -----
