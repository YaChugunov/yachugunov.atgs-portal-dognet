...
function ajaxRequest_cloneSelectedBlank_arch(kodblankwork, kodtipblank, kodstatusblank, responseHandler) {
    ...
    request = $.ajax({
        url: "php/examples/simple/blankview/blankview-gip/.prod/tabs/php/ajaxRequest_cloneSelectedBlank_arch.php",
        type: "post",
        cache: false,
        data: {
...
$(document).ready(function() {
    ...
    var table_blankview_gip_blankarchive = $('#blankview-gip-blankarchive-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.prod/tabs/process/dognet-blankview-gip-blankarchive-process.php",
            type: "POST"
        },
        serverSide: true,
        columns: [{
    ...
    var table_blankview_gip_blankarchive_docfiles = $('#blankview-gip-blankarchive-docfiles-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.prod/tabs/process/dognet-blankview-gip-blankarchive-docfiles-process.php",
            type: 'post',
            data: function(d) {
    ...
    var table_blankview_gip_blankarchive_blankpril = $('#blankview-gip-blankarchive-blankpril-table')
        .DataTable({
            ...
            ajax: {
                url: "php/examples/simple/blankview/blankview-gip/.prod/tabs/process/dognet-blankview-gip-blankarchive-blankpril-process.php",
                type: 'post',
                data: function(d) {
                    var selected = table_blankview_gip_blankarchive.row({
                        selected: true
    ...
    var table_blankview_gip_blankarchive_summadop = $('#blankview-gip-blankarchive-summadop-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.prod/tabs/process/dognet-blankview-gip-blankarchive-summadop-process.php",
            type: 'post',
            data: function(d) {
                var selected = table_blankview_gip_blankarchive.row({
                    selected: true
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.prod/tabs/css/blankview-gip-tab6_blankarchive.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.prod/tabs/css/blankview-gip-tab6_summadop.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.prod/tabs/css/blankview-gip-tab6_doc_files.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.prod/tabs/css/blankview-gip-tab6_pril_files.css">
<?php
//
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
//
