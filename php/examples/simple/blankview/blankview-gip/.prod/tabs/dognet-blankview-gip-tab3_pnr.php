...
function ajaxRequest_sendMailPNR(blanktip, blankname, ispolname, ispolrukname, objname, zakname, summablank,
    ...
    request = $.ajax({
        url: "php/examples/simple/blankview/blankview-gip/.prod/tabs/php/sendMail_onSubmit-newBlankPNR.php",
        type: "post",
        cache: false,
        data: {
            blanktip: blanktip,
...
$(document).ready(function() {
    ...
    var editor_blankview_edit_pnr = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: "php/examples/simple/blankview/blankview-gip/.prod/tabs/process/dognet-blankview-gip-pnr-process.php",
    ...
    var table_blankview_gip_pnr = $('#blankview-gip-pnr-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.prod/tabs/process/dognet-blankview-gip-pnr-process.php",
            type: "POST"
        },
        serverSide: true,
        columns: [{
    ...
    var editor_blankview_gip_pnr_docfiles = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: "php/examples/simple/blankview/blankview-gip/.prod/tabs/process/dognet-blankview-gip-pnr-docfiles-process.php",
    ...
    var table_blankview_gip_pnr_docfiles = $('#blankview-gip-pnr-docfiles-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.prod/tabs/process/dognet-blankview-gip-pnr-docfiles-process.php",
            type: 'post',
            data: function(d) {
    ...
    var editor_blankview_gip_pnr_blankpril = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.prod/tabs/process/dognet-blankview-gip-pnr-blankpril-process.php",
            data: function(d) {
                var selected = table_blankview_gip_pnr.row({
                    selected: true
                });
    ...
    var editor_blankview_gip_pnr_summadop = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.prod/tabs/process/dognet-blankview-gip-pnr-summadop-process.php",
            data: function(d) {
                var selected = table_blankview_gip_pnr.row({
                    selected: true
                });
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.prod/tabs/css/blankview-gip-tab3_pnr.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.prod/tabs/css/blankview-gip-tab3_summadop.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.prod/tabs/css/blankview-gip-tab3_doc_files.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.prod/tabs/css/blankview-gip-tab3_pril_files.css">
<?php
// ----- ----- ----- ----- -----
