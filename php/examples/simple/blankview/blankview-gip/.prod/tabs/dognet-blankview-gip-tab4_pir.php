...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        // ----- ----- ----- ----- -----
        /*
        	$('#blankview-gip-pnr-table').on( 'dblclick', 'tbody tr', function () {
        ...
        */
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        if (row.dognet_docblankwork.kodstatusblank == "DO") {
                            return '<span style="padding:0 5px"><a href="dognet-blankview.php?blankview_type=details&uniqueID=' +
                                row.dognet_docblankwork.kodblankwork +
                                '"><span class="glyphicon glyphicon-list-alt"></span></a></span>' +
                                '<span style="padding:0 5px"><a href=""><span class="glyphicon glyphicon-comment"></span></a></span>';
                        } else {
                            return '<span style="padding:0 5px"><a href="dognet-blankview.php?blankview_type=details&uniqueID=' +
                                row.dognet_docblankwork.kodblankwork +
                                '"><span class="glyphicon glyphicon-list-alt"></span></a></span>' +
                                '<span style="padding:0 5px"><a href="dognet-blankview.php?blankview_type=edit&uniqueID=' +
                                row.dognet_docblankwork.kodblankwork +
        ...
        $('#blankview-gip-pnr-table tbody').on('click', 'tr td.details-control', function() {
            ...
            if (row.child.isShown()) {
                ...
                d = row.data();
                rowData.child(<?php include('templates/blankview-gip-pnr-table.tpl'); ?>).show();
        ...
        var editor_blankview_gip_pnr_blankpril = new $.fn.dataTable.Editor({
            display: "bootstrap",
            ajax: "php/examples/php/blankview/blankview-gip/dognet-blankview-gip-pnr-blankpril-process.php",
...
*/
    /*
/* Общее для таблицы */
    #blankview-gip-pnr-table {}

    #blankview-gip-pnr-table .details-control:hover {
        cursor: hand
    }

    #blankview-gip-pnr-table>tbody>tr.selected,
...
/* Заголовок таблицы */
    ...
    #blankview-gip-pnr-table>thead>tr>th {
        border-bottom: none;
        font-weight: 400;
        font-size: 1.0em;
    ...
    #blankview-gip-pnr-table .sorting:after,
    #blankview-gip-pnr-table .sorting_asc:after,
    #blankview-gip-pnr-table .sorting_desc:after {
        display: none
    }

    #blankview-gip-pnr-table>thead>tr>th.sorting_asc {
        padding-right: 5px
    }

    #blankview-gip-pnr-table>thead>tr>th.sorting_desc {
        padding-right: 5px
    }
...
/* Тело таблицы */
    ...
    #blankview-gip-pnr-table>tbody>tr>td {
        padding: 5px;
    ...
    #blankview-gip-pnr-table>tbody>tr>td:last-child {
        text-align: right
    }

    #blankview-gip-pnr-table>tfoot>tr>td {
        padding: 5px 4px
    }

    #blankview-gip-pnr-table>tfoot>tr>td:last-child {
        text-align: right
    }

    #blankview-gip-pnr-table>tfoot {
...
----- ----- ----- ----- ----- ----- ----- ----- ----- -----
*/
    #blankview-gip-pnr-table>thead>tr>th:first-child,
    #blankview-gip-pnr-table>tbody>tr>td:first-child {
        width: 1%;
        text-align: center
    }

    #blankview-gip-pnr-table>thead>tr>th:nth-child(2),
    #blankview-gip-pnr-table>tbody>tr>td:nth-child(2) {
        width: 10%;
        text-align: left;
        border-left: 1px #fff solid
    }

    #blankview-gip-pnr-table>thead>tr>th:nth-child(3),
    #blankview-gip-pnr-table>tbody>tr>td:nth-child(3) {
        width: 19%;
        text-align: left;
        border-left: 1px #fff solid
    }

    #blankview-gip-pnr-table>thead>tr>th:nth-child(4),
    #blankview-gip-pnr-table>tbody>tr>td:nth-child(4) {
        width: 44%;
        text-align: left;
        border-left: 1px #fff solid
    }

    #blankview-gip-pnr-table>thead>tr>th:nth-child(5),
    #blankview-gip-pnr-table>tbody>tr>td:nth-child(5) {
        width: 18%;
        text-align: left;
        border-left: 1px #fff solid
    }

    #blankview-gip-pnr-table>thead>tr>th:nth-child(6),
    #blankview-gip-pnr-table>tbody>tr>td:nth-child(6) {
        width: 8%;
        text-align: center;
        border-left: 1px #fff solid
    }

    #blankview-gip-pnr-table>thead>tr>th:nth-child(7),
    #blankview-gip-pnr-table>tbody>tr>td:nth-child(7) {
        text-align: center;
        border-left: 1px #fff solid
    }

    #blankview-gip-pnr-table>thead>tr>th:nth-child(8),
    #blankview-gip-pnr-table>tbody>tr>td:nth-child(8) {
        text-align: center;
        border-left: 1px #fff solid
    }

    #blankview-gip-pnr-table>thead>tr>th:nth-child(9),
    #blankview-gip-pnr-table>tbody>tr>td:nth-child(9) {
        text-align: center;
        border-left: 1px #fff solid
    }

    #blankview-gip-pnr-table>thead>tr>th:nth-child(10),
    #blankview-gip-pnr-table>tbody>tr>td:nth-child(10) {
        text-align: center;
        border-left: 1px #fff solid
    }

    #blankview-gip-pnr-table>thead>tr>th:nth-child(11),
    #blankview-gip-pnr-table>tbody>tr>td:nth-child(11) {
        text-align: center;
        border-left: 1px #fff solid
    }
...
ТАБЛИЦА ФАЙЛОВ БЛАНКОВ : blankview-gip-pnr-docfiles-table

----- ----- ----- ----- ----- ----- ----- ----- ----- -----
*/
    #blankview-gip-pnr-docfiles {
        padding: 10px 15px;
        border: 1px #e9e9e9 solid;
        border-radius: 5px
    }

    #blankview-gip-pnr-docfiles>h3 {
        color: #111;
        font-family: 'Oswald', sans-serif;
        font-weight: 400;
        font-size: 1.7em;
    ...
    /* Общее для таблицы */
    #blankview-gip-pnr-docfiles-table {}

    #blankview-gip-pnr-docfiles-table .details-control:hover {
        cursor: hand
    }

    /* Заголовок таблицы */
    #blankview-gip-pnr-docfiles-table>thead {
        display: none
    }

    #blankview-gip-pnr-docfiles-table>thead>tr>th {
        color: #333;
        border-bottom: none;
        font-weight: 500;
        font-size: 1.2em;
    ...
    #blankview-gip-pnr-docfiles-table .sorting:after,
    #blankview-gip-pnr-table .sorting_asc:after,
    #blankview-gip-pnr-table .sorting_desc:after {
        display: none
    }

    #blankview-gip-pnr-docfiles-table>thead>tr>th.sorting_asc {
        padding-right: 8px
    }

    #blankview-gip-pnr-docfiles-table>thead>tr>th.sorting_desc {
        padding-right: 8px
    }

    #blankview-gip-pnr-docfiles-table .sorting_asc:after {
        display: none
    }
    ...
    /* Тело таблицы */
    #blankview-gip-pnr-docfiles-table>tbody>tr>td {
        padding: 5px;
        border: none
    }

    #blankview-gip-pnr-docfiles-table>tbody>tr>td:first-child {
        width: 5%;
        text-align: left
    }

    #blankview-gip-pnr-docfiles-table>tbody>tr>td:nth-child(2) {
        width: 5%;
        text-align: left
    }

    #blankview-gip-pnr-docfiles-table>tbody>tr>td:nth-child(3) {
        width: 85%;
        text-align: left
    }

    #blankview-gip-pnr-docfiles-table>tbody>tr>td:nth-child(4) {
        width: 5%;
        text-align: right;
        text-transform: uppercase
    }
    ...
    /* Разное */
    #blankview-gip-pnr-docfiles-table a.blank_link {
        color: #08C;
        text-decoration: underline
    }

    #blankview-gip-pnr-docfiles-table a.blank_link:hover {
...
ТАБЛИЦА ФАЙЛОВ ПРИЛОЖЕНИЙ : blankview-gip-pnr-blankpril-table

----- ----- ----- ----- ----- ----- ----- ----- ----- -----
*/
    #blankview-gip-pnr-blankpril {
        padding: 10px 15px;
        border: 2px #e9e9e9 solid;
        border-radius: 5px
    }

    #blankview-gip-pnr-blankpril>h3 {
        color: #111;
        font-family: 'Oswald', sans-serif;
        font-weight: 400;
        font-size: 1.7em;
    ...
    /* Общее для таблицы */
    #blankview-gip-pnr-blankpril-table {}

    #blankview-gip-pnr-blankpril-table .details-control:hover {
        cursor: hand
    }

    /* Заголовок таблицы */
    #blankview-gip-pnr-blankpril-table>thead {
        display: none
    }

    #blankview-gip-pnr-blankpril-table>thead>tr>th {
        color: #333;
        border-bottom: none;
        font-weight: 500;
        font-size: 1.2em;
    ...
    #blankview-gip-pnr-blankpril-table .sorting:after,
    #blankview-gip-pnr-table .sorting_asc:after,
    #blankview-gip-pnr-table .sorting_desc:after {
        display: none
    }

    #blankview-gip-pnr-blankpril-table>thead>tr>th.sorting_asc {
        padding-right: 8px
    }

    #blankview-gip-pnr-blankpril-table>thead>tr>th.sorting_desc {
        padding-right: 8px
    }

    #blankview-gip-pnr-blankpril-table .sorting_asc:after {
        display: none
    }
    ...
    /* Тело таблицы */
    #blankview-gip-pnr-blankpril-table>tbody>tr>td {
        padding: 5px;
        border: none
    }

    #blankview-gip-pnr-blankpril-table>tbody>tr>td:first-child {
        width: 5%;
        text-align: left
    }

    #blankview-gip-pnr-blankpril-table>tbody>tr>td:nth-child(2) {
        width: 90%;
        text-align: left
    }

    #blankview-gip-pnr-blankpril-table>tbody>tr>td:nth-child(3) {
        width: 5%;
        text-align: right;
        text-transform: uppercase
    }
    ...
    /* Разное */
    #blankview-gip-pnr-blankpril-table a.blank_link {
        color: #08C;
        text-decoration: underline
    }

    #blankview-gip-pnr-blankpril-table a.blank_link:hover {
        text-decoration: none
    }
...
*/
    ...
    #blankview-gip-pnr-table>tbody>tr.dtrg-start.dtrg-level-0>td {
        font-family: 'Oswald', sans-serif;
        font-size: 1.3em;
        font-weight: 400;
        text-align: left;
    ...
    #blankview-gip-pnr-table>tbody>tr.dtrg-end.dtrg-level-0>td {
        font-family: 'Oswald', sans-serif;
        font-size: 1.4em;
        font-weight: 500;
        color: #000;
...
<section>
                ...
                <div id="blankview-gip-filters" class="panel-body space30">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group space10" style="width:100%">
                            ...
                            <select name="blankStatusSearch_text_pnr" id="blankStatusSearch_text_pnr" class="form-control">
                                ...
                                ?>
                                    <option value='<?php echo $_ROW1["status_kod"]; ?>'>
                                        <?php echo $_ROW1["status_description"]; ?></option>
                                <?php
                                }
                                ?>
                            </select>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group space10" style="width:100%">
                            ...
                            <select name="blankTypeSearch_text_pnr" id="blankTypeSearch_text_pnr" class="form-control">
                                ...
                                ?>
                                    <option value='<?php echo $_ROW2["type_kod"]; ?>'>
                                        <?php echo $_ROW2["type_description"]; ?></option>
                                <?php
                                }
                                ?>
                            </select>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-right">
                        <div class="input-group-btn">
                            <button id="columnSearch_pnr_btnApply" class="btn btn-default" type="button">Применить
                                фильтры</button>
    ...
    <table id="blankview-gip-pnr-table" class="table table-striped" cellspacing="0" width="100%">
        <thead>
            <tr>
