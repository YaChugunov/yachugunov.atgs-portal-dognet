...
function ajaxRequest_sendMailSUB(blanktip, blankname, ispolname, ispolrukname, objname, zakname, summablank,
    ...
    request = $.ajax({
        url: "php/examples/simple/blankview/blankview-gip/.prod/tabs/php/sendMail_onSubmit-newBlankSUB.php",
        type: "post",
        cache: false,
        data: {
            blanktip: blanktip,
...
$(document).ready(function() {
    ...
    var editor_blankview_edit_sub = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.prod/tabs/process/dognet-blankview-gip-sub-process.php"
        },
    ...
    var editor_blankview_gip_sub = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: "php/examples/simple/blankview/blankview-gip/.prod/tabs/process/dognet-blankview-gip-sub-process.php",
        table: "#blankview-gip-sub-table",
        i18n: {
            create: {
    ...
    var editor_blankview_gip_sub_docfiles = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: "php/examples/simple/blankview/blankview-gip/.prod/tabs/process/dognet-blankview-gip-sub-docfiles-process.php",
    ...
    var table_blankview_gip_sub_docfiles = $('#blankview-gip-sub-docfiles-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.prod/tabs/process/dognet-blankview-gip-sub-docfiles-process.php",
            type: 'post',
            data: function(d) {
    ...
    var editor_blankview_gip_sub_blankpril = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.prod/tabs/process/dognet-blankview-gip-sub-blankpril-process.php",
            data: function(d) {
                var selected = table_blankview_gip_sub.row({
                    selected: true
                });
    ...
    var editor_blankview_gip_sub_summadop = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-gip/.prod/tabs/process/dognet-blankview-gip-sub-summadop-process.php",
            data: function(d) {
                var selected = table_blankview_gip_sub.row({
                    selected: true
                });
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.prod/tabs/css/blankview-gip-tab4_sub.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.prod/tabs/css/blankview-gip-tab4_summadop.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.prod/tabs/css/blankview-gip-tab4_doc_files.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-gip/.prod/tabs/css/blankview-gip-tab4_pril_files.css">
<?php
// ----- ----- ----- ----- -----
