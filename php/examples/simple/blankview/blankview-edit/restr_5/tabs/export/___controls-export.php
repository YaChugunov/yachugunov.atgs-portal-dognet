...
$_QRY = mysqlQuery( "SELECT * FROM dognet_docblankwork WHERE kodblankwork = '".$_GET['blankID']."'" );
		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 space20">
				<div id="report-settings" class="text-center">
					<h3 class="space10">Экспорт бланка требований на договор</h3>
					<h4 class="space10">Бланк № <?php echo $_ROW['yearblankwork']."-".numberFormat($_ROW['numberblankwork'], 3); ?></h4>
				</div>
			</div>
			<div class="col-xs-hidden col-sm-12 col-md-12 col-lg-12">
				<div id="export-format-block" class="center-block" style="">
					<form class="form-horizontal" method="GET" action="/dognet/dognet-blankview.php">
						<input type="hidden" name="blankview_type" value="edit">
						<input type="hidden" name="export" value="yes">
						<input type="hidden" name="blankID" value="<?php echo (isset($_GET['blankID'])&&!empty($_GET['blankID'])) ? $_GET['blankID'] : ""; ?>">
						<input type="hidden" name="blankType" value="<?php echo (isset($_GET['blankType'])&&!empty($_GET['blankType'])) ? $_GET['blankType'] : ""; ?>">
...
<?php
				if (isset($_GET['format'])) {
					switch ($_GET['format']) {
						case "doc":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/blankview/blankview-edit/restr_5/tabs/export/_docx/export2docx.php");
							break;
						case "xls":
							include('');
							break;
					...
					<div class="media-body text-center">
						<div style="background-color:#fafafa; padding:10px">
							...
							<p>
								...
								<span style="color:#111; margin:0 10px"><a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/dognet-blankview.php?blankview_type=edit">Бланки</a></span>
							</p>
						</div>
					</div>
				</div>
