...
$_KODTIPBLANK = $_POST['kodtipblank_archive'];
...
// 		    $q->where( 'dognet_docblankwork_files.koddel', '99', '!=' );
// 		    $q->and_where( 'dognet_docblankwork_files.blank_status', 'CR', '=' );
		} );
	} )
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
#
...
// 	->where( 'dognet_docblankwork_files.blank_status', $_KODTIPBLANK )
	->process( $_POST )
	->json();
