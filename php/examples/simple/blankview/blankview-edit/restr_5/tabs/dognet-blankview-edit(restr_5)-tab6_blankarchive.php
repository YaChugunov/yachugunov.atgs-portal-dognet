...
// 		dom: "<'space50'r>tip",
		...
		ajax: {
			url: "php/examples/simple/blankview/blankview-edit/restr_5/tabs/process/dognet-blankview-edit-blankarchive-process.php",
			type: "POST"
		},
		serverSide: true,
		columns: [
...
// 		dom: "<'space50'r>tip",
		...
		ajax: {
			url: "php/examples/simple/blankview/blankview-edit/restr_5/tabs/process/dognet-blankview-edit-blankarchive-docfiles-process.php",
			type: 'post',
      data: function ( d ) {
...
// 		dom: "<'space50'r>tip",
		...
		ajax: {
			url: "php/examples/simple/blankview/blankview-edit/restr_5/tabs/process/dognet-blankview-edit-blankarchive-blankpril-process.php",
			type: 'post',
      data: function ( d ) {
          var selected = table_blankview_edit_blankarchive.row( { selected: true } );
          if ( selected.any() ) {
...
// 		dom: "<'space50'r>tip",
		...
		ajax: {
			url: "php/examples/simple/blankview/blankview-edit/restr_5/tabs/process/dognet-blankview-edit-blankarchive-summadop-process.php",
			type: 'post',
      data: function ( d ) {
          var selected = table_blankview_edit_blankarchive.row( { selected: true } );
          if ( selected.any() ) {
