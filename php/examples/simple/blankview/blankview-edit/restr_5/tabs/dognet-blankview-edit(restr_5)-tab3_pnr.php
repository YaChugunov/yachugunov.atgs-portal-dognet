<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		var editor_blankview_edit_pnr = new $.fn.dataTable.Editor({
			display: "bootstrap",
			ajax: {
				url: "php/examples/simple/blankview/blankview-edit/restr_5/tabs/process/dognet-blankview-edit-pnr-process.php",
				data: function(d) {
		...
		var editor_blankview_edit_pnr_docfiles = new $.fn.dataTable.Editor({
			display: "bootstrap",
			ajax: "php/examples/simple/blankview/blankview-edit/restr_5/tabs/process/dognet-blankview-edit-pnr-docfiles-process.php",
		...
		var table_blankview_edit_pnr_docfiles = $('#blankview-edit-pnr-docfiles-table').DataTable({
			...
			ajax: {
				url: "php/examples/simple/blankview/blankview-edit/restr_5/tabs/process/dognet-blankview-edit-pnr-docfiles-process.php",
				type: 'post',
				data: function(d) {
					var selected = table_blankview_edit_pnr.row({
						selected: true
		...
		var editor_blankview_edit_pnr_blankpril = new $.fn.dataTable.Editor({
			display: "bootstrap",
			ajax: {
				url: "php/examples/simple/blankview/blankview-edit/restr_5/tabs/process/dognet-blankview-edit-pnr-blankpril-process.php",
				data: function(d) {
					var selected = table_blankview_edit_pnr.row({
						selected: true
					});
		...
		var editor_blankview_edit_pnr_summadop = new $.fn.dataTable.Editor({
			display: "bootstrap",
			ajax: {
				url: "php/examples/simple/blankview/blankview-edit/restr_5/tabs/process/dognet-blankview-edit-pnr-summadop-process.php",
				data: function(d) {
					var selected = table_blankview_edit_pnr.row({
						selected: true
					});
...
<section>
	...
	<table id="blankview-edit-pnr-table" class="table table-bordered table-condensed display compact" cellspacing="0" width="100%">
		<thead>
			<tr>
