<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		var editor_blankview_edit_pos_summadop = new $.fn.dataTable.Editor({
			display: "bootstrap",
			ajax: {
				url: "php/examples/php/blankview/blankview-edit/dognet-blankview-edit-pos-summadop-process.php",
				data: function(d) {
					var selected = table_blankview_edit_pos.row({
						selected: true
					});
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/restr_4/tabs/css/blankview-edit-tab2_pos.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/restr_4/tabs/css/blankview-edit-tab2_summadop.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/restr_4/tabs/css/blankview-edit-tab2_doc_files.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/restr_4/tabs/css/blankview-edit-tab2_pril_files.css">
<?php
// ----- ----- ----- ----- -----
