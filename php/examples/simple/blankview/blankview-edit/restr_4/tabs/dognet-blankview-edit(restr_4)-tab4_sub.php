<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        var editor_blankview_edit_sub = new $.fn.dataTable.Editor({
            display: "bootstrap",
            ajax: {
                url: "php/examples/php/blankview/blankview-edit/dognet-blankview-edit-sub-process.php",
                data: function(d) {
        ...
        var editor_blankview_edit_sub_docfiles = new $.fn.dataTable.Editor({
            display: "bootstrap",
            ajax: "php/examples/php/blankview/blankview-edit/dognet-blankview-edit-sub-docfiles-process.php",
        ...
        var table_blankview_edit_sub_docfiles = $('#blankview-edit-sub-docfiles-table').DataTable({
            ...
            ajax: {
                url: "php/examples/php/blankview/blankview-edit/dognet-blankview-edit-sub-docfiles-process.php",
                type: 'post',
                data: function(d) {
                    var selected = table_blankview_edit_sub.row({
                        selected: true
        ...
        var editor_blankview_edit_sub_blankpril = new $.fn.dataTable.Editor({
            display: "bootstrap",
            ajax: {
                url: "php/examples/php/blankview/blankview-edit/dognet-blankview-edit-sub-blankpril-process.php",
                data: function(d) {
                    var selected = table_blankview_edit_sub.row({
                        selected: true
                    });
        ...
        var editor_blankview_edit_sub_summadop = new $.fn.dataTable.Editor({
            display: "bootstrap",
            ajax: {
                url: "php/examples/php/blankview/blankview-edit/dognet-blankview-edit-sub-summadop-process.php",
                data: function(d) {
                    var selected = table_blankview_edit_sub.row({
                        selected: true
                    });
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/restr_4/tabs/css/blankview-edit-tab4_sub.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/restr_4/tabs/css/blankview-edit-tab4_summadop.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/restr_4/tabs/css/blankview-edit-tab4_doc_files.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/restr_4/tabs/css/blankview-edit-tab4_pril_files.css">
<?php
// ----- ----- ----- ----- -----
