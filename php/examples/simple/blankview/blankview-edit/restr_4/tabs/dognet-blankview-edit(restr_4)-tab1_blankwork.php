...
// 		dom: "<'space50'r>tip",
		...
		columnDefs: [
			...
			},
			{
				...
				render: function ( data, type, row, meta ) {
					fullstr = data;
					if (data.length > 28) { return data.substr(0,28)+" ..."; }
					else { return data;	}
				}
			},
			{
    ...
    $('#blankview-edit-blankwork-table tbody').on( 'click', 'tr td.details-control-blankwork', function () {
        ...
        if ( row.child.isShown() ) {
			...
			if (d.dognet_docblankwork.kodtipblank == "PIR") {
				rowData.child( <?php include('templates/blankview-edit-tab1-blankwork-pir-blank-table.tpl'); ?> ).show();
			}
// Add to the 'open' array
            if ( idx === -1 ) {
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/restr_4/tabs/css/blankview-edit-tab1_blankwork.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/restr_4/tabs/css/blankview-edit-tab1_summadop.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/restr_4/tabs/css/blankview-edit-tab1_doc_files.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/restr_4/tabs/css/blankview-edit-tab1_pril_files.css">
<?php
//
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
//
