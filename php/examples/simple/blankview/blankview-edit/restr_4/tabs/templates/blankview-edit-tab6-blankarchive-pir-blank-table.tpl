	...
	'<div class="row">'+
		'<div class="col-xs-12 col-sm-12 col-md-12">'+
			'<ul id="blankview-details-blank-tabs-menu" class="nav nav-tabs">'+
				'<li class="active"><a data-toggle="tab" href="#blankarchive-main-pir-'+row.id()+'-tab-1" title="">Основное</a></li>'+
				'<li><a data-toggle="tab" href="#blankarchive-main-pir-'+row.id()+'-tab-2" title="">Суммы</a></li>'+
				'<li><a data-toggle="tab" href="#blankarchive-main-pir-'+row.id()+'-tab-3" title="">Приложения</a></li>'+
				'<li><a data-toggle="tab" href="#blankarchive-main-pir-'+row.id()+'-tab-10" title="">Условия</a></li>'+
				'<li><a data-toggle="tab" href="#blankarchive-main-pir-'+row.id()+'-tab-4" title="">Исполнение</a></li>'+
				'<li><a data-toggle="tab" href="#blankarchive-main-pir-'+row.id()+'-tab-5" title="">Контакт</a></li>'+
				'<li><a data-toggle="tab" href="#blankarchive-main-pir-'+row.id()+'-tab-6" title="">Командировки</a></li>'+
				'<li><a data-toggle="tab" href="#blankarchive-main-pir-'+row.id()+'-tab-7" title="">Транспорт</a></li>'+
				'<li><a data-toggle="tab" href="#blankarchive-main-pir-'+row.id()+'-tab-8" title="">ДО</a></li>'+
				'<li><a data-toggle="tab" href="#blankarchive-main-pir-'+row.id()+'-tab-9" title="">Риски</a></li>'+
			'</ul>'+
			...
			'<div class="tab-content">'+
				'<div id="blankarchive-main-pir-'+row.id()+'-tab-1" class="tab-pane fade in active">'+
					...
					'</div>'+
				'</div>'+
				'<div id="blankarchive-main-pir-'+row.id()+'-tab-2" class="tab-pane fade">'+
					'<div class="hidden-xs col-sm-12 col-md-12 col-lg-12">'+
						'<div class="space10"></div>'+
						'<div style="padding:10px">'+
							'<table id="template-details-tab1-table" class="table">'+
					...
					'</div>'+
				'</div>'+
				'<div id="blankarchive-main-pir-'+row.id()+'-tab-3" class="tab-pane fade">'+
				...
				'</div>'+
				'<div id="blankarchive-main-pir-'+row.id()+'-tab-10" class="tab-pane fade">'+
				...
				'</div>'+
				'<div id="blankarchive-main-pir-'+row.id()+'-tab-4" class="tab-pane fade">'+
							...
							'<table id="template-details-tab1-table" class="table">'+
								'<tbody>'+
									...
									'<tr>'+
										'<td width="5%"><span class="template-details-tab1-table-title"></span></td>'+
										'<td width="5%"><span class="template-details-tab1-table-title">2)</span></td>'+
										'<td width="1%"><span class="template-details-tab1-table-txt">'+print_checkBox(d.dognet_blankdocpir.koduseispoldoc2)+'</span></td>'+
										'<td width="89%"><span class="template-details-tab1-table-txt"><span class="txt-parameter">'+d.dognet_blankdocpir.cdaysispoldoc2+'</span>дней от аванса</span></td>'+
									'</tr>'+
									'<tr>'+
										'<td width="5%"><span class="template-details-tab1-table-title"></span></td>'+
										'<td width="5%"><span class="template-details-tab1-table-title">3)</span></td>'+
									...
									'<tr>'+
										'<td width="5%"><span class="template-details-tab1-table-title"></span></td>'+
										'<td width="5%"><span class="template-details-tab1-table-title">4)</span></td>'+
										'<td width="1%"><span class="template-details-tab1-table-txt">'+print_checkBox(d.dognet_blankdocpir.koduseispoldoc4)+'</span></td>'+
				...
				'</div>'+
				'<div id="blankarchive-main-pir-'+row.id()+'-tab-5" class="tab-pane fade">'+
				...
				'</div>'+
				'<div id="blankarchive-main-pir-'+row.id()+'-tab-6" class="tab-pane fade">'+
							...
							'<table id="template-details-tab1-table" class="table">'+
								'<tbody>'+
									...
									'<tr>'+
										'<td width="5%"><span class="template-details-tab1-table-title"></span></td>'+
										'<td width="5%"><span class="template-details-tab1-table-title">3)</span></td>'+
										'<td width="60%"><span class="template-details-tab1-table-title">Входят в стоимость с установленным лимитом</span><span class="template-details-tab1-table-txt"><span class="txt-parameter">'+d.dognet_blankdocpir.summalimitmis+'</span></span></td>'+
				...
				'</div>'+
				'<div id="blankarchive-main-pir-'+row.id()+'-tab-7" class="tab-pane fade">'+
							...
							'<table id="template-details-tab1-table" class="table">'+
								'<tbody>'+
									...
									'<tr>'+
										'<td width="5%"><span class="template-details-tab1-table-title"></span></td>'+
										'<td width="5%"><span class="template-details-tab1-table-title">3)</span></td>'+
										'<td width="1%"><span class="template-details-tab1-table-txt">'+print_checkBox(d.dognet_blankdocpir.kodusetrans3)+'</span></td>'+
				...
				'</div>'+
				'<div id="blankarchive-main-pir-'+row.id()+'-tab-8" class="tab-pane fade">'+
				...
				'</div>'+
				'<div id="blankarchive-main-pir-'+row.id()+'-tab-9" class="tab-pane fade">'+
