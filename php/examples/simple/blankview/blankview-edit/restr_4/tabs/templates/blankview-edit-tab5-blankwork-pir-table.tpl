	...
	'<div class="row">'+
		'<div class="col-xs-12 col-sm-12 col-md-12">'+
			'<ul id="blankview-details-blank-tabs-menu" class="nav nav-tabs">'+
				'<li class="active"><a data-toggle="tab" href="#blankwork-pir-'+row.id()+'-tab-1" title="">Основное</a></li>'+
				'<li><a data-toggle="tab" href="#blankwork-pir-'+row.id()+'-tab-2" title="">Суммы</a></li>'+
				'<li><a data-toggle="tab" href="#blankwork-pir-'+row.id()+'-tab-3" title="">Приложения</a></li>'+
				'<li><a data-toggle="tab" href="#blankwork-pir-'+row.id()+'-tab-10" title="">Условия</a></li>'+
				'<li><a data-toggle="tab" href="#blankwork-pir-'+row.id()+'-tab-4" title="">Исполнение</a></li>'+
				'<li><a data-toggle="tab" href="#blankwork-pir-'+row.id()+'-tab-5" title="">Контакт</a></li>'+
				'<li><a data-toggle="tab" href="#blankwork-pir-'+row.id()+'-tab-6" title="">Командировки</a></li>'+
				'<li><a data-toggle="tab" href="#blankwork-pir-'+row.id()+'-tab-7" title="">Транспорт</a></li>'+
				'<li><a data-toggle="tab" href="#blankwork-pir-'+row.id()+'-tab-8" title="">ДО</a></li>'+
				'<li><a data-toggle="tab" href="#blankwork-pir-'+row.id()+'-tab-9" title="">Риски</a></li>'+
			'</ul>'+
			...
			'<div class="tab-content">'+
				'<div id="blankwork-pir-'+row.id()+'-tab-1" class="tab-pane fade in active">'+
					...
					'</div>'+
				'</div>'+
				'<div id="blankwork-pir-'+row.id()+'-tab-2" class="tab-pane fade">'+
					'<div class="hidden-xs col-sm-12 col-md-12 col-lg-12">'+
						'<div class="space10"></div>'+
						'<div style="padding:10px">'+
							'<table id="template-details-tab1-table" class="table">'+
								'<tbody>'+
									...
									'</tr>'+
									'<tr><td colspan="4"><a class="template-details-tab1-table-link" href="#blankview-gip-pir-summadop">Разбиение суммы договора</a></td></tr>'+
									'<tr><td colspan="4"></td></tr>'+
									'<tr class="tr-title">'+
					...
					'</div>'+
				'</div>'+
				'<div id="blankwork-pir-'+row.id()+'-tab-3" class="tab-pane fade">'+
				...
				'</div>'+
				'<div id="blankwork-pir-'+row.id()+'-tab-10" class="tab-pane fade">'+
							...
							'<table id="template-details-tab1-table" class="table">'+
								'<tbody>'+
									...
									'<tr>'+
										...
										'<td width="60%"><span class="template-details-tab1-table-txt">'+print_checkBox(d.dognet_blankdocpir.kodusetender)+'</span></td>'+
									'</tr>'+
								'</tbody>'+
							'</table>'+
						'</div>'+
				...
				'</div>'+
				'<div id="blankwork-pir-'+row.id()+'-tab-4" class="tab-pane fade">'+
				...
				'</div>'+
				'<div id="blankwork-pir-'+row.id()+'-tab-5" class="tab-pane fade">'+
				...
				'</div>'+
				'<div id="blankwork-pir-'+row.id()+'-tab-6" class="tab-pane fade">'+
				...
				'</div>'+
				'<div id="blankwork-pir-'+row.id()+'-tab-7" class="tab-pane fade">'+
							...
							'<table id="template-details-tab1-table" class="table">'+
								'<tbody>'+
									...
									'<tr>'+
										...
										'<td width="89%"><span class="template-details-tab1-table-txt">Входят в стоимость договора</span></td>'+
									'</tr>'+
									'<tr>'+
										'<td width="5%"><span class="template-details-tab1-table-title"></span></td>'+
										'<td width="5%"><span class="template-details-tab1-table-title">2)</span></td>'+
				...
				'</div>'+
				'<div id="blankwork-pir-'+row.id()+'-tab-8" class="tab-pane fade">'+
				...
				'</div>'+
				'<div id="blankwork-pir-'+row.id()+'-tab-9" class="tab-pane fade">'+
							...
							'<table id="template-details-tab1-table" class="table">'+
								'<tbody>'+
									...
									'<tr>'+
										...
										'<td width="89%"><span class="template-details-tab1-table-txt">Осуществимость выполнения работ по срокам</span></td>'+
									'</tr>'+
									'<tr>'+
										'<td width="5%"><span class="template-details-tab1-table-title"></span></td>'+
										'<td width="5%"><span class="template-details-tab1-table-title">2)</span></td>'+
									...
									'<tr>'+
										...
										'<td width="89%"><span class="template-details-tab1-table-txt">Сезон технического обслуживания объекта</span></td>'+
									'</tr>'+
									'<tr>'+
										'<td width="5%"><span class="template-details-tab1-table-title"></span></td>'+
										'<td width="5%"><span class="template-details-tab1-table-title">5)</span></td>'+
