						...
						'<div style="padding:10px">'+
							'<table id="template-details-table" class="table table-striped" >'+
								'<tbody>'+
									...
									'</tr>'+
									'<tr>'+
										'<td width="30%"><span class="template-details-table-title">Отслеживание договора</span></td>'+
										'<td width="70%"><span class="template-details-table-txt">'+d.dognet_docblankwork.odcomments+'</span></td>'+
									'</tr>'+
								'</tbody>'+
							'</table>'+
						'</div>'+
