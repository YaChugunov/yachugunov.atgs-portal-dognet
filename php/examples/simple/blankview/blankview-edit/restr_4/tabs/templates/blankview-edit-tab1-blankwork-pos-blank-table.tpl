'<div id="template-details">'+
	...
	'<div id="blankview-details-pos-tabs">'+
	'<div class="row">'+
		'<div class="col-xs-12 col-sm-12 col-md-12">'+
			'<ul id="blankview-details-pos-tabs-menu" class="nav nav-tabs">'+
							...
							'<table id="template-details-tab1-table" class="table">'+
								'<tbody>'+
									...
									'<tr>'+
										...
										'<td width="25%"><span class="template-details-tab1-table-txt">'+print_checkBox(d.dognet_blankdocpost.kodusepril1)+'</span></td>'+
									'</tr>'+
									'<tr>'+
										'<td width="5%"><span class="template-details-tab1-table-title"></span></td>'+
										'<td width="5%"><span class="template-details-tab1-table-title">2)</span></td>'+
										'<td width="65%"><span class="template-details-tab1-table-title">Календарный план</span></td>'+
										'<td width="25%"><span class="template-details-tab1-table-txt">'+print_checkBox(d.dognet_blankdocpost.kodusepril2)+'</span></td>'+
									'</tr>'+
									'<tr>'+
										'<td width="5%"><span class="template-details-tab1-table-title"></span></td>'+
										'<td width="5%"><span class="template-details-tab1-table-title">3)</span></td>'+
										'<td width="65%"><span class="template-details-tab1-table-title">Спецификация</span></td>'+
										'<td width="25%"><span class="template-details-tab1-table-txt">'+print_checkBox(d.dognet_blankdocpost.kodusepril3)+'</span></td>'+
									'</tr>'+
									'<tr>'+
										'<td width="5%"><span class="template-details-tab1-table-title"></span></td>'+
										'<td width="5%"><span class="template-details-tab1-table-title">4)</span></td>'+
										'<td width="65%"><span class="template-details-tab1-table-title">Протокол соглашения о договорной цене</span></td>'+
										'<td width="25%"><span class="template-details-tab1-table-txt">'+print_checkBox(d.dognet_blankdocpost.kodusepril4)+'</span></td>'+
									'</tr>'+
									'<tr>'+
										'<td width="5%"><span class="template-details-tab1-table-title"></span></td>'+
										...
										'<td width="25%"><span class="template-details-tab1-table-txt">'+print_checkBox(d.dognet_blankdocpost.kodusepril5)+'</span></td>'+
									'</tr>'+
								'</tbody>'+
							'</table>'+
						'</div>'+
							...
							'<table id="template-details-tab1-table" class="table">'+
								'<tbody>'+
									'<tr class="tr-title">'+
										...
										'<td width="95%" colspan="3"><span class="template-details-tab1-table-title_topic">Особые условия</span></td>'+
									'</tr>'+
									'<tr>'+
										'<td width="5%"><span class="template-details-tab1-table-title"></span></td>'+
									...
									'<tr>'+
										...
										'<td width="60%"><span class="template-details-tab1-table-txt">'+print_checkBox(d.dognet_blankdocpost.kodusetender)+'</span></td>'+
									'</tr>'+
								'</tbody>'+
							'</table>'+
						'</div>'+
							...
							'<table id="template-details-tab1-table" class="table">'+
								'<tbody>'+
									...
									'<tr>'+
										...
										'<td width="89%"><span class="template-details-tab1-table-txt"><span class="txt-parameter">'+d.dognet_blankdocpost.cdaysispoldoc2+'</span>дней от аванса</span></td>'+
									'</tr>'+
									'<tr>'+
										'<td width="5%"><span class="template-details-tab1-table-title"></span></td>'+
										'<td width="5%"><span class="template-details-tab1-table-title">3)</span></td>'+
