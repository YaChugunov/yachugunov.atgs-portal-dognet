...
$(document).ready(function() {
    ...
    var editor_blankview_edit_pir = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-edit-pir-process.php",
            data: function(d) {
            ...
            },
            {
                ...
                action: function(e, dt, node, config) {
                    ...
                    editor_blankview_edit_pir.on('preOpen', function(e) {
                        editor_blankview_edit_pir.field(
                            'dognet_blankdocpir.kodblankcreate').disable();
                        editor_blankview_edit_pir.field(
                            'dognet_blankdocpir.kodblankinprocess').set(1);
                        editor_blankview_edit_pir.field(
                            'dognet_blankdocpir.kodblankinprocess').disable();
                        editor_blankview_edit_pir.field(
                            'dognet_blankdocpir.kodblankdone').set(0);
                    });
    ...
    $('#blankview-edit-pir-table tbody').on('click', 'tr td.details-control-docblank-pir', function() {
        ...
        if (row.child.isShown()) {
            ...
            d = row.data();
            rowData.child(<?php include ('templates/blankview-edit-tab5-blankwork-doc-table.tpl'); ?>)
                .show();
    ...
    $('#blankview-edit-pir-table tbody').on('click', 'tr td.details-control-blankwork-pir', function() {
        ...
        if (row.child.isShown()) {
            ...
            rowData = table_blankview_edit_pir.row(row);
            d = row.data();
            rowData.child(<?php include ('templates/blankview-edit-tab5-blankwork-pir-table.tpl'); ?>)
                .show();
    ...
    table_blankview_edit_pir.on('user-select', function(e, dt, type, cell, originalEvent) {
        ...
        if (((row.data().dognet_blankdocpir.kodtipblank == "CR") && (row.data().dognet_blankdocpir
                .kodblankinprocess == 1))) {
            e.preventDefault();
        }
        if (((row.data().dognet_blankdocpir.kodtipblank == "RD") && (row.data().dognet_blankdocpir
                .kodblankdone == 1))) {
            e.preventDefault();
        }
    });
    ...
    var editor_blankview_edit_pir_docfiles = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-edit-pir-docfiles-process.php",
    ...
    var table_blankview_edit_pir_docfiles = $('#blankview-edit-pir-docfiles-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-edit-pir-docfiles-process.php",
            type: 'post',
            data: function(d) {
                var selected = table_blankview_edit_pir.row({
                    selected: true
    ...
    var editor_blankview_edit_pir_blankpril = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-edit-pir-blankpril-process.php",
            data: function(d) {
                var selected = table_blankview_edit_pir.row({
                    selected: true
                });
        ...
        fields: [{
            ...
            type: "upload",
            display: function(id) {
                return '<h4><a target="_blank" href="' + editor_blankview_edit_pir_blankpril
    ...
    editor_blankview_edit_pir_blankpril.on('initCreate', function(e) {
        ...
        editor_blankview_edit_pir_blankpril.field('dognet_blankworkpril.msgDocFileID').val(
    ...
    var editor_blankview_edit_pir_summadop = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-edit-pir-summadop-process.php",
            data: function(d) {
                var selected = table_blankview_edit_pir.row({
                    selected: true
                });
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.test/tabs/css/blankview-edit-tab5_pir.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.test/tabs/css/blankview-edit-tab5_summadop.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.test/tabs/css/blankview-edit-tab5_doc_files.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.test/tabs/css/blankview-edit-tab5_pril_files.css">
<?php
// ----- ----- ----- ----- -----
...
<section>
    ...
    <table id="blankview-edit-pir-table" class="table table-bordered table-condensed display compact" cellspacing="0"
           width="100%">
        <thead>
            <tr>
