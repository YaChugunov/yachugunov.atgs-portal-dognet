...
$(document).ready(function() {
    ...
    var editor_blankview_edit_blankwork = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-edit-blankwork-process.php",
    ...
    var table_blankview_edit_blankwork = $('#blankview-edit-blankwork-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-edit-blankwork-process.php",
            type: "POST"
        },
        serverSide: true,
    ...
    var table_blankview_edit_blankwork_docfiles = $('#blankview-edit-blankwork-docfiles-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-edit-blankwork-docfiles-process.php",
            type: 'post',
            data: function(d) {
    ...
    var table_blankview_edit_blankwork_blankpril = $('#blankview-edit-blankwork-blankpril-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-edit-blankwork-blankpril-process.php",
            type: 'post',
            data: function(d) {
                var selected = table_blankview_edit_blankwork.row({
                    selected: true
    ...
    var table_blankview_edit_blankwork_summadop = $('#blankview-edit-blankwork-summadop-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-edit-blankwork-summadop-process.php",
            type: 'post',
            data: function(d) {
                var selected = table_blankview_edit_blankwork.row({
                    selected: true
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.test/tabs/css/blankview-edit-tab1_blankwork.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.test/tabs/css/blankview-edit-tab1_summadop.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.test/tabs/css/blankview-edit-tab1_doc_files.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.test/tabs/css/blankview-edit-tab1_pril_files.css">
<?php
;  //
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
//
