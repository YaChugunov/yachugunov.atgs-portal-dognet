...
#
			...
			// Переименовываем файл
				...
				if ($_QRY_paperfiles[0]['flag'] == "0") {
					...
					$__newFileName = "NEW-B-{$_numberpril}-SUB-DO-{$_kodblankwork}";
...
if ( !isset($_POST['kodblankwork_tab4_blankpril']) || !is_numeric($_POST['kodblankwork_tab4_blankpril']) ) {
	echo json_encode( [ "data" => [] ] );
}
else {
$_KODBLANKWORK = $_POST['kodblankwork_tab4_blankpril'];
...
// 	->leftJoin( 'dognet_blankdocsub', 'dognet_blankdocsub.kodblankwork', '=', 'dognet_blankworkpril.kodblankwork' )
