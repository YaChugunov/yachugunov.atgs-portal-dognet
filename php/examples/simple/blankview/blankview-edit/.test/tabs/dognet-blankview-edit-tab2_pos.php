...
$(document).ready(function() {
    ...
    var editor_blankview_edit_pos = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-edit-pos-process.php",
            data: function(d) {
    ...
    editor_blankview_edit_pos.on('open', function() {
        ...
        if (($('#DTE_Field_dognet_blankdocpost-kodzakaz').value) != editor_blankview_edit_pos.field(
                'dognet_blankdocpost.kodzakaz').get()) {}
        // Поиск в ниспадающем списке по содержимому текстового поля для ответного документа
        $('#DTE_Field_dognet_blankdocpost-kodzakaz').filterByText(editor_blankview_edit_pos, $(
            '#kodzakaz_filter_pos'), 'dognet_blankdocpost.kodzakaz', false);
    });
    // ----- ----- ----- ----- -----
    editor_blankview_edit_pos.on('preSubmit', function(e) {
        ...
        if ((parsejson['dognet_blankdocpost.koduseopl1usl'] == 0) && (parsejson[
                'dognet_blankdocpost.koduseopl2usl'] == 0) && (parsejson[
                'dognet_blankdocpost.koduseopl3usl'] == 0) && (parsejson[
                'dognet_blankdocpost.koduseopl4usl'] == 0)) {
    ...
    var table_blankview_edit_pos = $('#blankview-edit-pos-table').DataTable({
            ...
            },
            {
                ...
                render: function(data, type, row, meta) {
                    if (data != null) {
                        ...
                        if (row.dognet_blankdocpost.koduseneworg == 1 && row.dognet_blankdocpost
                            .nameneworg != "") {
        ...
        buttons: [{
            ...
            },
            {
                ...
                action: function(e, dt, node, config) {
                    ...
                    editor_blankview_edit_pos.on('preOpen', function(e) {
                        editor_blankview_edit_pos.field(
                            'dognet_blankdocpost.kodblankcreate').disable();
                        editor_blankview_edit_pos.field(
                            'dognet_blankdocpost.kodblankinprocess').set(1);
                        editor_blankview_edit_pos.field(
                            'dognet_blankdocpost.kodblankinprocess').disable();
                        editor_blankview_edit_pos.field(
                            'dognet_blankdocpost.kodblankdone').set(0);
                    });
            ...
            // 			{ extend: "remove", editor: editor_blankview_edit_pos, text: '<span class="glyphicon glyphicon-remove"></span>' }
        ],
        rowGroup: {
    ...
    $('#blankview-edit-pos-table tbody').on('click', 'tr td.details-control-docblank-pos', function() {
        ...
        if (row.child.isShown()) {
            ...
            d = row.data();
            rowData.child(<?php include ('templates/blankview-edit-tab2-blankwork-doc-table.tpl'); ?>)
                .show();
    ...
    $('#blankview-edit-pos-table tbody').on('click', 'tr td.details-control-blankwork-pos', function() {
        ...
        if (row.child.isShown()) {
            ...
            rowData = table_blankview_edit_pos.row(row);
            d = row.data();
            rowData.child(<?php include ('templates/blankview-edit-tab2-blankwork-pos-table.tpl'); ?>)
                .show();
    ...
    table_blankview_edit_pos.on('user-select', function(e, dt, type, cell, originalEvent) {
        ...
        if (((row.data().dognet_blankdocpost.kodtipblank == "CR") && (row.data().dognet_blankdocpost
                .kodblankinprocess == 1))) {
            e.preventDefault();
        }
        if (((row.data().dognet_blankdocpost.kodtipblank == "RD") && (row.data().dognet_blankdocpost
                .kodblankdone == 1))) {
            e.preventDefault();
        }
    });
    ...
    var editor_blankview_edit_pos_docfiles = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-edit-pos-docfiles-process.php",
    ...
    var table_blankview_edit_pos_docfiles = $('#blankview-edit-pos-docfiles-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-edit-pos-docfiles-process.php",
            type: 'post',
            data: function(d) {
                var selected = table_blankview_edit_pos.row({
                    selected: true
    ...
    var editor_blankview_edit_pos_blankpril = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-edit-pos-blankpril-process.php",
            data: function(d) {
                var selected = table_blankview_edit_pos.row({
                    selected: true
                });
                if (selected.any()) {
                    d.kodblankwork_tab2_blankpril = selected.data().dognet_blankdocpost
                        .kodblankwork;
                }
            }
        },
        ...
        fields: [{
            ...
            type: "upload",
            display: function(id) {
                return '<h4><a target="_blank" href="' + editor_blankview_edit_pos_blankpril
                    .file('dognet_blankworkpril_files', id).file_webpath +
                    '"><span class="glyphicon glyphicon-eye-open"></span></a></h4>';
            },
            dragDrop: false,
            clearText: "",
    ...
    editor_blankview_edit_pos_blankpril.on('initCreate', function(e) {
        ...
        editor_blankview_edit_pos_blankpril.field('dognet_blankworkpril.msgDocFileID').val(
    ...
    var editor_blankview_edit_pos_summadop = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-edit-pos-summadop-process.php",
            data: function(d) {
                var selected = table_blankview_edit_pos.row({
                    selected: true
                });
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.test/tabs/css/blankview-edit-tab2_pos.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.test/tabs/css/blankview-edit-tab2_summadop.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.test/tabs/css/blankview-edit-tab2_doc_files.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.test/tabs/css/blankview-edit-tab2_pril_files.css">
<?php
// ----- ----- ----- ----- -----
        ...
        <div class="tab-content" style="padding:5px">
            ...
            <div id="pos-tab-1" class="tab-pane fade in active">
                ...
                <div class="Section">
                    ...
                    <div class="Block100">
                        <legend>Название договора / Основание договора</legend>
                        <fieldset class="field70">
            ...
            <div id="pos-tab-2" class="tab-pane fade">
                ...
                <div class="Section">
                    ...
                    <div class="Block70">
                        ...
                        <div id="tab2_useopl1usl" class="Block40"
                        ...
                        <div id="tab2_useopl2usl" class="Block60"
                             style="outline:1px dashed #ccc; outline-offset:-4px; padding:4px 8px">
                            <fieldset class="field100">
                        ...
                        <div id="tab2_useopl3usl" class="Block40"
                             style="outline:1px dashed #ccc; outline-offset:-4px; padding:4px 8px">
                            <fieldset class="field100">
                        ...
                        <div id="tab2_useopl4usl" class="Block60"
                             style="outline:1px dashed #ccc; outline-offset:-4px; padding:4px 8px">
                            <fieldset class="field30">
            ...
            <div id="pos-tab-4" class="tab-pane fade">
                ...
                <div class="Section">
                    <div class="Block100">
                        ...
                        <div id="tab2_useispoldoc1" class="Block50 fieldset-table-row"
                             style="outline:1px dashed #ccc; outline-offset:-4px; padding:4px 8px">
                            <div class="fieldset-table-cell" style="padding-bottom:3px">
                                <fieldset>
                        ...
                        <div id="tab2_useispoldoc2" class="Block50 fieldset-table-row"
                             style="outline:1px dashed #ccc; outline-offset:-4px; padding:4px 8px">
                            <div class="fieldset-table-cell" style="padding-bottom:3px">
                                <fieldset>
                        ...
                        <div id="tab2_useispoldoc3" class="Block50 fieldset-table-row"
                             style="outline:1px dashed #ccc; outline-offset:-4px; padding:4px 8px">
                            <div class="fieldset-table-cell" style="padding-bottom:3px">
                                <fieldset>
                        ...
                        <div id="tab2_useispoldoc4" class="Block50 fieldset-table-row"
                             style="outline:1px dashed #ccc; outline-offset:-4px; padding:4px 8px">
                            <div class="fieldset-table-cell" style="padding-bottom:3px">
                                <fieldset>
...
<section>
    ...
    <table id="blankview-edit-pos-table" class="table table-bordered table-condensed display compact" cellspacing="0"
           width="100%">
        <thead>
            <tr>
