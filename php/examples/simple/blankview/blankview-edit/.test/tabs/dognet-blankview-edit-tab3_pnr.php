...
$(document).ready(function() {
    ...
    var editor_blankview_edit_pnr = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-edit-pnr-process.php",
            data: function(d) {
    ...
    editor_blankview_edit_pnr.on('open', function() {
        ...
        if (($('#DTE_Field_dognet_blankdocpnr-kodzakaz').value) != editor_blankview_edit_pnr.field(
                'dognet_blankdocpnr.kodzakaz').get()) {}
        // Поиск в ниспадающем списке по содержимому текстового поля для ответного документа
        $('#DTE_Field_dognet_blankdocpnr-kodzakaz').filterByText(editor_blankview_edit_pnr, $(
            '#kodzakaz_filter_pnr'), 'dognet_blankdocpnr.kodzakaz', false);
    });
    // ----- ----- ----- ----- -----
    editor_blankview_edit_pnr.on('preSubmit', function(e) {
        ...
        if ((parsejson['dognet_blankdocpnr.koduseopl1usl'] == 0) && (parsejson[
                'dognet_blankdocpnr.koduseopl2usl'] == 0) && (parsejson[
                'dognet_blankdocpnr.koduseopl3usl'] == 0) && (parsejson[
                'dognet_blankdocpnr.koduseopl4usl'] == 0)) {
    ...
    var table_blankview_edit_pnr = $('#blankview-edit-pnr-table').DataTable({
        ...
        columns: [{
            ...
            {
                data: "dognet_blankdocpnr.kodpaperstr",
                className: ""
            },
            {
            ...
            },
            {
                ...
                render: function(data, type, row, meta) {
                    if (data != null) {
                        ...
                        if (row.dognet_blankdocpnr.koduseneworg == 1 && row.dognet_blankdocpnr
                            .nameneworg != "") {
            ...
            },
            {
                ...
                action: function(e, dt, node, config) {
                    ...
                    editor_blankview_edit_pnr.on('preOpen', function(e) {
                        editor_blankview_edit_pnr.field(
                            'dognet_blankdocpnr.kodblankcreate').disable();
                        editor_blankview_edit_pnr.field(
                            'dognet_blankdocpnr.kodblankinprocess').set(1);
                        editor_blankview_edit_pnr.field(
                            'dognet_blankdocpnr.kodblankinprocess').disable();
                        editor_blankview_edit_pnr.field(
                            'dognet_blankdocpnr.kodblankdone').set(0);
                    });
                    ...
                    editor_blankview_edit_pnr
                        .edit(table_blankview_edit_pnr.rows({
                            ...
                            title: '<h3>Работать с бланком на ПНР</h3>',
    ...
    $('#blankview-edit-pnr-table tbody').on('click', 'tr td.details-control-docblank-pnr', function() {
        ...
        if (row.child.isShown()) {
            ...
            d = row.data();
            rowData.child(<?php include ('templates/blankview-edit-tab3-blankwork-doc-table.tpl'); ?>)
                .show();
    ...
    $('#blankview-edit-pnr-table tbody').on('click', 'tr td.details-control-blankwork-pnr', function() {
        ...
        if (row.child.isShown()) {
            ...
            rowData = table_blankview_edit_pnr.row(row);
            d = row.data();
            rowData.child(<?php include ('templates/blankview-edit-tab3-blankwork-pnr-table.tpl'); ?>)
                .show();
    ...
    table_blankview_edit_pnr.on('draw', function() {
        ...
        cnt_pnr = table_blankview_edit_pnr.data().count();
        console.log("table_blankview_edit_pnr.count() : " + cnt_pnr);
        if (cnt_pnr > 0) {
            document.getElementById("pnr_newitems_cnt").innerHTML = cnt_pnr;
        }
        //
    ...
    table_blankview_edit_pnr.on('user-select', function(e, dt, type, cell, originalEvent) {
        ...
        if (((row.data().dognet_blankdocpnr.kodtipblank == "CR") && (row.data().dognet_blankdocpnr
                .kodblankinprocess == 1))) {
            e.preventDefault();
        }
        if (((row.data().dognet_blankdocpnr.kodtipblank == "RD") && (row.data().dognet_blankdocpnr
                .kodblankdone == 1))) {
            e.preventDefault();
        }
    });
    ...
    var editor_blankview_edit_pnr_docfiles = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-edit-pnr-docfiles-process.php",
    ...
    var table_blankview_edit_pnr_docfiles = $('#blankview-edit-pnr-docfiles-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-edit-pnr-docfiles-process.php",
            type: 'post',
            data: function(d) {
                var selected = table_blankview_edit_pnr.row({
                    selected: true
    ...
    var editor_blankview_edit_pnr_blankpril = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-edit-pnr-blankpril-process.php",
            data: function(d) {
                var selected = table_blankview_edit_pnr.row({
                    selected: true
                });
        ...
        fields: [{
            ...
            type: "upload",
            display: function(id) {
                return '<h4><a target="_blank" href="' + editor_blankview_edit_pnr_blankpril
    ...
    editor_blankview_edit_pnr_blankpril.on('initCreate', function(e) {
        ...
        editor_blankview_edit_pnr_blankpril.field('dognet_blankworkpril.msgDocFileID').val(
    ...
    var editor_blankview_edit_pnr_summadop = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-edit-pnr-summadop-process.php",
            data: function(d) {
                var selected = table_blankview_edit_pnr.row({
                    selected: true
                });
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.test/tabs/css/blankview-edit-tab3_pnr.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.test/tabs/css/blankview-edit-tab3_summadop.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.test/tabs/css/blankview-edit-tab3_doc_files.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.test/tabs/css/blankview-edit-tab3_pril_files.css">
<?php
// ----- ----- ----- ----- -----
...
<section>
    ...
    <table id="blankview-edit-pnr-table" class="table table-bordered table-condensed display compact" cellspacing="0"
           width="100%">
        <thead>
            <tr>
