...
// ПОЛНОЕ РЕДАКТИРОВАНИЕ БЛАНКА ::: Редактор
	var editor_blankview_edit = new $.fn.dataTable.Editor( {
		display: "bootstrap",
		ajax: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-edit-process.php",
		table: "#blankview-edit-table",
    i18n: {
...
// ----- ----- ----- ----- -----
/*
	$('#blankview-edit-table').on( 'dblclick', 'tbody tr', function () {
...
// РЕДАКТИРОВАНИЕ ГОТОВОГО БЛАНКА ::: Редактор
	var editor_blankview_gip = new $.fn.dataTable.Editor( {
		display: "bootstrap",
		ajax: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-edit-process.php",
		table: "#blankview-edit-table",
    i18n: {
...
// ----- ----- ----- ----- -----
	var openVals;
  editor_blankview_gip.on( 'preClose', function ( e ) {
      // On close, check if the values have changed and ask for closing confirmation if they have
      if ( openVals !== JSON.stringify( editor_blankview_gip.get() ) ) {
          return confirm( 'Вы изменили данные формы. Уверены, что хотите выйти из редактирования?' );
      }
  } )
// ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
// БЛАНК ГОТОВЫЙ ::: Таблица данных
	var table_blankview_gip = $('#blankview-edit-table').DataTable( {
		dom: "<'row'<'col-sm-9'B><'col-sm-3'>>" + "<'row'<'col-sm-12'tr>>" + "<'row'<'col-sm-4'i><'col-sm-8'p>>",
// 		dom: "<'space50'r>tip",
		language: {	url: "russian.json" },
		ajax: {
			url: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-edit-process.php",
			type: "POST"
		},
		serverSide: true,
		columns: [
		...
		buttons: [
			{ text:	'<span class="glyphicon glyphicon-refresh"></span>', action:
				function ( e, dt, node, config ) {
					...
					table_blankview_gip.columns().search('');
					table_blankview_gip.draw();
				}
			},
			...
			{ extend: "edit", editor: editor_blankview_gip, text: "ИЗМЕНИТЬ",
				formButtons:
					[ 'Изменить',
						{ text: 'Отмена', action: function () { this.close(); } }
					]
			},
			{ extend: "remove", editor: editor_blankview_gip, text: "УДАЛИТЬ" }
		],
    rowGroup: {
...
// ----- ----- ----- ----- -----
		$('#globalSearch_button').click(function(e){
			table_blankview_gip.search($("#globalSearch_text").val()).draw();
		});
		$('#clearSearch_button').click(function(e){
			table_blankview_gip.search('').draw();
...
// Array to track the ids of the edit displayed rows
    ...
    $('#blankview-edit-table tbody').on( 'click', 'tr td.details-control', function () {
        var tr = $(this).closest('tr');
        var row = table_blankview_gip.row( tr );
        ...
        if ( row.child.isShown() ) {
            ...
            tr.addClass( 'edit' );
			rowData = table_blankview_gip.row( row );
			d = row.data();
			rowData.child( <?php include ('templates/blankview-edit-table.tpl'); ?> ).show();
...
// On each draw, loop over the `detailRows` array and show any child rows
	table_blankview_gip.on( 'draw', function () {
...
// БЛАНК РАБОЧИЙ ::: Редактор
	var editor_blankview_docfiles = new $.fn.dataTable.Editor( {
		display: "bootstrap",
		ajax: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-docfiles-process.php",
...
// 		dom: "<'space50'r>tip",
		language: {	url: "russian.json" },
		ajax: {
			url: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-docfiles-process.php",
			type: 'post',
      data: function ( d ) {
          var selected = table_blankview_gip.row( { selected: true } );
          if ( selected.any() ) {
...
// ПРИЛОЖЕНИЯ БЛАНКА ::: Редактор
	var editor_blankview_blankpril = new $.fn.dataTable.Editor( {
		display: "bootstrap",
		ajax: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-blankpril-process.php",
...
// 		dom: "<'space50'r>tip",
		language: {	url: "russian.json" },
		ajax: {
			url: "php/examples/simple/blankview/blankview-edit/.test/tabs/process/dognet-blankview-blankpril-process.php",
			type: 'post',
      data: function ( d ) {
          var selected = table_blankview_gip.row( { selected: true } );
          if ( selected.any() ) {
...
//
// ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
	table_blankview_gip.on( 'select', function () {
			table_blankview_gip.buttons().enable();
	...
	table_blankview_gip.on( 'deselect', function () {
...
/*
/* Общее для таблицы */
#blankview-edit-table {  }
#blankview-edit-table .details-control:hover { cursor:hand }
#blankview-edit-table > tbody > tr.selected, #docview-details-tab3 > tbody > tr > .selected { color:#000;	background-color:#e9e9e9 }
/*
/*
/* Заголовок таблицы */
#blankview-edit-table > thead {	background-color:#111;	color:#fff; font-family:'Oswald', sans-serif; border-bottom:none;	border-top:none }
#blankview-edit-table > thead > tr > th { border-bottom:none; font-weight:400; font-size:1.0em; text-transform:uppercase }
#blankview-edit-table .sorting:after, #blankview-edit-table .sorting_asc:after, #blankview-edit-table .sorting_desc:after { display:none }
#blankview-edit-table > thead > tr > th.sorting_asc { padding-right:5px }
#blankview-edit-table > thead > tr > th.sorting_desc { padding-right:5px }
/*
/*
/* Тело таблицы */
#blankview-edit-table {  }
#blankview-edit-table > tbody { font-family:'Helioscond', sans-serif; font-size:1.0em; font-weight:300; color:#666; border-bottom:none; border-top:none }
#blankview-edit-table > tbody > tr > td { padding:5px; line-height:1.42857143; vertical-align:middle; border-top:none }
#blankview-edit-table > thead > tr > th { padding:8px 5px; border-bottom:none }
#blankview-edit-table > tbody > tr > td {  }
#blankview-edit-table > tbody > tr > td:last-child { text-align:right }

#blankview-edit-table > tfoot > tr > td { padding:5px 4px }
#blankview-edit-table > tfoot > tr > td:last-child { text-align:right }
#blankview-edit-table > tfoot {
...
----- ----- ----- ----- ----- ----- ----- ----- ----- -----
*/
	#blankview-edit-table > thead > tr > th:first-child, #blankview-edit-table > tbody > tr > td:first-child { width:1%; text-align:center }
	#blankview-edit-table > thead > tr > th:nth-child(2), #blankview-edit-table > tbody > tr > td:nth-child(2) { width:3%; text-align:center; border-left:1px #fff solid }
	#blankview-edit-table > thead > tr > th:nth-child(3), #blankview-edit-table > tbody > tr > td:nth-child(3) { width:4%; text-align:center; border-left:1px #fff solid }
	#blankview-edit-table > thead > tr > th:nth-child(4), #blankview-edit-table > tbody > tr > td:nth-child(4) { width:45%; text-align:left; border-left:1px #fff solid }
	#blankview-edit-table > thead > tr > th:nth-child(5), #blankview-edit-table > tbody > tr > td:nth-child(5) { width:19%; text-align:left; border-left:1px #fff solid }
	#blankview-edit-table > thead > tr > th:nth-child(6), #blankview-edit-table > tbody > tr > td:nth-child(6) { width:5%; text-align:center; border-left:1px #fff solid }
	#blankview-edit-table > thead > tr > th:nth-child(7), #blankview-edit-table > tbody > tr > td:nth-child(7) { width:4%; text-align:center; border-left:1px #fff solid }
	#blankview-edit-table > thead > tr > th:nth-child(8), #blankview-edit-table > tbody > tr > td:nth-child(8) { width:7%; text-align:center; border-left:1px #fff solid }
	#blankview-edit-table > thead > tr > th:nth-child(9), #blankview-edit-table > tbody > tr > td:nth-child(9) { width:8%; text-align:center; border-left:1px #fff solid }
	#blankview-edit-table > thead > tr > th:nth-child(10), #blankview-edit-table > tbody > tr > td:nth-child(10) { width:7%; text-align:center; border-left:1px #fff solid }
	#blankview-edit-table > thead > tr > th:nth-child(11), #blankview-edit-table > tbody > tr > td:nth-child(11) { width:5%; text-align:center; border-left:1px #fff solid }
	#blankview-edit-table .details-control:hover { cursor:pointer }

/*
----- ----- ----- ----- ----- ----- ----- ----- ----- -----
*/
	#blankview-edit-table .sorting_asc:after { display:none }
	#blankview-edit-table > thead > tr > th.sorting_asc { padding-right:8px }
/*
----- ----- ----- ----- ----- ----- ----- ----- ----- -----
*/
...
#blankview-docfiles-table .sorting:after, #blankview-edit-table .sorting_asc:after, #blankview-edit-table .sorting_desc:after { display:none }
...
#blankview-blankpril-table .sorting:after, #blankview-edit-table .sorting_asc:after, #blankview-edit-table .sorting_desc:after { display:none }
...
#blankview-edit-table .group { font-family:'Oswald', sans-serif; font-size:1.3em; font-weight:400; color:#000 }
#blankview-edit-table > tbody > tr.dtrg-start.dtrg-level-0 > td { font-family:'Oswald', sans-serif; font-size:1.3em; font-weight:400; text-align:left; background-color:#d9d9d9; color:#111; padding:5px }
#blankview-edit-table > tbody > tr.dtrg-end.dtrg-level-0 > td { font-family:'Oswald', sans-serif; font-size:1.4em; font-weight:500; color:#000; background-color:#f1f1f1 }
#blankview-edit-table > tbody > tr.dtrg-end.dtrg-level-0 > td { font-family:'Oswald', sans-serif; font-size:1.4em; font-weight:500; color:#000; background-color:#f1f1f1 }
.itogo-lvl0 {  }
...
?>
	...
	<table id="blankview-edit-table" class="table table-striped" cellspacing="0" width="100%">
			<thead>
				<tr>
