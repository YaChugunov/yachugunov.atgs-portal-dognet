...
$(document).ready(function() {
    ...
    var editor_blankview_edit_sub = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.prod/tabs/process/dognet-blankview-edit-sub-process.php",
            data: function(d) {
                ...
                if (selected.any()) {
                    ...
                    console.log("Kodblankwork (" + selected.id().substr(4) + ") :: kodblankwork: " +
                        d.kodblankwork_tab4);
                }
            }
        },
            ...
            },
            {
                ...
                action: function(e, dt, node, config) {
                    ...
                    editor_blankview_edit_sub.on('preOpen', function(e) {
                        editor_blankview_edit_sub.field(
                            'dognet_blankdocsub.kodblankcreate').disable();
                        editor_blankview_edit_sub.field(
                            'dognet_blankdocsub.kodblankinprocess').set(1);
                        editor_blankview_edit_sub.field(
                            'dognet_blankdocsub.kodblankinprocess').disable();
                        editor_blankview_edit_sub.field(
                            'dognet_blankdocsub.kodblankdone').set(0);
                    });
    ...
    $('#blankview-edit-sub-table tbody').on('click', 'tr td.details-control-docblank-sub', function() {
        ...
        if (row.child.isShown()) {
            ...
            d = row.data();
            rowData.child(<?php include ('templates/blankview-edit-tab4-blankwork-doc-table.tpl'); ?>)
                .show();
    ...
    $('#blankview-edit-sub-table tbody').on('click', 'tr td.details-control-blankwork-sub', function() {
        ...
        if (row.child.isShown()) {
            ...
            rowData = table_blankview_edit_sub.row(row);
            d = row.data();
            rowData.child(<?php include ('templates/blankview-edit-tab4-blankwork-sub-table.tpl'); ?>)
                .show();
    ...
    table_blankview_edit_sub.on('user-select', function(e, dt, type, cell, originalEvent) {
        ...
        if (((row.data().dognet_blankdocsub.kodtipblank == "CR") && (row.data().dognet_blankdocsub
                .kodblankinprocess == 1))) {
            e.preventDefault();
        }
        if (((row.data().dognet_blankdocsub.kodtipblank == "RD") && (row.data().dognet_blankdocsub
                .kodblankdone == 1))) {
            e.preventDefault();
        }
    });
    ...
    var editor_blankview_edit_sub_docfiles = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: "php/examples/simple/blankview/blankview-edit/.prod/tabs/process/dognet-blankview-edit-sub-docfiles-process.php",
    ...
    var table_blankview_edit_sub_docfiles = $('#blankview-edit-sub-docfiles-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.prod/tabs/process/dognet-blankview-edit-sub-docfiles-process.php",
            type: 'post',
            data: function(d) {
                var selected = table_blankview_edit_sub.row({
                    selected: true
    ...
    var editor_blankview_edit_sub_blankpril = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.prod/tabs/process/dognet-blankview-edit-sub-blankpril-process.php",
            data: function(d) {
                var selected = table_blankview_edit_sub.row({
                    selected: true
                });
        ...
        fields: [{
            ...
            type: "upload",
            display: function(id) {
                return '<h4><a target="_blank" href="' + editor_blankview_edit_sub_blankpril
    ...
    editor_blankview_edit_sub_blankpril.on('initCreate', function(e) {
        ...
        editor_blankview_edit_sub_blankpril.field('dognet_blankworkpril.msgDocFileID').val(
    ...
    var editor_blankview_edit_sub_summadop = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.prod/tabs/process/dognet-blankview-edit-sub-summadop-process.php",
            data: function(d) {
                var selected = table_blankview_edit_sub.row({
                    selected: true
                });
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.prod/tabs/css/blankview-edit-tab4_sub.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.prod/tabs/css/blankview-edit-tab4_summadop.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.prod/tabs/css/blankview-edit-tab4_doc_files.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.prod/tabs/css/blankview-edit-tab4_pril_files.css">
<?php
// ----- ----- ----- ----- -----
...
<section>
    ...
    <table id="blankview-edit-sub-table" class="table table-bordered table-condensed display compact" cellspacing="0"
           width="100%">
        <thead>
            <tr>
