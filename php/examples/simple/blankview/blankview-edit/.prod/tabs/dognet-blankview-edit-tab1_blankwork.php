...
$(document).ready(function() {
    ...
    var editor_blankview_edit_blankwork = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: "php/examples/simple/blankview/blankview-edit/.prod/tabs/process/dognet-blankview-edit-blankwork-process.php",
        table: "#blankview-edit-blankwork-table",
        i18n: {
            edit: {
                title: "<h3>Коррекция готового бланка</h3>"
            },
            error: {
        ...
        fields: [{
            ...
            name: "dognet_docblankwork.koddocsubpodr",
            type: "select",
            def: "",
            placeholder: "Без привязки"
        }, {
            ...
            attr: {
                placeholder: "Комментарии отдела договоров"
            }
        }]
    });
    // ----- ----- -----
    ...
    editor_blankview_edit_blankwork.on('open', function() {
        $(".modal-dialog").css({
            "width": "60%",
            "margin": "1.0em auto",
            "min-width": "640px",
    ...
    editor_blankview_edit_blankwork
        .on('open', function() {
            ...
            if (($('#DTE_Field_dognet_docblankwork-kodzakaz').value) != editor_blankview_edit_blankwork
                .field('dognet_docblankwork.kodzakaz').get()) {}
            // Поиск в ниспадающем списке по содержимому текстового поля для ответного документа
            $('#DTE_Field_dognet_docblankwork-kodzakaz').filterByText(editor_blankview_edit_blankwork, $(
                '#blankview-edit-tab1-kodzakaz_filter'), 'dognet_docblankwork.kodzakaz', false);

            $('#blankview-edit-tab1-kodsubpodr_filter').val('');
            if (($('#DTE_Field_dognet_docblankwork-kodsubpodr').value) != editor_blankview_edit_blankwork
                .field('dognet_docblankwork.kodsubpodr').get()) {}
            // Поиск в ниспадающем списке по содержимому текстового поля для ответного документа
            $('#DTE_Field_dognet_docblankwork-kodsubpodr').filterByText(editor_blankview_edit_blankwork, $(
                '#blankview-edit-tab1-kodsubpodr_filter'), 'dognet_docblankwork.kodsubpodr', false);

            $('#blankview-edit-tab1-koddoc_filter').val('');
            if (($('#DTE_Field_dognet_docblankwork-koddoc').value) != editor_blankview_edit_blankwork.field(
                    'dognet_docblankwork.koddoc').get()) {}
            // Поиск в ниспадающем списке по содержимому текстового поля для ответного документа
            $('#DTE_Field_dognet_docblankwork-koddoc').filterByText(editor_blankview_edit_blankwork, $(
                '#blankview-edit-tab1-koddoc_filter'), 'dognet_docblankwork.koddoc', false);
        });
    // ----- ----- -----
    editor_blankview_edit_blankwork
        .on('close', function() {
    ...
    var table_blankview_edit_blankwork = $('#blankview-edit-blankwork-table').DataTable({
        dom: "<'row'<'col-sm-2'B><'col-sm-9'<'#textttttttt'>><'col-sm-3'>>" + "<'row'<'col-sm-12'tr>>" +
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.prod/tabs/process/dognet-blankview-edit-blankwork-process.php",
            type: "POST"
        },
        serverSide: true,
        createdRow: function(row, data, index) {
            $('span[data-toggle="tooltip"]', row).tooltip({
                html: true,
                placement: 'top',
                trigger: "hover",
                customClass: 'tooltip-blank'
            });
        },
        initComplete: function() {
            $(this.api().table().body()).on('mouseenter', 'td span[data-toggle="tooltip"]',
                function() {
                    if (!$(this).data(
                            'bs.tooltip')) { // Убедимся, что tooltip не был ранее инициирован
                        $(this).tooltip({
                            html: true,
                            placement: 'top',
                            trigger: "hover",
        ...
        columns: [{
            ...
            {
                data: "dognet_docblankwork.kodusetender"
            }
        ],
        select: {
            style: 'single',
        ...
        columnDefs: [{
            ...
            },
            {
                ...
                targets: 5,
                render: function(data, type, row, meta) {
                    useTender = row.dognet_docblankwork.kodusetender == '1' ?
                        '<span style="float:right" data-toggle="tooltip" title="Заключен на основе выигранного тендера"><span class="label label-default text-uppercase" style="color:#fafafa; background-color:#31708f; border:1px #fff solid">Т</span></span>' :
                        '';
                    fullstr = data;
                    if (data.length > 25) {
                        return data.substr(0, 25) + " ..." + useTender;
                    } else {
                        return data + useTender;
                    }
                }
            },
            {
        ...
        buttons: [{
            ...
            {
                extend: "edit",
                editor: editor_blankview_edit_blankwork,
                text: "ИЗМЕНИТЬ",
    ...
    $('#columnSearch_btnApply').click(function(e) {
        ...
        table_blankview_edit_blankwork
            .columns(16)
            .search($("#blankUseTenderSearch_text").val())
            .draw();
    });
    ...
    $('#blankview-edit-blankwork-table tbody').on('click', 'tr td.details-control-docblank', function() {
        ...
        if (row.child.isShown()) {
            ...
            d = row.data();
            rowData.child(<?php include 'templates/blankview-edit-tab1-blankwork-doc-table.tpl'; ?>)
                .show();
    ...
    $('#blankview-edit-blankwork-table tbody').on('click', 'tr td.details-control-blankwork', function() {
        ...
        if (row.child.isShown()) {
            ...
            if (d.dognet_docblankwork.kodtipblank == "POS") {
                rowData.child(
                    <?php include 'templates/blankview-edit-tab1-blankwork-pos-blank-table.tpl'; ?>
                ).show();
            }
            if (d.dognet_docblankwork.kodtipblank == "PNR") {
                rowData.child(
                    <?php include 'templates/blankview-edit-tab1-blankwork-pnr-blank-table.tpl'; ?>
                ).show();
            }
            if (d.dognet_docblankwork.kodtipblank == "SUB") {
                rowData.child(
                    <?php include 'templates/blankview-edit-tab1-blankwork-sub-blank-table.tpl'; ?>
                ).show();
            }
            if (d.dognet_docblankwork.kodtipblank == "PIR") {
                rowData.child(
                    <?php include 'templates/blankview-edit-tab1-blankwork-pir-blank-table.tpl'; ?>
                ).show();
            }
            // Add to the 'open' array
            if (idx === -1) {
    ...
    var table_blankview_edit_blankwork_docfiles = $('#blankview-edit-blankwork-docfiles-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.prod/tabs/process/dognet-blankview-edit-blankwork-docfiles-process.php",
            type: 'post',
            data: function(d) {
                var selected = table_blankview_edit_blankwork.row({
                    selected: true
                });
                if (selected.any()) {
    ...
    var table_blankview_edit_blankwork_blankpril = $('#blankview-edit-blankwork-blankpril-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.prod/tabs/process/dognet-blankview-edit-blankwork-blankpril-process.php",
            type: 'post',
            data: function(d) {
                var selected = table_blankview_edit_blankwork.row({
                    selected: true
    ...
    var table_blankview_edit_blankwork_summadop = $('#blankview-edit-blankwork-summadop-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.prod/tabs/process/dognet-blankview-edit-blankwork-summadop-process.php",
            type: 'post',
            data: function(d) {
                var selected = table_blankview_edit_blankwork.row({
                    selected: true
    ...
    editor_blankview_edit_blankwork
        .on('open', function() {
            tipblank = table_blankview_edit_blankwork.row({
                selected: true
            }).data().dognet_docblankwork.kodtipblank;
            if (tipblank == "SUB") {
                editor_blankview_edit_blankwork.field('dognet_docblankwork.kodzakaz').hide();
                $('#dognet-docblankwork-kodzakaz').css({
                    "display": "none"
                });
                $('.kodzakazFilter').css({
                    "display": "none"
                ...
                $('#dognet-docblankwork-kodsubpodr').css({
                    "display": ""
                });
                $('.kodsubpodrFilter').css({
                    "display": ""
                });
            } else {
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.prod/tabs/css/blankview-edit-tab1_blankwork.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.prod/tabs/css/blankview-edit-tab1_summadop.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.prod/tabs/css/blankview-edit-tab1_doc_files.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.prod/tabs/css/blankview-edit-tab1_pril_files.css">
<?php
;  //
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
//
            ...
            <div id="blankview-edit-filters" class="panel-body space30">
                <div class="col-xs-12 col-sm-3 col-md-1 col-lg-1">
                    <div class="form-group space10" style="width:100%">
                        ...
                        <input type="text" id="blankNumberSearch_text" class="form-control" placeholder="###"
                               name="blankNumberSearch_text">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-3 col-md-1 col-lg-1">
                    <div class="form-group space10" style="width:100%">
                        <label for="docNumberSearch_text"><b># дог :</b></label>
                        <input type="text" id="docNumberSearch_text" class="form-control" placeholder="####"
                    ...
                    <div class="form-group space10" style="width:100%">
                        ...
                        <select name="blankStatusSearch_text" id="blankStatusSearch_text" class="form-control">
                            ...
                            while ($_ROW1 = mysqli_fetch_assoc($_QRY1)) {
                                ?>
                            <option value='<?php echo $_ROW1['status_kod']; ?>'><?php echo $_ROW1['status_name']; ?>
                            </option>
                            <?php
                            }
                            ?>
                    ...
                    <div class="form-group space10" style="width:100%">
                        ...
                        <select name="blankTypeSearch_text" id="blankTypeSearch_text" class="form-control">
                            ...
                            while ($_ROW2 = mysqli_fetch_assoc($_QRY2)) {
                                ?>
                            <option value='<?php echo $_ROW2['type_kod']; ?>'><?php echo $_ROW2['type_name']; ?>
                            </option>
                            <?php
                            }
                            ?>
                ...
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                    <div class="input-group space10" style="width:100%">
                        ...
                        <input type="text" id="blankObjectSearch_text" class="form-control" placeholder="Все объекты"
                               name="blankObjectSearch_text">
                    </div>
                </div>
                <?php // ----- ----- ----- ----- ----- ; ; ; ; ?>
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                    <div class="input-group space10" style="width:100%">
                        ...
                        <input type="text" id="blankNameSearch_text" class="form-control"
                               placeholder="Введите текст для поиска" name="blankNameSearch_text">
                    </div>
                </div>
                <?php // ----- ----- ----- ----- ----- ; ; ; ; ?>
                    ...
                    <div class="form-group space10" style="width:100%">
                        ...
                        <select name="blankIspolSearch_text" id="blankIspolSearch_text" class="form-control">
                            ...
                            while ($_ROW3 = mysqli_fetch_assoc($_QRY3)) {
                                ?>
                            <option value='<?php echo $_ROW3['ispolnameshot']; ?>'>
                                <?php echo $_ROW3['ispolnameshot']; ?></option>
                            <?php
                            }
                            ?>
                        </select>
                    ...
                    <div class="form-group space10" style="width:100%">
                        ...
                        <select name="blankIspolRukSearch_text" id="blankIspolRukSearch_text" class="form-control">
                            ...
                            while ($_ROW4 = mysqli_fetch_assoc($_QRY4)) {
                                ?>
                            <option value='<?php echo $_ROW4['ispolrukname']; ?>'><?php echo $_ROW4['ispolrukname']; ?>
                            </option>
                            <?php
                            }
                            ?>
                ...
                <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                    <div class="input-group space10" style="width:100%">
                        <label for="blankUseTenderSearch_text"><b>Конкурсная основа :</b></label>
                        <select name="blankUseTenderSearch_text" id="blankUseTenderSearch_text" class="form-control">
                            <option value="">Все</option>
                            <option value="1">Выигранный тендер</option>
                            <option value="0">Без тендера</option>
                        </select>
                    </div>
                </div>
                <?php // } ?>
...
<div id="customForm_edit_blankwork">
    <div class="Section">
        <div class="Block100 block-maindoc">
            <legend>Привязка основного договора</legend>
        ...
        <div class="Block100 fieldset-table-row space10">
            ...
            <div class="fieldset-table-cell" style="width:100%">
                <div>
                    <div class="chekbox-inline-text">Отменить привязку к договору</div>
                </div>
            </div>
        </div>
        <?php if (checkIsItSuperadmin($_SESSION['id']) == 1) { ?>
        <div class="Block100 block-subdoc">
            <legend>Привязка субподрядного договора</legend>
            <fieldset class="field75">
                <editor-field name="dognet_docblankwork.koddocsubpodr"></editor-field>
            </fieldset>
            <fieldset class="field25 koddocFilter" style="padding-top:30px; padding-right:15px">
                <input id="blankview-edit-tab1-koddocsubpodr_filter" type="text" placeholder="Поиск" />
            </fieldset>
        </div>
        <?php } ?>
...
<section>
    ...
    <table id="blankview-edit-blankwork-table" class="table table-bordered table-condensed compact display"
...
<section>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div id="blankview-edit-blankwork-summadop">
            ...
            <div class="demo-html"></div>
            <table id="blankview-edit-blankwork-summadop-table" class="table table-striped" cellspacing="0"
                   width="100%">
                <thead>
                    <tr>
                        <th width="" class=""></th>
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        ...
        <div id="blankview-edit-blankwork-docfiles">
            ...
            <div class="demo-html"></div>
            <table id="blankview-edit-blankwork-docfiles-table" class="table table-striped" cellspacing="0"
                   width="100%">
                <thead>
                    <tr>
                        <th width="" class=""></th>
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        ...
        <div id="blankview-edit-blankwork-blankpril">
            ...
            <div class="demo-html"></div>
            <table id="blankview-edit-blankwork-blankpril-table" class="table table-striped" cellspacing="0"
                   width="100%">
                <thead>
                    <tr>
                        <th width="" class=""></th>
