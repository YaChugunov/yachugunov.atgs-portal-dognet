...
$(document).ready(function() {
    ...
    var editor_blankview_edit_pir = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.prod/tabs/process/dognet-blankview-edit-pir-process.php",
            data: function(d) {
    ...
    var editor_blankview_edit_pir_docfiles = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: "php/examples/simple/blankview/blankview-edit/.prod/tabs/process/dognet-blankview-edit-pir-docfiles-process.php",
    ...
    var table_blankview_edit_pir_docfiles = $('#blankview-edit-pir-docfiles-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.prod/tabs/process/dognet-blankview-edit-pir-docfiles-process.php",
            type: 'post',
            data: function(d) {
                var selected = table_blankview_edit_pir.row({
                    selected: true
    ...
    var editor_blankview_edit_pir_blankpril = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.prod/tabs/process/dognet-blankview-edit-pir-blankpril-process.php",
            data: function(d) {
                var selected = table_blankview_edit_pir.row({
                    selected: true
                });
    ...
    var editor_blankview_edit_pir_summadop = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.prod/tabs/process/dognet-blankview-edit-pir-summadop-process.php",
            data: function(d) {
                var selected = table_blankview_edit_pir.row({
                    selected: true
                });
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.prod/tabs/css/blankview-edit-tab5_pir.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.prod/tabs/css/blankview-edit-tab5_summadop.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.prod/tabs/css/blankview-edit-tab5_doc_files.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.prod/tabs/css/blankview-edit-tab5_pril_files.css">
<?php
// ----- ----- ----- ----- -----
