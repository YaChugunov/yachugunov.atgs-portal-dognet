...
$(document).ready(function() {
    ...
    var editor_blankview_edit_pnr = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.prod/tabs/process/dognet-blankview-edit-pnr-process.php",
            data: function(d) {
    ...
    var editor_blankview_edit_pnr_docfiles = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: "php/examples/simple/blankview/blankview-edit/.prod/tabs/process/dognet-blankview-edit-pnr-docfiles-process.php",
    ...
    var table_blankview_edit_pnr_docfiles = $('#blankview-edit-pnr-docfiles-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.prod/tabs/process/dognet-blankview-edit-pnr-docfiles-process.php",
            type: 'post',
            data: function(d) {
                var selected = table_blankview_edit_pnr.row({
                    selected: true
    ...
    var editor_blankview_edit_pnr_blankpril = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.prod/tabs/process/dognet-blankview-edit-pnr-blankpril-process.php",
            data: function(d) {
                var selected = table_blankview_edit_pnr.row({
                    selected: true
                });
    ...
    var editor_blankview_edit_pnr_summadop = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.prod/tabs/process/dognet-blankview-edit-pnr-summadop-process.php",
            data: function(d) {
                var selected = table_blankview_edit_pnr.row({
                    selected: true
                });
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.prod/tabs/css/blankview-edit-tab3_pnr.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.prod/tabs/css/blankview-edit-tab3_summadop.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.prod/tabs/css/blankview-edit-tab3_doc_files.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.prod/tabs/css/blankview-edit-tab3_pril_files.css">
<?php
// ----- ----- ----- ----- -----
