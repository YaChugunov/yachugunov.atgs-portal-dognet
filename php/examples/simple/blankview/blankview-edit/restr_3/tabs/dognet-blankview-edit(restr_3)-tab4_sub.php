...
// ----- ----- ----- ----- -----
/*
	$('#blankview-edit-pos-table').on( 'dblclick', 'tbody tr', function () {
...
/*
/* Общее для таблицы */
#blankview-edit-pos-table {  }
#blankview-edit-pos-table .details-control:hover { cursor:hand }
#blankview-edit-pos-table > tbody > tr.selected, #docview-details-tab3 > tbody > tr > .selected { color:#000;	background-color:#e9e9e9 }
/*
/*
/* Заголовок таблицы */
#blankview-edit-pos-table > thead {	background-color:#111;	color:#fff; font-family:'Oswald', sans-serif; border-bottom:none;	border-top:none }
#blankview-edit-pos-table > thead > tr > th { border-bottom:none; font-weight:400; font-size:1.0em; text-transform:uppercase }
#blankview-edit-pos-table .sorting:after, #blankview-edit-pos-table .sorting_asc:after, #blankview-edit-pos-table .sorting_desc:after { display:none }
#blankview-edit-pos-table > thead > tr > th.sorting_asc { padding-right:5px }
#blankview-edit-pos-table > thead > tr > th.sorting_desc { padding-right:5px }
/*
/*
/* Тело таблицы */
#blankview-edit-pos-table {  }
#blankview-edit-pos-table > tbody { font-family:'Helioscond', sans-serif; font-size:1.0em; font-weight:300; color:#666; border-bottom:none; border-top:none }
#blankview-edit-pos-table > tbody > tr > td { padding:5px; line-height:1.42857143; vertical-align:middle; border-top:none }
#blankview-edit-pos-table > thead > tr > th { padding:8px 5px; border-bottom:none }
#blankview-edit-pos-table > tbody > tr > td {  }
#blankview-edit-pos-table > tbody > tr > td:last-child { text-align:right }

#blankview-edit-pos-table > tfoot > tr > td { padding:5px 4px }
#blankview-edit-pos-table > tfoot > tr > td:last-child { text-align:right }
#blankview-edit-pos-table > tfoot {
...
----- ----- ----- ----- ----- ----- ----- ----- ----- -----
*/
	#blankview-edit-pos-table > thead > tr > th:first-child, #blankview-edit-pos-table > tbody > tr > td:first-child { width:1%; text-align:center }
	#blankview-edit-pos-table > thead > tr > th:nth-child(2), #blankview-edit-pos-table > tbody > tr > td:nth-child(2) { width:3%; text-align:center; border-left:1px #fff solid }
	#blankview-edit-pos-table > thead > tr > th:nth-child(3), #blankview-edit-pos-table > tbody > tr > td:nth-child(3) { width:4%; text-align:center; border-left:1px #fff solid }
	#blankview-edit-pos-table > thead > tr > th:nth-child(4), #blankview-edit-pos-table > tbody > tr > td:nth-child(4) { width:45%; text-align:left; border-left:1px #fff solid }
	#blankview-edit-pos-table > thead > tr > th:nth-child(5), #blankview-edit-pos-table > tbody > tr > td:nth-child(5) { width:19%; text-align:left; border-left:1px #fff solid }
	#blankview-edit-pos-table > thead > tr > th:nth-child(6), #blankview-edit-pos-table > tbody > tr > td:nth-child(6) { width:5%; text-align:center; border-left:1px #fff solid }
	#blankview-edit-pos-table > thead > tr > th:nth-child(7), #blankview-edit-pos-table > tbody > tr > td:nth-child(7) { width:4%; text-align:center; border-left:1px #fff solid }
	#blankview-edit-pos-table > thead > tr > th:nth-child(8), #blankview-edit-pos-table > tbody > tr > td:nth-child(8) { width:7%; text-align:center; border-left:1px #fff solid }
	#blankview-edit-pos-table > thead > tr > th:nth-child(9), #blankview-edit-pos-table > tbody > tr > td:nth-child(9) { width:8%; text-align:center; border-left:1px #fff solid }
	#blankview-edit-pos-table > thead > tr > th:nth-child(10), #blankview-edit-pos-table > tbody > tr > td:nth-child(10) { width:7%; text-align:center; border-left:1px #fff solid }
	#blankview-edit-pos-table > thead > tr > th:nth-child(11), #blankview-edit-pos-table > tbody > tr > td:nth-child(11) { width:5%; text-align:center; border-left:1px #fff solid }
	#blankview-edit-pos-table .details-control:hover { cursor:pointer }

/*
----- ----- ----- ----- ----- ----- ----- ----- ----- -----
*/
	#blankview-edit-pos-table .sorting_asc:after { display:none }
	#blankview-edit-pos-table > thead > tr > th.sorting_asc { padding-right:8px }
/*
----- ----- ----- ----- ----- ----- ----- ----- ----- -----
*/
...
#blankview-docfiles-table .sorting:after, #blankview-edit-pos-table .sorting_asc:after, #blankview-edit-pos-table .sorting_desc:after { display:none }
...
#blankview-blankpril-table .sorting:after, #blankview-edit-pos-table .sorting_asc:after, #blankview-edit-pos-table .sorting_desc:after { display:none }
...
#blankview-edit-pos-table .group { font-family:'Oswald', sans-serif; font-size:1.3em; font-weight:400; color:#000 }
#blankview-edit-pos-table > tbody > tr.dtrg-start.dtrg-level-0 > td { font-family:'Oswald', sans-serif; font-size:1.3em; font-weight:400; text-align:left; background-color:#d9d9d9; color:#111; padding:5px }
#blankview-edit-pos-table > tbody > tr.dtrg-end.dtrg-level-0 > td { font-family:'Oswald', sans-serif; font-size:1.4em; font-weight:500; color:#000; background-color:#f1f1f1 }
#blankview-edit-pos-table > tbody > tr.dtrg-end.dtrg-level-0 > td { font-family:'Oswald', sans-serif; font-size:1.4em; font-weight:500; color:#000; background-color:#f1f1f1 }
.itogo-lvl0 {  }
