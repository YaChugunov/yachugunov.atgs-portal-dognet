	...
	<div class="container">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12">
				<?php // include("dognet-blankview-edit(restr_5)-main.php"); ?>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12">
						<ul id="blankview-tabs-menu" class="nav nav-tabs">
							...
							<li><a data-toggle="tab" href="#blankview-edit-tab-2" title="">Поставка</a></li>
							<li><a data-toggle="tab" href="#blankview-edit-tab-3" title="">ПНР</a></li>
							<li><a data-toggle="tab" href="#blankview-edit-tab-4" title="">Субподряд</a></li>
							<li><a data-toggle="tab" href="#blankview-edit-tab-5" title="">ПИР</a></li>
						...
						<div class="tab-content">
							<div id="blankview-edit-tab-1" class="tab-pane fade in active">
									<?php include("tabs/dognet-blankview-edit(restr_5)-tab1_blankwork.php"); ?>
							</div>
							<div id="blankview-edit-tab-2" class="tab-pane fade">
									<?php include("tabs/dognet-blankview-edit(restr_5)-tab2_pos.php"); ?>
							</div>
							<div id="blankview-edit-tab-3" class="tab-pane fade">
									<?php include("tabs/dognet-blankview-edit(restr_5)-tab3_pnr.php"); ?>
							</div>
							<div id="blankview-edit-tab-4" class="tab-pane fade">
									<?php // include("tabs/message_section-underconstruction.php"); ?>
									<?php include("tabs/dognet-blankview-edit(restr_5)-tab4_sub.php"); ?>
							</div>
							<div id="blankview-edit-tab-5" class="tab-pane fade in">
									<?php include("tabs/message_section-thinkaboutit.php"); ?>
							</div>
							<div id="blankview-edit-tab-6" class="tab-pane fade in">
									<?php include("tabs/dognet-blankview-edit(restr_5)-tab6_blankarchive.php"); ?>
							</div>
							<div id="blankview-edit-tab-7" class="tab-pane fade in">
									<?php include("dognet-blankview-edit(restr_5)-help.php"); ?>
