<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		var editor_blankview_edit_sub = new $.fn.dataTable.Editor({
			...
			i18n: {
				create: {
					title: "<h3>Создать новую заявку/бланк на договор субподряд</h3>"
				},
				edit: {
		...
		// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
		editor_blankview_edit_sub.on('open', function() {
			$('#blankview-edit-tab4-kodzakaz_filter').val('');
			...
			$('#DTE_Field_dognet_blankdocsub-kodzakaz').filterByText(editor_blankview_edit_sub, $('#blankview-edit-tab4-kodzakaz_filter'), 'dognet_blankdocsub.kodzakaz', false);
		});
		// ----- ----- ----- ----- -----
					...
					action: function(e, dt, node, config) {
						...
						editor_blankview_edit_sub
							.edit(table_blankview_edit_sub.rows({
								...
								title: '<h3>Оформить бланк на субподряд</h3>',
...
<section>
	...
	<table id="blankview-edit-sub-table" class="table table-striped" cellspacing="0" width="100%">
		<thead>
			<tr>
