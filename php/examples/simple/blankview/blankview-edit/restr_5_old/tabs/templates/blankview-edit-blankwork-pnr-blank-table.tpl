'<div id="template-details">'+
	...
	'<div id="blankview-details-pnr-tabs">'+
	'<div class="row">'+
		'<div class="col-xs-12 col-sm-12 col-md-12">'+
			'<ul id="blankview-details-pnr-tabs-menu" class="nav nav-tabs">'+
							...
							'<table id="template-details-tab1-table" class="table">'+
								'<tbody>'+
									...
									'<tr>'+
										...
										'<td width="89%"><span class="template-details-tab1-table-txt"><span class="txt-parameter">'+d.dognet_blankdocpnr.cdateispoldoc1+'</span>дней от аванса</span></td>'+
									'</tr>'+
									'<tr>'+
										'<td width="5%"><span class="template-details-tab1-table-title"></span></td>'+
										'<td width="5%"><span class="template-details-tab1-table-title">3)</span></td>'+
