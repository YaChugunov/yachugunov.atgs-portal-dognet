<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
		editor_blankview_edit_pos.on('open', function() {
			$('#blankview-edit-tab2-kodzakaz_filter').val('');
			...
			$('#DTE_Field_dognet_blankdocpost-kodzakaz').filterByText(editor_blankview_edit_pos, $('#blankview-edit-tab2-kodzakaz_filter'), 'dognet_blankdocpost.kodzakaz', false);
		});
		// ----- ----- ----- ----- -----
		...
		editor_blankview_edit_pos.dependent('dognet_blankdocpost.kodusespzakaz', function(val) {
			if (val == 0) {
				...
				$('#blankview-edit-tab2-kodzakaz_filter').prop('disabled', true);
			} else {
				editor_blankview_edit_pos.field('dognet_blankdocpost.kodzakaz').enable();
				$('#blankview-edit-tab2-kodzakaz_filter').prop('disabled', false);
			}
		});
					...
					action: function(e, dt, node, config) {
						...
						editor_blankview_edit_pos
							.edit(table_blankview_edit_pos.rows({
								...
								title: '<h3>Оформить бланк на поставку</h3>',
					...
					<div class="Block75">
						...
						<div class="Block60">
							...
							<fieldset class="field30 kodzakazFilter" style="padding-top:30px; padding-right:15px">
								<input id="blankview-edit-tab2-kodzakaz_filter" type="text" placeholder="Поиск" />
							</fieldset>
						</div>
						<div class="Block100">
