...
// ПОЛНОЕ РЕДАКТИРОВАНИЕ БЛАНКА ::: Редактор
	var editor_blankview_edit = new $.fn.dataTable.Editor( {
		display: "bootstrap",
		ajax: "php/examples/simple/blankview/blankview-edit/.dev/tabs/process/dognet-blankview-edit-process.php",
...
// 		dom: "<'space50'r>tip",
		...
		ajax: {
			url: "php/examples/simple/blankview/blankview-edit/.dev/tabs/process/dognet-blankview-edit-process.php",
			type: "POST"
		},
		serverSide: true,
		columns: [
...
// БЛАНК РАБОЧИЙ ::: Редактор
	var editor_blankview_docfiles = new $.fn.dataTable.Editor( {
		display: "bootstrap",
		ajax: "php/examples/simple/blankview/blankview-edit/.dev/tabs/process/dognet-blankview-docfiles-process.php",
...
// 		dom: "<'space50'r>tip",
		language: {	url: "russian.json" },
		ajax: {
			url: "php/examples/simple/blankview/blankview-edit/.dev/tabs/process/dognet-blankview-docfiles-process.php",
			type: 'post',
      data: function ( d ) {
...
// ПРИЛОЖЕНИЯ БЛАНКА ::: Редактор
	var editor_blankview_blankpril = new $.fn.dataTable.Editor( {
		display: "bootstrap",
		ajax: "php/examples/simple/blankview/blankview-edit/.dev/tabs/process/dognet-blankview-blankpril-process.php",
...
// 		dom: "<'space50'r>tip",
		language: {	url: "russian.json" },
		ajax: {
			url: "php/examples/simple/blankview/blankview-edit/.dev/tabs/process/dognet-blankview-blankpril-process.php",
			type: 'post',
      data: function ( d ) {
          var selected = table_blankview_gip.row( { selected: true } );
          if ( selected.any() ) {
