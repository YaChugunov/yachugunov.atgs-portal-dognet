...
$(document).ready(function() {
    ...
    var editor_blankview_edit_pos = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.dev/tabs/process/dognet-blankview-edit-pos-process.php",
            data: function(d) {
    ...
    var editor_blankview_edit_pos_docfiles = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: "php/examples/simple/blankview/blankview-edit/.dev/tabs/process/dognet-blankview-edit-pos-docfiles-process.php",
    ...
    var table_blankview_edit_pos_docfiles = $('#blankview-edit-pos-docfiles-table').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.dev/tabs/process/dognet-blankview-edit-pos-docfiles-process.php",
            type: 'post',
            data: function(d) {
                var selected = table_blankview_edit_pos.row({
                    selected: true
    ...
    var editor_blankview_edit_pos_blankpril = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.dev/tabs/process/dognet-blankview-edit-pos-blankpril-process.php",
            data: function(d) {
                var selected = table_blankview_edit_pos.row({
                    selected: true
                });
    ...
    var editor_blankview_edit_pos_summadop = new $.fn.dataTable.Editor({
        display: "bootstrap",
        ajax: {
            url: "php/examples/simple/blankview/blankview-edit/.dev/tabs/process/dognet-blankview-edit-pos-summadop-process.php",
            data: function(d) {
                var selected = table_blankview_edit_pos.row({
                    selected: true
                });
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.dev/tabs/css/blankview-edit-tab2_pos.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.dev/tabs/css/blankview-edit-tab2_summadop.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.dev/tabs/css/blankview-edit-tab2_doc_files.css">
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.dev/tabs/css/blankview-edit-tab2_pril_files.css">
<?php
// ----- ----- ----- ----- -----
