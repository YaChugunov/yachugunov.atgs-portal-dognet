...
// 		dom: "<'space50'r>tip",
		...
		ajax: {
			url: "php/examples/simple/blankview/blankview-edit/.dev/tabs/process/dognet-blankview-edit-blankarchive-process.php",
			type: "POST"
		},
		serverSide: true,
		columns: [
...
// 		dom: "<'space50'r>tip",
		...
		ajax: {
			url: "php/examples/simple/blankview/blankview-edit/.dev/tabs/process/dognet-blankview-edit-blankarchive-docfiles-process.php",
			type: 'post',
      data: function ( d ) {
...
// 		dom: "<'space50'r>tip",
		...
		ajax: {
			url: "php/examples/simple/blankview/blankview-edit/.dev/tabs/process/dognet-blankview-edit-blankarchive-blankpril-process.php",
			type: 'post',
      data: function ( d ) {
          var selected = table_blankview_edit_blankarchive.row( { selected: true } );
          if ( selected.any() ) {
...
// 		dom: "<'space50'r>tip",
		...
		ajax: {
			url: "php/examples/simple/blankview/blankview-edit/.dev/tabs/process/dognet-blankview-edit-blankarchive-summadop-process.php",
			type: 'post',
      data: function ( d ) {
          var selected = table_blankview_edit_blankarchive.row( { selected: true } );
          if ( selected.any() ) {
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.dev/tabs/css/blankview-edit-tab6_blankarchive.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.dev/tabs/css/blankview-edit-tab6_summadop.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.dev/tabs/css/blankview-edit-tab6_doc_files.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/blankview/blankview-edit/.dev/tabs/css/blankview-edit-tab6_pril_files.css">
<?php
//
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
//
