...
/* Изменено 20.06.2019 --- */
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12">
				<?php // include("dognet-blankview-edit-main.php"); ?>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12">
