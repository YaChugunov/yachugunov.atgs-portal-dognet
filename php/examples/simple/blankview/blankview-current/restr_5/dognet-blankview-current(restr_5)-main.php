...
// ПОЛНОЕ РЕДАКТИРОВАНИЕ БЛАНКА ::: Редактор
	var editor_blankview_edit = new $.fn.dataTable.Editor( {
		display: "bootstrap",
		ajax: "php/examples/php/blankview/blankview-current/dognet-blankview-current-process.php",
...
// 		dom: "<'space50'r>tip",
		...
		ajax: {
			url: "php/examples/php/blankview/blankview-current/dognet-blankview-current-process.php",
			type: "POST"
		},
		serverSide: true,
		columns: [
      {
		...
		buttons: [
			...
			{ extend: "create", editor: editor_blankview_edit, text: "НОВЫЙ БЛАНК",
				formButtons:
					[ 'Создать',
