...
<script type="text/javascript" language="javascript" class="">
    ...
    function ajaxRequest_checkUpdateOnReadAsync(updateid, userid, action) {
        ...
        $.ajax({
            ...
            cache: false,
            type: "post",
            url: "<?php echo __ROOT; ?>/dognet/php/examples/simple/updates/ajaxrequests/ajaxReq-checkUpdateOnRead.php",
            data: {
                updateid: updateid,
                userid: userid,
                action: action
    ...
    function showUpdateInModal(parUpdateID, parProgressOn, parModalID, parUpdatePath, parUpdateFilename) {
        ...
        $.getJSON('<?php echo __ROOT; ?>/dognet/php/examples/simple' + parUpdatePath + '/' + parUpdateFilename,
            function(data) {
...
<link href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/updates/dognet-updates.css" rel="stylesheet">
