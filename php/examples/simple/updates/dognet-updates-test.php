...
function ajaxRequest_checkUpdateOnReadAsync(updateid, userid, action) {
    ...
    $.ajax({
        ...
        cache: false,
        type: "post",
        url: "<?php echo __ROOT; ?>/dognet/php/examples/simple/updates/ajaxrequests/ajaxReq-checkUpdateOnRead-test.php",
        data: {
            updateid: updateid,
            userid: userid,
            action: action
...
<link href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/updates/dognet-updates.css"
      rel="stylesheet">
