...
$(document).ready(function() {
    ...
    table_tab7_report_missions = $('#report-missions').DataTable({
        ...
        ajax: {
            url: "php/examples/simple/base/missions/restr_1/includes/process/dognet-base-missions(restr_1)-view-process.php",
            type: "POST"
        },
        serverSide: true,
        columns: [{
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/base/missions/restr_1/includes/css/base-missions-main.css">
<section>
