...
<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		table_tab7_report_missions = $('#report-missions').DataTable({
			...
			ajax: {
				url: "php/examples/simple/base/missions/restr_5/includes/process/dognet-base-missions(restr_5)-view-process.php",
				type: "POST"
			},
			serverSide: true,
			columns: [{
...
// :::
include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/base/missions/restr_5/includes/forms/base-missions-filters.php");
// ----- ----- ----- ----- -----
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/base/missions/restr_5/includes/css/base-missions-main.css">
<section>
