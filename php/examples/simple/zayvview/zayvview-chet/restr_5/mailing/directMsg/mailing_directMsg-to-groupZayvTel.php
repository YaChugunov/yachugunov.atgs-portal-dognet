...
#
#
$subjectTxt = "АТГС.Договор [Заявки] : обновление по заявке № " . $_ROW_TIPZAYV['nametipzayvshotall'] . "-" . $_ROW_ZAYV['numberzayv'] . " от " . date('d.m.Y', strtotime($_ROW_ZAYV['datezayv']));
	...
	<table id="mail-preview-info" class="table table-responsive">
		<tbody>
			...
			<tr style="">
				...
				<td width="70%" class="text-left"><span><?php echo "Весь список Заявителей"; ?></span></td>
			</tr>
		</tbody>
	</table>
</div>
