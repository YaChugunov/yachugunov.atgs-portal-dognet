						...
						'<div class="hidden-xs col-sm-12 col-md-12 col-lg-12">'+
							...
							'<div style="padding:10px">'+
								'<table id="row-details-zayvview-chet-main-table" class="table table-condensed table-striped" >'+
									'<tbody>'+
										'<tr>'+
											'<td width="30%"><span class="row-details-zayvview-chet-main-table-title_topic">Внутренний ID счета</span></td>'+
											'<td width="70%"><span class="row-details-zayvview-chet-main-table-txt">'+d.dognet_doczayvchet.kodzayvchet+'</span></td>'+
										'</tr>'+
										'<tr>'+
