...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-chet/restr_5/css/zayvview-chet-main-customform.css">
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-chet/restr_5/css/zayvview-chet-chetf-customform.css">
...
<div id="tab-1" class="tab-pane fade in active">
	...
	<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-chet/restr_5/css/zayvview-chet-main.css">
	<?php // ----- ----- ----- ----- ----- 
	?>
	...
	<?php // ----- ----- ----- ----- ----- 
	?>
	<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-chet/restr_5/css/zayvview-chet-chetf.css">
	<div class="space30"></div>
	<div class="col-xs-12 space30" style="padding:10px; background-color:#fafafa">
...
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-chet/restr_5/css/zayvview-chet-transfer-zayvfrom.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-chet/restr_5/css/zayvview-chet-transfer-zayvto.css">
<div id="tab-2" class="tab-pane fade">
	<div class="space30"></div>
	<div class="col-xs-12 space30" style="padding:10px; background-color:#fafafa">
		<h4 class="text-uppercase" style="color:#31708f; font-family:'Oswald', sans-serif; font-weight:400; letter-spacing:0.4em">Перенос счета с заявки на заявку</h4>
	</div>
...
<div id="tab-3" class="tab-pane fade">
	...
	<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-chet/restr_5/css/zayvview-chet-archive.css">
	<?php // ----- ----- ----- ----- ----- 
	?>
	<div class="demo-html"></div>
	...
	<?php // ----- ----- ----- ----- ----- 
	?>
	<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-chet/restr_5/css/zayvview-chet-archive-chetf.css">
	<div class="space30"></div>
	<div class="col-xs-12 space30" style="padding:10px; background-color:#fafafa">
		<h4 class="text-uppercase" style="color:#31708f; font-family:'Oswald', sans-serif; font-weight:400; letter-spacing:0.4em">Счета-фактуры к выбранному счету</h4>
	</div>
