...
date_default_timezone_set('Europe/Moscow');
	...
	$__subsubtitle = "Работа со счетами";
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
							<ul id="main-tabs-menu" class="nav nav-tabs">
								<li id="link-to-tab1" class="active"><a data-toggle="tab" href="#tab-1" title="">Счета <?php echo (date("Y")-1)."-".date("Y"); ?></a></li>
								<li id="link-to-tab2"><a data-toggle="tab" href="#tab-2" title="">Перенос счета</a></li>
								<li id="link-to-tab3" style="float:right"><a data-toggle="tab" href="#tab-3" title="">Архив счетов</a></li>
							</ul>
							<div class="tab-content">
<?php include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-chet/restr_5/dognet-zayvview-chet(restr_5)-main.php")?>
							</div>
						</div>
					</div>
				</div>
