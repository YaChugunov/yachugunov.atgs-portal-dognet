					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
							<ul id="main-tabs-menu" class="nav nav-tabs">
								<li id="link-to-tab1" class="active"><a data-toggle="tab" href="#tab-1" title="">Счета <?php echo (date("Y")-2)."-".date("Y"); ?></a></li>
...
<?php include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-chet/restr_4/dognet-zayvview-chet(restr_4)-main.php")?>
							</div>
						</div>
					</div>
				</div>
