...
?>
	<div class="space10" style="padding:30px; background-color:#f1f1f1">
		<table id="mail-preview-info" class="table table-responsive">
			<tbody>
				<tr style="">
					<td width="30%" class="text-left"><span><b>Получатель (ID) :</b></span></td>
					<td width="70%" class="text-left"><span><?php echo "---"; ?></span></td>
				</tr>
				<tr style="">
				...
				<tr style="">
					...
					<td width="70%" class="text-left"><span><?php echo "[получатель рассылки]"; ?></span></td>
				</tr>
			</tbody>
		</table>
	</div>
