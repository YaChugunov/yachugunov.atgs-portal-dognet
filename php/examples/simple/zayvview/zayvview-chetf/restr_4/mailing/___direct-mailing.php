						...
						<div class="col-xs-hidden col-sm-12 col-md-12 col-lg-12">
							<div class="form-group text-left">
							  ...
							  <select class="form-control" id="msgTo" name="msgTo">
										...
										<option value="1">Уведомление только Заявителю</option>
										<option value="2">Уведомление отделу "ИТиТО"</option>
							  </select>
							</div>
							<div>
								<button class="btn btn-default" type="submit" name="done" value="ok">Предварительный просмотр</button>
							</div>
						</div>
					</form>
				</div>
...
<?php
				if (isset($_GET['msgTo'])) {
					switch ($_GET['msgTo']) {
						case "0":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-chetf/restr_4/mailing/directMsg/mailing_directMsg-to-ZayvTel.php");
							break;
						case "1":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-chetf/restr_4/mailing/directMsg/mailing_directMsg-to-ZayvTel.php");
							break;
