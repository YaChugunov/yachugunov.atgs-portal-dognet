		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 space20">
				<div id="report-settings" class="text-center">
					...
					<h4 class="space10">Обновление информации по счету-фактуре</h4>
				</div>
			</div>
			<div class="col-xs-hidden col-sm-12 col-md-12 col-lg-12">
				<div id="export-format-block" class="center-block" style="">
					<form class="form-horizontal" method="GET" action="/dognet/dognet-zayvview.php">
						<input type="hidden" name="zayvview_type" value="chetf">
						...
						<div class="col-xs-hidden col-sm-12 col-md-12 col-lg-12">
							<div class="form-group text-left">
							  ...
							  <select class="form-control" id="msgSubject" name="msgSubject">
										<option value="">---</option>
										<option value="1">Новый счет-фактура (поступила оплата)</option>
										<option value="2">Перенос счета-фактуры на другой счет</option>
										<option value="3">Изменение статуса счета-фактуры (проверен/не проверен)</option>
										<option value="4">Прочие изменения данных по счету-фактуре</option>
							  </select>
							</div>
							<div class="form-group text-left">
...
<?php
				if (isset($_GET['msgTo'])) {
					switch ($_GET['msgTo']) {
						case "0":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-chetf/restr_5/mailing/directMsg/mailing_directMsg-to-Chugunov.php");
							break;
						case "1":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-chetf/restr_5/mailing/directMsg/mailing_directMsg-to-ZayvTel.php");
							break;
						case "2":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-chetf/restr_5/mailing/directMsg/mailing_directMsg-to-groupZayvTel.php");
							break;
						case "3":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-chetf/restr_5/mailing/directMsg/mailing_directMsg-to-selectedZayvTel.php");
							break;
						default:
