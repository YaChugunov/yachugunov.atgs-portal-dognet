...
<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		//
		table_chet_linked.on('draw', function() {
			if (table_chet_linked.page.info().recordsTotal > 0) {
				$('#zayvview-chet-linked thead').css('display', '');
			} else {
				$('#zayvview-chet-linked thead').css('display', 'none');
			}
		});
		table_zayv_linked.on('draw', function() {
			if (table_zayv_linked.page.info().recordsTotal > 0) {
				$('#zayvview-zayv-linked thead').css('display', '');
			} else {
				$('#zayvview-zayv-linked thead').css('display', 'none');
			}
		});
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-chetf/restr_3/css/zayvview-chetf-main-customform.css">
...
<div id="tab-1" class="tab-pane fade in active">
	...
	<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-chetf/restr_3/css/zayvview-chetf-main.css">
	...
	<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-chetf/restr_3/css/zayvview-chet-linked.css">
	<div class="space30"></div>
	<div class="col-xs-12 space30" style="padding:10px; background-color:#fafafa">
	...
	<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-chetf/restr_3/css/zayvview-zayv-linked.css">
	<div class="space30"></div>
	<div class="col-xs-12 space30" style="padding:10px; background-color:#fafafa">
...
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-chetf/restr_3/css/zayvview-chetf-transfer-chetfrom.css">
...
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-chetf/restr_3/css/zayvview-chetf-transfer-chetto.css">
<div id="tab-3" class="tab-pane fade">
	...
	<div class="col-xs-12 space30" style="padding:10px; background-color:#fafafa">
		...
		<div class="col-xs-12 col-sm-4 col-md-2 col-lg-2">
			<div class="input-group space10" style="width:100%">
				<label for="chfNumberSearchInArchive_text"><b>Номер СФ :</b></label>
	...
	<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-chetf/restr_3/css/zayvview-chetf-archive.css">
	<div class="demo-html"></div>
