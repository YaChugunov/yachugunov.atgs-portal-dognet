...
<?php
				if (isset($_GET['msgTo'])) {
					switch ($_GET['msgTo']) {
						case "0":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-chetf/restr_3/mailing/directMsg/mailing_directMsg-to-Chugunov.php");
							break;
						case "1":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-chetf/restr_3/mailing/directMsg/mailing_directMsg-to-ZayvTel.php");
							break;
						case "2":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-chetf/restr_3/mailing/directMsg/mailing_directMsg-to-groupZayvTel.php");
							break;
						case "3":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-chetf/restr_3/mailing/directMsg/mailing_directMsg-to-selectedZayvTel.php");
							break;
						default:
