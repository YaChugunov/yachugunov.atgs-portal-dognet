	...
	$(document).ready(function() {
		...
		table_zayv_main = $('#zayvview-zayv-main').DataTable({
			...
			buttons: [{
					...
					action: function(e, dt, node, config) {
						...
						table_zayv_main.columns(2).search(moment().format("YYYY"));
						table_zayv_main.ajax.reload(null, false);
					}
				},
				{
		...
		editor_zayv_child_files = new $.fn.dataTable.Editor({
			...
			fields: [{
				...
				name: "dognet_doczayvdopspec.docFileID",
				type: "upload",
				display: function(id) {
					return '<a target="_blank" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet' + editor_zayv_child_files.file('dognet_doczayv_files', id).file_webpath + '"><h4>СКАЧАТЬ ФАЙЛ</h4></a>';
				},
				dragDrop: false,
				dragDropText: "",
		...
		editor_zayv_child_files.on('initCreate', function(e) {
			...
			editor_zayv_child_files.field('dognet_doczayvdopspec.docFileID').hide();
			editor_zayv_child_files.field('dognet_doczayvdopspec.docFileID').disable();
		});
		editor_zayv_child_files.on('initEdit', function(e, node, data, items, type) {
			...
			editor_zayv_child_files.field('dognet_doczayvdopspec.docFileID').show();
			editor_zayv_child_files.field('dognet_doczayvdopspec.docFileID').enable();
		});
		...
		table_zayv_child_files = $('#zayvview-zayv-child-files').DataTable({
			...
			columns: [{
				...
				{
					data: "dognet_doczayvdopspec.docFileID",
					render: function(id) {
						return id ?
							'<a class="" target="_blank" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet' + editor_zayv_child_files.file('dognet_doczayv_files', id).file_webpath + '"><span class="glyphicon glyphicon-file"></span></a>' :
		...
		// ----- ----- -----
		table_zayv_child_files.on('draw', function() {
			table_zayv_child_files.column(1, {
				search: 'applied',
				order: 'applied'
		...
		table_zayv_main.on('select', function() {
			...
			var kodrabzayv = selected.data().dognet_doczayv.kodrabzayv;
			if (kodrabzayv == 1) {
				$("#zayvview-zayv-child-dop-spec").css('display', 'block');
				$("#zayvview-zayv-child-dop-msg").css('display', 'none');
			} else {
				$("#zayvview-zayv-child-dop-spec").css('display', 'none');
				$("#zayvview-zayv-child-dop-msg").css('display', 'block');
			}
			var kodrabfile = selected.data().dognet_doczayv.kodrabfile;
			if (kodrabfile == 1) {
				$("#zayvview-zayv-child-files-spec").css('display', 'block');
				$("#zayvview-zayv-child-files-msg").css('display', 'none');
			} else {
				$("#zayvview-zayv-child-files-spec").css('display', 'none');
				$("#zayvview-zayv-child-files-msg").css('display', 'block');
			}
			...
			//
			$("#zayvview-zayv-child-chet-msg-noselect").css('display', 'none');
			$("#zayvview-zayv-child-chet-block").css('display', 'block');
			//
			$("#zayvview-zayv-child-dop-msg-noselect").css('display', 'none');
			//
			$("#zayvview-zayv-child-files-msg-noselect").css('display', 'none');
		});
		table_zayv_main.on('deselect', function() {
			$("#zayvview-zayv-child-dop-msg-noselect").css('display', 'block');
			$("#zayvview-zayv-child-dop-msg").css('display', 'none');
			//
			$("#zayvview-zayv-child-dop-spec").css('display', 'none');
			//
			$("#zayvview-zayv-child-chet-msg-noselect").css('display', 'block');
			$("#zayvview-zayv-child-chet-block").css('display', 'none');
			//
			$("#zayvview-zayv-child-files-msg-noselect").css('display', 'block');
			$("#zayvview-zayv-child-files-msg").css('display', 'none');
			//
			$("#zayvview-zayv-child-files-spec").css('display', 'none');
			...
			<div id="customForm-zayv-child-files-editor-tab-1" class="tab-pane fade in active">
				<div class="Section">
					<div class="Block100">
						...
						<fieldset class="field100">
							<editor-field name="dognet_doczayvdopspec.docFileID"></editor-field>
						</fieldset>
					</div>
				</div>
			</div>
...
<div id="tab-1" class="tab-pane fade in active">
	...
	<div id="zayvsearch-filters-block" class="panel-group">
		<div class="panel panel-default">
			...
			<div id="zayvsearch-filters" class="panel-collapse collapse">
				...
				<div id="zayvview-current-filters" class="panel-body space30" style="background-color:#fafafa">
					...
					<div class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
						<div class="form-group space10" style="width:100%">
							...
							<input type="text" id="docNumberSearch_text" class="form-control" placeholder="Все договора" name="docNumberSearch_text">
						</div>
					</div>
					<div class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
...
<div id="tab-2" class="tab-pane fade">
	...
	<div id="zayvview-zayv-child-dop-msg" style="display:none">
		<table id="zayvview-zayv-child-dop-msg" class="table table-responsive display compact" cellspacing="0" width="100%">
			<tbody>
				<tr>
					<td colspan="5" class="zayv-warning-message text-danger text-center">Не установлен флаг "Спецификация в виде списка". Либо спецификация в виде списка к данной заявке не создавалась.</td>
				</tr>
				<tr>
					<td colspan="5" class="zayv-warning-message-small text-default text-center">Если вы хотите создать список, то сначала надо установить соответствующий флаг в форме редактирования заявки.</td>
				</tr>
				<tr>
					<td colspan="5" class="text-center">
						<img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/_assets/images/doczayv_editform_img01.jpg">
					</td>
				</tr>
			</tbody>
		</table>
	</div>
	<div id="zayvview-zayv-child-dop-msg-noselect" style="display:block">
		<table id="zayvview-zayv-child-dop-msg" class="table table-responsive display compact" cellspacing="0" width="100%">
			<tbody>
				<tr>
					<td colspan="5" class="zayv-warning-message text-danger text-center">Не выбрана заявка в соответствующей вкладке</td>
				</tr>
			</tbody>
		</table>
	</div>
...
<div id="tab-3" class="tab-pane fade">
	...
	<div id="zayvview-zayv-child-files-msg" style="display:none">
		<table id="zayvview-zayv-child-files-msg" class="table table-responsive display compact" cellspacing="0" width="100%">
			<tbody>
				<tr>
					<td colspan="5" class="zayv-warning-message text-danger text-center">Не установлен флаг "Спецификация в виде файлов". Либо ни основного ни дополнительных файлов спецификаций по данной заявке не найдено.</td>
				</tr>
				<tr>
					<td colspan="5" class="zayv-warning-message-small text-default text-center">Основной файл спецификации можно прикрепить прямо в форме редактирования заявки. Здесь можно добавить также и дополнительные спецификации. В обоих слуаях сначала необходимо установить соответствующий флаг в форме редактирования заявки.</td>
				</tr>
				<tr>
					<td colspan="5" class="text-center">
						<img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/_assets/images/doczayv_editform_img02.jpg">
					</td>
				</tr>
			</tbody>
		</table>
	</div>
	<div id="zayvview-zayv-child-files-msg-noselect" style="display:block">
		<table id="zayvview-zayv-child-dop-msg" class="table table-responsive display compact" cellspacing="0" width="100%">
			<tbody>
				<tr>
					<td colspan="5" class="zayv-warning-message text-danger text-center">Не выбрана заявка в соответствующей вкладке</td>
...
<div id="tab-4" class="tab-pane fade">
	...
	<div id="zayvview-zayv-child-chet-msg-noselect" style="display:block">
		<table id="zayvview-zayv-child-chet-msg" class="table table-responsive display compact" cellspacing="0" width="100%">
			<tbody>
				<tr>
					<td colspan="5" class="zayv-warning-message text-danger text-center">Не выбрана заявка в соответствующей вкладке</td>
				</tr>
