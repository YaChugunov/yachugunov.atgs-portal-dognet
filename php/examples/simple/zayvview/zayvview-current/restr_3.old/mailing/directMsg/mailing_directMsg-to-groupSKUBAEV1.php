		...
		<table id="mail-preview-info" class="table table-responsive">
			<tbody>
				<tr style="">
					...
					<td width="70%" class="text-left"><span><?php echo "Рассылка по списку Скубаева #1"; ?></span></td>
				</tr>
				<tr style="">
				...
				<tr style="">
					...
					<td width="70%" class="text-left"><span><?php echo "Список Скубаева #1"; ?></span></td>
				</tr>
			</tbody>
		</table>
	</div>
...
# ----- ----- ----- ----- -----
		...
		//
		$email_1 = "skubaev@atgs.ru";
		$email_2 = "zeldin@atgs.ru";
		$email_3 = "martin@atgs.ru";
		$email_4 = "nev@atgs.ru";
		$email_5 = "ras@atgs.ru";
		// $email_6 = "vam@atgs.ru";
...
// Content
	  ...
	  $mail3->Subject = $subject." / Skubaev email list #1 and snab@atgs.ru";
	  $mail3->Body    = $message3;
