...
<div style="color:#555555;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.2;padding-top:5px;padding-right:10px;padding-bottom:5px;padding-left:10px;">
<div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
<p style="font-size: 12px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 14px; margin: 0;"><span style="color: #000000;"><strong><span style="font-size: 12px;">'.$_zayvdate.'</span></strong></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
...
<div style="color:#555555;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.2;padding-top:5px;padding-right:10px;padding-bottom:5px;padding-left:10px;">
<div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
<p style="font-size: 12px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 14px; margin: 0;"><span style="color: #000000;"><strong><span style="font-size: 12px;">'.$_zayvnum.'</span></strong></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
...
<div style="color:#555555;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.2;padding-top:5px;padding-right:10px;padding-bottom:5px;padding-left:10px;">
<div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
<p style="font-size: 12px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 14px; margin: 0;"><span style="color: #000000;"><strong><span style="font-size: 12px;">'.$_zayvuser.'</span></strong></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
...
<div style="color:#555555;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.2;padding-top:5px;padding-right:10px;padding-bottom:5px;padding-left:10px;">
<div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
<p style="font-size: 12px; line-height: 1.2; word-break: break-word; text-align: left; mso-line-height-alt: 14px; margin: 0;"><strong><span style="color: #000000; font-size: 12px;">'.$_zayvdesc.'</span></strong></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
		...
		<table id="mail-preview-info" class="table table-responsive">
			<tbody>
				<tr style="">
					...
					<td width="70%" class="text-left"><span><?php echo "Рассылка по списку Мартина"; ?></span></td>
				</tr>
				<tr style="">
				...
				<tr style="">
					...
					<td width="70%" class="text-left"><span><?php echo "Список Мартина"; ?></span></td>
				</tr>
			</tbody>
		</table>
	</div>
...
# ----- ----- ----- ----- -----
		...
		//
		$email_1 = "martin@atgs.ru";
		$email_2 = "zeldin@atgs.ru";
		$email_3 = "skubaev@atgs.ru";
		$email_4 = "nev@atgs.ru";
		$email_5 = "ras@atgs.ru";
		// $email_6 = "vam@atgs.ru";
		// $email_7 = "gaikalov@atgs.ru";
...
// Content
	  ...
	  $mail3->Subject = $subject." / Martin email list and snab@atgs.ru";
	  $mail3->Body    = $message3;
...
# Открыли файл для записи данных в конец файла
	    ...
	    if (is_writable($filename)) {
	      ...
	      if (!$mail3->send()) {
	        ...
	        $text = date('Y-m-d h:i:s')." : ошибка рассылки на ( Список Мартина ) : ".$err;
          ...
          echo "<span style='color:red; text-align:center'><i>Не могу произвести запись в лог файл.</i></span>";
	        ...
	        $text = date('Y-m-d h:i:s')." : сообщение на ( Список Мартина ) успешно отправлено".PHP_EOL;
	      // Записываем $somecontent в наш открытый файл.
	        if (fwrite($handle, $text) === FALSE) {
	        echo "<span style='color:red; text-align:center'><i>Не могу произвести запись в лог-файл.</i></span>";
	          exit;
