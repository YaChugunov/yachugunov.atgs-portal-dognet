...
<div id="tab-1" class="tab-pane fade in active">
    ...
    <div class="" style="margin-top:15px">
        ...
        <div style="float: left">
            <p><span class="label label-icon"><span class="glyphicon glyphicon-pushpin" title="Заявка сформирована"></span></span><span style="font-size:0.9em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Заявка
                    сформирована</span></p>
        </div>
        <div style="float: left">
            <p><span class="label label-icon"><span class="text-warning glyphicon glyphicon-credit-card" title="Есть выставленные счета"></span></span><span style="font-size:0.9em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Есть
                    выставленные счета</span></p>
        </div>
        <div style="float: left">
            <p><span class="label label-icon"><span class="text-info glyphicon glyphicon-credit-card" title="Все счета выставлены"></span></span><span style="font-size:0.9em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Все
                    счета выставлены</span></p>
        </div>
        <div style="float: left">
            <p><span class="label label-icon label-icon-zayv2"><span class="glyphicon glyphicon-ok-circle" title="Заявка закрыта"></span></span><span style="font-size:0.9em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Заявка
                    закрыта</span></p>
        </div>
        <div style="float: left">
            <p><span class="label label-icon"><span class="text-danger glyphicon glyphicon-ban-circle" title="Заявка аннулирована"></span></span><span style="font-size:0.9em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Заявка
                    аннулирована</span></p>
        </div>
        <div style="float: left">
            <p><span class="label label-icon"><span class="glyphicon glyphicon-comment" title="Есть комментарий к заявке"></span></span><span style="font-size:0.9em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Есть
                    комментарий к заявке</span></p>
        </div>
        <div style="float: left">
            <p><span class="label label-icon"><span class="glyphicon glyphicon-file" title="Спецификация в виде файла"></span></span><span style="font-size:0.9em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Спецификация
                    в виде файла</span></p>
        </div>
        <div style="float: left">
            <p><span class="label label-icon"><span class="glyphicon glyphicon-list-alt" title="Спецификация в виде списка"></span></span><span style="font-size:0.9em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Спецификация
                    в виде списка</span></p>
        </div>
        <div style="float: left">
            <p><span class="label label-icon"><span class="glyphicon glyphicon-print" title="Распечатать заявку (в разработке)"></span></span><span style="font-size:0.9em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Распечатать
                    заявку (в разработке)</span></p>
        </div>
        <div style="float: left">
            <p><span class="label label-icon"><span class="glyphicon glyphicon-send" title="Разослать уведомления на email"></span></span><span style="font-size:0.9em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Разослать
...
<div id="tab-2" class="tab-pane fade">
    ...
    <div id="zayvview-zayv-child-dop-spec" style="">
        <div class="col-xs-12 space30" style="padding:10px; background-color:#fafafa">
            <h4 class="text-uppercase" style="color:#31708f; font-family:'Oswald', sans-serif; font-weight:400; letter-spacing:0.4em">
    ...
    <div class="text-danger" style="font-size:0.85em"><span class="glyphicon glyphicon-exclamation-sign" style="margin-right:10px"></span>Чтобы иметь возможность добавлять позиции в этот список, необходимо в
...
<div id="tab-3" class="tab-pane fade">
    ...
    <div id="zayvview-zayv-child-files-spec" style="">
        <div class="col-xs-12 space30" style="padding:10px; background-color:#fafafa">
            <h4 class="text-uppercase" style="color:#31708f; font-family:'Oswald', sans-serif; font-weight:400; letter-spacing:0.4em">
                Спецификации к заявке (в виде прикреплённых файлов)</h4>
        </div>
        <div class="demo-html"></div>
    ...
    <div class="space10"></div>
    <div class="text-danger" style="font-size:0.85em"><span class="glyphicon glyphicon-exclamation-sign" style="margin-right:10px"></span><b>UPD 30.05.24</b> Теперь в этом разделе к выбранной заявке можно
...
<div id="tab-4" class="tab-pane fade">
    ...
    <div class="space30"></div>
    <div class="col-xs-12 space30" style="padding:10px; background-color:#fafafa">
        <h4 class="text-uppercase" style="color:#31708f; font-family:'Oswald', sans-serif; font-weight:400; letter-spacing:0.4em">Счета-фактуры
        </h4>
    </div>
    <div class="demo-html"></div>
...
<div id="tab-5" class="tab-pane fade">
    ...
    <div class="space30"></div>
    <div class="col-xs-12 space30" style="padding:10px; background-color:#fafafa">
        <h4 class="text-uppercase" style="color:#31708f; font-family:'Oswald', sans-serif; font-weight:400; letter-spacing:0.4em">Спецификации
            из договора</h4>
    </div>
    <div class="demo-html"></div>
