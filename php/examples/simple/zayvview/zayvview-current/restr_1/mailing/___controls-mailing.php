						...
						<div class="col-xs-hidden col-sm-12 col-md-12 col-lg-12">
							<div class="form-group text-left">
							  ...
							  <select class="form-control" id="msgRecipient" name="msgRecipient">
										...
										<option value="1">Группа получателей 1</option>
...
<?php
				if (isset($_GET['msgRecipient'])) {
					switch ($_GET['msgRecipient']) {
						case "0":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-current/restr_1/mailing/msgtypes/mailing_msgType0.php");
							break;
						case "1":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-current/restr_1/mailing/msgtypes/mailing_msgType1.php");
							break;
						case "2":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-current/restr_1/mailing/msgtypes/mailing_msgType2.php");
							break;
						case "3":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-current/restr_1/mailing/msgtypes/mailing_msgType3.php");
							break;
						case "4":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-current/restr_1/mailing/msgtypes/message_section-underconstruction.php");
							break;
						default:
