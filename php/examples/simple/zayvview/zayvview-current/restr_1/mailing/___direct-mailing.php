						...
						<div class="col-xs-hidden col-sm-12 col-md-12 col-lg-12">
							<div class="form-group text-left">
							  ...
							  <select class="form-control" id="msgSubject" name="msgSubject">
										...
										<option value="2">Изменение статуса заявки</option>
										<option value="3">Прочие изменения данных по заявке</option>
							  </select>
							</div>
							<div class="form-group text-left">
...
<?php
				if (isset($_GET['msgTo'])) {
					switch ($_GET['msgTo']) {
						case "0":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-current/restr_3/mailing/directMsg/mailing_directMsg-to-Chugunov.php");
							break;
						case "1":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-current/restr_3/mailing/directMsg/mailing_directMsg-to-ZayvTel.php");
							break;
						case "2":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-current/restr_3/mailing/directMsg/mailing_directMsg-to-groupZayvTel.php");
							break;
						case "3":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-current/restr_3/mailing/directMsg/mailing_directMsg-to-selectedZayvTel.php");
							break;
						case "4":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-current/restr_3/mailing/directMsg/mailing_directMsg-to-groupSKUBAEV1.php");
							break;
						case "5":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-current/restr_3/mailing/directMsg/mailing_directMsg-to-snab.php");
							break;
						case "6":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/zayvview/zayvview-current/restr_3/mailing/directMsg/mailing_directMsg-to-groupMARTIN.php");
							break;
						default:
