...
# ----- ----- ----- ----- -----
	 	$mail3->addAddress($email_1);
	 	$mail3->addAddress($email_2);
	 	$mail3->addAddress($email_3);
	 	$mail3->addAddress($email_4);
	 	$mail3->addAddress($email_5);
	 	$mail3->addAddress($email_6);
	 	$mail3->addAddress($email_7);
	 	$mail3->addAddress($email_8);
		$mail3->addReplyTo('notreply@atgs.ru', 'Do not reply');
# ----- ----- ----- ----- -----
#
// Content
	  $mail3->isHTML(true); // Set email format to HTML
	  $mail3->Subject = $subject." / Skubaev email list #1";
	  $mail3->Body    = $message3;
