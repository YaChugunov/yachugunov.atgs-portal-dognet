...
<script type="text/javascript" language="javascript" class="init">
	...
	function ajaxRequest_getLastZayvNumber(data, responseHandler) {
		...
		request = $.ajax({
			url: "php/examples/simple/zayvview/zayvview-current/restr_1/php/req_getLastZayvNumber.php",
			type: "post",
			cache: false,
			data: {
				tipZayv: data
	...
	function ajaxRequest_getFullMsg(zayvKOD, responseHandler) {
		...
		// Fire off the request to /form.php
		request = $.ajax({
			url: "php/examples/simple/zayvview/zayvview-current/restr_1/php/req_getComments(zayvview).php",
			type: "post",
			cache: false,
			data: {
				kodzayv: zayvKOD
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-current/restr_1/css/zayvview-zayv-main-customform.css">
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-current/restr_1/css/zayvview-zayv-child-dop-customform.css">
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-current/restr_1/css/zayvview-zayv-child-files-customform.css">
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-current/restr_1/css/zayvview-zayv-child-chet-customform.css">
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-current/restr_1/css/zayvview-chet-child-chetf-customform.css">
...
<div id="tab-1" class="tab-pane fade in active">
	...
	<?php // ----- ----- ----- ----- ----- 
	?>
	<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-current/restr_1/css/zayvview-zayv-main.css">
...
<div id="tab-2" class="tab-pane fade">
	<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-current/restr_1/css/zayvview-zayv-child-dop.css">
	<div class="space30"></div>
...
<div id="tab-3" class="tab-pane fade">
	<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-current/restr_1/css/zayvview-zayv-child-files.css">
	<div class="space30"></div>
...
<div id="tab-4" class="tab-pane fade">
	<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-current/restr_1/css/zayvview-zayv-child-chet.css">
	<div class="space30"></div>
	<div class="col-xs-12 space30" style="padding:10px; background-color:#fafafa">
	...
	<?php // ----- ----- ----- ----- ----- 
	?>
	<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-current/restr_1/css/zayvview-chet-child-chetf.css">
	<div class="space30"></div>
	<div class="col-xs-12 space30" style="padding:10px; background-color:#fafafa">
...
<div id="tab-5" class="tab-pane fade">
	<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-current/restr_1/css/zayvview-zayv-child-dop-docspec.css">
	<div class="space30"></div>
	<div class="col-xs-12 space30" style="padding:10px; background-color:#fafafa">
