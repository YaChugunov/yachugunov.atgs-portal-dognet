...
function ajaxRequest_getLastZayvNumber(data, responseHandler) {
    ...
    request = $.ajax({
        url: "php/examples/simple/zayvview/zayvview-current/restr_5/php/req_getLastZayvNumber.php",
        type: "post",
        cache: false,
        data: {
            tipZayv: data
...
$(document).ready(function() {
    ...
    editor_zayv_main = new $.fn.dataTable.Editor({
        ...
        fields: [{
            ...
            type: "upload",
            display: function(id) {
                return '<a target="_blank" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet' +
                    editor_zayv_main.file('dognet_doczayv_files', id).file_webpath +
                    '"><h4>СКАЧАТЬ ФАЙЛ</h4></a>';
            },
            dragDrop: false,
            dragDropText: "",
    ...
    editor_zayv_main.on('open', function(e, mode, action) {
        ...
        $('#DTE_Field_dognet_doczayv-kodtipzayvall').on('change', function(e) {
            console.log('Селектор типа заявки изменен' + '(' + form_in_create_mode + ', ' +
                form_in_edit_mode + ')');
            if (form_in_create_mode == 1) {
                ajaxRequest_getLastZayvNumber($(
                        '#DTE_Field_dognet_doczayv-kodtipzayvall option:selected').val(),
                    'lastZayvNumber');
            }
        });
        ...
        if (($('#DTE_Field_dognet_doczayv-koddoc').value) != editor_zayv_main.field(
                'dognet_doczayv.koddoc').get()) {}
        // Поиск в ниспадающем списке по содержимому текстового поля для ответного документа
        $('#DTE_Field_dognet_doczayv-koddoc').filterByText(editor_zayv_main, $(
            '#zayvview-zayv-main-koddoc_filter'), 'dognet_doczayv.koddoc', false);
        //
        editor_zayv_main.dependent('kodusezayv_0', function(val) {
            ...
            if (val == 0) {
                editor_zayv_main.field('dognet_doczayv.koddoc').set(editor_zayv_main.field(
                    'koddoc_tmp').get());
...
//            "max-width": "800px"
    ...
    editor_zayv_main.on('initCreate', function(e) {
        ...
        console.log('Событие InitCreate произошло!' + '(' + form_in_create_mode + ', ' +
            form_in_edit_mode + ')');
    ...
    editor_zayv_main.on('initEdit', function(e, node, data, items, type) {
        ...
        console.log('Событие InitEdit произошло!' + '(' + form_in_create_mode + ', ' +
            form_in_edit_mode + ')');
    ...
    table_zayv_main = $('#zayvview-zayv-main').DataTable({
        dom: "<'row'<'col-sm-5'B><'col-sm-4'<'#toolbar_msg'>><'col-sm-3 text-right'l>>" +
            ...
            },
            {
                ...
                render: function(id, type, row) {
                    ...
                    if (row.dognet_doczayv.kodrabfile == 1) {
                        if (id) {
                            txt1 =
                                '<span style="padding:0 5px"><a class="" target="_blank" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet' +
                                editor_zayv_main.file('dognet_doczayv_files', id).file_webpath +
                                '"><span class="glyphicon glyphicon-file"></span></a></span>';
                        } else {
                            txt1 = '';
                        }
                    }
                    if (row.dognet_doczayv.kodrabzayv == 1) {
                        txt2 =
                            '<span style="padding:0 5px"><span id="click-to-tab2"><a data-toggle="tab" href="#tab-2" onclick="switchtotab2()"><span class="glyphicon glyphicon-list-alt"></span></a></span></span>';
                    } else {
                        txt2 = '';
                    }
                    return txt1 + txt2;
        ...
        columnDefs: [{
            ...
            },
            {
                ...
                render: function(data, type, row, meta) {
                    return '' +
                        '<span style="padding:0 5px"><a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/dognet-zayvview.php?zayvview_type=current&uniqueID=' +
                        row.dognet_doczayv.kodzayv +
                        '&export=yes&format="><span class="glyphicon glyphicon-print"></span></a></span>' +
                        '<span style="padding:0 5px"><a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/dognet-zayvview.php?zayvview_type=current&uniqueID=' +
                        row.dognet_doczayv.kodzayv +
                        '&mailing=yes&msgtype="><span class="glyphicon glyphicon-send"></span></a></span>';
                }
            },
            {
                orderable: false,
    ...
    editor_zayv_child_files = new $.fn.dataTable.Editor({
        ...
        fields: [{
            ...
            display: function(id) {
                return '<a target="_blank" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet' +
                    editor_zayv_child_files.file('dognet_doczayvdopspec_files', id)
                    .file_webpath + '"><h4>СКАЧАТЬ ФАЙЛ</h4></a>';
            },
            dragDrop: false,
            dragDropText: "",
    ...
    editor_zayv_child_files.on('initCreate', function(e) {
        ...
        editor_zayv_child_files.field('dognet_doczayvdopspec.msgDocFileID').val(
    ...
    table_zayv_child_files = $('#zayvview-zayv-child-files').DataTable({
        ...
        columns: [{
            ...
            },
            {
                ...
                render: function(id) {
                    return id ?
                        '<a class="" target="_blank" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet' +
                        editor_zayv_child_files.file('dognet_doczayvdopspec_files', id)
                        .file_webpath + '"><span class="glyphicon glyphicon-file"></span></a>' :
    ...
    */
    ...
    editor_zayv_child_chet = new $.fn.dataTable.Editor({
        ...
        fields: [{
            ...
            label: "Валюта",
            type: "select",
            name: "dognet_doczayvchet.koddened",
            def: "",
            placeholder: "---"
        }, {
            ...
            display: function(id) {
                return '<a target="_blank" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet' +
                    editor_zayv_child_chet.file('dognet_doczayvchet_files', id)
                    .file_webpath + '"><h4>СКАЧАТЬ ФАЙЛ</h4></a>';
            },
            dragDrop: false,
            dragDropText: "",
    ...
    editor_zayv_child_chet.on('open', function(e) {
        ...
        $('#DTE_Field_dognet_doczayvchet-kodzayv').filterByText(editor_zayv_child_chet, $(
            '#zayvview-zayv-child-chet-kodzayv_filter'), 'dognet_doczayvchet.kodzayv', false);
        //
        $('#zayvview-zayv-child-chet-kodpost_filter').val('');
        // Поиск в ниспадающем списке по содержимому текстового поля для названия заявки
        $('#DTE_Field_dognet_doczayvchet-kodpost').filterByText(editor_zayv_child_chet, $(
            '#zayvview-zayv-child-chet-kodpost_filter'), 'dognet_doczayvchet.kodpost', false);
        //
        $('#zayvview-zayv-child-chet-kodpokup_filter').val('');
        // Поиск в ниспадающем списке по содержимому текстового поля для названия заявки
        $('#DTE_Field_dognet_doczayvchet-kodpokup').filterByText(editor_zayv_child_chet, $(
            '#zayvview-zayv-child-chet-kodpokup_filter'), 'dognet_doczayvchet.kodpokup', false);
    });
    // ----- ----- -----
    // Обработчик таблицы счетов
    table_zayv_child_chet = $('#zayvview-zayv-child-chet').DataTable({
        ...
        serverSide: true,
        createdRow: function(row, data, index) {
            if (data.dognet_doczayvchet.zayvchetpr < 100.00 || data.dognet_doczayvchet
                .zayvchetzadol > 0.00) {
        ...
        columnDefs: [{
            ...
            },
            {
                ...
                render: function(data, type, row, meta) {
                    if (data != null) {
                        if (row.dognet_spdened.html_code != null && row.dognet_spdened
                            .html_code != "") {
                            return '<span style="text-align:left">' + $.fn.dataTable.render
                                .number(' ', ',', 2, '').display(data) +
                                '</span><span style="float:right">' + row.dognet_spdened
                                .html_code + '</span>';
                        } else {
                            return '<span style="text-align:left">' + $.fn.dataTable.render
                                .number(' ', ',', 2, '').display(data) +
                        ...
                        if (row.dognet_spdened.html_code != null && row.dognet_spdened
                            .html_code != "") {
                            return '<span style="text-align:left">0.00</span><span style="float:right">' +
                                row.dognet_spdened.html_code + '</span>';
                        } else {
                            return '<span style="text-align:left">0.00</span><span style="float:right">--.</span>';
                        }
                    }
                },
                targets: 6
    ...
    editor_chet_child_chetf = new $.fn.dataTable.Editor({
        ...
        fields: [{
            ...
            display: function(id) {
                return '<a target="_blank" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet' +
                    editor_chet_child_chetf.file('dognet_doczayvchetf_files', id)
                    .file_webpath + '"><h4>СКАЧАТЬ ФАЙЛ</h4></a>';
            },
            dragDrop: false,
            dragDropText: "",
    ...
    editor_chet_child_chetf.on('initCreate', function(e) {
        ...
        editor_chet_child_chetf.field('dognet_doczayvchetf.msgDocFileID').val(
            'Сначала создайте запись!');
    ...
    table_chet_child_chetf = $('#zayvview-chet-child-chetf').DataTable({
        ...
        columnDefs: [{
            ...
            },
            {
                ...
                render: function(data, type, row, meta) {
                    if (data != null) {
                        return '<span style="text-align:left">' + $.fn.dataTable.render.number(
                                ' ', ',', 2, '').display(data) +
                            '</span><span style="float:right">&#8381;</span>';
                    } else {
                        return '<span style="text-align:left">0.00</span><span style="float:right">&#8381;</span>';
    ...
    editor_chet_child_chetf.on('open', function(e) {
        ...
        // Поиск в ниспадающем списке по содержимому текстового поля для ответного документа
        $('#DTE_Field_dognet_doczayvchetf-kodzayvchet').filterByText(editor_chet_child_chetf, $(
                '#zayvview-chet-child-chetf-kodzayvchet_filter'), 'dognet_doczayvchetf.kodzayvchet',
            false);
    ...
    table_zayv_child_dop.on('draw', function() {
        if (table_zayv_child_dop.page.info().recordsTotal > 0) {
            $('#zayvview-zayv-child-dop thead').css('display', '');
        } else {
            $('#zayvview-zayv-child-dop thead').css('display', 'none');
        }
    });
    table_zayv_child_files.on('draw', function() {
        if (table_zayv_child_files.page.info().recordsTotal > 0) {
            $('#zayvview-zayv-child-files thead').css('display', '');
        } else {
            $('#zayvview-zayv-child-files thead').css('display', 'none');
        }
    });
    table_zayv_child_chet.on('draw', function() {
        if (table_zayv_child_chet.page.info().recordsTotal > 0) {
            $('#zayvview-zayv-child-chet thead').css('display', '');
        } else {
            $('#zayvview-zayv-child-chet thead').css('display', 'none');
        }
    });
    table_chet_child_chetf.on('draw', function() {
        if (table_chet_child_chetf.page.info().recordsTotal > 0) {
            $('#zayvview-chet-child-chetf thead').css('display', '');
        } else {
            $('#zayvview-chet-child-chetf thead').css('display', 'none');
        }
    });
...
function ajaxRequest_countDocComments(kodzayv, responseHandler) {
    ...
    request_countDocComments = $.ajax({
        type: "post",
        url: 'php/examples/simple/zayvview/zayvview-current/restr_5/process/ajaxrequests/ajaxReq-doczayv-countDocComments.php',
        cache: false,
        data: {
            kodzayv: kodzayv
        },
    ...
    $(document).on("click", "span#link-logComments", function() {
        ...
        editor_logComments = new $.fn.dataTable.Editor({
            display: "bootstrap",
            ajax: {
                url: "php/examples/simple/zayvview/zayvview-current/restr_5/process/dognet-doczayv-process-showLogComments.php",
                type: "POST",
                data: {
                    kodzayv: kodzayv
                }
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-current/restr_5/css/zayvview-zayv-main-customform.css">
<div id="customForm-zayv-main">
    <div id="customForm-zayv-main-editor-tabs" style="width:100%">
        <ul id="customForm-zayv-main-editor-tabs-menu" class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#customForm-zayv-main-editor-tab-1" title="">Основание
                    заявки</a></li>
                ...
                <div class="Section">
                    ...
                    <div class="Block70">
                        ...
                        <fieldset class="field100 koddocFilter" style="padding-left:15px; padding-right:15px">
                            <input id="zayvview-zayv-main-koddoc_filter" type="text"
                                   placeholder="Вводите либо год, либо номер, либо текст из названия договора" />
                        </fieldset>
                ...
                <div class="Section">
                    <div class="Block100">
                        ...
                        <div class="Block100 fieldset-table-row">
                            ...
                            <div class="fieldset-table-cell" style="width:100%">
                                <div>
                                    <div class="chekbox-inline-text">Уведомить по email группу "Заявки" (функция
                                        временно отключена, используйте ручную рассылку)</div>
                                </div>
                            </div>
                        </div>
                    </div>
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-current/restr_5/css/zayvview-zayv-child-dop-customform.css">
<div id="customForm-zayv-child-dop">
    <div id="customForm-zayv-child-dop-editor-tabs" style="width:100%">
        <ul id="customForm-zayv-child-dop-editor-tabs-menu" class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#customForm-zayv-child-dop-editor-tab-1"
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-current/restr_5/css/zayvview-zayv-child-files-customform.css">
<div id="customForm-zayv-child-files">
    <div id="customForm-zayv-child-files-editor-tabs" style="width:100%">
        <ul id="customForm-zayv-child-files-editor-tabs-menu" class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#customForm-zayv-child-files-editor-tab-1"
                   title="">Параметры</a></li>
        </ul>
        <div class="tab-content" style="padding:5px">
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-current/restr_5/css/zayvview-zayv-child-chet-customform.css">
<div id="customForm-zayv-child-chet">
    <div id="customForm-zayv-child-chet-editor-tabs" style="width:100%">
        <ul id="customForm-zayv-child-chet-editor-tabs-menu" class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#customForm-zayv-child-chet-editor-tab-1"
                   title="">Параметры</a></li>
                ...
                <div class="Section">
                    <div class="Block100">
                        ...
                        <fieldset class="field25">
                            <editor-field name="dognet_doczayvchet.koddened"></editor-field>
                        </fieldset>
                    </div>
                </div>
            </div>
                ...
                <div class="Section">
                    <div class="Block100">
                        ...
                        <fieldset class="field40 kodpostFilter" style="padding:30px 15px 0;">
                            <input id="zayvview-zayv-child-chet-kodpost_filter" type="text"
                    ...
                    <div class="Block100">
                        ...
                        <fieldset class="field40 kodpokupFilter" style="padding:30px 15px 0;">
                            <input id="zayvview-zayv-child-chet-kodpokup_filter" type="text"
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-current/restr_5/css/zayvview-chet-child-chetf-customform.css">
<div id="customForm-chet-child-chetf">
    <div id="customForm-chet-child-chetf-editor-tabs" style="width:100%">
        <ul id="customForm-chet-child-chetf-editor-tabs-menu" class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#customForm-chet-child-chetf-editor-tab-1"
                   title="">Параметры</a></li>
                ...
                <div class="Section">
                    <div class="Block100">
                        ...
                        <div class="Block100 fieldset-table-row">
                            ...
                            <div class="fieldset-table-cell" style="width:100%">
                                <div>
                                    <div class="chekbox-inline-text">Создать/перенести счет-фактуру на другой счет (в
                                        пределах заявки)</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <fieldset class="field40 kodzayvchetFilter" style="padding:7px 15px 0;">
                            <input id="zayvview-chet-child-chetf-kodzayvchet_filter" type="text"
...
<div id="tab-1" class="tab-pane fade in active">
    ...
    <div id="zayvsearch-filters-block" class="panel-group">
        <div class="panel panel-default">
            <div class="panel-heading" style="padding:10px; background-color:#fafafa">
                <h4 class="space20 text-uppercase"
                    style="color:#31708f; font-family:'Oswald', sans-serif; font-weight:400; letter-spacing:0.4em; padding-bottom:5px; border-bottom:4px #fff solid">
                ...
                <div id="zayvview-current-filters" class="panel-body space30" style="background-color:#fafafa">
                    ...
                    <div class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
                        <div class="form-group space10" style="width:100%">
                            ...
                            <input type="text" id="docNumberSearch_text" class="form-control" placeholder="Все"
                    ...
                    <div class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
                        <div class="form-group space10" style="width:100%">
                            ...
                            <input type="text" id="zayvNumberSearch_text" class="form-control" placeholder="Все номера"
                                   name="zayvNumberSearch_text">
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-3 col-md-2 col-lg-2">
                        <div class="input-group space10" style="width:100%">
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-6 col-lg-4">
                        <div class="input-group space10" style="width:100%">
                            ...
                            <input type="text" id="zayvNameSearch_text" class="form-control"
                                   placeholder="Введите текст для поиска в описании" name="zayvNameSearch_text">
                        </div>
                    </div>
    ...
    <link rel="stylesheet"
          href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-current/restr_5/css/zayvview-zayv-main.css">
    <div class="demo-html"></div>
    <table id="zayvview-zayv-main" class="table table-responsive table-bordered display compact" cellspacing="0"
           width="100%">
        <thead>
            <tr>
    ...
    <div class="" style="margin-top:15px">
        ...
        <div style="float: left">
            <p><span class="label label-icon"><span class="glyphicon glyphicon-pushpin"
                          title="Заявка сформирована"></span></span><span
                      style="font-size:0.9em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Заявка
                    сформирована</span></p>
        </div>
        <div style="float: left">
            <p><span class="label label-icon"><span class="text-warning glyphicon glyphicon-credit-card"
                          title="Есть выставленные счета"></span></span><span
                      style="font-size:0.9em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Есть
                    выставленные счета</span></p>
        </div>
        <div style="float: left">
            <p><span class="label label-icon"><span class="text-info glyphicon glyphicon-credit-card"
                          title="Все счета выставлены"></span></span><span
                      style="font-size:0.9em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Все
                    счета выставлены</span></p>
        </div>
        <div style="float: left">
            <p><span class="label label-icon label-icon-zayv2"><span class="glyphicon glyphicon-ok-circle"
                          title="Заявка закрыта"></span></span><span
                      style="font-size:0.9em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Заявка
                    закрыта</span></p>
        </div>
        <div style="float: left">
            <p><span class="label label-icon"><span class="text-danger glyphicon glyphicon-ban-circle"
                          title="Заявка аннулирована"></span></span><span
                      style="font-size:0.9em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Заявка
                    аннулирована</span></p>
        </div>
        <div style="float: left">
            <p><span class="label label-icon"><span class="glyphicon glyphicon-comment"
                          title="Есть комментарий к заявке"></span></span><span
                      style="font-size:0.9em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Есть
                    комментарий к заявке</span></p>
        </div>
        <div style="float: left">
            <p><span class="label label-icon"><span class="glyphicon glyphicon-file"
                          title="Спецификация в виде файла"></span></span><span
                      style="font-size:0.9em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Спецификация
                    в виде файла</span></p>
        </div>
        <div style="float: left">
            <p><span class="label label-icon"><span class="glyphicon glyphicon-list-alt"
                          title="Спецификация в виде списка"></span></span><span
                      style="font-size:0.9em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Спецификация
                    в виде списка</span></p>
        </div>
        <div style="float: left">
            <p><span class="label label-icon"><span class="glyphicon glyphicon-print"
                          title="Распечатать заявку (в разработке)"></span></span><span
                      style="font-size:0.9em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Распечатать
                    заявку (в разработке)</span></p>
        </div>
        <div style="float: left">
            <p><span class="label label-icon"><span class="glyphicon glyphicon-send"
                          title="Разослать уведомления на email"></span></span><span
                      style="font-size:0.9em; font-family: 'HelliosCond', sans-serif; font-weight: 400; color:#8d8d8d">Разослать
                    уведомления на email</span></p>
        </div>
...
<div id="tab-2" class="tab-pane fade">
    <link rel="stylesheet"
          href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-current/restr_5/css/zayvview-zayv-child-dop.css">
    <div class="space30"></div>
    <div id="zayvview-zayv-child-dop-spec" style="">
        <div class="col-xs-12 space30" style="padding:10px; background-color:#fafafa">
            <h4 class="text-uppercase"
                style="color:#31708f; font-family:'Oswald', sans-serif; font-weight:400; letter-spacing:0.4em">
                Спецификация к заявке (список, создаваемый вручную)</h4>
        </div>
        <div class="demo-html"></div>
        <table id="zayvview-zayv-child-dop" class="table table-responsive table-bordered display compact"
    ...
    <div class="text-danger" style="font-size:0.85em"><span class="glyphicon glyphicon-exclamation-sign"
              style="margin-right:10px"></span>Чтобы иметь возможность добавлять позиции в этот список, необходимо в
...
<div id="tab-3" class="tab-pane fade">
    <link rel="stylesheet"
          href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-current/restr_5/css/zayvview-zayv-child-files.css">
    <div class="space30"></div>
    <div id="zayvview-zayv-child-files-spec" style="">
        <div class="col-xs-12 space30" style="padding:10px; background-color:#fafafa">
            <h4 class="text-uppercase"
                style="color:#31708f; font-family:'Oswald', sans-serif; font-weight:400; letter-spacing:0.4em">
                Прикреплённые файлы к заявке (спецификации и прочие)</h4>
        </div>
        <div class="demo-html"></div>
        <table id="zayvview-zayv-child-files" class="table table-responsive table-bordered display compact"
               cellspacing="0" width="100%">
            <thead>
                <tr>
                    <th class="text-center"><span class='glyphicon glyphicon-option-vertical'></span></th>
    ...
    <div class="space10"></div>
    <div class="text-danger" style="font-size:0.85em"><span class="glyphicon glyphicon-exclamation-sign"
              style="margin-right:10px"></span><b>UPD 30.05.24</b> Теперь в этом разделе к выбранной заявке можно
        прикрепить ЛЮБЫЕ файлы в неограниченном количестве (1 запись = 1 файл). Это можно сделать независимо от того,
...
<div id="tab-4" class="tab-pane fade">
    <link rel="stylesheet"
          href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-current/restr_5/css/zayvview-zayv-child-chet.css">
    <div class="space30"></div>
    <div class="col-xs-12 space30" style="padding:10px; background-color:#fafafa">
        <h4 class="text-uppercase"
            style="color:#31708f; font-family:'Oswald', sans-serif; font-weight:400; letter-spacing:0.4em">Счета</h4>
    </div>
    <div class="demo-html"></div>
    <table id="zayvview-zayv-child-chet" class="table table-responsive table-bordered display compact" cellspacing="0"
           width="100%">
        <thead>
            <tr>
                <th class="text-center"><span class='glyphicon glyphicon-option-vertical'></span></th>
    ...
    ?>
    <link rel="stylesheet"
          href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-current/restr_5/css/zayvview-chet-child-chetf.css">
    <div class="space30"></div>
    <div class="col-xs-12 space30" style="padding:10px; background-color:#fafafa">
        <h4 class="text-uppercase"
            style="color:#31708f; font-family:'Oswald', sans-serif; font-weight:400; letter-spacing:0.4em">Счета-фактуры
        </h4>
    </div>
    <div class="demo-html"></div>
    <table id="zayvview-chet-child-chetf" class="table table-responsive table-bordered display compact" cellspacing="0"
           width="100%">
        <thead>
            <tr>
                <th class="text-center"><span class='glyphicon glyphicon-option-vertical'></span></th>
...
<div id="tab-5" class="tab-pane fade">
    <link rel="stylesheet"
          href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-current/restr_5/css/zayvview-zayv-child-dop-docspec.css">
    <div class="space30"></div>
    <div class="col-xs-12 space30" style="padding:10px; background-color:#fafafa">
        <h4 class="text-uppercase"
            style="color:#31708f; font-family:'Oswald', sans-serif; font-weight:400; letter-spacing:0.4em">Спецификации
            из договора</h4>
    </div>
    <div class="demo-html"></div>
    <table id="zayvview-zayv-child-dop-docspec" class="table table-responsive table-bordered display compact"
           cellspacing="0" width="100%">
        <thead>
            <tr>
                <th class="text-center"><span class='glyphicon glyphicon-option-vertical'></span></th>
...
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvview/zayvview-current/restr_5/css/zayvview-zayv-modal-logComments.css">
