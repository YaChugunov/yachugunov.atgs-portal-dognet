...
<div class="container">
	<div class="row common-top-block">
		<?php
		include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/dognet-topblock.php");
		?>
	</div>
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12">
			<?php
			include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/_fixes-updates/dognet_fixes-updates.php");
			?>
		</div>
	</div>
	<div class="row">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12">
						<ul id="main-tabs-menu" class="nav nav-tabs">
							...
							<li id="link-to-tab6"><a data-toggle="tab" href="#tab-6" title="">ЧАТ (в разработке)</a></li>
						</ul>
						<div class="tab-content">
							<?php include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/zayvview/zayvview-current/restr_5/dognet-zayvview-current(restr_5)-main.php") ?>
						</div>
					</div>
				</div>
			</div>
