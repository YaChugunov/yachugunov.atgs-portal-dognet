...
?>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <?php include "dognet-chetview-edit(restr_4)-main.php"; ?>
        </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <ul id="main-tabs-menu" class="nav nav-tabs">
                            ...
                            <li><span id="doc_newitems_cnt"></span><a data-toggle="tab" href="#tab-6" title="">Документы
                                    по
                                    счету</a></li>
                            <li><span id="con_newitems_cnt"></span><a data-toggle="tab" href="#tab-7"
                                   title="">Контакты</a></li>
                            <li style="float:right"><a
                                   href="dognet-chetview.php?chetview_type=details&uniqueID=<?php echo $_GET['uniqueID']; ?>"
                                   title=""><span class="glyphicon glyphicon-list-alt"></span></a></li>
                            <li style="float:right"><a
                                   href="dognet-chetview.php?chetview_type=details&uniqueID=<?php echo $_GET['uniqueID']; ?>&action=unlock"
                                   title=""><span class="glyphicon glyphicon-lock"></span></a></li>
                        </ul>
                        <div class="tab-content">
                            <div id="tab-1" class="tab-pane fade in active">
                                <?php include "tabs/dognet-chetview-edit(restr_4)-tab1_chet.php"; ?>
                            </div>
                            <div id="tab-2" class="tab-pane fade">
                                <?php // include("tabs/dognet-chetview-edit(restr_4)-tab2_kalplans.php");
; ?>
                                <div class="space10"></div>
                            </div>
                            <div id="tab-3" class="tab-pane fade">
                                <?php include "tabs/dognet-chetview-edit(restr_4)-tab3_kalplanchf.php"; ?>
                                <div class="space10"></div>
                            </div>
                            <div id="tab-4" class="tab-pane fade">
                                <?php include "tabs/dognet-chetview-edit(restr_4)-tab4_avans.php"; ?>
                                <div class="space10"></div>
                            </div>
                            <div id="tab-5" class="tab-pane fade">
                                <?php include "tabs/dognet-chetview-edit(restr_4)-tab5_subpodr.php"; ?>
                                <div class="space10"></div>
                            </div>
                            <div id="tab-6" class="tab-pane fade">
                                <?php include "tabs/dognet-chetview-edit(restr_4)-tab6_files.php"; ?>
                                <div class="space10"></div>
                            </div>
