<script type="text/javascript" language="javascript" class="init">
	...
	function ajaxRequest_sendMail(docnumber, dateavans, summaavans, responseHandler) {
		...
		request = $.ajax({
			url: "php/examples/simple/chetview/chetview-edit/restr_4/tabs/php/sendMail_onSubmit-newAvans.php",
			type: "post",
			cache: false,
			data: {
				docnumber: docnumber,
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/chetview/chetview-edit/restr_4/tabs/css/chetview-edit-tab4_avans.css">
