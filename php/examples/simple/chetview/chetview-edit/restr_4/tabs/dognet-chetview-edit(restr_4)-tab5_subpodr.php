...
$(document).ready(function() {
	var	editor_tab5_subpodr = new $.fn.dataTable.Editor( {
		display: "bootstrap",
		ajax: "php/examples/php/chetview/chetview-edit/dognet-chetview-edit-tab5_subpodr-process.php",
		table: "#chetview-edit-tab5_subpodr",
    i18n: {
	...
	var table_tab5_subpodr = $('#chetview-edit-tab5_subpodr').DataTable( {
		dom: "<'row space20'<'col-md-8 col-sm-12'B><'col-md-4 col-sm-12'>r>t<'row'<'col-md-12 col-sm-12 footer'>>",
		language: {
				url: "php/examples/simple/chetview/chetview-edit/dt_russian-tab5_subpodr.json"
		},
		ajax: {
			url: "php/examples/php/chetview/chetview-edit/dognet-chetview-edit-tab5_subpodr-process.php",
			type: "POST",
	    data: function ( d ) {
		     }
		},
	  ...
	  rowGroup: {
	    ...
	    { text:	'<span class="glyphicon glyphicon-refresh"></span>', action:
	      function ( e, dt, node, config ) {
			...
			{ extend: "create", editor: editor_tab5_subpodr, text: "НОВЫЙ ДОГОВОР",
				formButtons:
					[ 'Создать',
						{ text: 'Отмена', action: function () { this.close(); } }
					]
			},
			{ extend: "edit", editor: editor_tab5_subpodr, text: "ИЗМЕНИТЬ",
				formButtons:
					[ 'Изменить',
						{ text: 'Отмена', action: function () { this.close(); } }
					]
			},
			{ extend: "remove", editor: editor_tab5_subpodr, text: "УДАЛИТЬ" }
		],
	} );
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
	var editor_tab5_chfsubpodr = new $.fn.dataTable.Editor( {
			display: "bootstrap",
			ajax: {
				url: "php/examples/php/chetview/chetview-edit/dognet-chetview-edit-tab5_subpodr_child_chetfact-process.php",
	      data: function ( d ) {
	          var selected = table_tab5_subpodr.row( { selected: true } );
	          if ( selected.any() ) {
	                d.koddocsubpodr = selected.data().dognet_docsubpodr.koddocsubpodr;
	          }
	      }
			},
			table: "#chetview-edit-tab5_chfsubpodr",
	    i18n: {
	        create: { title: "<h3>Новый договор субподряда</h3>" },
	        edit: { title: "<h3>Изменить параметры договора</h3>" },
	        remove: {
	...
	var table_tab5_chfsubpodr = $('#chetview-edit-tab5_chfsubpodr').DataTable( {
			dom: "<'row space20'<'col-md-8 col-sm-12'B><'col-md-4 col-sm-12'>r>t<'row'<'col-md-12 col-sm-12 footer'>>",
			language: {
				url: "php/examples/simple/chetview/chetview-edit/dt_russian-tab5_subpodr_chetfact.json"
			},
			ajax: {
				url: "php/examples/php/chetview/chetview-edit/dognet-chetview-edit-tab5_subpodr_child_chetfact-process.php",
				type: 'post',
	    ...
	    select: {
			...
			columns: [
				{ data: "dognet_docsubpodr.koddocsubpodr", className: "" },
...
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
	var editor_tab5_oplchfsubpodr = new $.fn.dataTable.Editor( {
			display: "bootstrap",
			ajax: {
				url: "php/examples/php/chetview/chetview-edit/dognet-chetview-edit-tab5_subpodr_child_child_oplatachf-process.php",
	      data: function ( d ) {
	          var selected2 = table_tab5_subpodr.row( { selected: true } );
	          if ( selected2.any() ) {
			...
			table: "#chetview-edit-tab5_oplchfsubpodr",
	    i18n: {
	...
	var table_tab5_oplchfsubpodr = $('#chetview-edit-tab5_oplchfsubpodr').DataTable( {
			dom: "<'row space20'<'col-md-8 col-sm-12'B><'col-md-4 col-sm-12'>r>t<'row'<'col-md-12 col-sm-12 footer'>>",
			language: {
				url: "php/examples/simple/chetview/chetview-edit/dt_russian-tab5_subpodr_oplatachf.json"
			},
			ajax: {
				url: "php/examples/php/chetview/chetview-edit/dognet-chetview-edit-tab5_subpodr_child_child_oplatachf-process.php",
				type: 'post',
...
/* 								$(row).css({ 'color':'#FFF'	}); */
			...
			columnDefs: [
	          ...
	          if ( selectedChf.any() ) { val1 = selectedChf.data().dognet_docchfsubpodr.kodchfsubpodr; }
						...
						if ((data === val1) && val1 != "") { return '<div style="font-size:0.95em; width:24px; height:20px; background-color:#951402; color:#fff; padding:2px 5px"><span class="glyphicon glyphicon-link"></span></span>'; }
						else { return ''; }
					},
					targets: 0
				},
...
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
	var editor_tab5_avchfsubpodr = new $.fn.dataTable.Editor( {
			display: "bootstrap",
			ajax: {
				url: "php/examples/php/chetview/chetview-edit/dognet-chetview-edit-tab5_subpodr_child_child_avanschf-process.php",
	      data: function ( d ) {
	          var selected2 = table_tab5_subpodr.row( { selected: true } );
	          if ( selected2.any() ) {
	                d.koddocsubpodr2 = selected2.data().dognet_docsubpodr.koddocsubpodr;
			...
			table: "#chetview-edit-tab5_avchfsubpodr",
	    i18n: {
	        create: { title: "<h3>Зачесть сумму из аванса</h3>" },
	        edit: { title: "<h3>Изменить зачтенную ранее сумму</h3>" },
	        remove: {
	...
	var table_tab5_avchfsubpodr = $('#chetview-edit-tab5_avchfsubpodr').DataTable( {
			dom: "<'row space20'<'col-md-8 col-sm-12'B><'col-md-4 col-sm-12'>r>t<'row'<'col-md-12 col-sm-12 footer'>>",
			language: {
				url: "php/examples/simple/chetview/chetview-edit/dt_russian-tab5_subpodr_chfavans.json"
			},
			ajax: {
				url: "php/examples/php/chetview/chetview-edit/dognet-chetview-edit-tab5_subpodr_child_child_avanschf-process.php",
				type: 'post',
...
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
	table_tab5_subpodr.on( 'select', function () {
	    ...
	    editor_tab5_chfsubpodr
	        ...
	        .set( table_tab5_subpodr.row( { selected: true } ).data().dognet_docsubpodr.koddocsubpodr );
...
//
	...
	editor_tab5_avchfsubpodr.on( 'submitSuccess', function () {
	    table_tab5_chfsubpodr.ajax.url("php/examples/php/chetview/chetview-edit/dognet-chetview-edit-tab5_subpodr_child_chetfact-process.php").load();
 	    table_tab5_subpodr.ajax.url("php/examples/php/chetview/chetview-edit/dognet-chetview-edit-tab5_subpodr-process.php").load();
	    table_tab5_subpodr.ajax.reload();
	} );
// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
//
...
// Изменяем размер диалогового окна редактирования договора субподряда
	editor_tab5_subpodr.on( 'open', function () { $(".modal-dialog").css("width", "80%");	} );
	editor_tab5_subpodr.on( 'close', function () { $(".modal-dialog").css("width", "80%"); } );
...
$('#chetview-edit-tab5_chfsubpodr tbody').on( 'click', 'tr', function () {
...
// Array to track the ids of the edit displayed rows
    ...
    $('#chetview-edit-tab5_subpodr tbody').on( 'click', 'tr td.details-control', function () {
        ...
        if ( row.child.isShown() ) {
			...
			d = row.data();
			rowData.child( <?php include('templates/chetview-edit_tab5_subpodr.tpl'); ?> ).show();
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/chetview/chetview-edit/restr_4/tabs/css/chetview-edit-tab5_subpodr.css">
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/chetview/chetview-edit/restr_4/tabs/css/chetview-edit-tab5_subpodr_chetfact.css">
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/chetview/chetview-edit/restr_4/tabs/css/chetview-edit-tab5_subpodr_oplatachf.css">
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/chetview/chetview-edit/restr_4/tabs/css/chetview-edit-tab5_subpodr_chfavans.css">
...
<section>
	<div class="" style="padding-left:5px; padding-right:5px">
		...
		<table id="chetview-edit-tab5_subpodr" class="table" cellspacing="0" width="100%">
			<thead>
				<tr>
					<th class="text-center"><span class='glyphicon glyphicon-option-vertical'></span></th>
					<th></th>
					<th class="text-uppercase">Договор №</th>
					<th class="text-center text-uppercase">Организация субподрядчик</th>
					<th class="text-center text-uppercase">Дата</th>
					<th class="text-center text-uppercase">Сумма</th>
					<th class="text-center text-uppercase">Задолженность</th>
				</tr>
			</thead>
		</table>
<?php // ----- ----- ----- ----- ----- ?>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="demo-html"></div>
			<table id="chetview-edit-tab5_chfsubpodr" class="table" cellspacing="0" width="100%">
				<thead>
					<tr>
						<th></th>
						<th>ID счета</th>
...
<?php // ----- ----- ----- ----- ----- ?>
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			...
			<div class="demo-html"></div>
			<table id="chetview-edit-tab5_oplchfsubpodr" class="table" cellspacing="0" width="100%">
				<thead>
					<tr>
						<th></th>
						<th>ID оплаты</th>
...
<!-- 			<h3 class="child-title space20"><span id="safasfaslaksjdlkasjd"></span></h3> -->
			<div class="demo-html"></div>
			<table id="chetview-edit-tab5_avchfsubpodr" class="table" cellspacing="0" width="100%">
				<thead>
					<tr>
						<th></th>
						<th>ID аванса</th>
