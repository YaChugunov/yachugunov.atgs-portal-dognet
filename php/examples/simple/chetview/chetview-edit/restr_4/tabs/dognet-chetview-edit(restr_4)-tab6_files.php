...
$(document).ready(function() {
    ...
    var editor_tab6_files = new $.fn.dataTable.Editor({
        ...
        fields: [{
            ...
            type: "upload",
            display: function(id) {
                return '<a target="_blank" href="' + editor_tab6_files.file(
                        'dognet_docpaper_files', id).file_webpath +
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/chetview/chetview-edit/restr_4/tabs/css/chetview-edit-tab6_files.css">
