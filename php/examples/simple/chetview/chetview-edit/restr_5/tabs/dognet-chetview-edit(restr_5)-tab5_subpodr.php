<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		var editor_tab5_subpodr = new $.fn.dataTable.Editor({
			display: "bootstrap",
			ajax: "php/examples/simple/chetview/chetview-edit/restr_5/tabs/process/dognet-chetview-edit-tab5_subpodr-process.php",
		...
		var table_tab5_subpodr = $('#chetview-edit-tab5_subpodr').DataTable({
			...
			ajax: {
				url: "php/examples/simple/chetview/chetview-edit/restr_5/tabs/process/dognet-chetview-edit-tab5_subpodr-process.php",
				type: "POST",
				data: function(d) {}
			},
			serverSide: true,
		...
		var editor_tab5_chfsubpodr = new $.fn.dataTable.Editor({
			display: "bootstrap",
			ajax: {
				url: "php/examples/simple/chetview/chetview-edit/restr_5/tabs/process/dognet-chetview-edit-tab5_subpodr_child_chetfact-process.php",
				data: function(d) {
		...
		var editor_tab5_oplchfsubpodr = new $.fn.dataTable.Editor({
			display: "bootstrap",
			ajax: {
				url: "php/examples/simple/chetview/chetview-edit/restr_5/tabs/process/dognet-chetview-edit-tab5_subpodr_child_child_oplatachf-process.php",
				data: function(d) {
		...
		var table_tab5_oplchfsubpodr = $('#chetview-edit-tab5_oplchfsubpodr').DataTable({
			...
			columnDefs: [{
					...
					render: function(data) {
						...
						if ((data === val1) && val1 != "") {
							return '<div style="font-size:0.95em; width:24px; height:20px; background-color:#951402; color:#fff; padding:2px 5px"><span class="glyphicon glyphicon-link"></span></span>';
						} else {
							return '';
						}
					},
		...
		var editor_tab5_avchfsubpodr = new $.fn.dataTable.Editor({
			display: "bootstrap",
			ajax: {
				url: "php/examples/simple/chetview/chetview-edit/restr_5/tabs/process/dognet-chetview-edit-tab5_subpodr_child_child_avanschf-process.php",
				data: function(d) {
					var selected2 = table_tab5_subpodr.row({
						selected: true
					});
		...
		editor_tab5_avchfsubpodr.on('submitSuccess', function() {
			table_tab5_chfsubpodr.ajax.url("php/examples/simple/chetview/chetview-edit/restr_5/tabs/process/dognet-chetview-edit-tab5_subpodr_child_chetfact-process.php").load();
			table_tab5_subpodr.ajax.url("php/examples/simple/chetview/chetview-edit/restr_5/tabs/process/dognet-chetview-edit-tab5_subpodr-process.php").load();
			table_tab5_subpodr.ajax.reload();
		});
		// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
		//
