<script type="text/javascript" language="javascript" class="init">
    $(document).ready(function() {
        ...
        var editor_tab3_kalplanchf = new $.fn.dataTable.Editor({
            display: "bootstrap",
            ajax: "php/examples/simple/chetview/chetview-edit/restr_5/tabs/process/dognet-chetview-edit-tab3_kalplanchf-process.php",
        ...
        var table_tab3_kalplanchf = $('#chetview-edit-tab3_kalplanchf').DataTable({
            ...
            ajax: {
                url: "php/examples/simple/chetview/chetview-edit/restr_5/tabs/process/dognet-chetview-edit-tab3_kalplanchf-process.php",
                type: "POST"
            },
            stateSave: true,
            serverSide: true,
        ...
        var editor_tab3_oplatachf = new $.fn.dataTable.Editor({
            display: "bootstrap",
            ajax: {
                url: 'php/examples/simple/chetview/chetview-edit/restr_5/tabs/process/dognet-chetview-edit-tab3_oplatachf_child-process.php',
                data: function(d) {
        ...
        var editor_tab3_chfavans = new $.fn.dataTable.Editor({
            display: "bootstrap",
            ajax: {
                url: 'php/examples/simple/chetview/chetview-edit/restr_5/tabs/process/dognet-chetview-edit-tab3_chfavans_child-process.php',
                data: function(d) {
...
<section>
    ...
    <div class="" style="padding-left:5px; padding-right:5px">
        ...
        <table id="chetview-edit-tab3_kalplanchf" class="table table-bordered table-striped" cellspacing="0" width="100%">
            <thead>
                <tr>
                    <th></th>
                    <th>ID счета</th>
