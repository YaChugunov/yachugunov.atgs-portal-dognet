<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		editor_tab2_kalplans = new $.fn.dataTable.Editor({
			display: "bootstrap",
			ajax: "php/examples/simple/chetview/chetview-edit/restr_5/tabs/process/dognet-chetview-edit-tab2_kalplans-process.php",
			table: "#chetview-edit-tab2_kalplans",
			i18n: {
				edit: {
					title: "<h3>Редактирование этапа</h3>"
				},
				error: {
		...
		table_tab2_kalplans = $('#chetview-edit-tab2_kalplans').DataTable({
			...
			ajax: {
				url: "php/examples/simple/chetview/chetview-edit/restr_5/tabs/process/dognet-chetview-edit-tab2_kalplans-process.php",
				type: "POST"
			},
			serverSide: true,
			columns: [{
