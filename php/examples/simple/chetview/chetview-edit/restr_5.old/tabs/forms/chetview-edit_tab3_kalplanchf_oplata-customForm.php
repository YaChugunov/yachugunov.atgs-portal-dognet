...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_5/tabs/css/docview-edit-tab3_kalplanchf_oplata-customForm.css">
<div id="customForm_tab3_oplata">

	<div class="doc-editor-tabs" style="width:100%">
		<ul id="" class="nav nav-tabs doc-editor-tabs-menu">
			<li class="active"><a data-toggle="tab" href="#doc-editor-tab3-kalplanchf_oplata-1" title="">Информация</a></li>
			<li><a data-toggle="tab" href="#doc-editor-tab3-kalplanchf_oplata-2" title="">Параметры</a></li>
			<li><a data-toggle="tab" href="#doc-editor-tab3-kalplanchf_oplata-3" title="">Комментарий</a></li>
		</ul>
		<div class="tab-content" style="padding:5px">
			...
			<div id="doc-editor-tab3-kalplanchf_oplata-3" class="tab-pane fade">
				<div class="Section">
					<div class="Block100">
						<legend>Комментарий к оплате</legend>
