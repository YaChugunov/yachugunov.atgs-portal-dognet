...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-edit/restr_5/tabs/css/docview-edit-tab5_subpodr-customForm.css">
<div id="customForm_tab5_subpodr">
	<div class="doc-editor-tabs" style="width:100%">
		<ul id="" class="nav nav-tabs doc-editor-tabs-menu">
			...
			<li><a data-toggle="tab" href="#doc-editor-tab5-subpodr-3" title="">Параметры</a></li>
		</ul>
		<div class="tab-content" style="padding:5px">
			...
			<div id="doc-editor-tab5-subpodr-3" class="tab-pane fade">
				<div class="Section">
					<div class="Block100">
