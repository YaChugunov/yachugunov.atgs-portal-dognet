...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/chetview/chetview-edit/restr_5/tabs/css/chetview-edit-tab4_avans-customForm.css">
<div id="customForm_tab4_avans">
	<div class="doc-editor-tabs" style="width:100%">
		<ul id="" class="nav nav-tabs doc-editor-tabs-menu">
			<li class="active"><a data-toggle="tab" href="#doc-editor-tab4-1" title="">Информация</a></li>
			<li><a data-toggle="tab" href="#doc-editor-tab4-2" title="">Параметры</a></li>
			<li><a data-toggle="tab" href="#doc-editor-tab4-3" title="">Комментарий</a></li>
		</ul>
