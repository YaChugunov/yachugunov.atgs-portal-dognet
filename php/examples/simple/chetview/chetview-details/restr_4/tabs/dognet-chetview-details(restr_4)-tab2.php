...
<div id="doc-details-tabs" class="doc-details-tabs" style="width:100%">
    ...
    <div class="tab-content" style="padding:5px; width:100%">
        <div id="doc-details-tab2-1" class="tab-pane fade in active">
            <?php include $_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/chetview/chetview-details/restr_4/tabs/dognet-chetview-details(restr_4)-tab2_progress.php"; ?>
        </div>
        <div id="doc-details-tab2-2" class="tab-pane fade">
            <?php include $_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/chetview/chetview-details/restr_4/tabs/dognet-chetview-details(restr_4)-tab2_avans.php"; ?>
        </div>
        <div id="doc-details-tab2-3" class="tab-pane fade">
            <?php include $_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/chetview/chetview-details/restr_4/tabs/dognet-chetview-details(restr_4)-tab2_chetf.php"; ?>
        </div>
    </div>
</div>