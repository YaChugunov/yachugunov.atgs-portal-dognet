<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		table_zayv_child_chet = $('#chetview-zayv-child-chet').DataTable({
			dom: "<'row'<'col-sm-5'><'col-sm-4'><'col-sm-3'<'test_msg'>>>" + "<'row'<'col-sm-12'tr>>" + "<'row'<'col-sm-1'B><'col-sm-5'i><'col-sm-6'p>>",
			language: {
				url: "php/examples/simple/chetview/chetview-details/dt_russian-tab7_zayv_child_chet.json"
			},
			ajax: {
				url: "php/examples/php/chetview/chetview-details/dognet-chetview-details-tab7_zayv_child_chet-process.php",
				type: "POST",
				data: function(d) {
		...
		$('#chetview-zayv-child-chet tbody').on('click', 'tr td.details-control', function() {
			...
			if (row.child.isShown()) {
				...
				d = row.data();
				rowData.child(<?php include('templates/chetview-details_tab7_zayv_child_chet.tpl'); ?>).show();
		...
		table_chet_child_chetf = $('#chetview-chet-child-chetf').DataTable({
			dom: "<'row'<'col-sm-5'><'col-sm-4'><'col-sm-3'<'test_msg'>>>" + "<'row'<'col-sm-12'tr>>" + "<'row'<'col-sm-1'B><'col-sm-5'i><'col-sm-6'p>>",
			language: {
				url: "php/examples/simple/chetview/chetview-details/dt_russian-tab7_zayv_child_chetf.json"
			},
			ajax: {
				url: "php/examples/php/chetview/chetview-details/dognet-chetview-details-tab7_zayv_child_chetf-process.php",
				type: 'post',
				data: function(d) {
		...
		$('#chetview-chet-child-chetf tbody').on('click', 'tr td.details-control', function() {
			var tr = $(this).closest('tr');
			...
			if (row.child.isShown()) {
				...
				d = row.data();
				rowData.child(<?php include('templates/chetview-details_tab7_zayv_child_chetf.tpl'); ?>).show();
...
//
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/chetview/chetview-details/restr_4/tabs/css/chetview-details-common-tab7_zayv_child_chet.css">
<h3 class="chetview-details-title2 text-right">Счета</h3>
<div class="demo-html"></div>
<table id="chetview-zayv-child-chet" class="table table-responsive table-bordered display compact" cellspacing="0" width="100%">
	<thead>
		<tr>
...
<?php // ----- ----- ----- ----- ----- 
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/chetview/chetview-details/restr_4/tabs/css/chetview-details-common-tab7_zayv_child_chetf.css">
<div class="space30"></div>
<h3 class="chetview-details-title2 text-right">Счета-фактуры</h3>
<div class="demo-html"></div>
<table id="chetview-chet-child-chetf" class="table table-responsive table-bordered display compact" cellspacing="0" width="100%">
	<thead>
		<tr>
			<th class="text-center"><span class='glyphicon glyphicon-option-vertical'></span></th>
			<th>Дата</th>
