...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/chetview/chetview-details/restr_4/tabs/css/chetview-details-common-tab4_docs.css">
    ...
    <div class="tab-content" style="padding:5px; width:100%">
        ...
        <div id="doc-details-tab4-3" class="tab-pane fade in active">
            <div class="col-xs-hidden col-sm-12 col-md-12 col-lg-12">
                ...
                <?php include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/chetview/chetview-details/restr_4/tabs/dognet-chetview-details(restr_4)-tab4_7.php"); ?>
            </div>
        </div>
    </div>
</div>