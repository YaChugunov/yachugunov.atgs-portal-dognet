...
// Обработчик таблицы счетов
	table_zayv_child_dop = $('#chetview-zayv-child-dop').DataTable( {
		dom: "<'row'<'col-sm-5'><'col-sm-4'><'col-sm-3'<'test_msg'>>>" + "<'row'<'col-sm-12'tr>>" + "<'row'<'col-sm-1'B><'col-sm-5'i><'col-sm-6'p>>",
		language: {
			url: "php/examples/simple/chetview/chetview-details/dt_russian-tab7_zayv_child_dop.json"
		},
		ajax: {
			url: "php/examples/php/chetview/chetview-details/dognet-chetview-details-tab7_zayv_child_dop-process.php",
			type: "POST",
      data: function ( d ) {
...
// Array to track the ids of the details displayed rows
  ...
  $('#chetview-zayv-child-dop tbody').on( 'click', 'tr td.details-control', function () {
      ...
      if ( row.child.isShown() ) {
		...
		d = row.data();
		rowData.child( <?php include('templates/chetview-details_tab7_zayv_child_dop.tpl'); ?> ).show();
...
//
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/chetview/chetview-details/restr_4/tabs/css/chetview-details-common-tab7_zayv_child_dop.css">
<h3 class="chetview-details-title2 text-right">Спецификация к заявке (список, создаваемый вручную)</h3>
<div class="demo-html"></div>
<table id="chetview-zayv-child-dop" class="table table-responsive table-bordered display compact" cellspacing="0" width="100%">
	<thead>
		<tr>
