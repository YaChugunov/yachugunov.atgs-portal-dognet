...
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/chetview/chetview-details/restr_4/tabs/css/chetview-details-common-tabs.css">
...
<div class="container">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <?php include("dognet-chetview-details(restr_4)-main.php"); ?>
        </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <ul id="main-tabs-menu" class="nav nav-tabs">
                            ...
                            <li style="float:right"><a
                                   href="dognet-chetview.php?chetview_type=edit&uniqueID=<?php echo $_GET['uniqueID']; ?>"
                                   title=""><span class="glyphicon glyphicon-pencil"></span></a></li>
                        </ul>
                        <div class="tab-content">
                            <div id="tab-1" class="tab-pane fade in active">
                                <?php include("tabs/dognet-chetview-details(restr_4)-tab1.php"); ?>
                            </div>
                            <div id="tab-2" class="tab-pane fade">
                                <?php include("tabs/dognet-chetview-details(restr_4)-tab2.php"); ?>
                            </div>
                            <div id="tab-4" class="tab-pane fade">
                                <?php include("tabs/dognet-chetview-details(restr_4)-tab4.php"); ?>
                            </div>
                            <div id="tab-5" class="tab-pane fade">
                                <?php include("tabs/dognet-chetview-details(restr_4)-tab5_zadolg.php"); ?>
                            </div>
                            <div id="tab-7" class="tab-pane fade">
                                <?php include("tabs/dognet-chetview-details(restr_4)-tab7.php"); ?>
                            </div>
                            <div id="tab-8" class="tab-pane fade">
                                <?php include("tabs/dognet-chetview-details(restr_4)-tab8_paperotgr.php"); ?>
                            </div>
                            <div id="tab-9" class="tab-pane fade">
                                <?php include("tabs/dognet-chetview-details(restr_4)-tab9_paperacts.php"); ?>
                            </div>
                        </div>
                    </div>
                </div>
