	...
	<div id="doc-details-tabs" class="doc-details-tabs" style="width:100%">
		...
		<div class="tab-content" style="padding:5px; width:100%">
			<div id="doc-details-tab1-1" class="tab-pane fade in active">
				<?php	include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/chetview/chetview-details/restr_3/tabs/dognet-chetview-details(restr_3)-tab1_common.php"); ?>
			</div>
			<div id="doc-details-tab1-3" class="tab-pane fade">
				<?php	include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/chetview/chetview-details/restr_3/tabs/dognet-chetview-details(restr_3)-tab1_finances.php"); ?>
			</div>
			<div id="doc-details-tab1-4" class="tab-pane fade">
				<?php	include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/chetview/chetview-details/restr_3/tabs/dognet-chetview-details(restr_3)-tab1_zakazchik.php"); ?>
			</div>
			<div id="doc-details-tab1-6" class="tab-pane fade">
				<?php	include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/chetview/chetview-details/restr_3/tabs/dognet-chetview-details(restr_3)-tab1_comments.php"); ?>
			</div>
		</div>
	</div>
