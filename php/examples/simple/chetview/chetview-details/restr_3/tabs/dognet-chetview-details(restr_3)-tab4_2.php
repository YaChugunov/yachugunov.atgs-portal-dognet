...
<style>
	#docview-details-tab4_2 > thead { display:none }
	#docview-details-tab4_2 > tbody > tr > td:first-child { width:20px }
	#docview-details-tab4_2 > tbody > tr > td,
	#docview-details-tab4_2 > tbody > tr > th,
	#docview-details-tab4_2 > tfoot > tr > td,
	#docview-details-tab4_2 > tfoot > tr > th,
	#docview-details-tab4_2 > thead > tr > td,
	#docview-details-tab4_2 > thead > tr > th { border:none }
	#docview-details-tab4_2 > tbody > tr > td > a { color:#3B7087; text-decoration:underline }
	#docview-details-tab4_2 > tbody > tr > td > a:hover { color:#333; text-decoration:none }
</style>

<script type="text/javascript" language="javascript" class="init">

var editor_tab4_2;		// use a global for the submit and return data rendering in the examples
var table_tab4_2;		// use a global for the submit and return data rendering in the examples

// ----- ----- ----- ----- ----- ----- ----- ----- ----- -----

$(document).ready(function() {

	table_tab4_2 = $('#docview-details-tab4_2').DataTable( {
// 		dom: "<'row'<'col-md-8 col-sm-12'><'col-md-4 col-sm-12'>r>t<'row'<'col-md-12 col-sm-12 footer'lftip>>",
		...
		ajax: {
			url: "php/examples/php/docview/docview-details/dognet-docview-details-tab4_2-process.php",
			type: "POST"
		},
		serverSide: true,
		columns: [
...
/*
		createdRow: function( row, d, i ) {
			...
			rowData.child( <?php include('templates/docview-details_tab4_2.tpl'); ?> ).show();

		}
*/
	} );
/*
	table_tab4_2.on( 'order.dt search.dt', function () {
		table_tab4_2.column(0, {search:'applied', order:'applied'}).nodes().each( function (cell, i) {
			cell.innerHTML = i+1;
		} );
	} ).draw();
*/
...
<section>
	...
	<table id="docview-details-tab4_2" class="table table-condensed" cellspacing="0" width="100%">
		<thead>
			<tr>
				<th width="100%"></th>
			</tr>
