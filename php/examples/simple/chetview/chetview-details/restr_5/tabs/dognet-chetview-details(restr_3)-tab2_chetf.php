...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/chetview/chetview-details/restr_5/tabs/css/chetview-details-common-tab2_chetf.css">
...
// :::
?>
		<h3 class="chetview-details-title2">Выставленые счета-фактуры</h3>
		<table id="chetview-details-tab2-chetfzadolg" class="table table-responsive table-bordered display compact" cellspacing="0" width="100%">
			<thead>
				<tr>
...
?>
				<tr style="background-color:#f7f7f7; color:#111">
					<td class="chetview-details-tab2-chetfzadolg text-center" style="font-size:1.0em; font-weight:700; border-bottom:none"><a href="#tab2-chetf-row-<?php echo $row_getKalplan['kodkalplan']; ?>" data-toggle="collapse"><span class='glyphicon glyphicon-option-vertical'></span></a></td>
					<td class="chetview-details-tab2-chetfzadolg-numberstage text-center" style="font-size:1.0em; font-weight:700; border-bottom:none"><?php echo $row_getKalplan['numberstage']; ?></td>
					<td colspan="6" class="chetview-details-tab2-chetfzadolg-namestage text-left" style="font-size:1.0em; font-weight:700; border-bottom:none"><?php echo ($row_getKalplan['namefullstage']!="") ? $row_getKalplan['namefullstage'] : $row_getKalplan['nameshotstage']; ?></td>
				</tr>
<?php
...
?>
				<tr id="tab2-chetf-row-<?php echo $row_getKalplan['kodkalplan']; ?>" class="collapse in">
					<td colspan="8" class="chetview-details-tab2-chetfzadolg-collapse">
						<table id="chetview-details-tab2-chetfzadolg-collapse-table" class="table table-responsive display compact" cellspacing="0" width="100%">
							<tbody>
<?php
...
?>
								<tr>
									...
									<td class="chetview-details-tab2-chetfzadolg-dateplan text-left"><?php echo date("d.m.Y", strtotime($row_getChetf['chetfdate'])); ?></td>
...
?>
								<tr>
									...
									<td></td>
									<td></td>
									<td class="chetview-details-tab2-chetfzadolg-namestage text-right">Оплата от <?php echo date("d.m.Y", strtotime($row_getOplatachf['dateopl'])); ?></td>
									<td></td>
				...
				<tr id="tab2-chetf-row-<?php echo $row_getKalplan['kodkalplan']; ?>" class="collapse in">
					...
					<td colspan="6" class="chetview-details-tab2-chetfzadolg-collapse">
						<table id="chetview-details-tab2-chetfzadolg-collapse-table" class="table table-responsive display compact" cellspacing="0" width="100%">
							<tbody>
								<tr>
									<td class="chetview-details-tab2-message text-left text-danger" style="text-align:left">Счетов-фактур по данному этапу не выставлялось...</td>
								</tr>
							</tbody>
						</table>
					</td>
...
?>
				<tr style="background-color:#f7f7f7; color:#111">
					<td colspan="8" class="chetview-details-tab2-nokalplan text-left" style="font-size:1.0em; font-weight:700; text-align:left">Без этапа</td>
				</tr>
<?php
			// Выбираем выставленные счета-фактуры по текущему календарному плану (этапу)
