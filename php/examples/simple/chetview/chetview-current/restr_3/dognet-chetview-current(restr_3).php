...
date_default_timezone_set('Europe/Moscow');
	...
	$__title = 'Договор';
	$__subtitle = "Текущие договора-счета";
	$__subsubtitle = "Работа с договорами-счетами";

		PORTAL_SYSLOG('99930000', '0000000', null, null, null, null);
...
<div class="container">
	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12">
			<?php include("dognet-chetview-current(restr_3)-main.php"); ?>
		</div>
	</div>
