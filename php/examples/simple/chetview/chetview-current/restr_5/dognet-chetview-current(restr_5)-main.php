...
<script type="text/javascript" language="javascript" class="init">
    ...
    function ajaxRequest_firstavansAsync(koddoc) {
        ...
        $.ajax({
            ...
            cache: false,
            type: "post",
            url: "php/examples/simple/chetview/chetview-current/restr_5/process/ajaxrequests/dognet-reqAjax-getFromDBAsync-firstavans.php",
            data: {
                koddoc: koddoc
            },
    ...
    function ajaxRequest_firstavans(data, responseHandler) {
        ...
        request = $.ajax({
            url: "php/examples/simple/chetview/chetview-current/restr_5/process/ajaxrequests/dognet-reqAjax-getFromDB-firstavans.php",
            type: "post",
            cache: false,
            data: {
                koddoc: data
    ...
    $(document).ready(function() {
        ...
        editor_chet_main = new $.fn.dataTable.Editor({
            display: "bootstrap",
            ajax: "php/examples/simple/chetview/chetview-current/restr_5/process/dognet-chetview-chet-main-process.php",
                ...
                if (action === "edit") {
                    if (firstavans_dateAsync !== "") {
                        console.log('CHECKPOINT',
                            'Div [id="block-chkDocDateEndInDays"] must be visible')
                        $('#block-chkDocDateEndInDays').css({
                            'margin-left': '15px',
                            'padding-top': '0',
                            'display': 'block'
                        });
                        $('#block-chkDocDateEndInDays').addClass("test");
                    } else {
                        $('#block-chkDocDateEndInDays').css({
                            'margin-left': '15px',
                            'padding-top': '0',
        ...
        table_chet_main = $('#chetview-chet-main').DataTable({
            ...
            ajax: {
                url: "php/examples/simple/chetview/chetview-current/restr_5/process/dognet-chetview-chet-main-process.php",
                type: "POST"
            },
            serverSide: true,
            columns: [{
