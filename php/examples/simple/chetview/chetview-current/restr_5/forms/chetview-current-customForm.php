				...
				<div class="Section">
					...
					<div class="Block60">
						...
						<div id="block-chkDocDateEndInDays" class="checkbox" style="">
							<label style="font-size:1.5rem"><input id="chkDocDateEndInDays" type="checkbox" value=""><b>Срок окончания в днях (от 1-го аванса)</b></label>
						</div>
					</div>
					<div class="Block40">
				...
				<div class="Section">
					<div class="Block100">
						...
						<div class="Block100">
							...
							<fieldset class="field40 kodobjectFilter" style="padding-top:30px; padding-right:15px; padding-left:15px">
						...
						<div class="Block100">
							...
							<fieldset class="field40 kodzakazFilter" style="padding-top:30px; padding-right:15px; padding-left:15px">
