...
?>
<?php
if (checkDognetMainpageViewBlock(4, 'new_blanks')>0) {
?>
...
// 		dom: "<'space50'r>tip",
		...
		ajax: {
			url: "php/examples/simple/main/main/restr_4/tabs/process/gipwork-main-blankinprogress-process.php",
			type: "POST"
		},
		serverSide: true,
		columns: [
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/main/main/restr_4/tabs/css/gipwork-main-blankinprogress.css">
<section>
