...
elseif (checkIsItGIP($_SESSION['id'])==1) {
	...
	$dognet_start_msg = "<span><b>Вы - сотрудник отдела договоров.</b> Ниже вы найдете информацию, которая возможно будет для вас полезной.</span>";
}
...
?>
	...
	<div id="admin-anounce" class="">
		<div class="row admin-anounce-block">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<?php include("dognet-main(restr_4)-tab1_gipwork-main-chart_stageprogress.php"); ?>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="block">
						...
						<?php include("dognet-main(restr_4)-tab1_gipwork-main-blankinprogress.php"); ?>
					</div>
			</div>
		</div>
	</div>
		...
		<div class="row space20">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="block">
						...
						<?php include("dognet-main(restr_4)-tab1_gipwork-main-newdocs.php"); ?>
					</div>
			</div>
		</div>
		<div class="row space20">
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
					<div class="block">
						...
						<?php include("dognet-main(restr_4)-tab1_gipwork-main-newavans.php"); ?>
					</div>
			</div>
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
					<div class="block">
						...
						<?php include("dognet-main(restr_4)-tab1_gipwork-main-newchf.php"); ?>
					</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
					<div class="block">
						...
						<?php include("dognet-main(restr_4)-tab1_gipwork-main-newoplchf.php"); ?>
					</div>
			</div>
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
					<div class="block">
						...
						<?php include("dognet-main(restr_4)-tab1_gipwork-main-newoplav.php"); ?>
					</div>
			</div>
		</div>
	</div>
...
<?php
include("dognet-main(restr_4)-tab1_gipwork-control-stages_oplataexpired.php");
?>
					</div>
			</div>
		</div>
	...
	<div id="doc-details-tabs" class="doc-details-tabs" style="width:100%">
		...
		<div class="tab-content" style="padding:5px; width:100%">
			<div id="doc-details-tab1-2" class="tab-pane fade in active">
					<?php include("dognet-main(restr_4)-tab1_gipwork-control-stages_expired.php"); ?>
			</div>
			<div id="doc-details-tab1-3" class="tab-pane fade">
					<?php include("dognet-main(restr_4)-tab1_gipwork-control-stages_avansostatok.php"); ?>
			</div>
			<div id="doc-details-tab1-4" class="tab-pane fade">
					<?php include("dognet-main(restr_4)-tab1_gipwork-control-stages_debtors.php"); ?>
			</div>
		</div>
	</div>
