...
// 	$("#main-newoplav-table-btnshow").click(function(){
		...
		table_gipwork_newoplav = $('#gipwork-main-newoplav-table').DataTable( {
			...
			ajax: {
				url: "php/examples/simple/main/main/restr_4/tabs/process/gipwork-main-newoplav-process.php",
				type: "POST"
			},
			serverSide: true,
			columns: [
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/main/main/restr_4/tabs/css/gipwork-main-newoplav.css">
