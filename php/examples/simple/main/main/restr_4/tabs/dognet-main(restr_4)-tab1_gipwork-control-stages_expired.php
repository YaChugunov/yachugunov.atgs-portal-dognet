...
$(document).ready(function() {
		table_gipwork_control_stages_expired = $('#gipwork-control-stages_expired-table').DataTable( {
			...
			ajax: {
				url: "php/examples/simple/main/main/restr_4/tabs/process/gipwork-control-stages_expired-process.php",
				type: "POST"
			},
			serverSide: true,
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/main/main/restr_4/tabs/css/gipwork-control-stages_expired.css">
<section>
