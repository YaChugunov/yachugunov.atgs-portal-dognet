...
$(document).ready(function() {
		table_gipwork_control_stages_uncompleted = $('#gipwork-control-stages_uncompleted-table').DataTable( {
			...
			ajax: {
				url: "php/examples/simple/main/main/restr_4/tabs/process/gipwork-control-stages_uncompleted-process.php",
				type: "POST"
			},
			serverSide: true,
			columns: [
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/main/main/restr_4/tabs/css/gipwork-control-stages_uncompleted.css">
<section>
	<div id="gipwork-control-stages_uncompleted" class="" style="">
