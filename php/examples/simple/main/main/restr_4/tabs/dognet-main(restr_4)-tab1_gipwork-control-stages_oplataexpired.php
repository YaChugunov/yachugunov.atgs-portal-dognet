...
$(document).ready(function() {
		table_gipwork_control_stages_oplataexpired = $('#gipwork-control-stages_oplataexpired-table').DataTable( {
			...
			ajax: {
				url: "php/examples/simple/main/main/restr_4/tabs/process/gipwork-control-stages_oplataexpired-process.php",
				type: "POST"
			},
			serverSide: true,
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/main/main/restr_4/tabs/css/gipwork-control-stages_oplataexpired.css">
<div id="gipwork-control-stages_oplataexpired-border" style="padding:4px 10px; border:2px #336a86 solid; border-radius:10px">
<section>
	<div id="gipwork-control-stages_oplataexpired" class="" style="">
