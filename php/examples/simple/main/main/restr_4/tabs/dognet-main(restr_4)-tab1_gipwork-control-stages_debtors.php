...
?>
<?php
if (checkDognetMainpageViewBlock(4, 'control_debtors') > 0) {
?>
	<script type="text/javascript" language="javascript" class="init">
		...
		$(document).ready(function() {
			table_gipwork_control_stages_debtors = $('#gipwork-control-stages_debtors-table').DataTable({
				...
				ajax: {
					url: "php/examples/simple/main/main/restr_4/tabs/process/gipwork-control-stages_debtors-process.php",
					type: "POST"
				},
				serverSide: true,
				columns: [{
	...
	// :::
	?>
	<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/main/main/restr_4/tabs/css/gipwork-control-stages_debtors.css">
	<section>
		<div id="gipwork-control-stages_debtors" class="">
