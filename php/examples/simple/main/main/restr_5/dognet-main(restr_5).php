...
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/main/main/restr_5/tabs/css/main-common-tabs.css">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12">
						<ul id="main-tabs-menu" class="nav nav-tabs">
							...
							<li id="tab-2-link"><a data-toggle="tab" href="#tab-2" title="">События</a></li>
							...
							<li id="tab-6-link"><a data-toggle="tab" href="#tab-6" title="">Отчёты и справки</a></li>
						</ul>
						<div class="tab-content">
							<div id="tab-1" class="tab-pane fade in active">
								<?php include("tabs/dognet-main(restr_5)-tab1.php"); ?>
							</div>
							<div id="tab-2" class="tab-pane fade">
								<?php include("tabs/dognet-main(restr_5)-tab2.php"); ?>
							</div>
							<div id="tab-3" class="tab-pane fade">
								<?php include("tabs/dognet-main(restr_5)-tab3.php"); ?>
							</div>
							<div id="tab-4" class="tab-pane fade">
								<?php // include("tabs/dognet-main(restr_5)-tab4.php"); 
								?>
							</div>
							<div id="tab-5" class="tab-pane fade">
								<?php include("tabs/dognet-main(restr_5)-tab5.php"); ?>
							</div>
							<div id="tab-6" class="tab-pane fade">
								<?php // include("tabs/dognet-main(restr_5)-tab6.php"); 
								?>
							</div>
						</div>
					</div>
