...
?>
<?php
if (checkDognetMainpageViewBlock(4, 'new_oplav')>0) {
?>
<script type="text/javascript" language="javascript" class="init">
var table_gipwork_newoplav;
// ----- ----- -----
$(document).ready(function() {
// 	$("#main-newoplav-table-btnshow").click(function(){
		$("#gipwork-main-newoplav").css({"display":""});
		table_gipwork_newoplav = $('#gipwork-main-newoplav-table').DataTable( {
			...
			ajax: {
				url: "php/examples/simple/main/main/restr_5/tabs/process/gipwork-main-newoplav-process.php",
				type: "POST"
			},
			serverSide: true,
			columns: [
		...
		table_gipwork_newoplav.on( 'processing', function( e, settings, processing ) {
			if(!processing) {
// 				$("#main-newoplav-table-btnshow").remove();
				$("#gipwork-main-newoplav-table").addClass("table-bordered");
				$(table_gipwork_newoplav.table().header()).css('display','');
			}
			else {
// 				$("#main-newoplav-table-btnshow").prop('disabled', true);
				$(table_gipwork_newoplav.table().header()).css('display','none');
			}
		} )
// 	} )
} );
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/main/main/restr_5/tabs/css/gipwork-main-newoplav.css">
<!-- <button id="main-newoplav-table-btnshow" type="button" class="" style="margin-top:10px">Показать данные</button> -->
<section>
	<div id="gipwork-main-newoplav" class="" style="display:none">
		<div class="demo-html"></div>
		<table id="gipwork-main-newoplav-table" class="table table-responsive display compact" cellspacing="0" width="100%">
			<thead id="gipwork-main-newoplav-table-header" style="display:none">
				<tr>
					<th>Дог/Сч</th>
					<th>Этап</th>
					<th>Зачет от</th>
