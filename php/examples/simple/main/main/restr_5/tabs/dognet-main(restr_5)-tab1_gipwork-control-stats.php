...
$(document).ready(function() {
	table_tab1_kalplans = $('#gipwork-control-stages_all').DataTable( {
		...
		ajax: {
			url: "php/examples/simple/main/main/restr_5/tabs/process/gipwork-control-stages_all-process.php",
			type: "POST"
		},
		serverSide: true,
		columns: [
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/main/main/restr_5/tabs/css/gipwork-control-stages_all.css">
<section>
