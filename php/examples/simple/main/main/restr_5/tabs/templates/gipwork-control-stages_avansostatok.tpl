		...
		'<div class="row">'+
			'<div class="col-xs-12 col-sm-12 col-md-12">'+
				'<ul id="row-details-gipwork-control-stages_avansostatok-tabs-menu" class="nav nav-tabs">'+
					'<li class="active"><a data-toggle="tab" href="#control-stages_avansostatok-'+row.id()+'-tab-1" title="">Информация по договору</a></li>'+
					'<li><a data-toggle="tab" href="#control-stages_avansostatok-'+row.id()+'-tab-2" title="">Информация по этапу</a></li>'+
					'<li><a data-toggle="tab" href="#control-stages_avansostatok-'+row.id()+'-tab-3" title="">Сроки выполнения и оплаты</a></li>'+
				'</ul>'+
				'<div class="tab-content">'+
					...
					'<div id="control-stages_avansostatok-'+row.id()+'-tab-2" class="tab-pane fade">'+
						...
						'</div>'+
					'</div>'+
					'<div id="control-stages_avansostatok-'+row.id()+'-tab-3" class="tab-pane fade">'+
						'<div class="hidden-xs col-sm-12 col-md-12 col-lg-12">'+
							'<div class="space10"></div>'+
							'<div style="padding:10px">'+
