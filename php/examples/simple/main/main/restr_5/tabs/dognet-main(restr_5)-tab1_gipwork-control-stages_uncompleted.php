...
$(document).ready(function() {
	$("#control-stages_uncompleted-table-btnshow").click( function(){
		$("#control-stages_uncompleted-table-btnshow").remove();
		$("#gipwork-control-stages_uncompleted").css({"display":""});
		table_gipwork_control_stages_uncompleted = $('#gipwork-control-stages_uncompleted-table').DataTable( {
			...
			ajax: {
				url: "php/examples/simple/main/main/restr_5/tabs/process/gipwork-control-stages_uncompleted-process.php",
				type: "POST"
			},
			serverSide: true,
			columns: [
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/main/main/restr_5/tabs/css/gipwork-control-stages_uncompleted.css">
<section>
<center><button id="control-stages_uncompleted-table-btnshow" type="button" class="" style="margin:10px">Показать данные</button></center>
	<div id="gipwork-control-stages_uncompleted" class="" style="display:none">
		<h3 class="docview-details-title2 space10">Незакрытые этапы</h3>
		<div class="demo-html"></div>
		<table id="gipwork-control-stages_uncompleted-table" class="table table-bordered table-responsive display compact" cellspacing="0" width="100%">
			<thead id="gipwork-control-stages_uncompleted-table-header">
				<tr>
