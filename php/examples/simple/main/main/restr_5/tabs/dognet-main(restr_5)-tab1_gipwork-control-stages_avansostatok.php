...
?>
<?php
if (checkDognetMainpageViewBlock(5, 'control_avans')>0) {
?>
<script type="text/javascript" language="javascript" class="init">
var table_gipwork_control_stages_avansostatok;
// ----- ----- -----
$(document).ready(function() {
	$("#control-stages_avansostatok-table-btnshow").click( function(){
		$("#control-stages_avansostatok-table-btnshow").remove();
		$("#gipwork-control-stages_avansostatok").css({"display":""});
		table_gipwork_control_stages_avansostatok = $('#gipwork-control-stages_avansostatok-table').DataTable( {
			...
			ajax: {
				url: "php/examples/simple/main/main/restr_5/tabs/process/gipwork-control-stages_avansostatok-process.php",
				type: "POST"
			},
			serverSide: true,
			columns: [
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/main/main/restr_5/tabs/css/gipwork-control-stages_avansostatok.css">
<section>
<center><button id="control-stages_avansostatok-table-btnshow" type="button" class="" style="margin:10px">Показать данные</button></center>
	<div id="gipwork-control-stages_avansostatok" class="" style="display:none">
