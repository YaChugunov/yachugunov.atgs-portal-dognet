...
?>
<?php
if (checkDognetMainpageViewBlock(5, 'new_stages') > 0) {
?>
	<script type="text/javascript" language="javascript" class="init">
		var table_gipwork_newdocs;
		// ----- ----- -----
		$(document).ready(function() {
			// 	$("#main-newdocs-table-btnshow").click( function(){
			$("#gipwork-main-newdocs").css({
				"display": ""
			});
			table_gipwork_newdocs = $('#gipwork-main-newdocs-table').DataTable({
				...
				ajax: {
					url: "php/examples/simple/main/main/restr_5/tabs/process/gipwork-main-newdocs-process.php",
					type: "POST"
				},
				serverSide: true,
			...
			table_gipwork_newdocs.on('processing', function(e, settings, processing) {
				if (!processing) {
					/* 				$("#main-newdocs-table-btnshow").remove(); */
					$("#gipwork-main-newdocs-table").addClass("table-bordered");
					$(table_gipwork_newdocs.table().header()).css('display', '');
				} else {
					$(table_gipwork_newdocs.table().header()).css('display', 'none');
				}
			})
			/* 	} ); */
		});
	...
	// :::
	?>
	<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/main/main/restr_5/tabs/css/gipwork-main-newdocs.css">
	<!-- <button id="main-newdocs-table-btnshow" type="button" class="" style="margin-top:10px">Показать данные</button> -->
	<section>
		<div id="gipwork-main-newdocs" class="" style="display:none">
			<div class="demo-html"></div>
			<table id="gipwork-main-newdocs-table" class="table table-responsive display compact" cellspacing="0" width="100%">
				<thead id="gipwork-main-newdocs-table-header" style="display:none">
					<tr>
