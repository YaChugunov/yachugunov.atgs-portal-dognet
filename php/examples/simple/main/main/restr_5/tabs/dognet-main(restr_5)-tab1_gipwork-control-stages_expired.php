...
?>
<?php
if (checkDognetMainpageViewBlock(5, 'control_stages')>0) {
?>
...
$(document).ready(function() {
		table_gipwork_control_stages_expired = $('#gipwork-control-stages_expired-table').DataTable( {
			...
			language: {
				url: "php/examples/simple/main/main/dt_russian-control-stages_uncompl.json"
			},
			ajax: {
				url: "php/examples/simple/main/main/restr_5/tabs/process/gipwork-control-stages_expired-process.php",
				type: "POST"
			},
			serverSide: true,
			columns: [
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/main/main/restr_5/tabs/css/gipwork-control-stages_expired.css">
<section>
