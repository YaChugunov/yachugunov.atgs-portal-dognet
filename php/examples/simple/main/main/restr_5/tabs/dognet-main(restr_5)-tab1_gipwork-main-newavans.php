...
// 	$("#main-newavans-table-btnshow").click(function(){
		...
		table_gipwork_newavans = $('#gipwork-main-newavans-table').DataTable( {
			...
			ajax: {
				url: "php/examples/simple/main/main/restr_5/tabs/process/gipwork-main-newavans-process.php",
				type: "POST"
			},
			serverSide: true,
			columns: [
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/main/main/restr_5/tabs/css/gipwork-main-newavans.css">
