...
?>
<?php
if (checkDognetMainpageViewBlock(3, 'new_stages') > 0) {
?>
	<script type="text/javascript" language="javascript" class="init">
		...
		$(document).ready(function() {
			table_gipwork_newdocs = $('#gipwork-main-newdocs-table').DataTable({
				...
				ajax: {
					url: "php/examples/simple/main/main/restr_3/tabs/process/gipwork-main-newdocs-process.php",
					type: "POST"
				},
				serverSide: true,
				columns: [{
	...
	// :::
	?>
	<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/main/main/restr_3/tabs/css/gipwork-main-newdocs.css">
	<section>
