...
?>
<?php
if (checkDognetMainpageViewBlock(3, 'new_oplchf')>0) {
?>
...
// 		dom: "<'row space20'<'col-md-8 col-sm-12'><'col-md-4 col-sm-12'>r>t<'row'<'col-md-12 col-sm-12 footer'ltip>>",
		...
		ajax: {
			url: "php/examples/simple/main/main/restr_3/tabs/process/gipwork-main-newoplchf-process.php",
			type: "POST"
		},
		serverSide: true,
		columns: [
  ...
  var detailRows = [];
  $('#gipwork-main-newoplchf-table tbody').on( 'click', 'tr td.details-control', function () {
      var tr = $(this).closest('tr');
      var row = table_gipwork_newoplchf.row( tr );
      ...
      if ( row.child.isShown() ) {
          ...
          tr.addClass( 'details' );
		rowData = table_gipwork_newoplchf.row( row );
		d = row.data();
	...
	table_gipwork_newoplchf.on( 'draw', function () {
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/main/main/restr_3/tabs/css/gipwork-main-newoplchf.css">
<section>
	<div id="gipwork-main-newoplchf" class="">
		<div class="demo-html"></div>
		<table id="gipwork-main-newoplchf-table" class="table table-bordered table-responsive display compact" cellspacing="0" width="100%">
			<thead style="">
				<tr>
					<th>Договор</th>
					<th>Этап</th>
