'<div id="template-details-gipwork-control">'+
	...
	'<div id="row-details-gipwork-main-newdocs-tabs">'+
		'<div class="row">'+
			'<div class="col-xs-12 col-sm-12 col-md-12">'+
				'<ul id="row-details-gipwork-main-newdocs-tabs-menu" class="nav nav-tabs">'+
					'<li class="active"><a data-toggle="tab" href="#main-newdocs-'+row.id()+'-tab-1" title="">Информация по договору</a></li>'+
					'<li><a data-toggle="tab" href="#main-newdocs-'+row.id()+'-tab-2" title="">Информация по этапу</a></li>'+
					'<li><a data-toggle="tab" href="#main-newdocs-'+row.id()+'-tab-3" title="">Сроки выполнения и оплаты</a></li>'+
				'</ul>'+
				'<div class="tab-content">'+
					'<div id="main-newdocs-'+row.id()+'-tab-1" class="tab-pane fade in active">'+
						'<div class="hidden-xs col-sm-12 col-md-12 col-lg-12">'+
							'<div class="space10"></div>'+
							'<div style="padding:10px">'+

								'<table id="row-details-gipwork-main-newdocs-table" class="table table-condensed table-striped" >'+
									'<tbody>'+
										'<tr>'+
										...
										'</tr>'+
										'<tr>'+
											'<td width="30%"><span class="row-details-gipwork-control-table-title_topic">Дата создания договора</span></td>'+
											'<td width="70%"><span class="row-details-gipwork-control-table-txt">'+d.dognet_docblankwork.dateblankdoc+'</span></td>'+
										'</tr>'+
										'<tr>'+
						...
						'</div>'+
					'</div>'+
					'<div id="main-newdocs-'+row.id()+'-tab-2" class="tab-pane fade">'+
						'<div class="hidden-xs col-sm-12 col-md-12 col-lg-12">'+
							'<div class="space10"></div>'+
							'<div style="padding:10px">'+
								...
								'<table id="row-details-gipwork-main-newdocs-table" class="table table-condensed table-striped" >'+
									'<tbody>'+
										...
										'</tr>'+
										'<tr>'+
											'<td width="30%"><span class="row-details-gipwork-control-table-title_topic">Дата создания этапа</span></td>'+
											'<td width="70%"><span class="row-details-gipwork-control-table-txt">'+d.dognet_dockalplan_progress.stagecreated+'</span></td>'+
										'</tr>'+
										'<tr>'+
						...
						'</div>'+
					'</div>'+
					'<div id="main-newdocs-'+row.id()+'-tab-3" class="tab-pane fade">'+
						'<div class="hidden-xs col-sm-12 col-md-12 col-lg-12">'+
							'<div class="space10"></div>'+
							'<div style="padding:10px">'+
