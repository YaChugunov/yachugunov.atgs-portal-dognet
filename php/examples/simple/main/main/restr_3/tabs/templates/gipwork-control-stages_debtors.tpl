'<div id="template-details-gipwork-control">'+
	...
	'<div id="row-details-gipwork-control-stages_debtors-tabs">'+
		'<div class="row">'+
			'<div class="col-xs-12 col-sm-12 col-md-12">'+
				'<ul id="row-details-gipwork-control-stages_debtors-tabs-menu" class="nav nav-tabs">'+
					'<li class="active"><a data-toggle="tab" href="#control-stages_debtors-'+row.id()+'-tab-1" title="">Информация по договору</a></li>'+
					'<li><a data-toggle="tab" href="#control-stages_debtors-'+row.id()+'-tab-2" title="">Информация по этапу</a></li>'+
					'<li><a data-toggle="tab" href="#control-stages_debtors-'+row.id()+'-tab-3" title="">Сроки выполнения и оплаты</a></li>'+
				'</ul>'+
				'<div class="tab-content">'+
					'<div id="control-stages_debtors-'+row.id()+'-tab-1" class="tab-pane fade in active">'+
						'<div class="hidden-xs col-sm-12 col-md-12 col-lg-12">'+
							'<div class="space10"></div>'+
							'<div style="padding:10px">'+

								'<table id="row-details-gipwork-control-stages_uncompleted-table" class="table table-condensed table-striped" >'+
									'<tbody>'+
										'<tr>'+
						...
						'</div>'+
					'</div>'+
					'<div id="control-stages_debtors-'+row.id()+'-tab-2" class="tab-pane fade">'+
						'<div class="hidden-xs col-sm-12 col-md-12 col-lg-12">'+
							'<div class="space10"></div>'+
							'<div style="padding:10px">'+

								'<table id="row-details-gipwork-control-stages_debtors-table" class="table table-condensed table-striped" >'+
									'<tbody>'+
										'<tr>'+
						...
						'</div>'+
					'</div>'+
					'<div id="control-stages_debtors-'+row.id()+'-tab-3" class="tab-pane fade">'+
						'<div class="hidden-xs col-sm-12 col-md-12 col-lg-12">'+
							'<div class="space10"></div>'+
							'<div style="padding:10px">'+
