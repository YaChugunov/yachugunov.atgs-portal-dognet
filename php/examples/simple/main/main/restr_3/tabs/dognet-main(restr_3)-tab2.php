		...
		<div class="row admin-anounce-block">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 space20">
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					<div class="block">
						<h3 class="space20">Флажки по финансам 1</h3>
						<blockquote class="">
							<p>Как вариант, например можно вывести финансовую сводку по договорам и счетам (общие суммы, задолженности, незакрытие и так далее). Все на ваше усмотрение. Главное сформулируйте задачу.</p>
				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					<div class="block">
						<h3 class="space20">Флажки по финансам 2</h3>
						<blockquote class="">
							<p>Как вариант, например можно вывести финансовую сводку по договорам субподряда (общие суммы, задолженности, незакрытие и так далее).</p>
							<footer>Ярослав Чугунов</footer>
						</blockquote>
					</div>
				</div>
