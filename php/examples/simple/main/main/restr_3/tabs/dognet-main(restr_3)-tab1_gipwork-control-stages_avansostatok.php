...
if (checkDognetMainpageViewBlock(3, 'control_avans')>0) {
?>
...
$(document).ready(function() {
	table_gipwork_control_stages_avansostatok = $('#gipwork-control-stages_avansostatok-table').DataTable( {
		...
		ajax: {
			url: "php/examples/simple/main/main/restr_3/tabs/process/gipwork-control-stages_avansostatok-process.php",
			type: "POST"
		},
		serverSide: true,
		columns: [
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/main/main/restr_3/tabs/css/gipwork-control-stages_avansostatok.css">
<section>
