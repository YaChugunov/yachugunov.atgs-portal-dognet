...
?>
<?php
if (checkDognetMainpageViewBlock(3, 'new_chf')>0) {
?>
...
// 		dom: "<'row space20'<'col-md-8 col-sm-12'><'col-md-4 col-sm-12'>r>t<'row'<'col-md-12 col-sm-12 footer'ltip>>",
		...
		ajax: {
			url: "php/examples/simple/main/main/restr_3/tabs/process/gipwork-main-newchf-process.php",
			type: "POST"
		},
		serverSide: true,
		columns: [
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/main/main/restr_3/tabs/css/gipwork-main-newchf.css">
<section>
	<div id="gipwork-main-newchf" class="">
		<div class="demo-html"></div>
		<table id="gipwork-main-newchf-table" class="table table-bordered table-responsive display compact" cellspacing="0" width="100%">
			<thead style="">
				<tr>
					<th>Дог/Сч</th>
					<th>Этап</th>
