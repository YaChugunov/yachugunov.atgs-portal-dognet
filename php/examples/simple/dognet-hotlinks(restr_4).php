    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="btn-group btn-group-justified">
                <a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/#"
                   class="btn btn-primary text-uppercase">Договор / Главная</a>
                <div class="btn-group">
                    <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown"><span
                              class="">Договора / Соглашения <span class="caret"></span></span></button>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/dognet-docview.php?docview_type=current"
                               class="">Текущие договора</a></li>
                        <li><a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/dognet-chetview.php?chetview_type=current"
                               class="">Текущие счета</a></li>
                        <li><a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/dognet-docview.php?docview_type=search"
                               class="">Расширенный поиск</a></li>
                        <li class="divider"></li>
                        <li><a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/dognet-agreeview.php?docview_type=current"
                               class="">Соглашения о партнерстве</a></li>
                    </ul>
                </div>
                <a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/dognet-blankview.php?blankview_type=edit"
                   class="btn btn-primary text-uppercase">Бланки</a>
                <?php
                if (checkIsItGIP($_SESSION['id']) == 1) {
                ?>
                <a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/dognet-blankview.php?blankview_type=current"
                   class="btn btn-primary text-uppercase">Работа ГИП</a>
                <?php
                }
                ?>
            </div>
            <div class="btn-group btn-group-justified">
                <div class="btn-group">
                    <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown"><span
                              class="">Отчетные формы <span class="caret"></span></span></button>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/dognet-report.php">Отчеты</a>
                        </li>
                    </ul>
                </div>
                <div class="btn-group">
                    <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown"><span
                              class="">Выходные документы <span class="caret"></span></span></button>
                    <ul class="dropdown-menu" role="menu">
                        <li><a
                               href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/dognet-actview.php?actview_type=list">Акты
                                о выполненных работах</a></li>
                        <li><a
                               href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/dognet-letterview.php?letterview_type=list">Журнал
                                писем должникам</a></li>
                    </ul>
                </div>
                <a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/sp/index.php?type=contragents&mode=main"
                   class="btn btn-danger text-uppercase">Новый справочник</a>
            ...
            <div class="btn-group btn-group-justified">
                <a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/dognet-zayvview.php?zayvview_type=current"
                   class="btn btn-primary text-uppercase">Заявки</a>
                <div class="btn-group">
                    <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown"><span
                              class="">Счета <span class="caret"></span></span></button>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/dognet-zayvview.php?zayvview_type=chet"
                               class="">Работа со счетами</a></li>
                        <li><a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/dognet-zayvview.php?zayvview_type=chetf"
                               class="">Работа со счетами-фактурами</a></li>
                    </ul>
                </div>
