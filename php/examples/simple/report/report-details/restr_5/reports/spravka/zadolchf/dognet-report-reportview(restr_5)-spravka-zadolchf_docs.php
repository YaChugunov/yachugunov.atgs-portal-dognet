<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		table_reports_spravka_zadolchf_docs = $('#reports-spravka-zadolchf-docs-table').DataTable({
			...
			ajax: {
				url: "php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf/process/dognet-report-reportview(restr_5)-spravka-zadolchf-docs-process.php",
				type: "POST"
			},
			serverSide: true,
			columns: [{
					...
					render: function(data, type, row, meta) {
						if (!isNaN(data)) {
							if (row.dognet_dockalplan.idsrokopl == 3) {
								...
								var par2 = moment(row.dognet_reports_zadolchf.chetfdate, 'DD.MM.YYYY').format('YYYY-MM-DD');
								...
								var chfdate = moment(row.dognet_reports_zadolchf.chetfdate, 'DD.MM.YYYY');
								var diff_days = data;
								var opldate = chfdate.add(diff_days, 'days').format('DD.MM.YYYY');
			...
			rowGroup: {
				startRender: function(rows, group, level) {
					...
					if (level == 0) {
						...
						return '<span style="text-align:left; white-space:nowrap">' + group + '</span><span style="float:right"><a href="dognet-report.php?reportview=zadolchf&export=yes&uniqueID1=' + koddoc + '&zak=' + kodzakaz + '"><span class="glyphicon glyphicon-print"></span></a></span>';
					}
					...
					if (level == 1) {
						...
						return '<span style="text-align:left; white-space:nowrap; margin-left:10px">Договор 3-4/' + docnumber + '&nbsp;:&nbsp;' + group + '</span>';
					}
				...
				endRender: function(rows, group, level) {
					...
					if (level == 0) {
						...
						return '<span class="itogo-lvl0"><span class="itogo-lvl0-title">Итого по заказчику</span><span class="itogo-lvl0-text"><span class="itogo-lvl-lbltext3">' + $.fn.dataTable.render.number(' ', ',', 2, '').display(avg) + '' + koddened + '</span></span></span>';

					}
					if (level == 1) {
						return '<span class="itogo-lvl1"><span class="itogo-lvl1-title">Итого по договору</span><span class="itogo-lvl1-text"><span class="itogo-lvl-lbltext3">' + $.fn.dataTable.render.number(' ', ',', 2, '').display(avg) + '' + koddened + '</span></span></span>';
					}
				},
				dataSrc: ["sp_contragents.nameshort", "dognet_docbase.docnameshot", "dognet_dockalplan.numberstage"]
			},
			...
			buttons: [{
				...
				action: function(e, dt, node, config) {
					...
					table_reports_spravka_zadolchf_docs.order([3, "asc"], [4, "asc"], [6, "asc"]).draw();
				}
			}],
...
*/
	...
	/* ----- */
	#reports-spravka-zadolchf-docs-table>tbody>tr.dtrg-start.dtrg-level-0>td {
		font-family: 'Oswald', sans-serif;
		font-size: 1.1em;
		font-weight: 500;
		text-align: left;
	...
	#reports-spravka-zadolchf-docs-table>tbody>tr.dtrg-end.dtrg-level-1>td {
		font-family: 'Play', sans-serif;
		font-size: 1.1em;
		font-weight: 300;
		color: #336a86;
	...
	/* ----- */
	#reports-spravka-zadolchf-docs-table>tbody>tr.dtrg-start.dtrg-level-1>td {
		padding: 5px;
		font-family: 'Oswald', sans-serif;
		font-size: 1.15em;
		font-weight: 500;
	...
	#reports-spravka-zadolchf-docs-table>tbody>tr.dtrg-start.dtrg-level-2>td {
		font-family: 'Oswald', sans-serif;
		font-size: 1.15em;
		font-weight: 400;
		color: #111;
...
*/
	...
	#reports-spravka-zadolchf-docs-table>tbody>tr.dtrg-end.dtrg-level-0>td {
		font-family: 'Oswald', sans-serif;
		font-size: 1.4em;
		font-weight: 500;
		color: #000;
						...
						<div id="reports-spravka-zadolchf-docs-filters" class="panel-body space30">
							...
							<div class="col-xs-12 col-sm-4 col-md-2 col-lg-2">
								<div class="input-group space10" style="width:100%">
									...
									<select name="reportZadolTypeSearch_text_1" id="reportZadolTypeSearch_text_1" class="form-control">
							...
							<div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
								<div class="form-group space10" style="width:100%">
									...
									<input type="text" id="reportChfNumberSearch_text_1" class="form-control" placeholder="####" name="reportChfNumberSearch_text_1">
								</div>
							</div>
							<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
								<div class="input-group space10" style="width:100%">
									<label for="reportObjectSearch_text_1"><b>Заказчик/объект :</b></label>
									<input type="text" id="reportObjectSearch_text_1" class="form-control" placeholder="Все объекты" name="reportObjectSearch_text_1">
								</div>
							</div>
							<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
								<div class="input-group space10" style="width:100%">
									<label for="reportDocNameSearch_text_1"><b>Текст из названия договора :</b></label>
									<input type="text" id="reportDocNameSearch_text_1" class="form-control" placeholder="Введите текст" name="reportDocNameSearch_text_1">
								</div>
							</div>
							<?php // ----- ----- ----- ----- ----- 
							?>
