...
$activeSheet->setCellValue("A{$line}", 'Судебная задолженность на ' . $_SPRAVKA_ONDATE);
...
//
$_queryStr .= "kodstatuszdl='2' AND koddoc IN (SELECT koddoc FROM dognet_reports_zadolchf)) ORDER BY nameshort ASC";
//
