<?php
    ...
    $_queryStr .= "koddoc IN (SELECT koddoc FROM dognet_reports_zadolchf)) ORDER BY nameshort ASC";
    if (checkUserRestrictions($_SESSION['id'], 'dognet', 5, 1) == 1) {
...
*/
    ...
    // PORTAL_SYSLOG('99942200', '0000002', null, $_GET['reportview'], "Задолженность по счетам-фактурам", "WORD");
