...
*/
#
$_queryStr = "SELECT * FROM dognet_spsubpodr WHERE kodsubpodr IN ( SELECT kodsubpodr FROM dognet_docsubpodr WHERE sumzadolsubpodr>'0.00' AND koddel<>'99' AND koddocsubpodr IN (SELECT koddocsubpodr FROM dognet_docchfsubpodr WHERE sumzadolchfsubpodr>'0.00' AND koddel<>'99' AND datechfsubpodr<='{$_ONDATE}') ) ORDER BY namesubpodrshot ASC";
...
while ($_ROW = mysqli_fetch_assoc($_QRY)) {
	...
	#
	$_MAINDOC_EXIST = 0;
	$_queryStr = "SELECT * FROM dognet_docbase WHERE koddoc IN (SELECT koddoc FROM dognet_dockalplan WHERE kodkalplan IN (SELECT koddoc FROM dognet_docsubpodr WHERE sumzadolsubpodr<>'0.00' AND koddel<>'99' AND kodsubpodr='{$_kodsubpodr}' AND koddocsubpodr IN (SELECT koddocsubpodr FROM dognet_docchfsubpodr WHERE koddel<>'99' AND datechfsubpodr<='{$_ONDATE}')))";
	if (checkUserRestrictions($_SESSION['id'], 'dognet', 5, 1) == 1) {
	...
	if ($_MAINDOC_EXIST == 1) {
		...
		while ($_ROW_docbase = mysqli_fetch_assoc($_QRY_docbase)) {
			...
			if (($_ROW_docbase['kodshab'] == 1) or ($_ROW_docbase['kodshab'] == 3)) {
				$_QRY_dockalplan_Str = "SELECT * FROM dognet_dockalplan WHERE koddel<>'99' AND koddoc='{$_koddoc}' AND kodkalplan IN (SELECT koddoc FROM dognet_docsubpodr WHERE sumzadolsubpodr>'0.00' AND koddel<>'99' AND kodsubpodr='{$_kodsubpodr}' AND koddocsubpodr IN (SELECT koddocsubpodr FROM dognet_docchfsubpodr WHERE koddel<>'99' AND datechfsubpodr<='{$_ONDATE}'))";
			}
			...
			if (($_ROW_docbase['kodshab'] == 2) or ($_ROW_docbase['kodshab'] == 4)) {
				$_QRY_dockalplan_Str = "SELECT * FROM dognet_docbase WHERE koddel<>'99' AND numberchet='' AND koddoc='{$_koddoc}' AND (kodshab='2' OR kodshab='4') AND koddoc IN (SELECT koddoc FROM dognet_docsubpodr WHERE sumzadolsubpodr>'0.00' AND koddel<>'99' AND kodsubpodr='{$_kodsubpodr}' AND koddocsubpodr IN (SELECT koddocsubpodr FROM dognet_docchfsubpodr WHERE koddel<>'99' AND datechfsubpodr<='{$_ONDATE}'))";
			}
			...
			if ($_ROW_docbase['kodshab'] == 0) {
				$_QRY_dockalplan_Str = "SELECT * FROM dognet_docbase WHERE koddel<>'99' AND numberchet<>'' AND koddoc='{$_koddoc}' AND kodshab='0' AND koddoc IN (SELECT koddoc FROM dognet_docsubpodr WHERE sumzadolsubpodr>'0.00' AND koddel<>'99' AND kodsubpodr='{$_kodsubpodr}' AND koddocsubpodr IN (SELECT koddocsubpodr FROM dognet_docchfsubpodr WHERE koddel<>'99' AND datechfsubpodr<='{$_ONDATE}'))";
			}
			...
			while ($_ROW_dockalplan = mysqli_fetch_assoc($_QRY_dockalplan)) {
				...
				$_QRY_docsubpodr_Str = "SELECT * FROM dognet_docsubpodr WHERE sumzadolsubpodr<>'0.00' AND koddel<>'99' AND koddoc='{$_kodkalplan}' AND kodsubpodr='{$_kodsubpodr}' AND koddocsubpodr IN ( SELECT koddocsubpodr FROM dognet_docchfsubpodr WHERE koddel<>'99' AND sumzadolchfsubpodr>'0' AND datechfsubpodr<='{$_ONDATE}' )";
				if (checkUserRestrictions($_SESSION['id'], 'dognet', 5, 1) == 1) {
				...
				while ($_ROW_docsubpodr = mysqli_fetch_assoc($_QRY_docsubpodr)) {
					...
					$_SUM_SUBDOC_INCOMING_F = F_CALC_SUBDOC_INCOM($_koddocsubpodr, $_ONDATE);
				...
				$activeSheet->setCellValue("A{$line}", '');
				$activeSheet->setCellValue("B{$line}", '');
				$activeSheet->setCellValue("C{$line}", 'Итого по этапу основного договора (альтернативный вариант подсчета)**');
