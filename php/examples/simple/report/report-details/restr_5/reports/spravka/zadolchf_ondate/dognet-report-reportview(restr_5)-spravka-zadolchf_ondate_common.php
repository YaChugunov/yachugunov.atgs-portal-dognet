...
// Текущая задолженность
	...
	$_QRY_CHT1 = mysqlQuery( "SELECT SUM(summazadol) as SUM_1 FROM dognet_reports_zadolchf_ondate WHERE kodstatuszdl = '1' AND koddel <> '99' AND koddoc IN (SELECT koddoc FROM dognet_docbase WHERE kodshab = 0 AND numberchet <> '')" );
...
// Судебная задолженность
	...
	$_QRY_CHT2 = mysqlQuery( "SELECT SUM(summazadol) as SUM_2 FROM dognet_reports_zadolchf_ondate WHERE kodstatuszdl = '2' AND koddel <> '99' AND koddoc IN (SELECT koddoc FROM dognet_docbase WHERE kodshab = 0 AND numberchet <> '')" );
...
// Невозвратная задолженность
	...
	$_QRY_CHT3 = mysqlQuery( "SELECT SUM(summazadol) as SUM_3 FROM dognet_reports_zadolchf_ondate WHERE kodstatuszdl = '3' AND koddel <> '99' AND koddoc IN (SELECT koddoc FROM dognet_docbase WHERE kodshab = 0 AND numberchet <> '')" );
