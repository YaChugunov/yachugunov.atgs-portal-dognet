	...
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-7">
		...
		<div id="summa-zadolzh" class="">
		  <div class="panel-body">
				...
				<ul class="list-group">
				  <li class="list-group-item"><span style="float:right; margin-left:20px"><kbd>A</kbd></span>Всего выставлено счетов на сумму :<span style="float:right"><?php echo ( $_total_sumchf ? number_format((float)($_total_sumchf), 2, '.', ' ') : "---" ); ?></span></li>
				  <li class="list-group-item"><span style="float:right; margin-left:20px"><kbd>B</kbd></span>Всего оплачено счетов на сумму :<span style="float:right"><?php echo ( $_total_sumoplchf ? number_format((float)($_total_sumoplchf), 2, '.', ' ') : "---" ); ?></span></li>
				  <li class="list-group-item"><span style="float:right; margin-left:20px"><kbd>C</kbd></span>Всего выплачено авансов на сумму :<span style="float:right"><?php echo ( $_total_sumavchf ? number_format((float)($_total_sumavchf), 2, '.', ' ') : "---" ); ?></span></li>
				  <li class="list-group-item"><span style="float:right; margin-left:20px"><kbd>D</kbd></span><span style="margin-left:20px">Из нее зачтено :<span style="float:right"><?php echo ( $_total_sumavoplchf ? number_format((float)($_total_sumavoplchf), 2, '.', ' ') : "---" ); ?></span></span></li>
				  <li class="list-group-item"><span style="float:right; margin-left:20px"><kbd>E</kbd></span>Итого закрыто по счетам :<span style="float:right"><?php echo ( $_total_oplavchf ? number_format((float)($_total_oplavchf), 2, '.', ' ') : "---" ); ?></span></li>
				</ul>
