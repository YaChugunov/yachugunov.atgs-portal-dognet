...
function ajaxRequest_calcDateOpl(idsrokopl, chetfdate, kodchfact, srokopl, responseHandler) {
    ...
    request1 = $.ajax({
        url: "php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf/php/ajaxRequest-report-details-isdaysoff_calc_opldate-fetch.php",
        type: "post",
        cache: false,
        data: {
            idsrokopl: idsrokopl,
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="tab-content">
                            <div id="tab-1" class="tab-pane fade in active">
                                <?php include $_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf/dognet-report-reportview-spravka-zadolchf_common.php"; ?>
                            </div>
                            <div id="tab-2" class="tab-pane fade">
                                <?php include $_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf/dognet-report-reportview-spravka-zadolchf_docs.php"; ?>
                            </div>
                            <div id="tab-3" class="tab-pane fade">
                                <?php include $_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf/dognet-report-reportview-spravka-zadolchf_chets.php"; ?>
                            </div>
                        </div>
                    </div>
                </div>
