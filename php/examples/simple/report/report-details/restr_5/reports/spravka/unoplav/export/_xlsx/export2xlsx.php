...
#
#
	include ($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_5/reports/spravka/unoplav/export/_xlsx/export2xlsx_unoplav.php");
#
# ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
/*
...
$filename = "SPRAVKA-AVANS_".date('YmdHis').".XLSX";
...
function countDown(){
	//время в сек.
		...
		timer = setInterval(function(){
			...
			url2 = 'http://'+host+'/dognet/dognet-report.php?reportview=unoplav&export=yes';
			if (i < 0) {
				clearInterval(timer);
