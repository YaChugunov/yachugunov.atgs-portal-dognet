...
function ajaxRequest_calcDateOpl(idsrokopl, chetfdate, kodchfact, srokopl, responseHandler) {
    ...
    request1 = $.ajax({
        url: "php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf/php/ajaxRequest-report-details(restr_5)-isdaysoff_calc_opldate-fetch.php",
        type: "post",
        cache: false,
        data: {
            idsrokopl: idsrokopl,
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <ul id="main-tabs-menu" class="nav nav-tabs">
                            ...
                            <li style="float:right"><a href="?reportview=zadolchf&export=yes&doc=&cht=&format="
                                   title="">Экспорт</a></li>
                        </ul>

                        <div class="tab-content">
                            <div id="tab-1" class="tab-pane fade in active">
                                <?php include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf/dognet-report-reportview(restr_5)-spravka-zadolchf_common.php"); ?>
                            </div>
                            <div id="tab-2" class="tab-pane fade">
                                <?php include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf/dognet-report-reportview(restr_5)-spravka-zadolchf_docs.php"); ?>
                            </div>
                            <div id="tab-3" class="tab-pane fade">
                                <?php include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf/dognet-report-reportview(restr_5)-spravka-zadolchf_chets.php"); ?>
                            </div>
                        </div>
                    </div>
                </div>
