...
if (!isset($_POST['on_date'])) {
    ...
    $query .= "dateavans <= '" . $on_date . "' AND ostatokavans != '0.0' AND ";
    $query .= "ostatokavans != '0.0' AND ";
    $query .= "koddel<>'99')";
...
*/
        ...
        // ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
        ->leftJoin('dognet_docavans', 'dognet_docavans.koddoc', '=', 'dognet_dockalplan.kodkalplan')
