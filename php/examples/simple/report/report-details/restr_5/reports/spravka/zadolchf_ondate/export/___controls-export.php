...
<?php
				if (isset($_GET['format'])) {
					switch ($_GET['format']) {
						case "doc":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf_ondate/export/_docx/export2docx.php");
							break;
						case "xls":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf_ondate/export/_xlsx/export2xlsx.php");
							break;
						case "pdf":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf_ondate/export/_pdf/export2pdf.php");
							break;
						default:
