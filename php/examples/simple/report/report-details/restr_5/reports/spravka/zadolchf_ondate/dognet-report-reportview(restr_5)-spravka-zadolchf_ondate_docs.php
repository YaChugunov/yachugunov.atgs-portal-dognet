<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		table_reports_spravka_zadolchf_docs = $('#reports-spravka-zadolchf-docs-table').DataTable({
			...
			ajax: {
				url: "php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf_ondate/process/dognet-report-reportview(restr_5)-spravka-zadolchf_ondate-docs-process.php",
				type: "POST"
			},
			serverSide: true,
			columns: [{
			...
			columnDefs: [{
				...
				*/
				...
				},
				{
					...
					render: function(data, type, row, meta) {
						if (!isNaN(data)) {
							var chfdate = moment(row.dognet_reports_zadolchf_ondate.chetfdate, 'DD.MM.YYYY');
							var diff_days = data;
							console.log("diff_days: " + data);
							var opldate = chfdate.add(diff_days, 'days').format('DD.MM.YYYY');
							return opldate;
						} else {
							return data;
