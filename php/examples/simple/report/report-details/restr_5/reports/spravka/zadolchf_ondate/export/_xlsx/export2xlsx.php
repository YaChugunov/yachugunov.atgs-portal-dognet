...
#
#
	include ($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf_ondate/export/_xlsx/export2xlsx_zdl_common.php");
if ($A1) {
	include ($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf_ondate/export/_xlsx/export2xlsx_kodstatuszdl_1.php");
}
if ($A2) {
	include ($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf_ondate/export/_xlsx/export2xlsx_kodstatuszdl_2.php");
}
if ($A3) {
	include ($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf_ondate/export/_xlsx/export2xlsx_kodstatuszdl_3.php");
}
...
$filename = "SPRAVKA-ZADOLCHF_ONDATE_".$_SESSION['id']."_".date('YmdHis').".XLSX";
$xmlWriter->save($filepath.$filename);

// Делаем запись в системный лог
// Все параметры в таблице portal_log_messages
	PORTAL_SYSLOG('99942200', '0000001', null, $_GET['reportview'], "Задолженность по счетам-фактурам / на дату", "EXCEL");
