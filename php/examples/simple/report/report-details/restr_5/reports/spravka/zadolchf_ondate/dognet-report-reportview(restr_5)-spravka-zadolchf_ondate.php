...
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/report/report-details/css/reports-spravka-zadolchf.css">
		...
		<div class="col-xs-12 col-sm-12 col-md-12">
			<div class="" style="margin-bottom:5px">
				<form class="form-inline" method="POST" action="">
					...
					<div class="form-group">
						<span><button class="text-uppercase" style="font-size:0.9em; height:34px" type="submit" name="update_data">Обновить данные</button></span>
					</div>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12">
						<ul id="main-tabs-menu" class="nav nav-tabs">
							...
							<li style="float:right"><a href="?reportview=zadolchf_ondate&export=yes&doc=&cht=&format=&ondate=<?php echo $_ZDL_ONDATE; ?>" title="">Экспорт</a></li>
						</ul>

						<div class="tab-content">
							<div id="tab-1" class="tab-pane fade in active">
								<?php include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf_ondate/dognet-report-reportview(restr_5)-spravka-zadolchf_ondate_common.php"); ?>
							</div>
							<div id="tab-2" class="tab-pane fade">
								<?php include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf_ondate/dognet-report-reportview(restr_5)-spravka-zadolchf_ondate_docs.php"); ?>
							</div>
							<div id="tab-3" class="tab-pane fade">
								<?php include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf_ondate/dognet-report-reportview(restr_5)-spravka-zadolchf_ondate_chets.php"); ?>
							</div>
						</div>
					</div>
				</div>
