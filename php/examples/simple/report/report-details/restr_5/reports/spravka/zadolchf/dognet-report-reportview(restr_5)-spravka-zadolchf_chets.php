<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		table_reports_spravka_zadolchf_chets = $('#reports-spravka-zadolchf-chets-table').DataTable({
			...
			ajax: {
				url: "php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf/process/dognet-report-reportview(restr_5)-spravka-zadolchf-chets-process.php",
				type: "POST"
			},
			serverSide: true,
			columns: [{
