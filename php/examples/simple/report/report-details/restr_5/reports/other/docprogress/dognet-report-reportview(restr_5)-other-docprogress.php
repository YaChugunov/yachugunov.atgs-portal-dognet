					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
							<ul id="main-tabs-menu" class="nav nav-tabs">
								...
								<li style="float:right"><a href="?reportview=docprogress&export=yes&format=" title="">Экспорт</a></li>
							</ul>

							<div class="tab-content">
								<div id="tab-1" class="tab-pane fade in active">
									<?php include("tabs/dognet-report-reportview(restr_5)-other-docprogress-tab1.php"); ?>
								</div>
