					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
							<ul id="main-tabs-menu" class="nav nav-tabs">
								<li class="active"><a data-toggle="tab" href="#tab-1" title="">Просроченные договора</a></li>
								<li><a data-toggle="tab" href="#tab-2" title="">Расширенный поиск</a></li>
								<li style="float:right"><a href="?reportview=alldocsexp&export=yes&format=" title="">Экспорт</a></li>
							</ul>

							<div class="tab-content">
								<div id="tab-1" class="tab-pane fade in active">
									<?php include("tabs/dognet-report-reportview(restr_5)-other-alldocsexp-tab1.php"); ?>
								</div>
