...
#
#
include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_5/reports/other/postexp/export/_xlsx/export2xlsx_postexp.php");
if ($A1) {
...
if ($A3) {
	...
	//	include ($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf/export/_xlsx/export2xlsx_postexp.php");
}
