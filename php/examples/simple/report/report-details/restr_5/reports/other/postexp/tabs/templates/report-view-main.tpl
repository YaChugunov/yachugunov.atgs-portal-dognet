							...
							'<div style="padding:10px">'+
								...
								'<table id="row-details-report-view-main-table" class="table table-condensed table-striped" >'+
									'<tbody>'+
										...
										'</tr>'+
										'<tr>'+
											'<td width="30%"><span class="row-details-report-view-main-table-title_topic">Задолженность по счету-фактуре</span></td>'+
											'<td width="70%"><span class="row-details-report-view-main-table-txt">'+$.fn.dataTable.render.number(' ', ',', 2, '').display( d.dognet_kalplanchf_zadol.chetfsumzadol )+''+d.dognet_spdened.short_code+'</span></td>'+
										'</tr>'+
									'</tbody>'+
								'</table>'+
