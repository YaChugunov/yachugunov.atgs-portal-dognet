...
if (!isset($_POST['start_date']) || !isset($_POST['end_date'])) {
    ...
    $query = "(SELECT kodchfact FROM dognet_kalplanchf WHERE ";
    $query .= "chetfdate BETWEEN '" . $start_date . "' AND '" . $end_date . "' AND ";
    $query .= "koddel<>'99')";
    ...
    Editor::inst($db, 'dognet_kalplanchf')
        ...
        ->on('preGet', function ($editor, $id) use ($query, $query2) {
            $editor->where(function ($q1) use ($query) {
                $q1->where('dognet_kalplanchf.kodchfact', $query, "IN", false);
            });
            /*
