...
#
#
	include ($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_5/reports/other/alldocsexp/export/_xlsx/export2xlsx_alldocsexp.php");
if ($A1) {
...
//	include ($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_5/reports/spravka/zadolchf/export/_xlsx/export2xlsx_alldocsexp.php");
}
