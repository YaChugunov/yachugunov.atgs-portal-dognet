		...
		<div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 space20">
				<div id="report-settings" class="text-center">
					<h3 class="space10">Справка о выполнении по договорам за период</h4>
					<h4 class="space10">Выберите интервал дат для экспорта</h4>
				</div>
			</div>
			<div class="col-xs-hidden col-sm-12 col-md-12 col-lg-12">
				<div id="export-format-block" class="center-block" style="">
					<form class="form-inline" method="GET" action="/dognet/dognet-report.php">
						<input type="hidden" name="reportview" value="docprogress">
...
<?php
				if (isset($_GET['format'])) {
					switch ($_GET['format']) {
						case "xls":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_5/reports/other/docprogress/export/_xlsx/export2xlsx.php");
							break;
						default:
