...
<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		table_reports_filterdocs = $('#report-view-filterdocs-table').DataTable({
			...
			language: {
				url: "php/examples/simple/report/report-details/restr_5/reports/list/filterdocs/dt_russian-report-view-filterdocs.json"
			},
			ajax: {
				url: "php/examples/simple/report/report-details/restr_5/reports/list/filterdocs/process/dognet-report-reportview(restr_5)-list-filterdocs-process.php",
				type: "POST"
			},
			serverSide: true,
			columns: [{
...
// :::
include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_5/reports/list/filterdocs/tabs/forms/report-view-filterdocs-filters.php");
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/report/report-details/restr_5/reports/list/filterdocs/tabs/css/report-view-filterdocs.css">
<section>
