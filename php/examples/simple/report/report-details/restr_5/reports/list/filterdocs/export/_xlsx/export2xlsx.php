...
#
#
	include ($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_5/reports/list/filterdocs/export/_xlsx/export2xlsx_filterdocs.php");
if ($A1) {
...
function countDown(){
	//время в сек.
		...
		timer = setInterval(function(){
			...
			url2 = 'http://'+host+'/dognet/dognet-report.php?reportview=filterdocs&export=yes';
			if (i < 0) {
				clearInterval(timer);
