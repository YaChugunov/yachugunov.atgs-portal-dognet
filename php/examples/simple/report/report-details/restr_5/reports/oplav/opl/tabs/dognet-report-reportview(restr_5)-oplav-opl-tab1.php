...
<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		table_report_view_main = $('#report-view-main-table').DataTable({
			...
			ajax: {
				url: "php/examples/simple/report/report-details/restr_5/reports/oplav/opl/process/dognet-report-reportview-oplav-opl-betweendates-process.php",
				type: "POST",
				data: function(d) {
...
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/report/report-details/restr_5/reports/oplav/opl/tabs/css/report-view-main.css">
<section>
	<div id="report-view-main" class="">
		...
		// :::
		include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_5/reports/oplav/opl/tabs/forms/report-view-main-filters.php");
		// ----- ----- ----- ----- -----
		?>
