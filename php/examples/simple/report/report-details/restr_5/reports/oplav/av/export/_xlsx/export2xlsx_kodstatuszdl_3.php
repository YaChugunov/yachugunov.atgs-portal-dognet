...
$activeSheet->setCellValue("A{$line}", 'Невозвратная задолженность');
...
//
$_queryStr .= "kodstatuszdl='3' AND koddoc IN (SELECT koddoc FROM dognet_reports_zadolchf)) ORDER BY namezakshot ASC";
//
