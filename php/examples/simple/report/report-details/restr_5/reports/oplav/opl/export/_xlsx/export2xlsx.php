...
$properties->setTitle('Оплаты по всем договорам за период');
$properties->setDescription('Оплаты по всем договорам за период');
...
$properties->setSubject('Оплаты по всем договорам за период');
...
#
#
include ($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_5/reports/oplav/opl/export/_xlsx/export2xlsx_opl_v2.php");
