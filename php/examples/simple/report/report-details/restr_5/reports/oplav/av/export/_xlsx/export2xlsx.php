...
$properties->setTitle('Авансы по договорам за период');
$properties->setDescription('Авансы по договорам за период');
...
$properties->setSubject('Авансы по договорам за период');
...
#
#
	include ($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_5/reports/oplav/av/export/_xlsx/export2xlsx_av.php");
#
# ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
/*
