...
<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		table_report_view_main = $('#report-view-main-table').DataTable({
			...
			ajax: {
				url: "php/examples/simple/report/report-details/restr_5/reports/oplav/av/process/dognet-report-reportview-oplav-av-betweendates-process.php",
				type: "POST",
				data: function(d) {
			...
			footerCallback: function(row, data, start, end, display) {
				...
				total1Str = $.fn.dataTable.render.number(' ', ',', 2, '').display(total1);
				total2Str = $.fn.dataTable.render.number(' ', ',', 2, '').display(total2);

				// Update footer
				$(api.column(8).footer()).html(total1Str + ' р.');
				$(api.column(9).footer()).html(total2Str + ' р.');
...
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/report/report-details/restr_5/reports/oplav/av/tabs/css/report-view-main.css">
<section>
	<div id="report-view-main" class="">
		...
		// :::
		include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_5/reports/oplav/av/tabs/forms/report-view-main-filters.php");
		// ----- ----- ----- ----- -----
		?>
