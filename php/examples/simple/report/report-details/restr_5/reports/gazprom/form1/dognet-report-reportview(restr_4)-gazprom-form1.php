...
$__subsubtitle = "Реестр контрактов компании";
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
							<ul id="main-tabs-menu" class="nav nav-tabs">
								<li class="active"><a data-toggle="tab" href="#tab-1" title="">Газпром мониторинг</a></li>
								<li style="float:right"><a href="?reportview=gazpromform1&export=yes&format=" title="">Экспорт</a></li>
							</ul>

							<div class="tab-content">
								<div id="tab-1" class="tab-pane fade in active">
									<?php include("tabs/dognet-report-reportview(restr_4)-gazprom-form1-tab1.php"); ?>
								</div>
							</div>
						</div>
					</div>
