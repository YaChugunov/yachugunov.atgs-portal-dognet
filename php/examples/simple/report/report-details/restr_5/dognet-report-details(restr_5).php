      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="list-group">
          ...
          <li class="list-group-item updated">
            <h4>Справка о задолженности по субподрядчикам (на любую дату) <span class="label label-danger"
                style="float:right">Обновлен</span></h4>
            <div class="labels">
              <!-- <p class="text-danger">Отчеты обновляются</p> -->
          ...
          <li class="list-group-item updated">
            <h4>Справка об авансах, не закрытых счетами-фактурами (на любую дату) <span class="label label-danger"
                style="float:right">Обновлен</span></h4>
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="list-group">
          ...
          <li class="list-group-item">
            ...
            <div class="labels">
              <a href="dognet-report.php?reportview=opl" class=""><span class="label label-default">Онлайн</span></a>
          ...
          <li class="list-group-item">
            ...
            <div class="labels">
              <a href="dognet-report.php?reportview=av" class=""><span class="label label-default">Онлайн</span></a>
