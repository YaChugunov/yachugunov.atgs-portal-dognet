        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 space20">
                <div id="report-settings" class="text-center">
                    <h3 class="space10">Отчет о договорах поставки с истёкшими сроками выполнения<br>на дату с расчетом
                        штрафа</h3>
                    <h4 class="space10">Выберите дату отчета и задайте процент штрафа</h4>
                    <div id="export-format-block" class="center-block" style="">
                        <form class="form-inline" method="GET" action="/dognet/dognet-report.php">
                            <input type="hidden" name="reportview" value="postexp">
                            ...
                            <div class="form-group">
                                ...
                                <div class='input-group ondate'>
                                    <input type='text' name="shtraf" id='shtraf' class="form-control" style="width:80px"
                                           value="0.05" />
                                    <span class="input-group-addon">
                            ...
                            <div id="report-info" class="">
                                ...
                                <ol>
                                    <li>В текущей версии по условиям выборки в отчет попадают этапы договоров, договора
                                        без этапов или договора-счета, по которым сумма счетов-фактур меньше суммы
                                        соответствующего этапа договора, договора без этапа или счета-договора.</li>
                                    <li>Выбранная дата на странице формирования отчета является дополнительной отсечкой
                                        по дате для соответствующего этапа, договора без этапов или договора-счета из
                                        выборки предыдущего пункта. Даты в выборке должны быть меньше либо равны
                                        выбранной дате.</li>
                                    <li>Если дата окончания этапа, договора или договора-счета, а также даты
                                        счетов-фактур, относящихся к ним, не прописаны корректно, то они будут
                                        проигнорированы и в отчет не попадут.</li>
                                </ol>
                            ...
                            <p class="text-small text-right" style="font-size:1.25rem; color: #999999; margin-top:10px">
                                Версия отчета от
                                16.12.2024</p>
...
if (isset($_GET['format'])) {
    switch ($_GET['format']) {
    case "xls":
        include $_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_4/reports/other/postexp/export/_xlsx/export2xlsx.php";
        break;
    default:
