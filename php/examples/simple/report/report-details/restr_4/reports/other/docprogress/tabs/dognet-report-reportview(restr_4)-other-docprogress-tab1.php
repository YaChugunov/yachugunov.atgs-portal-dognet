...
<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		table_report_view_main = $('#report-view-main-table').DataTable({
			...
			ajax: {
				url: "php/examples/simple/report/report-details/restr_4/reports/other/docprogress/process/dognet-report-reportview-other-docprogress-betweendates-process.php",
				type: "POST",
				data: function(d) {
			...
			footerCallback: function(row, data, start, end, display) {
				...
				// Update footer
				$(api.column(8).footer()).html(totalStr + ' р.');
...
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/report/report-details/restr_4/reports/other/docprogress/tabs/css/report-view-main.css">
<section>
	<div id="report-view-main" class="">
		...
		// :::
		include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_4/reports/other/docprogress/tabs/forms/report-view-main-filters.php");
		// ----- ----- ----- ----- -----
		?>
