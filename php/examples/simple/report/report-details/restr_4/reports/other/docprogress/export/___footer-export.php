        ...
        <div class="row">
                ...
                <div class="media">
                    <div class="media-body text-center">
                        <div class="footer-pics">
                            <img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/_assets/images/phone_icon.png"
            ...
            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                <div class="media">
                    <div class="media-body text-center">
                        <div class="footer-pics">
                            <img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/_assets/images/me_icon.png"
                                 class="img-circle" style="max-width:none; width:1.0em">
                        </div>
                        <div class="footer-text">
                    ...
                    <div class="media-body text-center">
                        <div class="footer-pics">
                            <a href="https://chat.whatsapp.com/EcqoZZ3cfwy5VgheL62EIq" target="_blank"><img
                                     src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/_assets/images/whatsapp_icon.png"
