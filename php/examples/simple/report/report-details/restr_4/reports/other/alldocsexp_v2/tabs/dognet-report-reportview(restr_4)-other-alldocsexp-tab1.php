...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        table_report_view_main = $('#report-view-main-table').DataTable({
            ...
            ajax: {
                url: "php/examples/simple/report/report-details/restr_4/reports/other/alldocsexp/process/dognet-report-reportview(restr_4)-other-alldocsexp-ondate-process.php",
                type: "POST",
                data: function(d) {
            ...
            createdRow: function(row, data, index) {
                datenow = moment();
                srokstage = moment(data.dognet_dockalplan_progress.srokstage_date, 'YYYY-MM-DD').format(
                    'YYYY-MM-DD');
            ...
            columnDefs: [{
                ...
                },
                {
                    ...
                    searchable: false,
                    render: function(data, type, row, meta) {
                        if (row.dognet_dockalplan.idobjectready == '1') {
                            return "<span style='background-color:brown; color:white; padding:1px 2px'>" +
                                moment(row
                                    .dognet_kalplanchf.chetfdate,
                                    'YYYY-MM-DD').format(
                                    'DD.MM.YYYY') + "*</span>";
                        } else {
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        srokstage = moment(row.dognet_dockalplan_progress.srokstage_date,
                            'YYYY-MM-DD').format('YYYY-MM-DD');
                        chetfdate = moment(row.dognet_kalplanchf.chetfdate, 'YYYY-MM-DD').format(
                            'YYYY-MM-DD');
                        diff = moment(chetfdate).diff(srokstage, 'days');
                        exp_weeks = Math.round(diff / 7);
                        if (row.dognet_dockalplan.idobjectready == '1') {
...
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/report/report-details/restr_4/reports/other/alldocsexp/tabs/css/report-view-main.css">
<section>
    <div id="report-view-main" class="">
        ...
        // :::
        // include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_4/reports/other/alldocsexp/tabs/forms/report-view-main-filters.php");
        // ----- ----- ----- ----- -----
        ?>
