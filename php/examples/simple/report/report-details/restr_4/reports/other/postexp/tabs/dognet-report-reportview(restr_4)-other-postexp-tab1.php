...
<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		table_report_view_main = $('#report-view-main-table').DataTable({
			...
			ajax: {
				url: "php/examples/simple/report/report-details/restr_4/reports/other/postexp/process/dognet-report-reportview-other-postexp-ondate-process.php",
				type: "POST",
				data: function(d) {
			...
			columnDefs: [{
				...
				},
				{
					...
					render: function(data, type, row, meta) {
						if (data != null) {
							diff = data - row.dognet_dockalplan_progress.sumchfstage;
							return $.fn.dataTable.render.number(' ', ',', 2, '').display(diff) + row.dognet_spdened.short_code;
						} else {
...
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/report/report-details/restr_4/reports/other/postexp/tabs/css/report-view-main.css">
<section>
	<div id="report-view-main" class="">
				...
				<form class="form-inline text-center">
					<div class="form-group">
						<div class='input-group date' id='on_date'>
							<input type='text' name="on_date" id='input_on_date' class="form-control" disabled="disabled" />
		...
		// :::
		// include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_4/reports/other/postexp/tabs/forms/report-view-main-filters.php");
		// ----- ----- ----- ----- -----
		?>
...
-->
		...
		<p class="text-default">*<span style="padding: 0 5px"></span>-<span style="padding: 0 5px"></span>разница суммы этапа и суммы выставленных счетов-фактур (частично выполненных поставок)</p>
		<p class="text-default" style="margin-bottom:2px"><span style="padding-right:10px">1)</span><b>В режиме "онлайн" можно посмотреть отчет только на текущую дату. Для отчета на любую дату воспользуйтесь формой экспорта.</b></p>
		<p class="text-danger" style="margin-bottom:2px"><span style="padding-right:10px">2)</span><b>29.1.2023. Счета с просроченными сроками поставки выводятся только при экспорте отчета в Excel.</b></p>
	</div>
</section>