<?php
    ...
    $properties->setTitle('Отчет о договорах с истёкшими сроками выполнения');
    $properties->setDescription('Отчет о договорах с истёкшими сроками выполнения');
    ...
    $properties->setSubject('Отчет о договорах с истёкшими сроками выполнения');
    ...
    #
    #
    include $_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_4/reports/other/alldocsexp_v2/export/_xlsx/export2xlsx_alldocsexp.php";
    if ($A1) {
    ...
    //    include ($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_4/reports/spravka/zadolchf/export/_xlsx/export2xlsx_alldocsexp.php");
    }
 ...
 */
    ...
    $filename = "Отчет-Договора_С_Истекшими_Сроками_Выполнения_(в2)-" . date('YmdHis') . ".xlsx";
    $xmlWriter->save($filepath . $filename);

    // Делаем запись в системный лог
    // Все параметры в таблице portal_log_messages
    // PORTAL_SYSLOG('99942200', '0000001', null, $_GET['reportview'], "Отчет о договорах с истёкшими сроками выполнения (версия 2)", "EXCEL");
...
function countDown() {
    ...
    timer = setInterval(function() {
        ...
        url2 = 'http://' + host + '/dognet/dognet-report.php?reportview=alldocsexp2&export=yes';
        if (i < 0) {
            clearInterval(timer);
