...
#
#
	include ($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_4/reports/other/alldocsexp/export/_xlsx/export2xlsx_alldocsexp.php");
if ($A1) {
...
$filename = "SPRAVKA-DOCalldocsexp_".date('YmdHis').".XLSX";
...
function countDown(){
	//время в сек.
		...
		timer = setInterval(function(){
			...
			url2 = 'http://'+host+'/dognet/dognet-report.php?reportview=alldocsexp&export=yes';
			if (i < 0) {
				clearInterval(timer);
