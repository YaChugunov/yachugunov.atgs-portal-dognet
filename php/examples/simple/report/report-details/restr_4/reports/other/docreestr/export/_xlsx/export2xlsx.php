...
#
#
include ($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_4/reports/other/docreestr/export/_xlsx/export2xlsx_docreestr.php");
#
# ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
/*
...
function countDown(){
	//время в сек.
		...
		timer = setInterval(function(){
			...
			url2 = 'http://'+host+'/dognet/dognet-report.php?reportview=docreestr&export=yes';
			if (i < 0) {
				clearInterval(timer);
