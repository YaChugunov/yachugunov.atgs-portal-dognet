<?php
    ...
    $__subsubtitle = "Все договора с истекшими сроками за год";
...
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/report/report-details/css/reports-main-tabs.css">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <ul id="main-tabs-menu" class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#tab-1" title="">Просроченные договора</a>
                            </li>
                            <li style="float:right"><a href="?reportview=alldocsexp2&export=yes&format="
                                   title="">Экспорт (версия 2)</a></li>
                            <li style="float:right"><a href="?reportview=alldocsexp&export=yes&format="
                                   title="">Экспорт</a></li>
                        </ul>

                        <div class="tab-content">
                            <div id="tab-1" class="tab-pane fade in active">
                                <?php include "tabs/dognet-report-reportview(restr_4)-other-alldocsexp-tab1.php"; ?>
                            </div>
                        </div>
                    </div>
                </div>
