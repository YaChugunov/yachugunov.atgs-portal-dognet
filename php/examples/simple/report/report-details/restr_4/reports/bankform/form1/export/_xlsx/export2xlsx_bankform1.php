...
*/
	...
	$activeSheet->setCellValue("R{$line}", "Нет");
	$activeSheet->setCellValue("S{$line}", "Нет");
	$activeSheet->setCellValue("T{$line}", "Нет");
	$activeSheet->setCellValue("U{$line}", "Нет");
	$activeSheet->setCellValue("V{$line}", "Нет");
