...
while ($_ROW_dockalplan = mysqli_fetch_assoc($_QRY_dockalplan)) {
	$_QRY_docavans = mysqlQuery("SELECT * FROM dognet_docavans WHERE koddel<>'99' AND koddoc = '" . $_ROW_dockalplan['kodkalplan'] . "' AND (dateavans BETWEEN '" . $start_date . "' AND '" . $end_date . "')");
	//
	$_SUM_STAGE_AV = 0.0;
	$_SUM_STAGE_OST = 0.0;
