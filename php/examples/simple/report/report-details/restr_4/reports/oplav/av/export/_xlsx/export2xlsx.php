...
$properties->setTitle('Справка об авансах по всем договорам');
$properties->setDescription('Справка об авансах по всем договорам');
...
$properties->setSubject('Справка об авансах по всем договорам');
...
#
#
	include ($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_4/reports/oplav/av/export/_xlsx/export2xlsx_av_v2.php");
#
# ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
/*
...
// Все параметры в таблице portal_log_messages
	PORTAL_SYSLOG('99942200', '0000001', null, $_GET['reportview'], "Авансы по договорам за период", "EXCEL");
...
function countDown(){
	//время в сек.
		...
		timer = setInterval(function(){
			...
			url2 = 'http://'+host+'/dognet/dognet-report.php?reportview=av&export=yes';
			if (i < 0) {
				clearInterval(timer);
