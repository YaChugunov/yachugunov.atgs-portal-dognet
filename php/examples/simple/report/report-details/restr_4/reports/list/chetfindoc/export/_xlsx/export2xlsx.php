...
<div class="space30">
    ...
    <a class="btn btn-primary btn-lg format-selected-btn"
       href="http://<?php echo $_SERVER['HTTP_HOST'] . '/dognet/tmp/' . $filename; ?>" role="button">Сохранить файл</a>
</div>
<div id="link"></div>
...
url2 = "http://" + host +
    "/dognet/dognet-report.php?reportview=chetfindoc&uniqueID=<?php echo $_GET['uniqueID']; ?>&export=yes";
document.getElementById("link").innerHTML =
    "<div class='space10'><span style='padding:0 15px'><a class='return-link' href=" + url1 +
    ">Вернуться в Отчеты</a></span></div><div class=''><span style='padding:0 15px'><a class='return-link' href=" +
