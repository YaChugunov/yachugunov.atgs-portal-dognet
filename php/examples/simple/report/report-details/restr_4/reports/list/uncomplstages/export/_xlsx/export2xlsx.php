...
#
#
	include ($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_4/reports/list/uncomplstages/export/_xlsx/export2xlsx_uncomplstages.php");
if ($A1) {
