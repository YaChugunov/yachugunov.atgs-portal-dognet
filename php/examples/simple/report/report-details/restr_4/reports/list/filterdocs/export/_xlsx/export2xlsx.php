...
#
#
	include ($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_4/reports/list/filterdocs/export/_xlsx/export2xlsx_filterdocs.php");
if ($A1) {
