...
#
#
include $_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_4/reports/list/uncomplstages2/export/_xlsx/export2xlsx_uncomplstages.php";
if ($A1) {
...
$filename = "LIST-CONTROLAVANS_" . $_SESSION['id'] . "_" . date('YmdHis') . ".XLSX";
...
function countDown() {
    ...
    timer = setInterval(function() {
        ...
        url2 = 'http://' + host + '/dognet/dognet-report.php?reportview=uncomplstages2&export=yes';
        if (i < 0) {
            clearInterval(timer);
