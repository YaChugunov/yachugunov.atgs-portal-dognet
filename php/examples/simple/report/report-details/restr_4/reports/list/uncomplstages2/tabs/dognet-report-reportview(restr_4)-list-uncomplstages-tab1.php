...
$(document).ready(function() {
    table_gipwork_control_stages_uncompleted = $('#report-view-uncomplstages-table').DataTable({
        dom: "<'row'<'col-sm-5'B><'col-sm-4'><'col-sm-3'f>>" + "<'row'<'col-sm-12'tr>>" +
            "<'row'<'col-sm-4'i><'col-sm-8'p>>",
        language: {
            url: "php/examples/simple/report/report-details/restr_4/reports/list/uncomplstages2/dt_russian-reports-view-uncomplstages.json"
        },
        ajax: {
            url: "php/examples/simple/report/report-details/restr_4/reports/list/uncomplstages2/process/dognet-report-reportview(restr_4)-list-uncomplstages-process.php",
            type: "POST"
        },
        serverSide: true,
        columns: [{
...
?>
<link rel="stylesheet"
      href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/report/report-details/restr_4/reports/list/uncomplstages2/tabs/css/report-view-uncomplstages.css">
<section>
    <div class="space20"></div>
    <div id="report-view-uncomplstages" class="" style="">
        <div class="demo-html"></div>
        <table id="report-view-uncomplstages-table" class="table table-bordered table-responsive display compact"
        ...
        <table id="compact-legend-table" class="table table-responsive" cellspacing="0" width="100%">
            <tbody>
                <tr>
                    ...
                    <td colspan="2">
                        <span>Поиск осуществляется сразу при вводе по столбцам: ДОГОВОР, НАЗВАНИЕ ДОГОВОРА/ЭТАПА и
                            СРОК</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="2%"><span class=""></span></td>
                    <td width="14%" style="background:#fafafa; border-bottom:2px #fff solid; border-top:2px #fff solid">
                        <span class=""><b>ДД/ММ/ГГГГ</b></span>
                    </td>
                ...
                <tr>
                    ...
                    <td><span class="">Срок равен дате 1-го аванса + количество дней, указанное в сроке выполнения
                            этапа.</span></td>
                </tr>
                <tr>
                    <td width="8%" valign="middle"><span class=""></span></td>
                    <td width="2%"><span class=""></span></td>
                    <td width="14%" style="background:#fafafa; border-bottom:2px #fff solid; border-top:2px #fff solid">
                        <span class=""><b>--- (ДД)</b></span>
                    </td>
                    <td><span class="">Срок выполнения этапа указан в днях (ДД), но авансовых платежей пока не
                            поступало.</span></td>
                </tr>
                <tr>
                    <td width="8%" valign="middle"><span class=""></span></td>
                    ...
                    <td><span class="">Срок выполнения в этапе указан не был и в качестве срока используется планируемая
                            дата (ДД.ММ.ГГГГ).</span></td>
                </tr>
            </tbody>
        </table>
    </div>
