...
$(document).ready(function() {
		table_gipwork_control_stages_uncompleted = $('#report-view-uncomplstages-table').DataTable( {
			...
			language: {
				url: "php/examples/simple/report/report-details/restr_4/reports/list/uncomplstages/dt_russian-reports-view-uncomplstages.json"
			},
			ajax: {
				url: "php/examples/simple/report/report-details/restr_4/reports/list/uncomplstages/process/dognet-report-reportview(restr_4)-list-uncomplstages-process.php",
				type: "POST"
			},
			serverSide: true,
			columns: [
...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/report/report-details/restr_4/reports/list/uncomplstages/tabs/css/report-view-uncomplstages.css">
<section>
