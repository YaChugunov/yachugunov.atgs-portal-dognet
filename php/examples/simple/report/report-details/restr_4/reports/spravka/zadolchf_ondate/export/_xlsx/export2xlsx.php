...
#
#
	include ($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_4/reports/spravka/zadolchf_ondate/export/_xlsx/export2xlsx_zdl_common.php");
if ($A1) {
	include ($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_4/reports/spravka/zadolchf_ondate/export/_xlsx/export2xlsx_kodstatuszdl_1.php");
}
if ($A2) {
	include ($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_4/reports/spravka/zadolchf_ondate/export/_xlsx/export2xlsx_kodstatuszdl_2.php");
}
if ($A3) {
	include ($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_4/reports/spravka/zadolchf_ondate/export/_xlsx/export2xlsx_kodstatuszdl_3.php");
}
