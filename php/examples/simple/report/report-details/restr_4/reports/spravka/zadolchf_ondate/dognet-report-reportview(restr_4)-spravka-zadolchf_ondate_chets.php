<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		table_reports_spravka_zadolchf_chets = $('#reports-spravka-zadolchf-chets-table').DataTable({
			...
			ajax: {
				url: "php/examples/simple/report/report-details/restr_4/reports/spravka/zadolchf_ondate/process/dognet-report-reportview(restr_4)-spravka-zadolchf_ondate-chets-process.php",
				type: "POST"
			},
			serverSide: true,
			columns: [{
