          ...
          <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="tab-content">
              <div id="tab-1" class="tab-pane fade in active">
                <?php include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_4/reports/spravka/zadolsub_ondate/dognet-report-reportview(restr_4)-spravka-zadolsub_ondate_common.php"); ?>
              </div>
              <div id="tab-2" class="tab-pane fade">
                <p>Онлайн-отчет отключен. Пользуйтесь функцией экспорта.</p>
                <?php // include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_4/reports/spravka/zadolsub_ondate/dognet-report-reportview(restr_4)-spravka-zadolsub_ondate_docs.php"); 
								?>
              </div>
            </div>
          </div>
