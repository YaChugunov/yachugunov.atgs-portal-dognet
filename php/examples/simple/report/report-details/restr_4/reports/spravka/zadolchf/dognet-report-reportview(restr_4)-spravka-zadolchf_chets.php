<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		table_reports_spravka_zadolchf_chets = $('#reports-spravka-zadolchf-chets-table').DataTable({
			...
			ajax: {
				url: "php/examples/simple/report/report-details/restr_4/reports/spravka/zadolchf/process/dognet-report-reportview(restr_4)-spravka-zadolchf-chets-process.php",
				type: "POST"
			},
			serverSide: true,
			columns: [{
			...
			rowGroup: {
				startRender: function(rows, group, level) {
					...
					if (level == 1) {
						...
						return '<span style="text-align:left; white-space:nowrap; margin-left:10px">Счет&nbsp;' + docnumber + '&nbsp;:&nbsp;' + group + '</span>';
					}
			...
			buttons: [{
				...
				action: function(e, dt, node, config) {
					...
					table_reports_spravka_zadolchf_chets.order([3, "asc"], [4, "asc"], [6, "asc"]).draw();
				}
			}],
...
*/
	...
	/* ----- */
	#reports-spravka-zadolchf-chets-table>tbody>tr.dtrg-start.dtrg-level-0>th {
		font-family: 'Oswald', sans-serif;
		font-size: 1.1em;
		font-weight: 500;
		text-align: left;
	...
	#reports-spravka-zadolchf-chets-table>tbody>tr.dtrg-start.dtrg-level-0>th>span>a {
		color: white
	}

	#reports-spravka-zadolchf-chets-table>tbody>tr.dtrg-start.dtrg-level-0>th>span>a:hover {
		color: #f10000
	}

	/* #reports-spravka-zadolchf-chets-table > tbody > tr.dtrg-end.dtrg-level-1 > td { font-family:'Play', sans-serif; font-size:1.1em; font-weight:300; color:#336a86; background-color:#fff } */
	/* ----- */
	#reports-spravka-zadolchf-chets-table>tbody>tr.dtrg-start.dtrg-level-1>th {
		padding: 5px;
		font-family: 'Oswald', sans-serif;
		font-size: 1.15em;
		font-weight: 500;
	...
	#reports-spravka-zadolchf-chets-table>tbody>tr.dtrg-end.dtrg-level-1>th {
		font-family: 'Play', sans-serif;
		font-size: 1.1em;
		font-weight: 300;
		color: #336a86;
	...
	#reports-spravka-zadolchf-chets-table>tbody>tr.dtrg-start.dtrg-level-2>th>div {
		font-family: 'Oswald', sans-serif;
		font-size: 1.15em;
		font-weight: 400;
		color: #111;
						...
						<div id="reports-spravka-zadolchf-chets-filters" class="panel-body space30">
							...
							<div class="col-xs-12 col-sm-4 col-md-2 col-lg-2">
								<div class="input-group space10" style="width:100%">
									...
									<select name="reportZadolTypeSearch_text_2" id="reportZadolTypeSearch_text_2" class="form-control">
							...
							<div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
								<div class="form-group space10" style="width:100%">
									...
									<input type="text" id="reportChetNumberSearch_text" class="form-control" placeholder="####" name="reportChetNumberSearch_text">
								</div>
							</div>
							<div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
								<div class="form-group space10" style="width:100%">
									<label for="reportChfNumberSearch_text_2"><b>Счет-фактура № :</b></label>
									<input type="text" id="reportChfNumberSearch_text_2" class="form-control" placeholder="####" name="reportChfNumberSearch_text_2">
								</div>
							</div>
							<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
								<div class="input-group space10" style="width:100%">
									<label for="reportObjectSearch_text_2"><b>Заказчик/объект :</b></label>
									<input type="text" id="reportObjectSearch_text_2" class="form-control" placeholder="Все объекты" name="reportObjectSearch_text_2">
								</div>
							</div>
							<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
								<div class="input-group space10" style="width:100%">
									<label for="reportDocNameSearch_text_2"><b>Текст из названия счета :</b></label>
									<input type="text" id="reportDocNameSearch_text_2" class="form-control" placeholder="Введите текст" name="reportDocNameSearch_text_2">
								</div>
							</div>
							<?php // ----- ----- ----- ----- ----- 
							?>
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-right">
								<div class="input-group-btn">
									<button id="columnSearch_btnApply2" class="btn btn-default" type="button">Применить фильтры</button>
									<button id="columnSearch_btnClear2" class="btn btn-default" type="button"><i class="glyphicon glyphicon-remove"></i></button>
									<button id="columnSearch_btnRefresh2" class="btn btn-default" type="button"><i class="glyphicon glyphicon-refresh"></i></button>
								</div>
							</div>
							<?php // ----- ----- ----- ----- ----- 
							?>
