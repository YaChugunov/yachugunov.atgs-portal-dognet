            ...
            <div id="export-format-block" class="center-block" style="">
              <form class="form-inline" method="GET" action="/dognet/dognet-report.php">
                ...
                <div id="report-info" class="">
                  ...
                  <ol>
                    <li>Учитываются только авансы с датой ранее или равной выбранной и имеющие рассчитанный остаток
                      больше нулевого на дату ранее или равной выбранной.</li>
                    <li>В расчет берутся только зачтенные (частично или полностью) авансы в дату счетов-фактур ранее или
                      равной выбранной.</li>
                    <li>Остаток по авансу рассчитывается как разность между суммой аванса и суммой
                      всех зачтенных сумм в пользу счетов-фактур на дату ранее или равную выбранной.</li>
                    <li>Все суммы, зачеты и остатки по каждому авансу циклически суммируются в рамках основного договора
                      (если счета) и заказчика, а затем формируется итоговая
                      сумма по всем заказчикам.</li>
                  </ol>
                  <p class="text-danger"><b>По всем возникающим вопросам и найденным ошибкам в отчете докладываем в
                      департамент разработки отчетов не откладывая! Чем дольше пауза, тем сложнее поиск ошибки.</b></p>
                </div>
