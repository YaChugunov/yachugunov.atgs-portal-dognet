                            ...
                            <form class="form-inline" method="GET" action="/dognet/dognet-report.php">
                                ...
                                <div id="report-info" class="">
                                    ...
                                    <ol>
                                        ...
                                        <li>В расчет берутся только зачтенные (частично или полностью) авансы в дату
                                            счетов-фактур ранее или
                                            равной выбранной.</li>
                                        <li>Остаток по авансу рассчитывается как разность между суммой аванса и суммой
                                            всех зачтенных сумм в пользу счетов-фактур на дату ранее или равную
                                            выбранной.</li>
                                        <li>Все суммы, зачеты и остатки по каждому авансу циклически суммируются в
                                            рамках основного договора
                                            (если счета) и заказчика, а затем формируется итоговая
                                            сумма по всем заказчикам.</li>
                                    </ol>
                                    <p class="text-info"><b>Обновление от 28.10.2025. </b>Вместо планируемой даты
                                        окончания этапа выводится дата либо введенная напрямую либо рассчитанная в днях
                                        от 1-го аванса. Если параметры окончания этапа по каким-то причинам отсутствуют,
                                        то выводится планируемая дата с меткой "(план)", либо же - "нет данных". Для
                                        договоров без этапов
                                        выводится дата окончания договора.</p>
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
                <div class="text-center">
                    ...
                    if (isset($_GET['format'])) {
                      switch ($_GET['format']) {
                        case 'xls':
                          include ($_SERVER['DOCUMENT_ROOT'] . '/dognet/php/examples/simple/report/report-details/restr_4/reports/spravka/unoplav_ondate/export/_xlsx/export2xlsx.php');
                          break;
                        default:
