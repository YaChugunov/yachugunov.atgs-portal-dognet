...
$activeSheet->setCellValue("A{$line}", 'Справка о задолженности по субподрядчикам');
...
// Вывод данных
	...
	$activeSheet->setCellValue("E{$line}", number_format($_total_sumoplchf, 2, '.', ' '));
// Выравнивание по горизонтали - центр
	$activeSheet->getStyle("A{$line}")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
	$activeSheet->getStyle("B{$line}")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
	$activeSheet->getStyle("D{$line}")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
...
// Вывод данных
	...
	$activeSheet->setCellValue("E{$line}", number_format($_total_sumavchf, 2, '.', ' '));
// Выравнивание по горизонтали - центр
	$activeSheet->getStyle("A{$line}")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
	$activeSheet->getStyle("B{$line}")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
	$activeSheet->getStyle("D{$line}")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
...
// Вывод данных
	...
	$activeSheet->setCellValue("E{$line}", number_format($_total_sumavoplchf, 2, '.', ' '));
// Выравнивание по горизонтали - центр
	$activeSheet->getStyle("A{$line}")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
	$activeSheet->getStyle("B{$line}")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
	$activeSheet->getStyle("D{$line}")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
...
#
	...
	$activeSheet->setCellValue("B{$line}", number_format($_itogo_table, 2, '.', ' '));
#
#
# ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
# Пропускаем строки
