<?php
    ...
    $table = $header->addTable(['width' => 100 * 50, 'unit' => "pct", 'borderBottomSize' => 10, 'borderBottomColor' => "C0C0C0", 'cellMarginBottom' => 100, 'valign' => "top"]);
    $table->addRow();
    $cell    = $table->addCell();
    $textrun = $cell->addTextRun();
    // Оформляем содержимое таблицы в header
    $textrun->addText('Справка о задолженности', ['name' => "Arial", 'size' => 12, 'color' => '333333', 'allCaps' => true, 'bold' => true]);
    //
    $cell    = $table->addCell();
    $textrun = $cell->addTextRun(['alignment' => \PhpOffice\PhpWord\SimpleType\Jc::RIGHT]);
    $textrun->addText('По счетам-фактурам', ['name' => "Arial", 'size' => 12, 'italic' => true]);
    #
    # ::::: НИЖНИЙ КОЛОНТИТУЛ (FOOTER)
    #
    $footer = $section->addFooter();
    // Вставляем таблицу в верхний колонтитул (header)
    $table = $footer->addTable(['width' => 100 * 50, 'unit' => "pct", 'borderTopSize' => 10, 'borderTopColor' => "C0C0C0", 'cellMarginTop' => 100]);
    $table->addRow();
    $cell    = $table->addCell();
    $textrun = $cell->addTextRun();
    // Оформляем содержимое таблицы в header
    $textrun->addText($_SESSION["current_user_firstname"] . " " . $_SESSION["current_user_lastname"], ['name' => "Arial", 'size' => 8, 'color' => '333333', 'allCaps' => true]);
    $textrun->addTextBreak();
    $textrun->addText(date('d.m.Y H:i:s'), ['name' => "Arial", 'size' => 8, 'color' => '333333']);
    //
    ...
    //
    //
    $table->addCell()->addPreserveText('Страница {PAGE} из {NUMPAGES}', ['name' => "Arial", 'size' => 8, 'color' => '333333', 'allCaps' => true], ['alignment' => \PhpOffice\PhpWord\SimpleType\Jc::RIGHT]);
    # ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
    #
    #
    #
    ...
    #
    # ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
    $phpWord->addTitleStyle(1, ['name' => "Arial", 'size' => 16, 'bold' => true], ['spaceAfter' => 240]);
    $phpWord->addTitleStyle(2, ['name' => "Arial", 'size' => 14, 'bold' => true], ['spaceAfter' => 200]);
    $section->addTitle('Справка о задолженностях по счетам-фактурам на ' . date('d.m.Y', strtotime($_ONDATE)), 2);
    //
    //
    ...
    $_TBL_HEADERStyle_Row = [
        'tblHeader' => true,
    ];
    // Стиль TBL.HEADER.CELL-LEFT
    $_TBL_HEADERStyle_CellLeft = [
        'valign'            => 'center',
        'bgColor'           => 'F1F1F1',
    ...
    $_TBL_HEADERFont = ['name' => "Arial Narrow", 'allCaps' => true, 'bold' => true, 'size' => 10];
    # ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
    #
    # ТЕЛО ТАБЛИЦЫ
    #
    ...
    $_TBL_BODYStyle_CellSpan7_1 = [
        'valign'            => 'center',
        'gridSpan'          => 7,
        'borderBottomColor' => "999999",
        'borderBottomSize'  => 2,
    ];
    $_TBL_BODYStyle_CellSpan6_1 = [
        'valign'            => 'center',
        'gridSpan'          => 6,
        'bgColor'           => 'E0E0E0',
        'borderBottomColor' => "999999",
    ...
    $_TBL_BODYStyle_CellRight = [
        'valign'            => 'center',
        'borderBottomColor' => "999999",
        'borderBottomSize'  => 2,
    ];
    // FONTS TBL.BODY.CELL
    $_TBL_BODYFont_H1_1 = ['name' => "Arial Narrow", 'allcaps' => true, 'bold' => true, 'size' => 11, 'color' => "111111"];
    $_TBL_BODYFont_H1_2 = ['name' => "Arial Narrow", 'allcaps' => true, 'bold' => true, 'size' => 11, 'color' => "FFFFFF"];
    $_TBL_BODYFont_H1_3 = ['name' => "Arial", 'bold' => true, 'size' => 11, 'color' => "111111"];

    $_TBL_BODYFont_H2_1 = ['name' => "Arial", 'bold' => true, 'size' => 9, 'color' => "111111"];
    $_TBL_BODYFont_H2_2 = ['name' => "Arial", 'bold' => true, 'size' => 9, 'color' => "D9534F"];
    $_TBL_BODYFont_H3_1 = ['name' => "Arial", 'italic' => false, 'size' => 9, 'color' => "111111"];
    $_TBL_BODYFont      = ['name' => "Arial", 'bold' => false, 'size' => 8, 'color' => "666666"];
    $_TBL_BODYFont_2    = ['name' => "Arial", 'bold' => false, 'size' => 10, 'color' => "333333"];

    $_TBL_CELLAlign_H_Left   = ['alignment' => \PhpOffice\PhpWord\SimpleType\Jc::LEFT];
    $_TBL_CELLAlign_H_Right  = ['alignment' => \PhpOffice\PhpWord\SimpleType\Jc::RIGHT];
    $_TBL_CELLAlign_H_Center = ['alignment' => \PhpOffice\PhpWord\SimpleType\Jc::CENTER];
    $_TBL_CELLAlign_V_Middle = ['valign' => 'center'];
    # ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
    $_TBL_BODYFont_Title_H1_1 = ['name' => "Arial Narrow", 'allcaps' => true, 'bold' => true, 'size' => 12, 'color' => "111111"];
    $_TBL_BODYFont_Title_H1_2 = ['name' => "Arial Narrow", 'bold' => true, 'size' => 12, 'color' => "111111"];
    $_TBL_BODYFont_Title_H2_1 = ['name' => "Arial Narrow", 'allcaps' => true, 'bold' => true, 'size' => 9, 'color' => "111111"];
    $_TBL_BODYFont_Title_H2_2 = ['name' => "Arial Narrow", 'bold' => true, 'size' => 9, 'color' => "111111"];
    $_TBL_BODYFont_Title_H3_1 = ['name' => "Arial", 'bold' => true, 'size' => 9, 'color' => "111111"];
    $_TBL_BODYFont_Title_H3_2 = ['name' => "Arial", 'bold' => true, 'size' => 9, 'color' => "111111"];
    # ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
    ...
    //
    //
    $section->addText("", null, ['widowControl' => false, 'indentation' => ['left' => 0, 'right' => 0], 'spaceBefore' => 90, 'spaceAfter' => 240]);
    //
    //
    $section->addText(
        "Далее приведен список компаний-плательщиков, со стороны которых по выставленным счетам-фактурам имеются задолженности.",
        null,
        ['widowControl' => false, 'indentation' => ['left' => 240, 'right' => 0], 'spaceBefore' => 90, 'spaceAfter' => 90]
    );
    //
    //
    $section->addText(
    ...
    if ($A1) {
        $section->addText(
            "- текущая",
            ['bold' => true, 'size' => 8],
            ['widowControl' => false, 'indentation' => ['left' => 480, 'right' => 0], 'spaceBefore' => 0, 'spaceAfter' => 60]
        );
    }
    if ($A2) {
        $section->addText(
    ...
    $AAA = $A1 . $A2 . $A3;
    $_queryStr .= "koddoc IN (SELECT koddoc FROM dognet_reports_zadolchf_ondate WHERE ";
    if (checkUserRestrictions($_SESSION['id'], 'dognet', 5, 1) == 1) {
    ...
    while ($_ROW = mysqli_fetch_assoc($_QRY)) {
        ...
        $table->addRow(450, $_TBL_BODYStyle_Row);
        $table->addCell(8000, $_TBL_BODYStyle_CellSpan8_2)->addTextRun($_TBL_CELLAlign_H_Left)->addText($_ROW['nameshort'], $_TBL_BODYFont_H1_2);
        ...
        while ($_ROW_docbase = mysqli_fetch_assoc($_QRY_docbase)) {
            ...
            if (($_ROW_docbase['kodshab'] == 1) or ($_ROW_docbase['kodshab'] == 3)) {
                $_QRY_dockalplan_Str = "SELECT * FROM dognet_dockalplan WHERE koddel<>'99' AND koddoc='" . $_ROW_docbase['koddoc'] . "' AND kodkalplan IN (SELECT kodkalplan FROM dognet_reports_zadolchf_ondate)";
            }
            if (($_ROW_docbase['kodshab'] == 2) or ($_ROW_docbase['kodshab'] == 4)) {
                $_QRY_dockalplan_Str = "SELECT * FROM dognet_docbase WHERE koddel<>'99' AND numberchet='' AND koddoc='" . $_ROW_docbase['koddoc'] . "' AND (kodshab='2' OR kodshab='4') AND koddoc IN (SELECT koddoc FROM dognet_reports_zadolchf_ondate)";
            }
            if ($_ROW_docbase['kodshab'] == 0) {
                $_QRY_dockalplan_Str = "SELECT * FROM dognet_docbase WHERE koddel<>'99' AND numberchet<>'' AND koddoc='" . $_ROW_docbase['koddoc'] . "' AND kodshab='0' AND koddoc IN (SELECT koddoc FROM dognet_reports_zadolchf_ondate)";
            }
            ...
            while ($_ROW_dockalplan = mysqli_fetch_assoc($_QRY_dockalplan)) {
                ...
                // 			$_QRY_kalplanchf = mysqlQuery( "SELECT * FROM dognet_kalplanchf WHERE kodkalplan='".$_ROW_dockalplan['kodkalplan']."' AND kodchfact IN (SELECT kodchfact FROM dognet_reports_zadolchf_ondate)" );

                if (($_ROW_docbase['kodshab'] == 1) or ($_ROW_docbase['kodshab'] == 3)) {
                    $_QRY_kalplanchf = mysqlQuery("SELECT dognet_kalplanchf.chetfnumber, dognet_kalplanchf.chetfdate, dognet_kalplanchf.chetfsumma, dognet_reports_zadolchf_ondate.summaoplav, dognet_reports_zadolchf_ondate.summaopl, dognet_reports_zadolchf_ondate.summazadol FROM dognet_kalplanchf INNER JOIN dognet_reports_zadolchf_ondate ON dognet_kalplanchf.kodchfact = dognet_reports_zadolchf_ondate.kodchfact WHERE dognet_kalplanchf.kodkalplan='" . $_ROW_dockalplan['kodkalplan'] . "' AND dognet_kalplanchf.chetfdate <='" . $_ONDATE . "'");
                } elseif (($_ROW_docbase['kodshab'] == 0) or ($_ROW_docbase['kodshab'] == 2) or ($_ROW_docbase['kodshab'] == 4)) {
                    $_QRY_kalplanchf = mysqlQuery("SELECT dognet_kalplanchf.chetfnumber, dognet_kalplanchf.chetfdate, dognet_kalplanchf.chetfsumma, dognet_reports_zadolchf_ondate.summaoplav, dognet_reports_zadolchf_ondate.summaopl, dognet_reports_zadolchf_ondate.summazadol FROM dognet_kalplanchf INNER JOIN dognet_reports_zadolchf_ondate ON dognet_kalplanchf.kodchfact = dognet_reports_zadolchf_ondate.kodchfact WHERE dognet_kalplanchf.kodkalplan='" . $_ROW_docbase['koddoc'] . "' AND dognet_kalplanchf.chetfdate <='" . $_ONDATE . "'");
                }
    ...
    $table->addRow(450, $_TBL_BODYStyle_Row);
    $table->addCell(6000, $_TBL_BODYStyle_CellSpan6_2)->addTextRun($_TBL_CELLAlign_H_Left)->addText('Общая задолженность', $_TBL_BODYFont_Title_H1_1);
    $table->addCell(4000, $_TBL_BODYStyle_CellSpan2_2)->addTextRun($_TBL_CELLAlign_H_Right)->addText(number_format($_SUM_summazadol_total, 2, '.', ' ') . $_DENED, $_TBL_BODYFont_Title_H1_2);
...
*/
    ...
    // PORTAL_SYSLOG('99942200', '0000002', null, $_GET['reportview'], "Задолженность по счетам-фактурам / на дату", "WORD");
