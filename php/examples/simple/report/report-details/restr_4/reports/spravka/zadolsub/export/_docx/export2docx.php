<?php
    ...
    $textrun->addText('Справка о задолженности', ['name' => "Arial", 'size' => 10, 'color' => '333333', 'allCaps' => true, 'bold' => true]);
    //
    $cell    = $table->addCell();
    $textrun = $cell->addTextRun(['alignment' => \PhpOffice\PhpWord\SimpleType\Jc::RIGHT]);
    $textrun->addText('По субподрядчикам', ['name' => "Arial", 'size' => 10, 'italic' => true]);
    #
    ...
    $textrun = $cell->addTextRun();
    // Оформляем содержимое таблицы в header
    $textrun->addText($_SESSION["current_user_firstname"] . " " . $_SESSION["current_user_lastname"], ['name' => "Arial", 'size' => 6, 'color' => '333333', 'allCaps' => true]);
    $textrun->addTextBreak();
    $textrun->addText(date('d.m.Y H:i:s'), ['name' => "Arial", 'size' => 6, 'color' => '333333']);
    //
    ...
    //
    //
    $table->addCell()->addPreserveText('Страница {PAGE} из {NUMPAGES}', ['name' => "Arial", 'size' => 6, 'color' => '333333', 'allCaps' => true], ['alignment' => \PhpOffice\PhpWord\SimpleType\Jc::RIGHT]);
    # ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
    #
    #
    #
    ...
    #
    # ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
    $phpWord->addTitleStyle(1, ['name' => "Arial", 'size' => 16, 'bold' => true], ['spaceAfter' => 320]);
    $phpWord->addTitleStyle(2, ['name' => "Arial", 'size' => 14, 'bold' => true], ['spaceAfter' => 320]);
    $phpWord->addTitleStyle(3, ['name' => "Arial", 'size' => 12, 'bold' => true], ['spaceAfter' => 240]);
    ...
    $section->addText("Далее приведен список компаний-плательщиков, со стороны которых по выставленным счетам-фактурам имеются задолженности.",
        null,
        ['widowControl' => false, 'indentation' => ['left' => 0, 'right' => 0], 'spaceBefore' => 90, 'spaceAfter' => 90]
    );
    #
    #
    #
    ...
    #
        ...
        if (mysqli_num_rows($_QRY_docbase) > 0) {$_MAINDOC_EXIST = 1;} else { $_MAINDOC_EXIST = 0;}
