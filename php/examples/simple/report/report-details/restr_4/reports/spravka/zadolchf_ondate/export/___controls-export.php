		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 space20">
				<div id="report-settings" class="text-center">
					<h3 class="space10">
						Справка о задолженности по счетам-фактурам
						<br>
						на <?php echo date('d.m.Y', strtotime($_GET['ondate'])); ?>
					</h3>
					<h4 class="space10">Выберите формат экспорта</h4>
				</div>
			</div>
			<div class="col-xs-hidden col-sm-12 col-md-12 col-lg-12">
				<div id="export-format-block" class="center-block" style="">
					<form method="GET" action="/dognet/dognet-report.php">
						<input type="hidden" name="reportview" value="zadolchf_ondate">
						<input type="hidden" name="ondate" value="<?php echo $_GET['ondate'] ?>">
						<input type="hidden" name="export" value="yes">
						<div class="col-xs-hidden col-sm-12 col-md-12 col-lg-12">
							<div id="select-type" class="space10">
								<label class="checkbox-inline"><input type="checkbox" name="doc" value="yes" checked>Договора</label>
								<label class="checkbox-inline"><input type="checkbox" name="cht" value="yes" checked>Счета</label>
							</div>
						</div>
						<div class="col-xs-hidden col-sm-12 col-md-12 col-lg-12">
							<div id="select-type" class="space10">
								<label class="checkbox-inline"><input type="checkbox" name="zdl_1" value="yes" checked>Текущая</label>
								<label class="checkbox-inline"><input type="checkbox" name="zdl_2" value="yes" checked>Судебная</label>
								<label class="checkbox-inline"><input type="checkbox" name="zdl_3" value="yes" checked>Невозвратная</label>
							</div>
						</div>
...
<?php
				if (isset($_GET['format'])) {
					switch ($_GET['format']) {
						case "doc":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_4/reports/spravka/zadolchf_ondate/export/_docx/export2docx.php");
							break;
						case "xls":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_4/reports/spravka/zadolchf_ondate/export/_xlsx/export2xlsx.php");
							break;
						case "pdf":
							include($_SERVER['DOCUMENT_ROOT']."/dognet/php/examples/simple/report/report-details/restr_4/reports/spravka/zadolchf_ondate/export/_pdf/export2pdf.php");
							break;
						default:
