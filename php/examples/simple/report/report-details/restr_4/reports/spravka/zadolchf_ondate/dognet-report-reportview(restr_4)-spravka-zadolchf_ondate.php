        ...
        while ($_ROW = mysqli_fetch_assoc($_QRY)) {
            ...
            if (round($chf_summazadol, 2) > 0 or round($chf_summazadol, 2) < 0) {
                ...
                if ($_NUM1 > 0) {
                    ...
                    $kodstatuszdl      = ! empty($_ROW_kodstatuszdl['kodstatuszdl']) ? $_ROW_kodstatuszdl['kodstatuszdl'] : "";
                    if ($kodstatuszdl == '2' || $kodstatuszdl == '3' || $kodstatuszdl == '0') {
                ...
                // Определяем ID договора (koddoc) для договора без календарного плана
                    ...
                    $kodstatuszdl = ! empty($_ROW_koddoc2['kodstatuszdl']) ? $_ROW_koddoc2['kodstatuszdl'] : "";
                    if ($kodstatuszdl == '2' || $kodstatuszdl == '3' || $kodstatuszdl == '0') {
