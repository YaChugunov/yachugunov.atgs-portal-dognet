...
<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		table_report_view_main = $('#report-view-main-table').DataTable({
			...
			ajax: {
				url: "php/examples/simple/report/report-details/restr_4/reports/spravka/unoplav/process/dognet-report-reportview-spravka-unoplav-betweendates-process.php",
				type: "POST",
				data: function(d) {
...
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/report/report-details/restr_4/reports/spravka/unoplav/tabs/css/report-view-main.css">
<section>
	<div id="report-view-main" class="">
		...
		// :::
		include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_4/reports/spravka/unoplav/tabs/forms/report-view-main-filters.php");
		// ----- ----- ----- ----- -----
		?>
