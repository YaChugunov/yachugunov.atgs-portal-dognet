		...
		'<div class="row">'+
			'<div class="col-xs-12 col-sm-12 col-md-12">'+
				'<ul id="row-details-report-view-main-tabs-menu" class="nav nav-tabs">'+
					...
					'<li><a data-toggle="tab" href="#report-view-main-'+row.id()+'-tab-4" title="">Суммы по авансу</a></li>'+
				'</ul>'+
							...
							'<div style="padding:10px">'+
								...
								'<table id="row-details-report-view-main-table" class="table table-condensed table-striped" >'+
									'<tbody>'+
										...
										'</tr>'+
										'<tr>'+
											'<td width="30%"><span class="row-details-report-view-main-table-title_topic">Сумма аванса</span></td>'+
											'<td width="70%"><span class="row-details-report-view-main-table-txt">'+$.fn.dataTable.render.number(' ', ',', 2, '').display( d.dognet_docavans.summaavans )+''+d.dognet_spdened.short_code+'</span></td>'+
										'</tr>'+
										'<tr>'+
											'<td width="30%"><span class="row-details-report-view-main-table-title_topic">Незачтенный остаток</span></td>'+
											'<td width="70%"><span class="row-details-report-view-main-table-txt">'+$.fn.dataTable.render.number(' ', ',', 2, '').display( d.dognet_docavans.ostatokavans )+''+d.dognet_spdened.short_code+'</span></td>'+
										'</tr>'+
									'</tbody>'+
								'</table>'+
