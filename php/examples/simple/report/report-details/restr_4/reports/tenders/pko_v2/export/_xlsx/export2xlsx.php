...
#
#
include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_4/reports/tenders/pko_v2/export/_xlsx/export2xlsx_pko.php");
if ($A1) {
...
function countDown() {
    ...
    timer = setInterval(function() {
        ...
        url2 = 'http://' + host + '/dognet/dognet-report.php?reportview=pko_v2&export=yes';
        if (i < 0) {
            clearInterval(timer);
