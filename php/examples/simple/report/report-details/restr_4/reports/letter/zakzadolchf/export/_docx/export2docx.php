<?php
    ...
    #
    require $_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_4/reports/letter/zakzadolchf/export/_docx/export2docx_styles.inc.php";
    # ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
    #
    ...
    $src  = $_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_4/reports/letter/zakzadolchf/export/_docx/logo_footer_cert.png";
    $cell->addImage($src, ['width' => 220, 'height' => 46, 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::RIGHT]);
    # ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
    #
    #
    #
    ...
    #
    # ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
    $phpWord->addTitleStyle(1, ['name' => "Arial", 'size' => 14, 'bold' => true], ['spaceBefore' => 360, 'spaceAfter' => 360, 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::CENTER]);
    $phpWord->addTitleStyle(2, ['name' => "Arial", 'size' => 12, 'bold' => true], ['spaceBefore' => 180, 'spaceAfter' => 180, 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::CENTER]);
    $phpWord->addTitleStyle(3, ['name' => "Arial", 'size' => 11, 'bold' => true], ['spaceAfter' => 180, 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::CENTER]);
    # ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
    $_PARAGRAF_B = 'pStyleB';
    $phpWord->addParagraphStyle($_PARAGRAF_B, ['widowControl' => false, 'indentation' => ['left' => 0, 'right' => 0], 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::BOTH, 'spacing' => 120, 'spaceBefore' => 420, 'spaceAfter' => 420]);
    $_PARAGRAF_1L = 'pStyle1L';
    $phpWord->addParagraphStyle($_PARAGRAF_1L, ['widowControl' => false, 'indentation' => ['firstLine' => 600, 'left' => 0, 'right' => 0], 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::LEFT, 'spacing' => 120, 'spaceBefore' => 240, 'spaceAfter' => 360]);
    $_PARAGRAF_1B = 'pStyle1B';
    $phpWord->addParagraphStyle($_PARAGRAF_1B, ['widowControl' => false, 'indentation' => ['left' => 0, 'right' => 0], 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::BOTH, 'spacing' => 120, 'spaceBefore' => 240, 'spaceAfter' => 360]);
    $_PARAGRAF_2L = 'pStyle2L';
    $phpWord->addParagraphStyle($_PARAGRAF_2L, ['widowControl' => false, 'indentation' => ['firstLine' => 600, 'left' => 0, 'right' => 0], 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::LEFT, 'spacing' => 120, 'spaceBefore' => 240, 'spaceAfter' => 360]);
    $_PARAGRAF_2B = 'pStyle2B';
    $phpWord->addParagraphStyle($_PARAGRAF_2B, ['widowControl' => false, 'indentation' => ['left' => 0, 'right' => 0], 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::BOTH, 'spacing' => 120, 'spaceBefore' => 240, 'spaceAfter' => 360]);
    $_PARAGRAF_3L = 'pStyle3L';
    $phpWord->addParagraphStyle($_PARAGRAF_3L, ['widowControl' => false, 'indentation' => ['firstLine' => 600, 'left' => 0, 'right' => 0], 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::LEFT, 'spacing' => 60, 'spaceBefore' => 150, 'spaceAfter' => 150]);
    $_PARAGRAF_3B = 'pStyle3B';
    $phpWord->addParagraphStyle($_PARAGRAF_3B, ['widowControl' => false, 'indentation' => ['left' => 0, 'right' => 0], 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::BOTH, 'spacing' => 60, 'spaceBefore' => 150, 'spaceAfter' => 150]);
    $_PARAGRAF_3R = 'pStyle3R';
    $phpWord->addParagraphStyle($_PARAGRAF_3R, ['widowControl' => false, 'indentation' => ['left' => 0, 'right' => 0], 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::RIGHT, 'spacing' => 60, 'spaceBefore' => 150, 'spaceAfter' => 150]);
    #
    #
    ...
    function printParagraphSeparator($phpWord, $section, $pStyle)
    {
        ...
        $phpWord->addParagraphStyle($_PARAGRAF_B, ['widowControl' => false, 'indentation' => ['left' => 0, 'right' => 0], 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::BOTH, 'spacing' => 120, 'spaceBefore' => 420, 'spaceAfter' => 420]);
        $_PARAGRAF_1L = 'pStyle1L';
        $phpWord->addParagraphStyle($_PARAGRAF_1L, ['widowControl' => false, 'indentation' => ['firstLine' => 360, 'left' => 0, 'right' => 0], 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::LEFT, 'spacing' => 120, 'spaceBefore' => 240, 'spaceAfter' => 360]);
        $_PARAGRAF_1B = 'pStyle1B';
        $phpWord->addParagraphStyle($_PARAGRAF_1B, ['widowControl' => false, 'indentation' => ['left' => 0, 'right' => 0], 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::BOTH, 'spacing' => 120, 'spaceBefore' => 240, 'spaceAfter' => 360]);
        $_PARAGRAF_2L = 'pStyle2L';
        $phpWord->addParagraphStyle($_PARAGRAF_2L, ['widowControl' => false, 'indentation' => ['firstLine' => 360, 'left' => 0, 'right' => 0], 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::LEFT, 'spacing' => 120, 'spaceBefore' => 240, 'spaceAfter' => 360]);
        $_PARAGRAF_2B = 'pStyle2B';
        $phpWord->addParagraphStyle($_PARAGRAF_2B, ['widowControl' => false, 'indentation' => ['left' => 0, 'right' => 0], 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::BOTH, 'spacing' => 120, 'spaceBefore' => 240, 'spaceAfter' => 360]);
        $_PARAGRAF_3L = 'pStyle3L';
        $phpWord->addParagraphStyle($_PARAGRAF_3L, ['widowControl' => false, 'indentation' => ['firstLine' => 360, 'left' => 0, 'right' => 0], 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::LEFT, 'spacing' => 60, 'spaceBefore' => 150, 'spaceAfter' => 150]);
        $_PARAGRAF_3B = 'pStyle3B';
        $phpWord->addParagraphStyle($_PARAGRAF_3B, ['widowControl' => false, 'indentation' => ['left' => 0, 'right' => 0], 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::BOTH, 'spacing' => 60, 'spaceBefore' => 150, 'spaceAfter' => 150]);
        $_PARAGRAF_3R = 'pStyle3R';
        $phpWord->addParagraphStyle($_PARAGRAF_3R, ['widowControl' => false, 'indentation' => ['left' => 0, 'right' => 0], 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::RIGHT, 'spacing' => 60, 'spaceBefore' => 150, 'spaceAfter' => 150]);
    ...
    $src  = $_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/report/report-details/restr_4/reports/letter/zakzadolchf/export/_docx/logo_header_atgs.png";
    $cell->addImage($src, ['width' => 280, 'height' => 143, 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::LEFT]);
    #
    ...
    for ($i = 0; $i < $count; $i++) {
        ...
        if ($_QRY1) {
            ...
            if (! empty($koddoc)) {
                ...
                $doc_number = ! empty($_ROW2['docnumber']) ? $_ROW2['docnumber'] : "";
                $var1       = ! empty($_ROW2['daynachdoc']) ? str_pad($_ROW2['daynachdoc'], 2, "0", STR_PAD_LEFT) : "--";
                $var2       = ! empty($_ROW2['monthnachdoc']) ? str_pad($_ROW2['monthnachdoc'], 2, "0", STR_PAD_LEFT) : "--";
                $var3       = ! empty($_ROW2['yearnachdoc']) ? $_ROW2['yearnachdoc'] : "----";
                $doc_date   = $var1 . "." . $var2 . "." . $var3;
            } else {
                $doc_number = "---";
                $doc_date   = "---";
            }
