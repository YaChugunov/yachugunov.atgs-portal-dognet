<?php
    ...
    $cell->addImage($src, ['width' => 320, 'height' => 46, 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::RIGHT]);
    # ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
    #
    #
    #
    ...
    #
    # ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
    $phpWord->addTitleStyle(1, ['name' => "Arial", 'size' => 14, 'bold' => true], ['spaceAfter' => 840, 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::CENTER]);
    $phpWord->addTitleStyle(2, ['name' => "Arial", 'size' => 12, 'bold' => true], ['spaceAfter' => 180, 'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::CENTER]);
    ...
    if (! empty($_GET['fio_manual']) && isset($_GET['fio_manual']) && $_GET['fio_manual'] == "yes") {
        ...
        $_ZAK_ORG       = (! empty($_ROW_ZAK_SP['namefull'])) ? $_ROW_ZAK_SP['namefull'] : "";
