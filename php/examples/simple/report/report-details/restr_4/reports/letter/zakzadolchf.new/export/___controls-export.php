                        ...
                        <div id="export-format-block" class="center-block" style="">
                            <form class="form-horizontal" method="GET" action="/dognet/dognet-report.php">
                                ...
                                <div class="col-xs-hidden col-sm-12 col-md-12 col-lg-12 space20">
                                    ...
                                    $_ROW_B = mysqli_fetch_assoc($_QRY_B);
                                    $docdate = numberFormat($_ROW_A['daynachdoc'], 2) . "." . numberFormat($_ROW_A['monthnachdoc'], 2) . numberFormat($_ROW_A['yearnachdoc'], 4);
                                    $_zakFirstName = $_ROW_B['director_firstname'];
                                    $_zakMidName = $_ROW_B['director_middlename'];
                                    $_zakLastName = $_ROW_B['director_lastname'];
                                    $_zakDolj = $_ROW_B['director_post'];
                                    /**
                                     * 
                                ...
                                <div class="col-xs-hidden col-sm-12 col-md-12 col-lg-12 space20">
                                    ...
                                    <div class="col-sm-12 space10">
                                        <input type="text" class="form-control" id="zak-dolj" name="zak_dolj" placeholder="Должность">
                                    </div>
                                    <div class="col-sm-12 space10">
                                        <input type="text" class="form-control" id="zak-org" name="zak_org" placeholder="Организация">
                                    </div>
                                    <div class="col-sm-4 space30">
                                        <input type="text" class="form-control" id="zak-lastname" name="zak_lastname" placeholder="Фамилия">
                                    </div>
                                    <div class="col-sm-4 space30">
                                        <input type="text" class="form-control" id="zak-firstname" name="zak_firstname" placeholder="Имя">
                                    </div>
                                    <div class="col-sm-4 space30">
                                        <input type="text" class="form-control" id="zak-midname" name="zak_midname" placeholder="Отчество">
                                    </div>
                                    <h4 class="section-title space10">Как будет выглядеть приветственное
                                        обращение</h4>
                                    <div class="col-sm-12 space10">
                                        <input type="text" class="form-control" id="zak-hello" name="zak_hello" placeholder='Обращение (по умолчанию - "Уважаемый")'>
                                    </div>
                                    <div class="col-sm-4 space10">
                                        <input type="text" class="form-control" id="zak-hello-firstname" name="zak_hello_firstname" placeholder="Имя">
                                    </div>
                                    <div class="col-sm-4 space10">
                                        <input type="text" class="form-control" id="zak-hello-midname" name="zak_hello_midname" placeholder="Отчество">
                                    </div>
                                </div>
                                ...
                                <div class="space10">
                                    <button id="exportBtn" class="btn btn-export" type="submit" name="done" value="ok">Сформировать документ</button>
                                </div>
                            </form>
                        </div>
                    </div>
