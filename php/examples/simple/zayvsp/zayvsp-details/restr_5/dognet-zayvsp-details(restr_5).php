...
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvsp/zayvsp-details/restr_5/tabs/css/zayvsp-details-common-tables.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvsp/zayvsp-details/restr_5/tabs/css/zayvsp-details-common-customForm.css">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
							<ul id="main-tabs-menu" class="nav nav-tabs">
								...
								<li id="tab-2-link"><a data-toggle="tab" href="#tab-2" title="">Списки рассылок</a></li>
							</ul>
							<div class="tab-content">
								<div id="tab-1" class="tab-pane fade in active">
									<?php include("tabs/dognet-zayvsp-details(restr_5)-tab_postav.php"); ?>
								</div>
								<div id="tab-2" class="tab-pane fade in active">
									<?php // include("tabs/dognet-zayvsp-details(restr_5)-tab1_zayvtel.php"); ?>
								</div>
							</div>
						</div>
					</div>
