...
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvsp/zayvsp-details/restr_3/tabs/css/zayvsp-details-common-tables.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvsp/zayvsp-details/restr_3/tabs/css/zayvsp-details-common-customForm.css">
						...
						<div class="col-xs-12 col-sm-12 col-md-12">
							...
							<div class="tab-content">
								<div id="tab-1" class="tab-pane fade in active">
									<?php include("tabs/dognet-zayvsp-details(restr_3)-tab_postav.php"); ?>
								</div>
							</div>
						</div>
					</div>
