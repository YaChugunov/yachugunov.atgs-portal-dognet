<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		editor_tab_postav = new $.fn.dataTable.Editor({
			display: "bootstrap",
			ajax: "php/examples/simple/zayvsp/zayvsp-details/restr_3/tabs/process/dognet-zayvsp-details-tab_postav-process.php",
		...
		table_tab_postav = $('#zayvsp-details-tab_postav-table').DataTable({
			...
			ajax: {
				url: "php/examples/simple/zayvsp/zayvsp-details/restr_3/tabs/process/dognet-zayvsp-details-tab_postav-process.php",
				type: "POST"
			},
			serverSide: true,
			columns: [{
...
// :::
include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/zayvsp/zayvsp-details/restr_3/tabs/forms/zayvsp-details-tab_postav-customForm.php");
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/zayvsp/zayvsp-details/restr_3/tabs/css/zayvsp-details-tab_postav.css">
<section>
