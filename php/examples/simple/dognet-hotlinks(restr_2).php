	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12">
			<div class="btn-group btn-group-justified">
				...
				<a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/dognet-docview.php?docview_type=current" class="btn btn-primary text-uppercase">Текущие договора</a>
				<a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/index.php" class="btn btn-info text-uppercase">Портал / Главная</a>
			</div>
		</div>
	</div>
</div>
