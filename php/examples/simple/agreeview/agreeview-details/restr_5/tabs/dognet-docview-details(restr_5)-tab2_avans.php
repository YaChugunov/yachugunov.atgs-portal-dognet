...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-details/restr_5/tabs/css/docview-details-common-tab2_avans.css">
...
?>
		...
		<table id="docview-details-tab2-avans" class="table table-responsive table-bordered display compact" cellspacing="0" width="100%">
			<thead>
				<tr>
...
?>
				<tr style="background-color:#f7f7f7; color:#111">
					<td class="docview-details-tab2 text-center" style="font-size:1.0em; font-weight:700"><a href="#tab2-avans-row-<?php echo $row_getKalplan['kodkalplan']; ?>" data-toggle="collapse"><span class='glyphicon glyphicon-option-vertical'></span></a></td>
					<td class="docview-details-tab2-avans-numberstage" style="font-size:1.0em; font-weight:700"><?php echo $row_getKalplan['numberstage']; ?></td>
					<td colspan="5" class="docview-details-tab2-namestage" style="font-size:1.0em; font-weight:700; text-align:left"><?php echo ($row_getKalplan['namefullstage']!="") ? $row_getKalplan['namefullstage'] : $row_getKalplan['nameshotstage']; ?></td>
				</tr>
<?php
...
?>
				<tr id="tab2-avans-row-<?php echo $row_getKalplan['kodkalplan']; ?>" class="collapse in">
					...
					<td colspan="5" class="docview-details-tab2-avans-collapse">
						<table id="docview-details-tab2-avans-collapse-table" class="table table-responsive display compact" cellspacing="0" width="100%">
							<tbody>
<?php
...
?>
								<tr>
									<td class="docview-details-tab2-avans-dateplan"><?php echo date("d.m.Y", strtotime($row_getDocavans['dateavans'])); ?></td>
									<td class=""><?php echo $row_getDocavans['nameavans']; ?></td>
									<td class="docview-details-tab2-avans-summastage"><?php echo number_format((float)($row_getDocavans['summaavans']), 2, '.', ' ').$__dened; ?></td>
									<td class="docview-details-tab2-avans-summastage"><?php echo number_format((float)($row_getAvanschf['sum1']), 2, '.', ' ').$__dened; ?></td>
									<td class="docview-details-tab2-avans-summastage <?php echo (($row_getDocavans['summaavans']-$row_getAvanschf['sum1']) <> 0 ? 'text-danger' : 'text-default'); ?> text-right"><?php echo number_format((float)($row_getDocavans['summaavans']-$row_getAvanschf['sum1']), 2, '.', ' ').$__dened; ?></td>
								</tr>
<?php
...
?>
				<tr id="tab2-avans-row-<?php echo $row_getKalplan['kodkalplan']; ?>" class="collapse in">
					...
					<td class="text-center"></td>
					<td colspan="5" class="docview-details-tab2-message text-danger" style="text-align:left">Авансовых платежей по данному этапу не поступало...</td>
				</tr>
<?php
