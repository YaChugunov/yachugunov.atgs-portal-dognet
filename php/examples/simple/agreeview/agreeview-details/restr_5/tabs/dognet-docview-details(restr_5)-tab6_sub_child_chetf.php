...
table_sub_child_chetf = $('#docview-sub-child-chetf').DataTable( {
	dom: "<'row'<'col-sm-5'><'col-sm-4'><'col-sm-3'>>" + "<'row'<'col-sm-12'tr>>" + "<'row'<'col-sm-1'B><'col-sm-5'i><'col-sm-6'p>>",
		...
		ajax: {
			...
			type: 'post',
      data: function ( d ) {
          var selected = table_sub_main.row( { selected: true } );
          if ( selected.any() ) {
...
//
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/docview/docview-details/restr_5/tabs/css/docview-details-common-tab6_sub_child_chetf.css">
<h3 class="docview-details-title2 text-right">Выставленные счета-фактуры</h3>
<div class="demo-html"></div>
<table id="docview-sub-child-chetf" class="table table-responsive table-bordered display compact" cellspacing="0" width="100%">
	<thead>
		<tr>
