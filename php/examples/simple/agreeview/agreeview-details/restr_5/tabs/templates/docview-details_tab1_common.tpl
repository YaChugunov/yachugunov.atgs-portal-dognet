			...
			'<table id="row-details-docview-details-table" class="table table-condensed table-striped" >'+
				'<tbody>'+
					...
					'<tr>'+
						...
						'<td width="70%"><span class="row-details-docview-details-table-txt">'+d.dognet_docbase.daynachdoc+'.'+d.dognet_docbase.monthnachdoc+'.'+d.dognet_docbase.yearnachdoc+'</span></td>'+
					'</tr>'+
					'<tr>'+
						'<td width="30%"><span class="row-details-docview-details-table-title_topic">Дата окончания договора</span></td>'+
						'<td width="70%"><span class="row-details-docview-details-table-txt">'+d.dognet_docbase.dayenddoc+'.'+d.dognet_docbase.monthenddoc+'.'+d.dognet_docbase.yearenddoc+'</span></td>'+
					'</tr>'+
					'<tr>'+
