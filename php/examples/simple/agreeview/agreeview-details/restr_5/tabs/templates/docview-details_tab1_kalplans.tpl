						...
						'<div class="hidden-xs col-sm-12 col-md-12 col-lg-12">'+
							...
							'<div style="padding:10px">'+
								...
								'<table id="row-details-docview-common-kalplans-table" class="table table-condensed table-striped" >'+
									'<tbody>'+
										'<tr>'+
											'<td width="30%"><span class="row-details-docview-details-table-title_topic">Срок выполнения</span></td>'+
											'<td width="70%"><span class="row-details-docview-details-table-txt">'+d.dognet_dockalplan.srokstage+'</span></td>'+
										'</tr>'+
										'<tr>'+
											'<td width="30%"><span class="row-details-docview-details-table-title_topic">Срок оплаты</span></td>'+
											'<td width="70%"><span class="row-details-docview-details-table-txt">'+d.dognet_dockalplan.srokopl+'</span></td>'+
										'</tr>'+
										'<tr>'+
											'<td width="30%"><span class="row-details-docview-details-table-title_topic">Срок выполнения (план)</span></td>'+
											'<td width="70%"><span class="row-details-docview-details-table-txt">'+d.dognet_dockalplan.dateplan+'</span></td>'+
										'</tr>'+
										'<tr>'+
											'<td width="30%"><span class="row-details-docview-details-table-title_topic">Дней до платежа (план)</span></td>'+
											'<td width="70%"><span class="row-details-docview-details-table-txt">'+d.dognet_dockalplan.numberdayoplstage+'</span></td>'+
										'</tr>'+
										'<tr>'+
											'<td width="30%"><span class="row-details-docview-details-table-title_topic">Дата окончательного платежа (план)</span></td>'+
											'<td width="70%"><span class="row-details-docview-details-table-txt">'+d.dognet_dockalplan.dateoplall+'</span></td>'+
										'</tr>'+
									'</tbody>'+
								'</table>'+
