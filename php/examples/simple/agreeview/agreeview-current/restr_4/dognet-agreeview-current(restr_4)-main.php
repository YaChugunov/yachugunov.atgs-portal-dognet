...
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/agreeview/agreeview-current/restr_4/css/agreeview-current-common-tables.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/agreeview/agreeview-current/restr_4/css/agreeview-current-common-customForm.css">
...
<script type="text/javascript" language="javascript" class="">
	...
	$(document).ready(function() {
		...
		editor_doc_main = new $.fn.dataTable.Editor({
			display: "bootstrap",
			ajax: "php/examples/simple/agreeview/agreeview-current/restr_4/process/dognet-agreeview-current(restr_4)-main-process.php",
		...
		editor_doc_main
			.on('open', function() {
				$('#kodzakaz_filter').val('');
				if (($('#DTE_Field_dognet_agreebase-kodzakaz').value) != editor_doc_main.field('dognet_agreebase.kodzakaz').get()) {}
				// Поиск в ниспадающем списке по содержимому текстового поля для ответного документа
				$('#DTE_Field_dognet_agreebase-kodzakaz').filterByText(editor_doc_main, $('#kodzakaz_filter'), 'dognet_agreebase.kodzakaz', false);

				$('#kodobject_filter').val('');
				if (($('#DTE_Field_dognet_agreebase-kodobject').value) != editor_doc_main.field('dognet_agreebase.kodobject').get()) {}
				// Поиск в ниспадающем списке по содержимому текстового поля для ответного документа
				$('#DTE_Field_dognet_agreebase-kodobject').filterByText(editor_doc_main, $('#kodobject_filter'), 'dognet_agreebase.kodobject', false);

				$('#kodblankwork_filter').val('');
				if (($('#DTE_Field_dognet_agreebase-kodblankwork').value) != editor_doc_main.field('dognet_agreebase.kodblankwork').get()) {}
				// Поиск в ниспадающем списке по содержимому текстового поля для ответного документа
				$('#DTE_Field_dognet_agreebase-kodblankwork').filterByText(editor_doc_main, $('#kodblankwork_filter'), 'dognet_agreebase.kodblankwork', false);
		...
		editor_doc_main.on('open', function(e, mode, action) {
				...
				editor_doc_main.dependent('dognet_agreebase.usedoczayv', function(val) {
					if (val == 1) {
						...
						editor_doc_main.dependent('dognet_agreebase.kodblankwork', function(val, data, callback) {
							if ($("#DTE_Field_dognet_agreebase-kodblankwork option:selected").val() != "") {

								// Serialize the data in the form
								// var serializedData = $form.serialize();
								var kodblankwork = $("#DTE_Field_dognet_agreebase-kodblankwork").val();
								// Fire off the request to /form.php
								request2 = $.ajax({
									url: "php/examples/simple/agreeview/agreeview-current/restr_4/process/dognet-docview-doc(restr_4)-main_fetch-process.php",
									type: "post",
									cache: false,
									data: {
			...
			$('#DTE_Field_dognet_agreebase-docsummamis').inputmask({
				alias: "currency",
				rightAlign: false,
				greedy: false,
				tabThrough: true,
			...
			$('#DTE_Field_dognet_agreebase-docsumma').inputmask({
				alias: "currency",
				rightAlign: false,
				greedy: false,
				tabThrough: true,
		...
		table_doc_main = $('#agreeview-doc-main').DataTable({
			...
			ajax: {
				url: "php/examples/simple/agreeview/agreeview-current/restr_4/process/dognet-agreeview-current(restr_4)-main-process.php",
				type: "POST"
			},
			serverSide: true,
			columns: [{
		...
		var editor_doc_files = new $.fn.dataTable.Editor({
			display: "bootstrap",
			ajax: {
				url: "php/examples/simple/agreeview/agreeview-current/restr_4/process/dognet-agreeview-current(restr_4)-files-process.php",
				data: function(d) {
			...
			i18n: {
				create: {
					title: "<h3>Добавить документ к соглашению</h3>"
				},
				edit: {
					title: "<h3>Изменить параметры документа</h3>"
				},
				remove: {
					button: "Удалить",
					title: "<h3>Удалить документ из соглашения</h3>",
					submit: "Удалить",
					confirm: {
...
// :::
include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/agreeview/agreeview-current/restr_4/forms/agreeview-current-customForm.php");
include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/agreeview/agreeview-current/restr_4/forms/agreeview-current-filters.php");
// ----- ----- ----- ----- -----
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/agreeview/agreeview-current/restr_4/css/agreeview-current-main.css">
<section>
...
// :::
include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/agreeview/agreeview-current/restr_4/forms/agreeview-current-files-customForm.php");
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/agreeview/agreeview-current/restr_4/css/agreeview-current-files.css">
<section>
...
// :::
include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/agreeview/agreeview-current/restr_4/forms/agreeview-current-modals.php");
?>