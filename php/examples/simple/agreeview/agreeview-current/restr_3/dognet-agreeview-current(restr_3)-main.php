...
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/agreeview/agreeview-current/restr_3/css/agreeview-current-common-tables.css">
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/agreeview/agreeview-current/restr_3/css/agreeview-current-common-customForm.css">
...
<script type="text/javascript" language="javascript" class="">
	...
	$(document).ready(function() {
		...
		editor_doc_main = new $.fn.dataTable.Editor({
			display: "bootstrap",
			ajax: "php/examples/simple/agreeview/agreeview-current/restr_3/process/dognet-agreeview-current(restr_3)-main-process.php",
					...
					if (val == 1) {
						...
						editor_doc_main.dependent('dognet_agreebase.kodblankwork', function(val, data, callback) {
							if ($("#DTE_Field_dognet_docbase-kodblankwork option:selected").val() != "") {
								...
								request2 = $.ajax({
									url: "php/examples/simple/agreeview/agreeview-current/restr_3/process/dognet-docview-doc(restr_3)-main_fetch-process.php",
									type: "post",
									cache: false,
									data: {
		...
		table_doc_main = $('#agreeview-doc-main').DataTable({
			...
			ajax: {
				url: "php/examples/simple/agreeview/agreeview-current/restr_3/process/dognet-agreeview-current(restr_3)-main-process.php",
				type: "POST"
			},
			serverSide: true,
			columns: [{
		...
		var editor_doc_files = new $.fn.dataTable.Editor({
			display: "bootstrap",
			ajax: {
				url: "php/examples/simple/agreeview/agreeview-current/restr_3/process/dognet-agreeview-current(restr_3)-files-process.php",
				data: function(d) {
...
// :::
include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/agreeview/agreeview-current/restr_3/forms/agreeview-current-customForm.php");
include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/agreeview/agreeview-current/restr_3/forms/agreeview-current-filters.php");
// ----- ----- ----- ----- -----
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/agreeview/agreeview-current/restr_3/css/agreeview-current-main.css">
<section>
...
// :::
include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/agreeview/agreeview-current/restr_3/forms/agreeview-current-files-customForm.php");
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/agreeview/agreeview-current/restr_3/css/agreeview-current-files.css">
<section>
...
// :::
include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/agreeview/agreeview-current/restr_3/forms/agreeview-current-modals.php");
?>