        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
            <div class="text-center">
                ...
                if (isset($_GET['format'])) {
                    switch ($_GET['format']) {
                        case "doc":
                            include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/actview/actview-current/restr_4/export-letter/_docx/export2docx.php");
                            break;
                        case "xls":
                            include('');
                            break;
    ...
    $('#isp-selector').change(function() {
        ...
        if ($(this).val() == 'isp1') {
            ...
            if ($(this).val() == 'isp2') {
                ...
                if ($(this).val() == 'isp3') {
                    $('input[name="isp_name"]').val('Иванова В. И.');
                    $('input[name="isp_tel"]').val('8 (495) 660-0802 доб. 302');
