...
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/actview/actview-current/restr_4/css/actview-current-common-tables.css">
				...
				<div id="actview-tabs">
					...
					<div class="tab-content">
						<div id="actview-tab-1" class="tab-pane fade in active">
							<div class="col-xs-12 col-sm-12 col-md-12 сol-lg-12">
								<?php include("tabs/dognet-actview(restr_4)-tab1_docs.php"); ?>
							</div>
						</div>
						<div id="actview-tab-2" class="tab-pane fade">
							<div class="col-xs-12 col-sm-12 col-md-12 сol-lg-12">
								<?php include("tabs/dognet-actview(restr_4)-tab2_log.php"); ?>
							</div>
						</div>
						<div id="actview-tab-3" class="tab-pane fade">
							<div class="col-xs-12 col-sm-12 col-md-12 сol-lg-12">
								<?php include("tabs/dognet-actview(restr_4)-tab3_log.php"); ?>
							</div>
						</div>
					</div>
				</div>
