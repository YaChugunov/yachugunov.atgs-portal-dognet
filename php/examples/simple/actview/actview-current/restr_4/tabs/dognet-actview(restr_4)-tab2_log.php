...
$(document).ready(function() {
	editor_act_log = new $.fn.dataTable.Editor( {
		display: "bootstrap",
		ajax: {
			url: 'php/examples/simple/actview/actview-current/restr_4/process/dognet-actview-current-log_act-process.php'
		},
		table: '#actview-act-log',
	    i18n: {
	        remove: {
	            button: "Удалить",
...
// 		dom: "<'space50'r>tip",
		...
		buttons: [
			...
			{ extend: "remove", editor: editor_act_log, text: '<span class="glyphicon glyphicon-remove"></span>' }
		],
