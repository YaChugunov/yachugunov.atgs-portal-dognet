...
<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		table_doc_main = $('#docview-doc-list').DataTable({
			...
			ajax: {
				url: "php/examples/php/actview/actview-current/dognet-actview-current-docs-process.php",
				type: "POST"
			},
			serverSide: true,
			columns: [{
			...
			columnDefs: [{
				...
				},
				{
					...
					targets: 10,
					render: function(data, type, row, meta) {
						return '<span style="padding:0 5px"><a href="dognet-actview.php?actview_type=list&uniqueID1=' + row.dognet_docbase.koddoc + '&export=yes&format=" title="Сформировать акт выполненных работ"><span class="glyphicon glyphicon-export"></span></a></span><span style="padding:0 5px"><a href="dognet-actview.php?actview_type=list&uniqueID1=' + row.dognet_docbase.koddoc + '&export=letter&zak=' + row.dognet_docbase.kodzakaz + '&format=" title="Сформировать письмо о направлении акта"><span class="glyphicon glyphicon-envelope"></span></a></span>';
					}
				}
			],
			order: [
		...
		$('#docview-doc-list tbody').on('click', 'tr td.details-control', function() {
...
// :::
include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/actview/actview-current/restr_5/forms/actview-current-docs-filters.php");
// ----- ----- ----- ----- -----
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/actview/actview-current/restr_5/css/actview-current-docs-main.css">
<section>
	<div class="demo-html"></div>
	<table id="docview-doc-list" class="table table-responsive table-bordered display compact" cellspacing="0" width="100%">
		<thead>
			<tr>
				<th><span class='glyphicon glyphicon-option-vertical'></span></th>
				<th>№</th>
				<th>Год</th>
				<th>Краткое название договора</th>
				<th>Статус</th>
				<th></th>
				<th></th>
				<th></th>
