...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/actview/actview-current/restr_5/css/actview-current-log_letter-filters.css">
<div id="letter-logsearch-filters-block" class="panel-group">
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" href="#letter-logsearch-filters">Фильтры для поиска в журнале писем</a>
      </h4>
    </div>
    <div id="letter-logsearch-filters" class="panel-collapse collapse">

			<div id="letterview-current-filters" class="panel-body space30">
