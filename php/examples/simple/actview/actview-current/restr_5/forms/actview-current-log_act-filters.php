...
// :::
?>
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/dognet/php/examples/simple/actview/actview-current/restr_5/css/actview-current-log_act-filters.css">
<div id="act-logsearch-filters-block" class="panel-group">
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" href="#act-logsearch-filters">Фильтры для поиска в журнале актов</a>
      </h4>
    </div>
    <div id="act-logsearch-filters" class="panel-collapse collapse">
