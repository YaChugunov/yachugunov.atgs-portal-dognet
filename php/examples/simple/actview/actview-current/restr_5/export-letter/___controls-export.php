...
while ($_ROW = mysqli_fetch_assoc($_QRY)) {
	...
	echo $subname." | ";
// 	$_QRY_A = mysqlQuery( "UPDATE sp_contragents SET zaklastname='".$subname."'" );
}
*/
			...
			<div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 space20">
					<div id="report-settings" class="text-center">
						<h3 class="space10">Письмо заказчику о направлении акта выполненных работ</h3>
				...
				<div class="col-xs-hidden col-sm-12 col-md-12 col-lg-12">
					<div id="export-format-block" class="center-block" style="">
						<form class="form-horizontal" method="GET" action="/dognet/dognet-actview.php">
							...
							<input type="hidden" name="export" value="letter">
								...
								<div class="text-left">
									<div class="form-group">
										...
										<p>
											...
											<span>
												<?php
												// echo $_ROW_B['zakfistname']." ".$_ROW_B['zakmidname']." ".$_ROW_B['zaklastname'];
												echo $_ROW_B['zakfistname'] . " " . $_ROW_B['zakmidname'] . " " . $_ROW_B['zakfio'];
												?>
										</p>
										<p>
		...
		<div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
			<div class="text-center">
				...
				if (isset($_GET['format'])) {
					switch ($_GET['format']) {
						case "doc":
							include($_SERVER['DOCUMENT_ROOT'] . "/dognet/php/examples/simple/actview/actview-current/restr_5/export-letter/_docx/export2docx.php");
							break;
						case "xls":
							include('');
							break;
