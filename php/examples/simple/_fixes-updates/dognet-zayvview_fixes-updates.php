...
.zayv-slider-news { position:relative; padding-right:35px; background-color: #fafafa; z-index:1 }
.zayv-slider-news .slick-arrow{ position:absolute; top:12px; z-index:2 }
.zayv-slider-news-item { height:20px; padding-left:4px; padding-top:2px; color:#999; font-size:12px }
...
.zayv-slider-news-title { position:relative; height:20px; float:left; padding-top:1px; padding-left:2px; padding-right:2px; background:#a94442; color:#fff; border-radius:2px; font-size:12px; font-weight:500; letter-spacing:0.1em; z-index:2 }
.zayv-slider-news-section { color:#000; font-weight:500 }
.zayv-slider-news-msgdate {  }
...
?>
	<div class="zayv-slider-news-item">
		<span class="zayv-slider-news-section">
		<?php
			switch ($_ROW['section']) {
				case "zayvview" :
					echo "Заявки";
